...
$tampil = mysqli_query($conn, "SELECT * FROM CENTRAL_USER WHERE CTR_U_UID = '$id'");
}
        ...
        <div class="form-group">
            <div class="col-md-4">
                ...
                <label for="message-text" class="col-form-label">Username Baru</label>
                 <input type="text" class="form-control" name="username" id="username" class="form-control" value="" minlength="3" oninvalid="this.setCustomValidity('Password minimal 3 karakter')" required/>
