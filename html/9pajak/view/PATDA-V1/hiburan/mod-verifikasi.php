...
function displayMenu() {
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hiburan/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'1','s':'2','f':'fPatdaVerifikasi2','mod':'ver'}") . "\">Tertunda</a></li>\n";
    #echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hiburan/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'2','s':'3','f':'fPatdaVerifikasi2','mod':'ver'}") . "\">Proses</a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hiburan/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'3','s':'4','f':'fPatdaVerifikasi2','mod':'ver'}") . "\">Ditolak</a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hiburan/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'4','s':'5','f':'fPatdaVerifikasi2','mod':'ver'}") . "\">Disetujui</a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hiburan/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'5','s':'0','f':'fPatdaVerifikasi2','mod':'ver'}") . "\">Semua Data</a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hiburan/svc-list-pembanding.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'6'}") . "\">Data Pembanding</a></li>\n";
    echo "\t</ul>\n";
}
?>
