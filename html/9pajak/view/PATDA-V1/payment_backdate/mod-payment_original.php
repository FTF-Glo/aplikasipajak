...
<table class="main" width="1200" cellpadding="0" cellspacing="0" border="0">
		...
		<td width="45%" >
			<form id="form-inquiry" method="post" enctype="multipart/form-data">
				<table border="0" width="100%" align="center" class="child" style="padding:10px">
					<tr>
						<td width="25%">Kode Bayar<b class="isi">*</b></td>
						<td width="75%"> : 
							<input type="text" name="payment_code" id="payment_code" style="width:200px" autocomplete="off" placeholder="masukan kode bayar">
						</td>
					</tr>
					...
					<tr>
						...
						<td width="75%">
							...
							<label>
                                <input type="checkbox" id="KURANG_BAYAR">
                                Kurang Bayar
                            </label>
						</td>
					</tr>
					...
					<tr>
						<td width="150" style="padding-top:33px"><label style='cursor:pointer'>Upload Bukti Bayar</label></td>
						<td id="berkas" style="display:none">
							<br>
	...
	<tr>
		...
		<td align="right" style="border-top:2px #CCC solid">
			...
			<button type="button" id="btnKurangBayar" class="button" style="margin:10px">Kurang Bayar</button>
		</td>
	</tr>
</table>
