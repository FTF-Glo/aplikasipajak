...
require_once($sRootPath . "function/{$DIR}/{$modul}/{$submodul}/class-surveillance.php");
...
<script type="text/javascript">
    ...
    // Add : parameter
    function get_resume(parameter, id){
	     var allid = '';
	     $('.loadsign').html("<img src='inc/PATDA-V1/img/ui-anim_basic_16x16.gif'>");
	     // Add : parameter dateStart, dateEnd, noTran to svc_tran_restoran.php [OST - 14/05/2018]
	     $.ajax({
		     type:'post',
		     data:parameter,
		     url : "view/<?php echo $DIR."/".$modul."/".$submodul?>/svc-laporan-harian.php?function=get_resume&a=<?php echo $q->a?>&m=<?php echo $q->m?>&i="+id,
		     dataType:'json',
