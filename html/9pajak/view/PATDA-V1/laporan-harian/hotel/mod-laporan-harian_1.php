...
function displayMenu() {
	...
	echo "\t<ul>\n";
	//echo "\t\t<li><a href=\"view/{$DIR}/laporan-harian/hotel/svc-list-tran.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'1','s':'1','f':'fPatdaLapor3','mod':'pel'}") . "\">Belum dilaporkan </a></li>\n";
    //echo "\t\t<li><a href=\"view/{$DIR}/laporan-harian/hotel/svc-list-tran.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'2','s':'2','f':'fPatdaLapor3','mod':'pel'}") . "\">Sudah dilaporkan </a></li>\n";
    echo "\t\t<li><a href=\"view/{$DIR}/laporan-harian/hotel/svc-list-tran.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'5','s':'0','f':'fPatdaLapor3','mod':'pel'}") . "\">Semua Data</a></li>\n";
	echo "\t</ul>\n";
}
?>
