...
function displayMenu() {
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/skpdkb/svc-list-berkas.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'1','s':'1','f':'fPatdaBerkasSKPDKB','mod':'ply'}") . "\">Berkas Masuk <b class='notif masuk'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/skpdkb/svc-list-berkas.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'2','s':'2','f':'fPatdaBerkasSKPDKB','mod':'ply'}") . "\">Berkas Diterima <b class='notif diterima'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/skpdkb/svc-list-berkas.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'3','s':'5','f':'fPatdaPenetapan','mod':'ply'}") . "\">Cetak SSPD <b class='notif disetujui'></b></a></li>\n";
...
<script type="text/javascript">
    ...
    $.ajax({
        ...
        url: "function/<?php echo $DIR ?>/pelayanan/skpdkb/svc-berkas-skpdkb.php",
        dataType: "json",
	...
	function download_excel(id, url, type) {
        ...
        var skpdkb = document.createElement("input");
        skpdkb.setAttribute("type", "hidden");
        skpdkb.setAttribute("name", 'CPM_NO_SKPDKB');
        skpdkb.setAttribute("value", $('#CPM_NO_SKPDKB-' + id).val());
        form.appendChild(skpdkb);
