...
function displayMenu()
{
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/reklame/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'1','s':'1','f':'fPatdaPelayanan7','mod':'pel'}") . "\">Draft <b class='notif draf_ply'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/reklame/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'2','s':'2','f':'fPatdaPelayanan7','mod':'pel'}") . "\">Proses <b class='notif proses_ply'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/reklame/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'3','s':'4','f':'fPatdaPelayanan7','mod':'pel'}") . "\">Ditolak <b class='notif ditolak_ply'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/reklame/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'4','s':'5','f':'fPatdaPelayanan7','mod':'pel'}") . "\">Disetujui <b class='notif disetujui_ply'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/reklame/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'5','s':'0','f':'fPatdaPelayanan7','mod':'pel'}") . "\">Semua Data</a></li>\n";
    echo "\t</ul>\n";
}
?>
...
<script type="text/javascript">
    ...
    function download_excel(id, url) {
        ...
        var jenis_pajak = document.createElement("input");
        jenis_pajak.setAttribute("type", "hidden");
        jenis_pajak.setAttribute("name", 'CPM_JENIS_PJK');
        jenis_pajak.setAttribute("value", $('#CPM_JENIS_PJK-' + id).val());
        form.appendChild(jenis_pajak);
        ...
        //
        var filterv2 = document.createElement("input");
        filterv2.setAttribute("type", "hidden");
        filterv2.setAttribute("name", 'CPM_FILTER_V2');
        filterv2.setAttribute("value", $('#CPM_FILTER_V2-' + id).val());
        form.appendChild(filterv2);


        var nomor_rekening = document.createElement("input");
        nomor_rekening.setAttribute("type", "hidden");
        nomor_rekening.setAttribute("name", 'CPM_REKENING');
        nomor_rekening.setAttribute("value", $('#CPM_KODE_REKENING-' + id).val());
