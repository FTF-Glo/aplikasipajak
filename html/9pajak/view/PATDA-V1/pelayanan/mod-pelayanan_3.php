...
function displayMenu() {
    ...
    if($_SESSION['role'] == 'rmPatdaWp'){
		echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/{$DIR}/pelayanan/svc-list-berkas.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'3','s':'5','f':'fPatdaBerkas','mod':'ply'}") . "\">Cetak SSPD <b class=''></b></a></li>\n";
    echo "\t</ul>\n";
	}else{
	
		echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/{$DIR}/pelayanan/svc-list-berkas.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'1','s':'1','f':'fPatdaBerkas','mod':'ply'}") . "\">Berkas Masuk <b class='notif masuk'></b></a></li>\n";
    echo "\t\t<li><a href=\"view/{$DIR}/pelayanan/svc-list-berkas.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'2','s':'2','f':'fPatdaBerkas','mod':'ply'}") . "\">Berkas Diterima <b class='notif diterima'></b></a></li>\n";
    echo "\t\t<li><a href=\"view/{$DIR}/pelayanan/svc-list-berkas.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'3','s':'5','f':'fPatdaBerkas','mod':'ply'}") . "\">Cetak SSPD <b class='notif disetujui'></b></a></li>\n";

	echo "\t\t<li><a href=\"view/{$DIR}/pelayanan/svc-list-berkas.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'5','s':'5','f':'fPatdaBerkas','mod':'ply'}") . "\">Berkas Expired <b class='notif disetujui'></b></a></li>\n";
