...
function displayMenu() {
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/jalan/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'1','s':'1','f':'fPatdaPelayanan6','mod':'pel'}") . "\">Draft <b class='notif draf_ply'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/jalan/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'2','s':'2','f':'fPatdaPelayanan6','mod':'pel'}") . "\">Proses <b class='notif proses_ply'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/jalan/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'3','s':'4','f':'fPatdaPelayanan6','mod':'pel'}") . "\">Ditolak <b class='notif ditolak_ply'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/jalan/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'4','s':'5','f':'fPatdaPelayanan6','mod':'pel'}") . "\">Disetujui <b class='notif disetujui_ply'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/pelayanan/jalan/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'5','s':'0','f':'fPatdaPelayanan6','mod':'pel'}") . "\">Semua Data</a></li>\n";
    echo "\t</ul>\n";
}
?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            url: "function/<?php echo $DIR ?>/jalan/lapor/svc-lapor.php",
            dataType: "json",
