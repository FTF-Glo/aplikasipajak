...
function displayMenu() {
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"view/{$DIR}/monitoring/trans-surveillance/svc-list-tran.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'2'}") . "\">Daftar Transaksi</a></li>\n";
	echo "\t</ul>\n";
}
?>
...
<script type="text/javascript">
    ...
    function download_excel(id, url, p, l) {
        ...
        if ($("#cBox").is(":hidden")) {
            var nmfileAll = 'file-surveillance';
...
<div id="cBox" class="animate" style="width: 205px;z-index:9999; height: 300px; right:25%; top: 35%; border: 1px solid gray; background-color: #eaeaea; display: none; position:fixed; overflow: auto;">
