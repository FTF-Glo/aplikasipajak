...
<script type="text/javascript">
    ...
    function get_resume(dateStart, dateEnd, noTran){
	     var allid = '';
	     ...
	     $.ajax({
		     type:'post',
		     data:{allid:allid},
		     url : "view/<?php echo $DIR."/".$modul."/".$submodul?>/svc-tran-hotel.php?function=get_resume&a=<?php echo $q->a?>&m=<?php echo $q->m?>&dateStart="+dateStart+"&dateEnd="+dateEnd+"&noTran="+noTran,
		     dataType:'json',
