...
function displayMenu() {
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"view/{$DIR}/monitoring/tran-hotel/svc-list-tran.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'2'}") . "\">Daftar Transaksi</a></li>\n";
	echo "\t</ul>\n";
}
?>
...
<div id="cBox" style="width: 205px;z-index:9999; height: 300px; right:35%; top: 10%; border: 1px solid gray; background-color: #eaeaea; display: none; position:fixed; overflow: auto;">
