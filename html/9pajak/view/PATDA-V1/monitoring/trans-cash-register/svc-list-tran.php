...
require_once($sRootPath . "function/{$DIR}/{$modul}/class-cash-register.php");
...
$tran = new TransaksiCashRegister();
?>
<script type="text/javascript">
    ...
    function get_resume(parameter){
	     ...
	     $.ajax({
		     type:'post',
		     data:parameter,
		     url : "view/<?php echo $DIR."/".$modul."/".$submodul?>/svc-trans-cash-register.php?function=get_resume&a=<?php echo $q->a?>&m=<?php echo $q->m?>",
		     dataType:'json',
