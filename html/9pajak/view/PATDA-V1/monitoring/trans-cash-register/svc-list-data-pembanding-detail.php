...
require_once($sRootPath . "function/{$DIR}/monitoring/class-cash-register.php");
...
$lapor = new TransaksiCashRegister();
...
if($_GET["action"] == "list"){
	...
	$lapor->insertRecord($_POST["npwpd"],$_POST["nop"],$_POST["tran_code"],$_POST["tax_code"],$tran_date,$tran_amount);	
}
?>
