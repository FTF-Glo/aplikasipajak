...
function displayMenu() {
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a class='tab' href=\"view/{$DIR}/monitoring/dashboard-tapbox/svc-list-alarm.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'1'}") . "\">Alarm Device</a></li>\n";
	echo "\t\t<li><a class='tab' href=\"view/{$DIR}/monitoring/dashboard-tapbox/svc-list-status.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'2'}") . "\">Alarm Status Transaksi</a></li>\n";
	echo "\t</ul>\n";
}
?>
