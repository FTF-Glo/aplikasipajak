...
function displayMenu() {
    ...
    echo "\t<ul>\n";    
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/penetapan/svc-list-penetapan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'2','s':'2','f':'fPatdaVerifikasiPenetapan','mod':'ver'}") . "\">Tertunda <b class='notif tertunda'></b></a></li>\n";    
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/penetapan/svc-list-penetapan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'3','s':'4','f':'fPatdaVerifikasiPenetapan','mod':'ver'}") . "\">Ditolak <b class='notif ditolak'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/penetapan/svc-list-penetapan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'4','s':'5','f':'fPatdaVerifikasiPenetapan','mod':'ver'}") . "\">Disetujui <b class='notif disetujui'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/penetapan/svc-list-penetapan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'5','s':'0','f':'fPatdaVerifikasiPenetapan','mod':'ver'}") . "\">Semua Data</a></li>\n";
    echo "\t</ul>\n";
}
?>
