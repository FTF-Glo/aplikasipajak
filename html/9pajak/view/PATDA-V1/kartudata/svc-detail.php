...
require_once($sRootPath . "function/{$DIR}/{$modul}/class-kartudata.php");
...
$p = $json->decode(base64_decode($_REQUEST['p']));

$_REQUEST['npwpd'] = $p->npwpd;
$_REQUEST['tahun'] = $p->tahun;
$_REQUEST['jenis'] = $p->jenis;

$message  = new Message();
$message->show();
$berkas = new KartuData();
$berkas->grid_table_detail();
?>
