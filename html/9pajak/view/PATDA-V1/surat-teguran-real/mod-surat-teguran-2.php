...
function displayMenu() {
    global $DIR, $a, $m, $data;
    echo "\t<ul>\n";
	echo "\t\t<li><a href=\"view/{$DIR}/surat-teguran-real/svc-list-teguran-jatuh-tempo-2.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'6','s':'0','f':'fPatdaSuratTeguranReal4','mod':'pel'}") . "\">Semua Data</a></li>\n";
    echo "\t\t<li><a href=\"view/{$DIR}/surat-teguran-real/svc-list-teguran-2.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'1','s':'0','f':'fPatdaSuratTeguranReal2','mod':'pel'}") . "\">Teguran 2</a></li>\n";
    echo "\t</ul>\n";
}
?>
