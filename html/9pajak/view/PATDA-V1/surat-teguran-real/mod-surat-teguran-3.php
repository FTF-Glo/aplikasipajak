...
function displayMenu() {
    global $DIR, $a, $m, $data;
    echo "\t<ul>\n";
	echo "\t\t<li><a href=\"view/{$DIR}/surat-teguran-real/svc-list-teguran-jatuh-tempo-3.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'6','s':'0','f':'fPatdaSuratTeguranReal5','mod':'pel'}") . "\">Semua Data</a></li>\n";
    echo "\t\t<li><a href=\"view/{$DIR}/surat-teguran-real/svc-list-teguran-3.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'1','s':'0','f':'fPatdaSuratTeguranReal6','mod':'pel'}") . "\">Teguran 3</a></li>\n";
    echo "\t</ul>\n";
}
?>
