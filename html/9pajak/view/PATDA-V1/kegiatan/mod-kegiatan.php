...
function displayMenu()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a  class='tab' href=\"view/{$DIR}/kegiatan/svc-list-kegiatan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'1','s':'1','f':'fPatdaPelayananLaporkegiatan','mod':''}") . "\">Daftar Pelaksana Kegiatan</a></li>\n";
