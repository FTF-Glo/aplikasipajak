...
function displayMenu() {
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hotel/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'1','s':'2','f':'fPatdaVerifikasi3','mod':'ver'}") . "\">Tertunda <b class='notif tertunda'></b></a></li>\n";
    #echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hotel/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'2','s':'3','f':'fPatdaVerifikasi3','mod':'ver'}") . "\">Proses</a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hotel/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'3','s':'4','f':'fPatdaVerifikasi3','mod':'ver'}") . "\">Ditolak <b class='notif ditolak_ver'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hotel/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'4','s':'5','f':'fPatdaVerifikasi3','mod':'ver'}") . "\">Disetujui <b class='notif disetujui_ver'></b></a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hotel/svc-list-pelaporan.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'5','s':'0','f':'fPatdaVerifikasi3','mod':'ver'}") . "\">Semua Data</a></li>\n";
    echo "\t\t<li><a class='tab' href=\"view/{$DIR}/hotel/svc-list-pembanding.php?q=" . base64_encode("{'a':'$a', 'm':'$m','u':'$data->uname','i':'6'}") . "\">Data Pembanding</a></li>\n";
    echo "\t</ul>\n";
}
?>
...
<script type="text/javascript">
    ...
    function getDetTranTapbox(json) {
        ...
        $.ajax({
            ...
            type: "post",
            url: "view/<?php echo $DIR ?>/hotel/svc-list-pembanding-detail.php",
