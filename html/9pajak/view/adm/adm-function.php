...
<?php
			...
			foreach ($FuncIds as $FuncId) {
				$id = isset($FuncId["id"])?$FuncId["id"]:null;
				$mid = isset($FuncId["mid"])?$FuncId["mid"]:null;
				$mname = isset($FuncId["mname"])?$FuncId["mname"]:null;
				$name = isset($FuncId["name"])?$FuncId["name"]:null;
				$page = isset($FuncId["page"])?$FuncId["page"]:null;
				$image = isset($FuncId["image"])?$FuncId["image"]:null;
				$pos = isset($FuncId["pos"])?$FuncId["pos"]:null;
