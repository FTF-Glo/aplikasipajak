...
// if ($_SERVER['HTTP_USER_AGENT'] == 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36') {
						...
						<div class='navbar-header'>
							<ul class='nav navbar-nav'>
								...
								<li class='nav-item mobile-menu hidden-md-up float-xs-left'><a class='nav-link nav-menu-main menu-toggle hidden-xs'><i class='icon-menu5 font-large-1'></i></a></li>
															<li class='nav-item'><a href='#' class='navbar-brand nav-link'><img style='color:white; font-size:32px;' height='40px' alt='9 PAJAK ONLINE' src='#' data-expand='style/default/pring.png' data-collapse='style/default/logo.png' class='brand-logo'></a></li>
		...
		if ($data) {
			...
			$uname = $User->GetUserName($uid);
				...
				if($a == 'aPatda' && $m == null){
					...
					if($_SESSION['role']  == 'rmPatdaAdmin'){
						header("Location: main.php?param=YT1hUGF0ZGEmbT1tUGF0ZGFNb25EYXNoYm9hcmRHcmFmaWtQZW5jYXBhaWFu");
					}
			echo'<div class="app-content content container-fluid">';
			echo'<div class="content-wrapper">';
			echo "<div id='content'>";
			...
			<div class="card-header" style="text-align:center;">
				...
				<span class="font-weight-bold" style="font-size:24px;">9 PAJAK ONLINE</span>
			</div>
			<div class="card-body">
				<img src="style/default/logo.png" height="400px" width="auto" class="rounded mx-auto d-block mt-1 mb-1" alt="...">
			</div>
			</div>
