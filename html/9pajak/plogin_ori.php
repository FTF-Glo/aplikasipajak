...
?>
	...
	<div class="formLeft spiner-logo">
		<p style="font-size:22px" ><b>9 PAJAK ONLINE</b></p>
		<br>
		<img src='<?php echo $MAINstyle["logo"] ?>' id='logo' alt='<?php echo $MAINtitle?>' width="160" height="195"/>
			...
			<div class="formRight">
			<p style="font-size:22px; padding-bottom:6px;"><b>LOGIN</b></p>
...
?>
	...
	<!-- <div><br><a href='registrasi/registrasi.php'>Registrasi User Notaris Baru</a> -->
