						...
						<div class='navbar-header'>
							<ul class='nav navbar-nav'>
								...
								<li class='nav-item mobile-menu hidden-md-up float-xs-left'><a class='nav-link nav-menu-main menu-toggle hidden-xs'><i class='icon-menu5 font-large-1'></i></a></li>
															<li class='nav-item'><a href='#' class='navbar-brand nav-link'><img style='color:white; font-size:32px;' height='40px' alt='9 PAJAK' src='#' data-expand='style/default/logoxx.png' data-collapse='style/default/logo.png' class='brand-logo'></a></li>
	  ...
	  class='vertical-layout vertical-menu 2-columns  fixed-navbar'>
		...
		if ($data) {
			...
			<div class="card-header" style="text-align:center;">
				...
				<span class="font-weight-bold" style="font-size:24px;"> AlfaTax | 9 PAJAK</span>
			</div>
			<div class="card-body">
