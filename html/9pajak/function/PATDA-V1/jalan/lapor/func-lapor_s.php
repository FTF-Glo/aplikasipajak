                ...
                <table width="100%" border="0" align="center" class="child">
                    ...
                    <tr valign="top">
                        ...
                        <td width="200" rowspan="9">Keterangan :</br>
                            <textarea class="form-control" name="PAJAK[CPM_KETERANGAN]" id="CPM_KETERANGAN" rows="10" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Keterangan"><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td> : <input type="text" name="PAJAK[CPM_PEMBANGKIT]" id="CPM_PEMBANGKIT" class="number" maxlength="19" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> value="<?php echo $DATA['pajak']['CPM_PEMBANGKIT']; ?>" placeholder="Kapasitas Pembangkit"></td>
                        </tr>
                        <tr>
                            <td width="250">Faktor Daya <b class="isi">*</b></td>
                            <td> : <input type="text" name="PAJAK[CPM_FAKTOR_DAYA]" id="CPM_FAKTOR_DAYA" class="number" maxlength="19" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> value="<?php echo $DATA['pajak']['CPM_FAKTOR_DAYA']; ?>" placeholder="Faktor Daya"></td>
                        </tr>
                        <tr>
                            <td width="250">Harga Satuan <b class="isi">*</b></td>
                            <td> : <input type="text" name="PAJAK[CPM_SATUAN]" id="CPM_SATUAN" class="number" maxlength="19" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> value="<?php echo $DATA['pajak']['CPM_SATUAN']; ?>" placeholder="Harga Satuan"> </td>
                        </tr>
                        <tr>
                            <td width="250">Pemakaian <b class="isi">*</b></td>
                            <td> : <input type="text" name="PAJAK[CPM_TOTAL_KWH]" id="CPM_TOTAL_KWH" class="number" maxlength="19" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> value="<?php echo $DATA['pajak']['CPM_TOTAL_KWH']; ?>" placeholder="Total Jam"> Satuan Jam</td>
                        </tr>

                        <!-- <tr>
                                <td width="250">Kapasitas Daya<b class="isi">*</b></td>
                                <td> : <input type="text" name="PAJAK[CPM_TOTAL_KVA]" id="CPM_TOTAL_KVA" class="number" maxlength="19" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> value="<?php echo $DATA['pajak']['CPM_TOTAL_KVA']; ?>" placeholder="Satuan Kva"> Satuan Kva </td>
                            </tr>

                            <tr>
                                <td width="250">Pemakaian <b class="isi">*</b></td>
                                <td> : <input type="text" name="PAJAK[CPM_TOTAL_KWH]" id="CPM_TOTAL_KWH" class="number" maxlength="19" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> value="<?php echo $DATA['pajak']['CPM_TOTAL_KWH']; ?>" placeholder="Total Kwh"> Satuan Kwh</td>
                            </tr>

                            <tr>
                                <td width="250">Jam Nyala<b class="isi">*</b></td>
                                <td> : <input type="text" name="PAJAK[CPM_NYALA]" id="CPM_NYALA" class="number" maxlength="19" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> value="<?php echo $DATA['pajak']['CPM_NYALA']; ?>" placeholder="Jam Nyala"></td>
                            </tr> -->
                    <?php
                    } else {
                    ?>
                        <tr>
                            <td width="250">Pemakaian <b class="isi">*</b></td>
                            <td> : <input type="text" name="PAJAK[CPM_TOTAL_KWH]" id="CPM_TOTAL_KWH2" class="number" maxlength="19" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> value="<?php echo $DATA['pajak']['CPM_TOTAL_KWH']; ?>" placeholder="Total Kwh"> Satuan Kwh</td>
                        </tr>
                    <?php
                    }
                    ?>
                    ...
                    <tr>
                        ...
                        <td> : <input type="text" name="PAJAK[CPM_TOTAL_OMZET]" id="CPM_TOTAL_OMZET" class="number SUM" maxlength="19" value="<?php echo $DATA['pajak']['CPM_TOTAL_OMZET'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Pembayaran Pemakaian"></td>
                    </tr>
                    <tr style="display:none">
                        <td>Pembayaran Lain-lain</td>
                        <td> : <input type="text" name="PAJAK[CPM_BAYAR_LAINNYA]" id="CPM_BAYAR_LAINNYA" class="number SUM" maxlength="19" value="<?php echo $DATA['pajak']['CPM_BAYAR_LAINNYA'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Pembayaran Lain-lain"></td>
                    </tr>
                    <tr>
                        <td>Dasar Pengenaan Pajak (DPP)</td>
                        <td> : <input type="text" name="PAJAK[CPM_DPP]" id="CPM_DPP" class="number" readonly maxlength="19" value="<?php echo $DATA['pajak']['CPM_DPP'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Dasar Pengenaan Pajak (DPP)"></td>
                    </tr>
                    <tr>
