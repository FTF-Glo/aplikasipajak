...
function hitung_total() {
	...
	var omzet = parseFloat($("#CPM_TOTAL_OMZET").autoNumeric("get"));
	// var omzet = 0;
	// console.log(omzet);
	var kurangLebih = 0;
	var count = parseInt($("#count").val());
...
$('#CPM_TOTAL_OMZET-'+ no ).keyup(function () {
   ...
   //console.log(jum) ;
    ...
    var total= tot+a;
    total=Math.ceil(total)
    console.log('iani adalah jumlah : '+ jum);
    console.log(a);
    $('#CPM_ATR_TOTAL-'+no).autoNumeric('set', terutang+jum); 
    $('#CPM_BAYAR_TERUTANG').autoNumeric('set',jum); 
