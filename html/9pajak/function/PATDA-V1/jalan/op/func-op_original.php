			...
			<?php if (isset($nop)): ?>
				...
				<tr valign="top">
					...
					<td>: <select name="PROFIL[CPM_REKENING]" id="CPM_REKENING">
						...
						<input type="hidden" name="PROFIL[CPM_JENIS_JALAN]" value="" />
					</td>
				</tr>
				<tr>
				...
				<!-- <tr valign="top">
					...
					<td>: 
						<select name="PROFIL[CPM_JENIS_JALAN]" id="CPM_JENIS_JALAN">
							<?php
							$arr_jenis = array('PLN' => 'PLN', 'Non PLN' => 'Non PLN', 'Listrik industry' => 'Listrik industry', 'Listrik dihasilkan sendiri' => 'Listrik dihasilkan sendiri');
							foreach ($arr_jenis as $k => $v) {
								$sel = $value['CPM_JENIS_JALAN'] == $k ? ' selected' : '';
