$(document).ready(function() {
    ...
    form.validate({
        ...
        messages: {
            ...
            "PROFIL[CPM_GOL_JALAN]": "harus diisi"
        }
    });
    ...
    $("#CPM_NPWPD").keyup(function() {
        ...
        $("#CPM_NAMA_OP").val('');
        $("#CPM_ALAMAT_OP").val('');
        $("#CPM_GOL_JALAN option").prop('selected', false);
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.result == 1) {
                    ...
                    $("#CPM_GOL_JALAN option[value='" + res.CPM_GOL_JALAN + "']").prop('selected', true);
                } else {
