...
class LaporPajak extends Pajak
{
	...
	// 	// die;
	// 	$tgl_percetakan = $this->tgl_indo_full(date('Y-m-d'));
	// 	$npwdR = "P" . implode(".", str_split(substr($DATA['CPM_NPWPD'], 1), 3));
	...
	// 									<b style=\"font-size:45px\"> <br/>SKPD<br/>
	...
	// 				<tr>
	// 				<td colspan=\"2\">
	// 					<table width=\"310\" border=\"1\" cellpadding=\"3\" border=\"1\" cellspacing=\"0\">
	// 						<tr>
	// 						<table width=\"500\" cellpadding=\"3\" border=\"1\" cellspacing=\"0\">
	// 							<tr>
	// 								<td width=\"350\" align=\"left\"><b>Tanggal Jatuh Tempo : </b></td>
	// 								<td width=\"360\" align=\"left\"><b>No. SKPD : {$NO_URUT}</b></td>
	// 							</tr>
	// 						</table>
	// 						</tr>
	// 					</table>
	...
	// 										</td>
	// 										<td align=\"right\">
	// 											<b>" . number_format($DATA['CPM_TOTAL_OMZET'] + $DENDA, 0) . "</b>
	// 										</td>
	// 									</tr>
	// 									<tr>
	// 										<td align=\"left\" colspan=\"4\">
	// 										Dengan huruf :<br/>
	// 										<b><i>" . ucwords($this->SayInIndonesian($DATA['CPM_BAYAR_TERUTANG'] + $DENDA)) . "</i></b>
	// 										</td>
	...
	// 									</tr>
	// 									<tr>
	// 										<td>&nbsp;&nbsp;&nbsp;1. Harap Penyetoran dilakukan BKP atau Kas Daerah ( Bank yang ditunjuk) dengan menggunakan Surat Setoran Pajak Daerah ( SSPD ).</td>
	// 									</tr>
	// 									<tr>
	// 										<td>&nbsp;&nbsp;&nbsp;2. Apabila SKPD ini tidak atau kurang dibayar lewat waktu paling lama 30 hari sejak SKPD ini diterima, <br>
	// 										&nbsp;&nbsp; &nbsp; &nbsp;
	// 										dikenakan sanksi administrasi berupa bunga sebesar 2% perbulan.</td>
	// 									</tr>
	// 								</table>
	// 								</td>
	// 							</tr>
	...
	// 									<u>PUTRA A. GUNAWAN, S.Sos, MM</u><br/>
	// 									NIP. 19740830 200003 1 001
	// 								</b></td>
	// 							</tr>
	// 						</table>
	// 					</td>
	...
	public function print_skpd($type = "")
	{
		...
		foreach ($pajak_atr as $no => $atr) {
			...
			$panajng_lebar =  round($atr['CPM_ATR_LEBAR'] * $atr['CPM_ATR_PANJANG'], 2);
			...
			if ($atr['CPM_ATR_REKENING'] == "4.1.01.09.01.005") {
				...
				$tot_terpasang = round($atr['CPM_ATR_HARGA'] * $biaya);
				$total_ketetapan = $tot_terpasang * $panajng_lebar *  intval($atr['CPM_ATR_JUMLAH_HARI']) * $atr['CPM_ATR_JUMLAH'] * $jam;
			} else {
			...
			$html .= "<tr>
											...
											<td align=\"left\">
												...
												" . number_format($atr['CPM_ATR_PANJANG'], 2) . "M x {$atr['CPM_ATR_LEBAR']}M x  " . intval($atr['CPM_ATR_JUMLAH']) . " Buah x " . intval($DATA['CPM_MASA_PAJAK']) . " {$DATA['CPM_JNS_MASA_PAJAK']} x Rp. " . number_format($atr['CPM_ATR_HARGA']) . " / {$DATA['CPM_JNS_MASA_PAJAK']} / M<sup>2</sup> x 25% " . ($atr['CPM_ATR_ALKOHOL_ROKOK'] == 1 ? "+" . number_format($penambahan) : "") . " " . ($atr['CPM_ATR_GEDUNG'] == 'DALAM' ? "- (" . number_format($penambahan) . ")" : "") . "<br>
		...
		$html .= "<tr>
										...
										<tr>
											...
											<td align=\"right\">
												<b>" .  number_format($total_keseluruhan_jumlah) . "</b>
											</td>
										</tr>
										<tr>
											<td align=\"left\" colspan=\"4\">
						...
						<td colspan=\"2\" align=\"center\" style=\"font-size:24px;\">
							<table width=\"100%\" border=\"0\" align=\"left\" cellpadding=\"10\">
								<tr>
									<td width=\"355\"></td>
									<td align=\"center\"><b>
										Bandar Lampung, " . date("d") . " {$this->arr_bulan[(int) date("m")]} " . date("Y") . " {$tgl_approve} <br/>
										a.n. Kepala Badan Pengelola Pajak dan Retribusi Daerah <br/> Bandar Lampung <br/>
		...
		$page1 .= "<br>
					...
					<span style=\"font-size:24px\"><i>BPPRD BALAM {$tgl_cetak}</i></span>
                </table>";
		// echo $page1; exit;
		require_once("{$sRootPath}inc/payment/tcpdf/sptpd_pdf.php");
		$pdf = new SPTPD_PDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
                        ...
                        <td width=\"710\" colspan=\"2\" align=\"center\"><table width=\"100%\" border=\"0\" align=\"left\" cellpadding=\"5\">
							<tr style=\"font-size:28px\">
								<td><table width=\"130%\" border=\"0\" align=\"left\">
										...
										<tr>
											<td>&nbsp;&nbsp;&nbsp;1. Setelah Formulir SPTD ini ditandatangani, wajib diserahkan <br>  &nbsp;&nbsp;&nbsp; kembali kepada Badan Pengelola Pajak dan Retribusi Daerah <br> &nbsp;&nbsp;&nbsp;&nbsp; Kota Bandar Lampung</td>
										</tr>
										<tr>
					...
					<tr>
						<td colspan=\"2\"><table width=\"100%\" border=\"0\" align=\"left\" cellpadding=\"10\">
									...
									<td><table width=\"700\" cellpadding=\"0\" border-right=\"0\" cellspacing=\"0\"><br><br>
											...
											<tr align=\"center\">
												<td width=\"300\"><i>Official Assesment(Dihitung dan ditetapkan oleh Pejabat BPPRD)</i></td>
											</tr>
										</table>
									</td>
	...
	public function print_sspd()
	{
		...
		// Jika melebihi tanggal jatuh tempo, tambahkan denda 2% per bulan
		...
		$html .= " <tr>
					...
					<span style=\"font-size:24px\"><i>BPPRD BANDAR LAMPUNG {$tgl_cetak}</i></span>
	...
	public function print_nota_hitung()
	{
		...
		// if ($flag == 0 && ($DATA->CPM_MASA_PAJAK1 != '' || $DATA->CPM_MASA_PAJAK1 != NULL)) {
		// 	// Denda otomatis
		// 	$total_pajak = $DATA->CPM_TOTAL_OMZET;
		// 	$tgl_jatuh_tempo = $DATA->CPM_MASA_PAJAK1;
		// 	$tgl_jatuh_tempo_obj = date_create_from_format("d/m/Y", $tgl_jatuh_tempo);
		...
		foreach ($pajak_atr as $no => $atr) {
			...
			if ($atr['CPM_ATR_REKENING'] == "4.1.01.09.01.005") {
				...
				$tot_terpasang = round($atr['CPM_ATR_HARGA'] * $biaya);
				$total_ketetapan = $tot_terpasang * $panajng_lebar * $atr['CPM_ATR_JUMLAH_HARI'] * $atr['CPM_ATR_JUMLAH'] * $jam;
			} else {
			...
			if ($DATA->CPM_NO == '900001783/REK/23') {
				$total_keseluruhan_jumlah = 43449600;
				$total_seluruh = 43449600;
			}
			$total_huruf = round($total_keseluruhan_jumlah);
			...
			$row_atr .= "<tr>
												...
												<td align=\"center\">{$atr['CPM_ATR_REKENING']}</td>
												<td>Rp." . number_format($atr['CPM_ATR_HARGA'], 2) . " x {$DATA->CPM_MASA_PAJAK} {$DATA->CPM_JNS_MASA_PAJAK} x {$panajng_lebar} M x {$atr['CPM_ATR_JUMLAH']} Buah x  " . number_format($atr['CPM_ATR_BIAYA']) . '% ' . ($atr['CPM_ATR_ALKOHOL_ROKOK'] == 1 ? "+" . number_format($penambahan) : "") . " " . ($atr['CPM_ATR_GEDUNG'] == 'DALAM' ? "- (" . number_format($penambahan) . ")" : "") . "</td>
												<td  align=\"right\">" . number_format($total_ketetapan) . "</td>
		...
		<td align=\"right\">" . (number_format($DENDA)) . "</td>
		<td align=\"right\"><b>" . number_format($total_keseluruhan_jumlah) . "</b></td>
</tr>";
		$html .= "						
										</table>
													...
													<table width=\"299\" border=\"0\">
														<tr>
															<td width=\"289\" align=\"center\">
																Diperiksa oleh :<br/>KASUBID PENDAFTARAN<br>
															</td>
														</tr>
														<tr>
															<td><p>&nbsp;</p>
														...
														<tr>
															<td align=\"center\">
															<strong><u>RISWAN ISMAIL, S.Sos, MM</u></strong><br/>
															NIP. 19690402200801 1 010</td>
														</tr>
													</table>
												</td>
												<td>
