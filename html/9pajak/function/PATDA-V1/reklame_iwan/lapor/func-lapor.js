...
function playSound() {
	var sounbd = $("#myAudio");
	var audioSource = $(sounbd).find('source').attr('src');
...
// setInterval(() => {
// 	$.ajax({
//         url: 'function/PATDA-V1/reklame/lapor/class-lapor.php',
//         type: 'GET',
//         data: {
//             no_ktp_wp: ktpNumber
//         },
...
$(function () {
	$(".datepicker").datepicker({
		...
		onSelect: function (dateText) {
			var batasAwal = document.getElementById('CPM_ATR_BATAS_AWAL').value;
			var year = new Date(batasAwal).getFullYear();
			document.getElementById('CPM_TAHUN_PAJAK').value = year;
			$("#CPM_ATR_TYPE_MASA").trigger("change");
