...
class BerkasPajak extends Pajak {
	...
	public function update() {
		...
		$res = mysql_query($query, $this->Conn);
		 ...
		 $id_tranmain = $this->getIDTranmain($this->CPM_ID);
		 $base644 = "a=aPatda&m=mPatdaPelayananPelapor2&mod=pel&f=fPatdaPelayanan2&id={$$this->CPM_ID}&s=2&i=2&flg=0&info=&idtran=f4c89d6558fdfb94add32971c8f45942&read=0";
	...
	public function filtering($id) {
	   $html = "<div class=\"filtering\">
		...
		$html.= "</select>    
						No. SPTPD : <input type=\"text\" name=\"CPM_NO_SPTPD-{$id}\" id=\"CPM_NO_SPTPD-{$id}\" ><br/><br/><hr style=\"border-top:1px #CCC solid\"/><br/>  
	...
	public function grid_data() {
 	...
 	private function grid_data_berkas_masuk() {
		...
		$query = "SELECT CPM_ID, CPM_JENIS_PAJAK, CPM_NO_SPTPD, CPM_VERSION, 
					...
					CPM_TAHUN_PAJAK, CPM_NPWPD, CPM_AUTHOR, CPM_STATUS, CPM_TGL_INPUT, CPM_TRAN_READ
		...
		$html = "<table border=\"1\" cellpadding=\"5\">
					<tr>
						...
						<td align=\"center\" width=\"72%\" colspan=\"2\">
							<br>
							".strtoupper($JENIS_PEMERINTAHAN)." " . strtoupper($NAMA_PEMERINTAHAN) . "<br/>DINAS PENGELOLAAN KEUANGAN<br/>DAN KEKAYAAN DAERAH<br/><br/>
	...
	public function print_disposisi() {
							...
							<table border=\"0\" cellpadding=\"2\" cellspacing=\"4\">
								...
								<tr>
									...
									<td width=\"auto\" cellspacing=\"5\"><table>
											...
											<tr><td>{$radio_lampiran[2]} Laporan Omzet Harian</td></tr>
											<tr><td>{$radio_lampiran[3]} Bon Bill</td></tr>
											{$lampiran_tambahan}
										</table>
									</td>
								</tr>
		...
		$pdf->AddPage('P', 'A4');
		$pdf->writeHTML($html, true, false, false, false, '');
		$pdf->Image(/*$_SERVER['DOCUMENT_ROOT']*/.'/view/Registrasi/configure/logo/' . $LOGO_CETAK_PDF, 16, 16, 18, '', '', '', '', false, 300, '', false);
		$pdf->SetAlpha(0.3);
