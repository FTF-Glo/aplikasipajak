...
<form class="cmxform" id="form-berkas" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/svc-berkas.php?param=<?php echo base64_encode($json->encode(array("a" => $berkas->_a, "m" => $berkas->_m))) ?>">
        ...
        <tr>
            <td colspan="2">
                ...
                <table width="100%" border="0" align="center" class="header">
                    <tr>
                        <td width="80"><label style='cursor:pointer'><input type="checkbox" name="CPM_LAMPIRAN[]" id="CPM_LAMPIRAN" value="1" <?php echo $radio_lampiran[1] ?>> SPTPD</label></td>
                        <td width="100"></td>
                    </tr>
                    <?php if($DATA['CPM_JENIS_PAJAK'] == 1):?>
                    <tr>
                        <td width="80"><label style='cursor:pointer'><input type="checkbox" name="CPM_LAMPIRAN[]" id="CPM_LAMPIRAN" value="5" <?php echo $radio_lampiran[5] ?>> Rekapitulasi Pemanfaatan Air</label></td>
                        <td width="100"></td>
                    </tr>
                    <tr>
                        <td width="80"><label style='cursor:pointer'><input type="checkbox" name="CPM_LAMPIRAN[]" id="CPM_LAMPIRAN" value="6" <?php echo $radio_lampiran[6] ?>> Fotocopy SIPA, KTP, SIUP</label></td>
                        <td width="100"></td>
                    </tr>
                    <tr>
                        <td width="80"><label style='cursor:pointer'><input type="checkbox" name="CPM_LAMPIRAN[]" id="CPM_LAMPIRAN" value="7" <?php echo $radio_lampiran[7] ?>> Foto Water Meter</label></td>
                        <td width="100"></td>
                    </tr>
                  <?php endif; ?>
                    <tr>
                        <td width="80"><label style='cursor:pointer'><input type="checkbox" name="CPM_LAMPIRAN[]" id="CPM_LAMPIRAN" value="8" <?php echo $radio_lampiran[8] ?>> NPWP/NPWPD</label></td>
                        <td width="100"></td>
                    </tr>
