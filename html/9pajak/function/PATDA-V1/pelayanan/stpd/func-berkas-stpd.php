...
require_once("function/{$DIR}/{$modul}/class-berkas-stpd.php");
$berkas = new BerkasSTPD();
$berkas->read_dokumen();
...
<script type="text/javascript" src="function/<?php echo "{$DIR}/{$modul}"; ?>/func-berkas-stpd.js"></script>

<form class="cmxform" id="form-berkas-stpd" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/svc-berkas-stpd.php?param=<?php echo base64_encode($json->encode(array("a" => $berkas->_a, "m" => $berkas->_m))) ?>">
    ...
    <table class="main" width="900">               
        ...
        <tr>
            <td>No. STPD <b class="isi">*</b></td>
            <td>: 
                <input type="text" name="BERKAS[CPM_NO_STPD]" id="CPM_NO_SPTPD" style="width: 200px;" <?php echo ($berkas->_id != "") ? "readonly" : "" ?> value="<?php echo $DATA['CPM_NO_STPD'] ?>">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                ...
                <table width="100%" border="0" align="center" class="header">                    
                    <tr>
                        <td width="80"><input type="checkbox" name="CPM_LAMPIRAN[]" id="CPM_LAMPIRAN" value="1" <?php echo $radio_lampiran[1] ?>> STPD</td>
                        <td width="100"></td>
                    </tr>                 
                </table></br>
            </td>
