$(document).ready(function() {
    ...
    $("#btn-search-sptpd").click(function() {
        ...
        $.ajax({
            ...
            url: "function/PATDA-V1/pelayanan/svc-berkas-skpdkb.php",
            dataType: "json",
    ...
    $("input.btn-submit").click(function() {
        ...
        if (res) {
            document.getElementById("form-berkas-skpdkb").submit();
        }
    });
    ...
    $("input.btn-print").click(function() {
        var action = $(this).attr('action');
        $('#function').val(action);
        $("#form-berkas-skpdkb").attr('target', '_blank');
        document.getElementById("form-berkas-skpdkb").submit();
    });
});
