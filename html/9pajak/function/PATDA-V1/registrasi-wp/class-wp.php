...
class WajibPajak extends Pajak
{
    ...
    public function filtering($id)
    {
        ...
        $html = "<div class=\"filtering\">
                    <form>
                        <label>User Name :</label> <input type=\"text\" name=\"CPM_USER-{$id}\" id=\"CPM_USER-{$id}\" class=\"form-control\" style=\"height: 36px; width: 168px; display: inline-block\">  
                        <label style=\"margin-left: 10px\">NPWPD :</label> <input type=\"text\" name=\"CPM_NPWPD-{$id}\" id=\"CPM_NPWPD-{$id}\" class=\"form-control\" style=\"height: 36px; width: 168px; display: inline-block\" >  
                        <label style=\"margin-left: 10px\">Jenis Pajak :</label> <select name=\"CPM_JENIS_PAJAK-{$id}\" id=\"CPM_JENIS_PAJAK-{$id}\" class=\"form-control\" style=\"width: 144px; display: inline-block\">{$opt_jenispajak}</select>    
                        <label style=\"margin-left: 10px\">Asal WP :</label> <select name=\"CPM_ASAL_WP-{$id}\" id=\"CPM_ASAL_WP-{$id}\" class=\"form-control\" style=\"width: 144px; display: inline-block\">{$opt_asalwp}</select>    
                        ...
                        <button type=\"button\" id=\"cetak-{$id}\" class=\"download-xls btn btn-success lm-btn\" data-id=\"{$id}\" style=\"font-size: 0.7rem !important\" ><i class=\"fa fa-download\"></i>  Eksport ke Excel</button>
                    </form>
                </div> ";
        return $html;
    }
                        ...
                        $('#{$idTable}-{$this->_i}').jtable({
                            ...
                            fields: {
								...
								ACTION: {title: 'Action',width: '12%',
                                    display : function (data) {
                                        return '<button class=\"btn btn-primary\" onClick=\"printCard(\''+data.record.CPM_NPWPD+'\',\''+data.record.CPM_JENIS_PAJAK_C+'\');\"><i class=\"fa fa-download\"></i> Kartu Data PDF</button>';
                                    }
                                }
                            }
                        });
