...
function print_card() {
	...
	$pdf->SetXY(20,($x+6));
	$pdf->SetFont('helvetica', 'B', 9);
	$pdf->Write(0, 'BADAN PENGELOLA PAJAK DAN RETRIBUSI', '', 00, 'C', true, 0, false, false, 0);
	$pdf->SetXY(17,($x+9.5));
	$pdf->SetFont('helvetica', 'B', 9);
	$pdf->Write(0, 'DAERAH', '', 00, 'C', true, 0, false, false, 0);
	$pdf->SetXY(20,($x+8));
	$pdf->SetFont('helvetica', 'B', 10);
	$pdf->Write(0, '', '', 00, 'C', true, 0, false, false, 0);
	$pdf->SetXY(20,($x+13));
	$pdf->SetFont('helvetica', 'B', 8);
	$pdf->Write(0, "{$JALAN}", '', 00, 'C', true, 0, false, false, 0);
	$pdf->SetXY(20,($x+16.5));
	$pdf->SetFont('helvetica', 'B', 8);
	...
	$pdf->SetXY(5,42);
	$pdf->SetFont('helvetica', '', 9);
	$pdf->Write(0, "Terdaftar", '', 00, 'L', true, 0, false, false, 0);
	$pdf->SetXY(25,42);
	$pdf->SetFont('helvetica', '', 9);
	$pdf->Write(0, ": {$TERDAFTAR}", '', 00, 'L', true, 0, false, false, 0);
