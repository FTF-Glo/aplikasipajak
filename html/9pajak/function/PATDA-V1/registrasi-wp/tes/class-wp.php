...
$conn = mysqli_connect($servername, $username, $password, $database);
        $save = mysqli_query($conn, $query) or die(mysqli_error($this->Conn));
        if ($save) {
...
$conn = mysqli_connect($servername, $username, $password, $database);
        ...
        if (mysqli_num_rows($res) == 0) {
         ...
         $username = "root";
         $password = "Lamsel2@21";
		$conn = mysqli_connect($conn, $username, $password, $database);
    ...
    private function update_core_user()
    {
        ...
        // cek central user
        if ($cek = mysqli_fetch_assoc(mysqli_query($conn, sprintf("SELECT * from CENTRAL_USER WHERE CTR_U_ID='%s'", $this->CPM_USER)))) {
            // ada data, update
