    ...
    <div class="container lm-container">
        <div class="row">
            <div id="subMenu" class="col-md-12 subtitle lm-title" align="center">
                <b>Tambah Daftar Pelaksana Kegiatan</b>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label>Nama Pelaksana Kegiatan <b class="isi">*</b></label>
                    <input type="text" name="nama_kegiatan" id="nama_kegiatan" class="form-control" value="<?php echo $value['nama_kegiatan'] ?>" <?php echo ($wp->_i == 1 || $wp->_i == "") ? "" : "readonly"; ?> placeholder="Nama Pelaksana <?php echo $value['CPM_JENIS_TANDABUKTI'] == '' ? 'Kegiatan' : $value['CPM_JENIS_TANDABUKTI'] ?>" />
                </div>
            </div>
        </div>

        <div class="row button-area WP" <?php echo $attr_wp ?>>
