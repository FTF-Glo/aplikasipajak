...
class LaporPajak extends Pajak {
    ...
    public function filtering($id) {
        ...
        $reks = $this->getRekening("4.1.01.06");
    ...
    private function save_pajak($cpm_no='') {
        ...
        if ($validasi['result'] == true || ($validasi['data']['CPM_TRAN_STATUS'] == '4')) {
            ...
            $query = sprintf("INSERT INTO {$this->PATDA_HOTEL_DOC}
                    ...
                    VALUES ( '%s','%s','%s',
                             ...
                             '%s','%s','%s',
                             '%s','%s','%s',
                             '%s','%s','%s','%s')", $this->CPM_ID, $this->CPM_ID_PROFIL, $this->CPM_NO, $this->CPM_MASA_PAJAK, $this->CPM_TAHUN_PAJAK, $this->CPM_TOTAL_OMZET, $this->CPM_TOTAL_PAJAK, $this->CPM_TARIF_PAJAK, $this->CPM_METODE_HITUNG, $this->CPM_KETERANGAN, $this->CPM_VERSION, $this->CPM_AUTHOR, $this->CPM_ID_TARIF, $this->CPM_BAYAR_LAINNYA, $this->CPM_DPP, $this->CPM_BAYAR_TERUTANG, $this->CPM_NO_SSPD,$this->CPM_MASA_PAJAK1,$this->CPM_MASA_PAJAK2,$this->CPM_TIPE_PAJAK, $this->CPM_DENDA_TERLAMBAT_LAP
            );
    ...
    private function save_tranmain($param) {
        ...
        $query = sprintf("INSERT INTO {$this->PATDA_HOTEL_DOC_TRANMAIN}
                    ...
                    VALUES ( '%s','%s','%s','%s','%s',
                             '%s','%s','%s','%s','%s')", $CPM_TRAN_ID, $CPM_TRAN_HOTEL_ID, $param['CPM_TRAN_HOTEL_VERSION'], $param['CPM_TRAN_STATUS'], $param['CPM_TRAN_FLAG'], $param['CPM_TRAN_DATE'], $param['CPM_TRAN_OPR'], $param['CPM_TRAN_OPR_DISPENDA'], $param['CPM_TRAN_READ'], $param['CPM_TRAN_INFO']
        );
        return mysqli_query($this->Conn, $query);
    }
    ...
    public function update() {
        ...
        if ($validasi['result'] == true) {
            ...
            $query = sprintf("UPDATE {$this->PATDA_HOTEL_DOC} SET
                    CPM_TOTAL_OMZET = '%s',
                    CPM_TOTAL_PAJAK = '%s',
                    CPM_TARIF_PAJAK = '%s',
                    CPM_BAYAR_LAINNYA = '%s',
                    ...
                    WHERE
                    CPM_ID ='{$this->CPM_ID}'", $this->CPM_TOTAL_OMZET, $this->CPM_TOTAL_PAJAK, $this->CPM_TARIF_PAJAK, $this->CPM_BAYAR_LAINNYA, $this->CPM_METODE_HITUNG, $this->CPM_DPP, $this->CPM_BAYAR_TERUTANG, $this->CPM_KETERANGAN, $this->CPM_MASA_PAJAK1, $this->CPM_MASA_PAJAK2, $this->CPM_TIPE_PAJAK, $this->CPM_TAHUN_PAJAK, $this->CPM_MASA_PAJAK,$this->CPM_DENDA_TERLAMBAT_LAP);
							...
							<tr>
								<td><table width=\"100%\" border=\"0\" align=\"left\">
										...
										<tr>
											...
											&nbsp;&nbsp;Telepon : {$DATA['profil']['CPM_TELEPON_OP']}
											</td>
										</tr>
										<tr>
