        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input name="PAJAK[CPM_NO]" class="form-control" type="text" id="CPM_NO" value="<?php echo $DATA['pajak']['CPM_NO'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "") ? "" : "readonly"; ?> placeholder="No Pelaporan"></td>
                </div>
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" name="PAJAK[CPM_MASA_PAJAK1]" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "id=\"CPM_MASA_PAJAK1\"" : ""; ?> class="form-control" style=readonly value="<?php echo $DATA['pajak']['CPM_MASA_PAJAK1']; ?>" placeholder="Masa Awal">
                        </div>
                        <div class="col-md-1">
                            s.d
                        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="PAJAK[CPM_REKENING]" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "id=\"CPM_REKENING\"" : ""; ?> class="form-control" readonly value="<?php echo $DATA['pajak']['CPM_REKENING']; ?>">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
