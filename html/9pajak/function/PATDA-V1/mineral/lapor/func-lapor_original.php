        ...
        <tr>
            <td colspan="2">
                ...
                <table width="100%" border="0" align="center" class="child">
                    ...
                    <tr valign="top">
                        ...
                        <td width="150" rowspan="4">Keterangan :</br>
                            <textarea name="PAJAK[CPM_KETERANGAN]" id="CPM_KETERANGAN" rows="4" cols="40" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Keterangan"><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            <td width="400" rowspan="">Tanggal Jatuh Tempo <span style="color:red; font-size:10px">(Tidak wajib)</span></br>                            
                    ...
                    <tr>
                        <td>Jenis Tipe Masa</td>
                        <td> : <select class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" name="PAJAK[CPM_MASA_TIPE]" id="CPM_MASA_TIPE">
                        <?php
                    ...
                    <tr>
                        ...
                        <td> : <input type="text" class="form-control" style="width:266px;height:30px;display:inline-block;font-size:small;" name="PAJAK[CPM_REKENING]" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "id=\"CPM_REKENING\"" : ""; ?> readonly value="<?php echo $DATA['pajak']['CPM_REKENING']; ?>">
                        </td>
                    </tr>
                </table><br />
                <table width="900" class="child">
                    <tr>
                        <th width="50">No.</th>
                        <th width="250">Nama Komoditas</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td align="center">
                                <select style="width:150px;height:30px;display:inline-block;font-size:small;" name="PAJAK_ATR[CPM_ATR_NAMA][]" class="CPM_ATR_NAMA form-control" id="CPM_ATR_NAMA_<?php echo $xx ?>" onchange="javascript:getHarga(this, <?php echo $xx ?>)" idsum="<?php echo $xx ?>">
                                    <?php
                            ...
                            <td align="center"><input type="text" name="PAJAK_ATR[CPM_ATR_VOLUME][]" id="CPM_ATR_VOLUME_<?php echo $xx ?>" class="number" style="width: 150px;" value="<?php echo $pajak_atr['CPM_ATR_VOLUME'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> onkeyup="javascript:getBayar(<?php echo $xx ?>)"></td>
                            <td align="center"><input type="text" name="PAJAK_ATR[CPM_ATR_HARGA][]" id="CPM_ATR_HARGA_<?php echo $xx ?>" class="number" style="width: 150px;" value="<?php echo (int) $pajak_atr['CPM_ATR_HARGA'] ?>" readonly></td>
                        </tr>
                    <?php
                        $xx++;
                    }
                ...
                <table width="100%" border="0" align="center" class="child">
                    <tr>
                        ...
                        <td> : <input type="text" name="PAJAK[CPM_TOTAL_OMZET]" id="CPM_TOTAL_OMZET" class="number SUM" maxlength="17" readonly="" value="<?php echo $DATA['pajak']['CPM_TOTAL_OMZET'] ?>" placeholder="Pembayaran Pemakaian"> </td>
                        <td rowspan="6" style="padding-top:8px;">
                            <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "<font id=\"tapbox\">Data Pembanding : Total Volume <label id=\"val_tracking\"></label></font>" : ""; ?>
                        </td>
                    </tr>
