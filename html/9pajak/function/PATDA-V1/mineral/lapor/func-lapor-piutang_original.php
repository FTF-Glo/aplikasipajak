...
$masa = !empty($DATA['pajak']['JENIS_TIPE_MASA']) ? $DATA['pajak']['JENIS_TIPE_MASA'] : 'Triwulan';
            ...
            <td colspan="2">
                ...
                <table width="100%" border="0" align="center" class="child">
                    ...
                    <tr valign="top">
                        ...
                        <td width="302">: <input name="PAJAK[CPM_NO]" class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" type="text" id="CPM_NO" value="<?php echo $DATA['pajak']['CPM_NO'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "") ? "" : "readonly"; ?> placeholder="No Pelaporan"></td>
                        <td width="150" rowspan="4">Keterangan :</br>
                            <textarea name="PAJAK[CPM_KETERANGAN]" class="form-control" style="width:200px;" id="CPM_KETERANGAN" rows="4" cols="40" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Keterangan"><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> : <select class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" name="PAJAK[CPM_MASA_TIPE]" id="CPM_MASA_TIPE"><?php
                    ...
                    <tr>
                        ...
                        <td> : <input type="text" name="PAJAK[CPM_REKENING]" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "id=\"CPM_REKENING\"" : ""; ?> style="width: 266px;" readonly value="<?php echo $DATA['pajak']['CPM_REKENING']; ?>">
                        </td>
                    </tr>

                    <tr>
                        <td>Jumlah Pajak yang dibayar <b class="isi">*</b></td>
                        <td> : <input type="text" name="PAJAK[CPM_TOTAL_PAJAK]" id="CPM_TOTAL_PAJAK" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> class="number SUM" value="<?php echo $DATA['pajak']['CPM_TOTAL_PAJAK'] ?>" placeholder="Jumlah Pajak yang dibayar"></td>
                    </tr>
                    <tr>
