						...
						<table>
                            <tr valign=\"bottom\">
								...
								<td>Filter V2 :<br><select style=\"width:100px; height:30px;\" class=\"form-control\" name=\"CPM_FILTER_V2-{$id}\" style=\"max-width:200px\" id=\"CPM_FILTER_V2-{$id}\">
									...
									<option value=\"\">Pajak Reklame Papan / Billboard / Videotron / Megatron (Baru)</option>
									<option value=\"\">Pajak Reklame Papan / Billboard / Videotron / Megatron (Lama)</option>
								</select></td>
	...
	function addRow()
	{
		...
		<tr>
			...
			<td width="130" align="center" valign="top"><label id="load-type-' . $no . '"></label>
				<input name="PAJAK_ATR[CPM_ATR_PANJANG][' . ($no - 1) . ']" type="text" class="number" tabindex="' . ($idx + 4) . '" id="CPM_ATR_PANJANG-' . $no . '" maxlength="6" style="width:70px;height:30px;display:inline-block;font-size:small" placeholder="Panjang" onkeyup="hitungDetail(' . $no . ')" />
			</td>
			<td rowspan="3" align="center" valign="top">
				<input name="PAJAK_ATR[CPM_ATR_SISI][' . ($no - 1) . ']" type="text" class="number" tabindex="' . ($idx + 7) . '" id="CPM_ATR_SISI-' . $no . '" value="" maxlength="3" style="width:50px;height:30px;display:inline-block;font-size:small" placeholder="Jumlah" onkeyup="hitungDetail(' . $no . ')" />
				<b class="isi">*</b>
			</td>
			<td rowspan="3" align="center" valign="top">
		...
		<tr>
			...
			<td align="left" width="240" valign="top">
				<select name="PAJAK_ATR[CPM_ATR_NOP][' . ($no - 1) . ']" tabindex="' . ($idx) . '" id="CPM_NOP-' . $no . '" class="CPM_NOP" onchange="hitungDetail(' . $no . ')" style="max-width:260px">' . $opt_nop . '</select>
			</td>
			<td align="left" valign="top">Lebar <b class="isi">*</b></td>
			<td align="center" valign="top"><input name="PAJAK_ATR[CPM_ATR_LEBAR][' . ($no - 1) . ']" tabindex="' . ($idx + 5) . '" type="text" class="number" id="CPM_ATR_LEBAR-' . $no . '" maxlength="6" style="width:70px;height:30px;display:inline-block;font-size:small" placeholder="Lebar" onkeyup="hitungDetail(' . $no . ')" /></td>
		...
		<tr>
			...
			<td align="center" valign="top">
				...
				<input name="PAJAK_ATR[CPM_ATR_TINGGI][' . ($no - 1) . ']" tabindex="' . ($idx + 6) . '" type="text" id="CPM_ATR_TINGGI-' . $no . '" class="number" maxlength="6" style="width:70px;height:30px;display:inline-block;font-size:small" value="" placeholder="Tinggi" />
			</td>
		</tr>
		<tr>
		...
		<td>Jenis Waktu Pemakaian</td>
			...
			<td align="left" valign="top" colspan="2">
				<select class="form-control" style="width:200px;height:30px;display:inline-block;font-size:small" id="CPM_ATR_SUDUT_PANDANG-' . $no . '" onchange="hitungDetail(' . $no . ')" name="PAJAK_ATR[CPM_ATR_SUDUT_PANDANG][' . ($no - 1) . ']">' . $opt_sudut_pandang . '</select>
				<br>&nbsp;<br>
				<label><input type="radio" name="PAJAK_ATR[CPM_ATR_GEDUNG][' . ($no - 1) . ']" class="CPM_GEDUNG" value="LUAR" checked> Luar Gedung</label>&nbsp;
				<label><input type="radio" name="PAJAK_ATR[CPM_ATR_GEDUNG][' . ($no - 1) . ']" class="CPM_GEDUNG" value="DALAM" id="ForCheck2" /> Dalam Gedung</label>
			</td>
		</tr>
		...
		<tr>	
			...
			<td>
				<select class="form-control" style="height:30px;" id="CPM_ATR_KAWASAN-' . $no . '" tabindex="' . ($idx + 3) . '" onchange="hitungDetail(' . $no . ')" name="PAJAK_ATR[CPM_ATR_KAWASAN][' . ($no - 1) . ']">' . $opt_kawasan_1 . '</select>
			</td>
			<td colspan="2">
			...
			<td colspan="2">
				...
				<input type="radio" name="PAJAK_ATR[CPM_ATR_TOL][' . ($no - 1) . ']" class="CPM_TOL-' . $no . '" onchange="hitungDetail(' . $no . ')" value="1" style="margin-left:20px"> Ya &nbsp;
				<label><input type="radio" name="PAJAK_ATR[CPM_ATR_TOL][' . ($no - 1) . ']" class="CPM_TOL-' . $no . '" onchange="hitungDetail(' . $no . ')" checked value="0" id="ForCheck2" /> Tidak</label>
			</td>
		</tr>
		<tr>	
