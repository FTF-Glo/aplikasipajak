...
<script type="text/javascript" src="function/<?php echo "{$DIR}/{$modul}"; ?>/lapor/func-lapor.js?d"></script>
    ...
    <table class="main" width="900">
        ...
        <?php if (!empty($npwpd)) : ?>
            <tr>
                ...
                <td>:
                    <input type="text" name="PAJAK[CPM_NPWPD]" id="CPM_NPWPD" class="form-control" style="width:250px;height:30px;display:inline-block;font-size:small;" value="<?php echo Pajak::formatNPWPD($DATA['profil']['CPM_NPWPD']) ?>" readonly>
        ...
        <tr>
            ...
            <td>: <input type="text" name="PAJAK[CPM_NAMA_WP]" id="CPM_NAMA_WP" class="form-control" style="width:250px;height:30px;display:inline-block;font-size:small;" value="<?php echo  $DATA['profil']['CPM_NAMA_WP'] ?>" readonly></td>
        </tr>
        <tr valign="top">
            <td>Alamat Wajib Pajak <b class="isi">*</b></td>
            <td>: <textarea name="PAJAK[CPM_ALAMAT_WP]" class="form-control" style="width:250px;display:inline-block;" id="CPM_ALAMAT_WP" cols="70" rows="3" readonly><?php echo  $DATA['profil']['CPM_ALAMAT_WP'] ?></textarea></td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                ...
                <table width="900" class="child" border="0">
                    <tr>
                        ...
                        <th width="80" idx="label_jumlah">Qty / Muka</th>
                    ...
                    <tr>
                        ...
                        <td width="130" align="center" valign="top">
                            <input name="PAJAK_ATR[CPM_ATR_PANJANG][]" class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" type="text" class="number" tabindex="18" id="CPM_ATR_PANJANG" value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_PANJANG'] ?>" size="11" maxlength="11" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Panjang">
                        </td>
                        <td rowspan="3" align="center" valign="top">
                            <input name="PAJAK_ATR[CPM_ATR_JUMLAH][]" type="hidden" class="number" tabindex="21" id="CPM_ATR_JUMLAH" value="<?php echo isset($DATA['pajak_atr'][0]['CPM_ATR_JUMLAH']) ? $DATA['pajak_atr'][0]['CPM_ATR_JUMLAH'] : 1 ?>" size="11" maxlength="11" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Jumlah">
                            <input type="text" name="PAJAK_ATR[CPM_ATR_SISI][]" class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" class="number" id="CPM_ATR_SISI" value="<?= $DATA['pajak_atr'][0]['CPM_ATR_SISI'] ?>" <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>>
                            <b class="isi">*</b>
                        </td>
                        <td rowspan="3" align="center" valign="top">
                    ...
                    <tr>
                        ...
                        <td align="left" width="240" valign="top">
                            <?php if (empty($DATA['pajak']['CPM_ID'])) : ?>
                                <select class="form-control" style="width:260px;height:30px;display:inline-block;font-size:small;" name="PAJAK_ATR[CPM_ATR_NOP][]" tabindex="14" id="CPM_NOP" class="CPM_NOP">
                                    <?php
                                    if (count($DATA['list_nop']) == 0) echo "<option value=''>NOP Tidak tersedia</option>";
                                    else echo (empty($nop)) ? "<option value='' selected disabled>Pilih NOP</option>" : "";
                        ...
                        <td align="center" valign="top"><input name="PAJAK_ATR[CPM_ATR_LEBAR][]" class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" tabindex="19" type="text" class="number" id="CPM_ATR_LEBAR" value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_LEBAR'] ?>" size="11" maxlength="11" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Lebar" /></td>

                    </tr>
                    <tr>
                        <td align="left" valign="top">Pilih rekening <b class="isi">*</b></td>
                        <td align="left" valign="top">
                            <select class="form-control" style="width:260px;height:30px;display:inline-block;font-size:small;"" tabindex=" 15" name="PAJAK_ATR[CPM_ATR_REKENING][]" id="CPM_ATR_REKENING" style="width:260px">
                                <?php
                        ...
                        <td align="center" valign="top"><input name="PAJAK_ATR[CPM_ATR_TINGGI][]" class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" tabindex="3" type="text" class="number" id="CPM_ATR_TINGGI" size="11" maxlength="11" value="<?= $DATA['pajak_atr'][0]['CPM_ATR_TINGGI'] ?>" <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Tinggi" /></td>
                    ...
                    <tr>
                        ...
                        <td class="ID_JAM" align="center" valign="top"><input class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" name="PAJAK_ATR[CPM_ATR_JAM][]" tabindex="3" type="text" class="number" id="CPM_ATR_JAM" size="11" maxlength="11" value="<?= $DATA['pajak_atr'][0]['CPM_ATR_JAM'] ?>" <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Jam" /></td>
                    </tr>
                    <tr>
                        <td>Jenis Waktu Pemakaian</td>
                        <td>
                            <select class="form-control" style="width:260px;height:30px;display:inline-block;font-size:small;" id="CPM_ATR_TYPE_MASA" name="PAJAK_ATR[CPM_ATR_TYPE_MASA][]">
                                <?php
                        ...
                        <td align="left" valign="top">Sudut Pandang <b class="isi">*</b></td>
                        <td align="left" valign="top" colspan="3">
                            <select class="form-control" style="width:100px;height:30px;display:inline-block;font-size:small;" id="CPM_ATR_SUDUT_PANDANG" name="PAJAK_ATR[CPM_ATR_SUDUT_PANDANG][]">
                                <?php
                            ...
                            <label><input type="radio" name="PAJAK_ATR[CPM_ATR_GEDUNG][]" class="CPM_GEDUNG" value="LUAR" <?= $DATA['pajak_atr'][0]['CPM_ATR_GEDUNG'] == 'LUAR' ? ' checked' : '' ?> <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : " onclick=\"javascript:return false\""; ?> id="ForCheck" /> Luar Gedung</label> &nbsp;
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" style="width:260px;height:30px;display:inline-block;font-size:small;" id="CPM_ATR_KAWASAN" name="PAJAK_ATR[CPM_ATR_KAWASAN][]">
                                <?php
                        ...
                        <td colspan="2">
                            Alkohol/Rokok <label><input type="radio" name="PAJAK_ATR[CPM_ATR_ALKOHOL_ROKOK][]" class="CPM_ALKOHOL_ROKOK" value="1" <?= ($lapor->_id != "" && $lapor->_s != 1) ? 'onclick:javascript:return false"' : '' ?> <?= $DATA['pajak_atr'][0]['CPM_ATR_ALKOHOL_ROKOK'] == '1' ? 'checked' : '' ?> /> Ya</label> &nbsp;
                            <label><input type="radio" name="PAJAK_ATR[CPM_ATR_ALKOHOL_ROKOK][]" class="CPM_ALKOHOL_ROKOK" value="0" <?= ($lapor->_id != "" && $lapor->_s != 1) ? 'onclick:javascript:return false"' : '' ?> <?= $DATA['pajak_atr'][0]['CPM_ATR_ALKOHOL_ROKOK'] == '0' ? 'checked' : '' ?> id="ForCheck2" /> Tidak</label>
                        </td>
                        <td colspan="2">
                            Jalan Tol : <label><input type="radio" name="PAJAK_ATR[CPM_ATR_TOL][]" class="CPM_TOL" value="1" <?= ($lapor->_id != "" && $lapor->_s != 1) ? 'onclick:javascript:return false"' : '' ?> <?= $DATA['pajak_atr'][0]['CPM_ATR_TOL'] == '1' ? 'checked' : '' ?> /> Ya</label> &nbsp;
                            <label><input type="radio" name="PAJAK_ATR[CPM_ATR_TOL][]" class="CPM_TOL" value="0" <?= ($lapor->_id != "" && $lapor->_s != 1) ? 'onclick:javascript:return false"' : '' ?> <?= $DATA['pajak_atr'][0]['CPM_ATR_TOL'] == '0' ? 'checked' : '' ?> id="ForCheck3" /> Tidak</label>
                        </td>
                    ...
                    if (count($DATA['pajak_atr']) > 1) {
                        ...
                        foreach ($DATA['pajak_atr'] as $atr) {
                            ...
                            echo '</td>
                                ...
                                <td rowspan="3" align="center" valign="top">
                                    <input name="PAJAK_ATR[CPM_ATR_SISI][]" type="text" class="number" tabindex="' . ($idx + 7) . '" id="CPM_ATR_SISI-' . $no . '"  size="11" maxlength="11" value="' . $atr['CPM_ATR_SISI'] . '" ' . $readonly . ' placeholder="Jumlah" onkeyup="hitungDetail(' . $no . ')" />
                                    <b class="isi">*</b>
                                </td>
                                <td rowspan="3" align="center" valign="top">
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top">Tinggi <b class="isi">*</b></td>
                                <td valign="top">
                                    <input name="PAJAK_ATR[CPM_ATR_TINGGI][]" tabindex="' . ($idx + 6) . '" type="text" id="CPM_ATR_TINGGI-' . $no . '" class="number" size="11" maxlength="11" onkeyup="hitungDetail(' . $no . ')" value="' . $atr['CPM_ATR_TINGGI'] . '" ' . $readonly . ' placeholder="TINGGI" />
                                </td>
                            </tr>
                            <tr>
                                <td>Jenis Waktu Pemakaian </td>
                            ...
                            <tr>
                                <td>Lokasi Reklame</td>
                                <td>
                                    <select class="form-control" id="CPM_ATR_KAWASAN-' . $no . '" tabindex="' . ($idx + 3) . '" onchange="hitungDetail(' . $no . ')" name="PAJAK_ATR[CPM_ATR_KAWASAN][]">';
