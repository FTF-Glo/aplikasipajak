$(document).ready(function() {
    ...
    form.validate({
        ...
        messages: {
            ...
            "PROFIL[CPM_GOL_WALET]": "harus diisi"
        }
    });
    ...
    $("#CPM_NPWPD").keyup(function() {
        ...
        $("#CPM_NAMA_OP").val('');
        $("#CPM_ALAMAT_OP").val('');
        $("#CPM_GOL_WALET option").prop('selected', false);
    });
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.result == 1) {
                    ...
                    $("#CPM_GOL_WALET option[value='" + res.CPM_GOL_WALET + "']").prop('selected', true);
                } else {
