...
<form class="cmxform" autocomplete="off" id="form-lapor" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/lapor/svc-lapor.php?param=<?php echo base64_encode($json->encode(array("a" => $lapor->_a, "m" => $lapor->_m, "mod" => $lapor->_mod, "f" => $lapor->_f))) ?>">
    ...
    <table class="main" width="900">
        <tr>
            <td colspan="2" align="center" class="subtitle"><b>PROFIL PAJAK SARANG WALET</b></td>
        </tr>
        <?php if (!empty($npwpd)) : ?>
            <tr>
        ...
        <tr>
            <td colspan="2" align="center" class="subtitle"><b>LAPOR PAJAK SARANG WALET</b></td>
        </tr>
        <tr>
            <td colspan="2">
                <?php
                ...
                <table width="100%" border="0" align="center" class="child">
                    ...
                    <tr valign="top">
                        ...
                        <td width="300"> : <?php echo ($DATA['pajak']['CPM_NO'] != "") ? "<input class=\"form-control\" style=\"width:150px;height:30px;display:inline-block;font-size:small;\" type=\"text\" name=\"PAJAK[CPM_NO]\" id=\"CPM_NO\" maxlength=\"25\" value=\"{$DATA['pajak']['CPM_NO']}\" readonly>" : "..." ?></td>
                        <td width="200" rowspan="5">Keterangan :</br>
                            <textarea name="PAJAK[CPM_KETERANGAN]" id="CPM_KETERANGAN" rows="4" cols="30" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Bulan Pajak</td>
                        <td> :
                            <select class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" name="PAJAK[CPM_MASA_PAJAK]" id="CPM_MASA_PAJAK">
                                <?php
                                if (in_array($lapor->_mod, array("pel", ""))) {
                                    if (!in_array($lapor->_i, array(1, 3, ""))) {
                ...
                <table width="900" class="child">
                    <tr>
                        <th width="50">No.</th>
                        <th width="100">Luas Gedung m<sup>3</sup></th>
                        <th width="450">Jumlah titik sarang walet</th>
                    ...
                    <tr>
                        ...
                        <td align="center"><input type="text" name="PAJAK_ATR[CPM_ATR_LUAS_GEDUNG][]" id="CPM_ATR_LUAS_GEDUNG" class="number" style="width: 150px;" value="<?php echo ($DATA['pajak_atr'][0]['CPM_ATR_LUAS_GEDUNG']) ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>></td>
                        <td align="center"><input type="text" name="PAJAK_ATR[CPM_ATR_JUMLAH_TITIK][]" id="CPM_ATR_JUMLAH_TITIK" class="number" style="width: 150px;" value="<?php echo ($DATA['pajak_atr'][0]['CPM_ATR_JUMLAH_TITIK']) ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>></td>
                        <td align="center"><input type="text" name="PAJAK_ATR[CPM_ATR_JUMLAH_KG][]" id="CPM_ATR_JUMLAH_KG" class="JUMLAH number" style="width: 150px;" value="<?php echo ($DATA['pajak_atr'][0]['CPM_ATR_JUMLAH_KG']) ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>></td>
                    </tr>
                    <tr>
                        <td align="center">2.<input type="hidden" name="PAJAK_ATR[CPM_ATR_ID][]" value="<?php echo $DATA['pajak_atr'][1]['CPM_ATR_ID']; ?>"></td>
                        <td align="center"><input type="text" name="PAJAK_ATR[CPM_ATR_LUAS_GEDUNG][]" id="CPM_ATR_LUAS_GEDUNG" class="number" style="width: 150px;" value="<?php echo ($DATA['pajak_atr'][1]['CPM_ATR_LUAS_GEDUNG']) ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>></td>
                        <td align="center"><input type="text" name="PAJAK_ATR[CPM_ATR_JUMLAH_TITIK][]" id="CPM_ATR_JUMLAH_TITIK" class="number" style="width: 150px;" value="<?php echo ($DATA['pajak_atr'][1]['CPM_ATR_JUMLAH_TITIK']) ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>></td>
                        <td align="center"><input type="text" name="PAJAK_ATR[CPM_ATR_JUMLAH_KG][]" id="CPM_ATR_JUMLAH_KG" class="JUMLAH number" style="width: 150px;" value="<?php echo ($DATA['pajak_atr'][1]['CPM_ATR_JUMLAH_KG']) ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>></td>
                    </tr>
                    <tr>
                        <td align="center">3.<input type="hidden" name="PAJAK_ATR[CPM_ATR_ID][]" value="<?php echo $DATA['pajak_atr'][2]['CPM_ATR_ID']; ?>"></td>
                        <td align="center"><input type="text" name="PAJAK_ATR[CPM_ATR_LUAS_GEDUNG][]" id="CPM_ATR_LUAS_GEDUNG" class="number" style="width: 150px;" value="<?php echo ($DATA['pajak_atr'][2]['CPM_ATR_LUAS_GEDUNG']) ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>></td>
                        <td align="center"><input type="text" name="PAJAK_ATR[CPM_ATR_JUMLAH_TITIK][]" id="CPM_ATR_JUMLAH_TITIK" class="number" style="width: 150px;" value="<?php echo ($DATA['pajak_atr'][2]['CPM_ATR_JUMLAH_TITIK']) ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>></td>
                        <td align="center"><input type="text" name="PAJAK_ATR[CPM_ATR_JUMLAH_KG][]" id="CPM_ATR_JUMLAH_KG" class="JUMLAH number" style="width: 150px;" value="<?php echo ($DATA['pajak_atr'][2]['CPM_ATR_JUMLAH_KG']) ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>></td>
                    </tr>
                </table>
                </br>
                <table width="100%" border="0" align="center" class="child">
                    ...
                    <tr>
                        ...
                        <td> : <input type="text" name="PAJAK[CPM_TOTAL_OMZET]" id="CPM_TOTAL_OMZET" class="number SUM" maxlength="17" value="<?php echo $DATA['pajak']['CPM_TOTAL_OMZET'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Pembayaran Pemakaian"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td> :<input type="text" name="PAJAK[CPM_DENDA_TERLAMBAT_LAP]" id="CPM_DENDA_TERLAMBAT_LAP" <?php echo ($lapor->_s == 1 || $lapor->_s == "" ) ?  "" : "readonly" ?> class="SUM2 number" value="<?php echo $DATA['pajak']['CPM_DENDA_TERLAMBAT_LAP'] ?>" placeholder="Sanksi Telat Lapor"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3">Terbilang : <b><input type="text" name="PAJAK[CPM_TERBILANG]" id="CPM_TERBILANG" readonly class="form-control" style="width:800px;height:30px;display:inline-block;" value="<?php echo ucwords($DATA['pajak']['CPM_TERBILANG']) ?>" placeholder="Terbilang"></b></td>
                    </tr>
                </table>
            </td>
        </tr>
