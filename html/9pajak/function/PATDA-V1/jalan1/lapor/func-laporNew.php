                ...
                <table width="100%" border="0" align="center" class="child">
                    ...
                    ?>
                        <tr>
                            ...
                            <td> : <input type="text" name="PAJAK[merkJenset]" id="merkJenset" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> value="<?php echo $DATA['pajak']['merkJenset']; ?>" placeholder="Merk Jenset"></td>
                        </tr>
                        <tr>
                            <td width="250">Faktor Daya <b class="isi">*</b></td>
                            <td> : <input type="text" name="PAJAK[unit]" id="unit" class="number" maxlength="19" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> value="<?php echo $DATA['pajak']['unit']; ?>" placeholder="Unit"></td>
                        </tr>
                        <tr>
