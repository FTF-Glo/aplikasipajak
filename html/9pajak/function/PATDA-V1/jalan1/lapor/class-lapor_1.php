        ...
        if ($validasi['result'] == true || ($validasi['data']['CPM_TRAN_STATUS'] == '4')) {
            ...
            $query = sprintf("INSERT INTO {$this->PATDA_JALAN_DOC}  
                    ...
                    VALUES ( '%s','%s','%s',
                             ...
                             $this->CPM_TOTAL_KWH, $this->CPM_HARGA_DASAR, $this->CPM_TOTAL_OMZET, $this->CPM_TOTAL_PAJAK, $this->CPM_TARIF_PAJAK, $this->CPM_TGL_LAPOR, $this->CPM_KETERANGAN, $this->CPM_VERSION, $this->CPM_AUTHOR, $this->CPM_ID_TARIF, $this->CPM_BAYAR_LAINNYA, $this->CPM_DPP, $this->CPM_BAYAR_TERUTANG, $this->CPM_NO_SSPD, $this->CPM_MASA_PAJAK1, $this->CPM_MASA_PAJAK2, $this->CPM_TIPE_PAJAK, $this->CPM_DENDA_TERLAMBAT_LAP
            );
        ...
        $html = "<table width=\"710\" class=\"main\" cellpadding=\"5\" border=\"1\" cellspacing=\"0\">
                    ...
                    <tr>
                        <td width=\"710\" colspan=\"2\"><table width=\"700\" align=\"center\" cellpadding=\"1\" border=\"1\" cellspacing=\"0\">                                            
                                ...
                                <tr>
                                    <td align=\"left\" width=\"270\">&nbsp;&nbsp;&nbsp;".($x++).". Sanksi Administrasi Telat Lapor ({$persen_terlambat_lap}%)</td>
                                    <td width=\"30\" align=\"left\">Rp.</td>
