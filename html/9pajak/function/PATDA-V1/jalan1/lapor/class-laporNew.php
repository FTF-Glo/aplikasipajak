...
class LaporPajak extends Pajak
{
    ...
    function addRow()
    {
        ...
        <tr valign="top">
            ...
            <textarea class="form-control" name="PAJAK[CPM_KETERANGAN]" id="CPM_KETERANGAN" rows="10"></textarea>
            </td>
        <tr>
		<tr>
            <td>Tipe Pajak <b class="isi">*</b></td>
            <td> :
                <select class="form-control" onchange="rumusPerhitungan(' . $no . ')" style="width:150px;height:30px;display:inline-block;font-size:small;" name="PAJAK[CPM_TIPE_PAJAK]" tabindex="' . ($idx) . '" id="CPM_TIPE_PAJAK-' . $no . '">
                ' . $optTipePajak . '
                </select>
            </td>	
		</tr>
        <tr>
            ...
            <td> :
                <select class="form-control" onchange="rumusPerhitungan(' . $no . ')" style="width:150px;height:30px;display:inline-block;font-size:small;" name="PAJAK[CPM_TAHUN_PAJAK][]" tabindex="' . ($idx) . '" id="CPM_TAHUN_PAJAK-' . $no . '"  >
                ' . $optTahun . '
                </select>
            </td>	
		</tr>
        ...
        <td> :
                <select class="form-control" onchange="rumusPerhitungan(' . $no . ')" style="width:150px;height:30px;display:inline-block;font-size:small;" name="PAJAK[CPM_MASA_PAJAK][]" tabindex="' . ($idx) . '" id="CPM_MASA_PAJAK-' . $no . '">
                ' . $optBulan . '
                </select>
            </td>	
        </tr>
        ...
        <td> :
            <input type="text" name="PAJAK[CPM_MASA_PAJAK1][]" id="CPM_MASA_PAJAK1-' . $no . '" style="width: 120px;" readonly placeholder="Masa Awal">s.d
            <input type="text" name="PAJAK[CPM_MASA_PAJAK2][]" id="CPM_MASA_PAJAK2-' . $no . '" style="width: 120px;" readonly placeholder="Masa Akhir">
        </td>	
        </tr>';
        if ($rek2 == '4.1.01.10.03' || $rek2 == '4.1.01.10.04' || $rek2 == "4.1.01.10.05" || $rek2 == "4.1.01.10.06") {
            echo '<tr>
            <td width="250">Pemakaian <b class="isi">*</b></td>
            <td> : <input type="text" name="PAJAK[merkJenset]" id="merkJenset"  placeholder="Merk Jenset"> </td>
        </tr>
        <tr>
                            <td width="250">Faktor Daya <b class="isi">*</b></td>
                            <td> : <input type="text" name="PAJAK[unit]" id="unit-' . $no . '" class="number" maxlength="19"  value="" placeholder="Unit"></td>
                        </tr>
                        <tr>
                            <td width="250">Kapasitas Pembangkit <b class="isi">*</b></td>
                            <td> : <input type="text" name="PAJAK[CPM_PEMBANGKIT]" id="CPM_PEMBANGKIT-' . $no . '" class="number" maxlength="19"  value="" placeholder="Kapasitas Pembangkit"></td>
                        </tr>
                        <tr>
                            <td width="250">Faktor Daya <b class="isi">*</b></td>
                            <td> : <input type="text" name="PAJAK[CPM_FAKTOR_DAYA]" id="CPM_FAKTOR_DAYA-' . $no . '" class="number" maxlength="19"  value=">" placeholder="Faktor Daya"></td>
                        </tr>
                        <tr>
                            <td width="250">Harga Satuan <b class="isi">*</b></td>
                            <td> : <input type="text" name="PAJAK[CPM_SATUAN]" id="CPM_SATUAN-' . $no . '" class="number" maxlength="19"  value="" placeholder="Harga Satuan"> </td>
                        </tr>
                        <tr>
                            <td width="250">Pemakaian <b class="isi">*</b></td>
                            <td> : <input type="text" name="PAJAK[CPM_TOTAL_KWH]" id="CPM_TOTAL_KWH-' . $no . '" class="number" maxlength="19"  value="" placeholder="Total Jam"> Satuan Jam</td>
                        </tr>';
        } else {
            echo '<tr>
            <td width="250">Pemakaian <b class="isi">*</b></td>
            <td> : <input type="text" onkeyup="rumusPerhitungan(' . $no . ')" name="PAJAK[CPM_TOTAL_KWH][]" id="CPM_TOTAL_KWH-' . $no . '" class="number" maxlength="19" placeholder="Total Kwh"> Satuan Kwh</td>
        </tr>';
        }
        ...
        echo ' <tr>
            ...
            <td> : <input type="text" onkeyup="rumusPerhitungan(' . $no . ')" name="PAJAK[CPM_TOTAL_OMZET][]" id="CPM_TOTAL_OMZET-' . $no . '" class="number SUM" maxlength="19"  placeholder="Pembayaran Pemakaian"></td>
        </tr>
        <tr>
        <td width="250">Dasar Pengenaan Pajak (DPP)</td>
        <td> : <input type="text"  name="PAJAK[CPM_DPP][]" id="CPM_DPP-' . $no . '" class="number SUM" maxlength="19"  placeholder="Pembayaran Pemakaian" readonly></td>
    </tr>
    <tr>
        <td>Tarif Pajak <b class="isi">*</b></td>
        <td> : <input type="text" name="PAJAK[CPM_TARIF_PAJAK][]" id="CPM_TARIF_PAJAK-' . $no . '" style="width: 50px;" readonly value="' . $DATA['pajak']['ARR_REKENING'][$rek2]["tarif"] . '" placeholder="Tarif Pajak"> %
        </td>
    </tr>
	
        <tr>
			<td colspan="6" align="right" valign="top">
				<input type="hidden" name="PAJAK_ATR[CPM_ATR_ID][]" id="CPM_ATR_ID-' . $no . '" value="id" />
				<input type="hidden" name="PAJAK_ATR[CPM_ATR_TOTAL][]" id="CPM_ATR_TOTAL-' . $no . '" value="0" />
				<input type="hidden" name="PAJAK_ATR[CPM_ATR_TARIF][]" id="CPM_ATR_TARIF-' . $no . '" value="tarf" />
