$(document).ready(function() {
    ...
    $("#CPM_NPWPD").keyup(function() {
        ...
        $("#CPM_NAMA_WP").val('');
        $("#CPM_ALAMAT_WP").val('');
		$("#CPM_KECAMATAN_WP").val('');
		$("#CPM_KELURAHAN_WP").val('');
        $("#CPM_NOP").val('');
        $("#CPM_NAMA_OP").val('');
        $("#CPM_ALAMAT_OP").val('');        
        $("#CPM_GOL_AIRBAWAHTANAH option").prop('selected', false);
    });
    ...
    $("#btn-search-npwpd").click(function() {
        ...
        $.ajax({
		    ...
		    $("#CPM_KELURAHAN_WP").val(res.CPM_KELURAHAN_WP);
                    ...
                    $("#CPM_GOL_AIRBAWAHTANAH option[value='" + res.CPM_GOL_AIRBAWAHTANAH + "']").prop('selected', true);
                } else {
