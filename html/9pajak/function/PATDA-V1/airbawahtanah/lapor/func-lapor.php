        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="PAJAK[CPM_DENDA_TERLAMBAT_LAP]" id="CPM_DENDA_TERLAMBAT_LAP" style="text-align: right; width: 100%" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || $lapor->_s == 4) ?  "" : "readonly" ?> class="form-control SUM2 number" value="<?php echo $DATA['pajak']['CPM_DENDA_TERLAMBAT_LAP'] ?>" placeholder="Sanksi Telat Lapor">
                </div>
            </div>
        </div>
        <div class="row">
