        ...
        if ($validasi['result'] == true || ($validasi['data']['CPM_TRAN_STATUS'] == '4')) {
            ...
            $query = sprintf(
                "INSERT INTO {$this->PATDA_AIRBAWAHTANAH_DOC}
                    ...
                    CPM_DENDA_TERLAMBAT_LAP, CPM_PIUTANG,CPM_RUMUS)
                    VALUES ( '%s','%s','%s',
                             '%s','%s',
                             '%s','%s',
                             '%s','%s','%s',
...
// var_dump($query);die;
	...
	*/
    ...
    public function print_skpd($type = "")
    {
        ...
        $TOTAL = $TOTAL + $DATA['CPM_DENDA_TERLAMBAT_LAP'];
        ...
        $page1 = "<table width=\"710\" class=\"main\" cellpadding=\"0\" border=\"1\" cellspacing=\"0\">
                    ...
                    <tr>
                        <td width=\"710\" colspan=\"2\" align=\"center\"><table width=\"100%\" border=\"0\" align=\"left\" cellpadding=\"5\" style=\"font-size:28px;\">
							<tr>
								<td colspan=\"2\">
									<table width=\"500\" cellpadding=\"3\" border=\"1\" cellspacing=\"0\">
										<tr style=\"background-color:#CCC\">
											<td width=\"20\" align=\"center\"><b>No</b></td>
											<td width=\"80\" align=\"center\"><b>Kode Rekening</b></td>
											<td width=\"100\" align=\"center\"><b>Jenis Pajak</b></td>
											<td width=\"85\" align=\"center\"><b>Uraian</b></td>
											<td width=\"90\" align=\"center\"><b>Banyaknya Nilai</b></td>
											<td width=\"110\" align=\"center\"><b>Tarif</b></td>
											<td width=\"90\" align=\"center\"><b>Ketetapan</b></td>
											<td width=\"120\" align=\"center\"><b>Jumlah (Rp.)</b></td>
										</tr>";
                                        $i = 0;
                                        foreach ($DATA['pajak_atr'] as $no => $atr) {
                                            $no++;
                                            ...
                                            $bulanss = isset($this->arr_bulan[$DATA['CPM_MASA_PAJAK']]) ? $this->arr_bulan[$DATA['CPM_MASA_PAJAK']] : '';
                            
                                            if ($i == 2) {
                                                //$bulanss =$this->arr_bulan[$DATA['CPM_MASA_PAJAK']+1];
                                                $bulanss = isset($this->arr_bulan[$DATA['CPM_MASA_PAJAK']]) ? $this->arr_bulan[$DATA['CPM_MASA_PAJAK'] + 1] : '';
                                            }
                                            if ($i == 3) {
                                                //$bulanss = $this->arr_bulan[$DATA['CPM_MASA_PAJAK']+2];
                                                $bulanss = isset($this->arr_bulan[$DATA['CPM_MASA_PAJAK']]) ? $this->arr_bulan[$DATA['CPM_MASA_PAJAK'] + 2] : '';
                                            }
                                        }
                                        $page1 .= "<tr>
											<td align=\"center\">1.</td>
											<td align=\"center\" style=\"font-size:27px;\">" . $profil['CPM_REKENING'] . ".001</td>
											<td align=\"center\">Pajak Air Tanah</td>
                                            <td align=\"right\"> ";
                                            if ($DATA['CPM_RUMUS'] == 'rbaru') {
                                            $page1 .=  "0 - 100 M<sup>2</sup>&nbsp;<br>
                                                101 - 500 M<sup>2</sup>&nbsp;<br>
                                                501 - 1000 M<sup>2</sup>&nbsp;<br>
                                                1001 - 2500 M<sup>2</sup>&nbsp;<br>
                                                > 2500 M<sup>2</sup>&nbsp; ";
                                            }else{
                                            $page1 .=   "0 - 50 M<sup>2</sup>&nbsp;<br>
                                            51 - 500 M<sup>2</sup>&nbsp;<br>
                                                501 - 1000 M<sup>2</sup>&nbsp;<br>
                                                1001 - 2500 M<sup>2</sup>&nbsp;<br>
                                                > 2500 M<sup>2</sup>&nbsp; ";
                                            }
											...
											<td width=\"90\" align=\"right\">";
                                                ...
                                                if ($DATA['CPM_RUMUS'] == 'rbaru') {
                                                    if ($hitNilaiAwal > 100) {
                                                        ...
                                                        $total1 = 100;
                                                        $page1 .= "100 M<sup>2</sup> x<br>";
                                                    } else {
                                                        $page1 .= "{$hitNilaiAwal} M<sup>2</sup> x<br>";
                                                        $total1 = $hitNilaiAwal;
                                                        $sisa = 0;
                                                    }
                                                    if ($sisa > 400) {
                                                        ...
                                                        $page1 .= "400 M<sup>2</sup> x<br>";
                                                    } else {
                                                        if ($sisa != 0) {
                                                            $page1 .= "{$sisa} M<sup>2</sup> x<br>";
                                                        } else {
                                                            $page1 .= "0.00 M<sup>2</sup> x<br>";
                                                        }
                                                        $total2 = $sisa;
                                                        $sisa = $sisa - $sisa;
                                                    }
                                                    ...
                                                    if ($hitNilaiAwal > 50) {
                                                        $sisa = $hitNilaiAwal - 50;
                                                        $total1 = 50;
                                                        $page1 .= "50 M<sup>2</sup> x<br>";
                                                    } else {
                                                        $page1 .= "{$hitNilaiAwal} M<sup>2</sup> x<br>";
                                                        $total1 = $hitNilaiAwal;
                                                        $sisa = 0;
                                                ...
                                                $page1 .= number_format($sisa, 2) . " M<sup>2</sup> x";
                                            ...
                                            <table>
                                                <tr>
                                                    <td align=\"right\" >
                                                    Rp. " . number_format($tarif[0], 2) . " x 20%<br>
                                                    Rp. " . number_format($tarif[1], 2) . " x 20%<br>
                                                    Rp. " . number_format($tarif[2], 2) . " x 20%<br>
                                                    Rp. " . number_format($tarif[3], 2) . " x 20%<br>
                                                    Rp. " . number_format($tarif[4], 2) . " x 20%<br>
                                            ...
                                            ";
                                                        ...
                                                        $page1 .= "
                                                                                                <td align=\"right\">
                                                                                                    ...
                                                                                                    " . number_format($SUMTotal5, 2) . " <br>
                                                                                                   
                                                                                                </td>
											
											<td align=\"right\">" . number_format($DATA['CPM_DPP'], 2) . "</td>
										</tr>";
                                    ...
                                    $html .= "<tr>
										...
										<tr>
											<td align=\"left\" align=\"right\" colspan=\"2\">
												Denda Telat Bayar
											</td>
											<td  align=\"right\">
												<b>" . number_format($DENDA, 0) . "</b>
											</td>
										</tr>
										<tr >
											<td align=\"left\" align=\"right\" colspan=\"5\">
										...
										<tr>
											...
											Dengan huruf :<br/>
											<b><i>" . ucfirst($this->SayInIndonesian($TOTAL)) . " rupiah</i></b>
											</td>
							...
							<tr>
                                ...
                                <table width=\"100%\" border=\"0\" align=\"left\" style=\"font-size:28px;\">
										...
										<tr>
											...
											&nbsp;&nbsp; &nbsp; &nbsp;
											1% perbulan dan ditagih dengan menggunakan Surat Tagihan Pajak</td>
										</tr>
									</table>
									</td>
								</tr>
...
<tr>
    ...
    function list_npa()
    {
        $query = "SELECT * from PATDA_AIRBAWAHTANAH_NPA WHERE CPM_AKTIF='1'  AND TYPE_RUMUS = '1'";
        $res = mysqli_query($this->Conn, $query);
    ...
    function list_npa2()
    {
        $query = "SELECT * from PATDA_AIRBAWAHTANAH_NPA WHERE CPM_AKTIF='1'  AND TYPE_RUMUS = 2";
        // var_dump($query);die;
        $res = mysqli_query($this->Conn, $query);
        $output = array('combo' => array(), 'tarif' => array());
        while ($row = mysqli_fetch_assoc($res)) {
    ...
    function list_npa_hide_pdam()
    {
        $query = "SELECT * from PATDA_AIRBAWAHTANAH_NPA WHERE CPM_AKTIF='1'  AND CPM_PERUNTUKAN NOT LIKE '%(Lama)' AND CPM_PERUNTUKAN NOT LIKE '%PDAM' AND CPM_PERUNTUKAN NOT LIKE '%Usaha lain yang Bersifat Komersil'";
        $res = mysqli_query($this->Conn, $query);
        $output = array('combo' => array(), 'tarif' => array());
        while ($row = mysqli_fetch_assoc($res)) {
            $output['combo'][$row['CPM_PERUNTUKAN']] = $row['CPM_PERUNTUKAN'];
        ...
        if ($DATA['pajak']['CPM_PERUNTUKAN'] == 'Industri Besar (Lama)' || $DATA['pajak']['CPM_PERUNTUKAN'] == 'Industri Kecil (Lama)' || $DATA['pajak']['CPM_PERUNTUKAN'] == 'Niaga Besar (Lama)' || $DATA['pajak']['CPM_PERUNTUKAN'] == 'Niaga Kecil (Lama)' || $DATA['pajak']['CPM_PERUNTUKAN'] == 'Perkebunan, Perikanan, Peternakan (Lama)' || $DATA['pajak']['CPM_PERUNTUKAN'] == 'Usaha Lain Yang Bersifat Komersil/Industri Minuman (Lama)' || $DATA['pajak']['CPM_PERUNTUKAN'] == 'Sosial (Lama)') {
            ...
            foreach ($DATA['pajak_atr'] as $no => $atr) {
                ...
                $html .= "<tr style=\"font-size:30px;\">
                                                        ...
                                                        if ($DATA['pajak']['CPM_RUMUS'] == 'rbaru') {
                                                            $html .=  "0 - 100 M<sup>2</sup>&nbsp;<br>
                                                                101 - 500 M<sup>2</sup>&nbsp;<br>
                                                                501 - 1000 M<sup>2</sup>&nbsp;<br>
                                                                1001 - 2500 M<sup>2</sup>&nbsp;<br>
                                                                > 2500 M<sup>2</sup>&nbsp; ";
                                                            }else{
                                                            $html .=   "0 - 50 M<sup>2</sup>&nbsp;<br>
                                                            51 - 500 M<sup>2</sup>&nbsp;<br>
                                                                501 - 1000 M<sup>2</sup>&nbsp;<br>
                                                                1001 - 2500 M<sup>2</sup>&nbsp;<br>
                                                                > 2500 M<sup>2</sup>&nbsp; ";
                ...
                if ($DATA['pajak']['CPM_RUMUS'] == 'rbaru') {
                    if ($hitNilaiAwal > 100) {
                        $sisa = $hitNilaiAwal - 100;
                        $total1 = 100;
                        $html .= "100 M<sup>2</sup> x<br>";
                    } else {
                        $html .= "{$hitNilaiAwal} M<sup>2</sup> x<br>";
                        $total1 = $hitNilaiAwal;
                        $sisa = 0;
                    }
                    if ($sisa > 400) {
                        $sisa = $sisa - 400;
                        $total2 = 400;
                        $html .= "400 M<sup>2</sup> x<br>";
                    } else {
                        if ($sisa != 0) {
                            $html .= "{$sisa} M<sup>2</sup> x<br>";
                        } else {
                            $html .= "0.00 M<sup>2</sup> x<br>";
                        }
                        $total2 = $sisa;
                        $sisa = $sisa - $sisa;
                    }
                ...
                $html .= number_format($sisa, 2) . " M<sup>2</sup> x";
                ...
                $html .= "
                                                        ...
                                                        <td width=\"120\" align=\"right\">
                                                            ...
                                                            " . number_format($SUMTotal5 + $SANKSITotal5, 2) . " <br>
