		...
		<?php if (isset($npwpd)) : ?>
			...
			<?php if (isset($nop)) : ?>
				...
				<tr valign="top">
					...
					<td>: <select class="form-control" style="width: 200px;height:30px;display:inline-block;font-size:smaller;" name="PROFIL[CPM_REKENING]" id="CPM_REKENING">
							<?php
				...
				<tr valign="top">
					<td>Peruntukan air <b class="isi">*</b></td>
					<td> :

						<?php if (!empty($value['CPM_PERUNTUKAN_AIR'])) { ?>
							<select class="form-control" style="width:200px;height:30px;display:inline-block;" name="PAJAK[CPM_PERUNTUKAN]" id="CPM_PERUNTUKAN">
