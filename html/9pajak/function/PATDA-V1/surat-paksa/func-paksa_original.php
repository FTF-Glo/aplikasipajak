...
<form class="cmxform" id="form-lapor" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/svc-paksa.php?param=<?php echo base64_encode($json->encode(array("a" => $lapor->_a, "m" => $lapor->_m, "mod" => $lapor->_mod, "f" => $lapor->_f))) ?>">
    ...
    <table class="main" width="900"> 
        <tr>
            <td colspan="2" align="center" class="subtitle"><b>SURAT PAKSA</b></td>
        </tr>
        <tr>
            <td colspan="2">
                <table width="100%" border="0" align="center" class="child"> 
					...
					<tr>
                        <td>Penanggung Pajak <b class="isi">*</b></td>
                        <td>: <input type="text" name="PAJAK[CPM_NAMA_WP]" id="CPM_NAMA_WP" style="width: 200px;" value="<?php echo $DATA['pajak']['CPM_NAMA_WP'] ?>" readonly placeholder="Penanggung Pajak"></td>
                    </tr>
                    <tr valign="top">
        ...
        <tr>
            <td colspan="2">
                <table width="100%" border="0" align="center" class="child">                    
                    <tr valign="top">
                        <td width="250">No Paksa <b class="isi">*</b></td>
                        <td width="150"> : <input type="text" name="PAJAK[CPM_NO_SURAT]" id="CPM_NO_SURAT" maxlength="25" value="<?php echo $DATA['pajak']['CPM_NO_SURAT'] ?>" placeholder="No Paksa"></td>
