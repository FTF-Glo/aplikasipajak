...
// require_once("function/{$DIR}/{$modul}/perpanjangan/get_data_reklame.php");
...
<form class="cmxform" autocomplete="off" id="form-lapor" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/lapor/svc-lapor.php?param=<?php echo base64_encode($json->encode(array("a" => $lapor->_a, "m" => $lapor->_m, "mod" => $lapor->_mod, "f" => $lapor->_f))) ?>">
    ...
    <table class="main" width="900">
        <tr>
            <td colspan="2" align="center" class="subtitle"><b>PROFIL PAJAK REKLAME PERPANJANGAN</b></td>
        </tr>
        <?php if (!empty($npwpd)) : ?>
            <tr>
        ...
        <tr>
            <td>No Pelaporan Sebelumnya <b class="isi">*</b></td>
            <td>:
                <select class="form-select" aria-label="Default select example" style="width: 200px;height:30px" name="PAJAK[CPM_NO_SEBELUMNYA]" id="CPM_NO_SEBELUMNYA">
                    <option value="" disabled selected>Pilih No Laporan</option>
                    <?php
                    $sspd = mysqli_query($DBLink, "SELECT * FROM simpatda_gw where npwpd = '{$npwpd}' AND sspd LIKE '%/REK/%' order by sspd desc LIMIT 5");
                    while ($d = mysqli_fetch_array($sspd)) {
                    ?>
                        <option value="<?php echo $d['sspd']; ?>"><?php echo $d['sspd'] ?></option>
                    <?php
                    }
                    ?>
                </select>
        ...
        <tr>
            <td colspan="2" align="center" class="subtitle"><b>LAPOR PAJAK REKLAME PERPANJANGAN</b></td>
        </tr>
        <tr>
            <td colspan="2">
                <?php
                ...
                <table style="width:100%" border="0" align="center" class="child">
                    ...
                    <tr valign="top">
                        ...
                        <td width="10">:</td>
                        <td width="700">
                            <?php echo ($DATA['pajak']['CPM_NO'] != "") ? "<input style=\"width:200px;height:30px;\" type=\"text\" class=\"form-control\" name=\"PAJAK[CPM_NO]\" id=\"CPM_NO\" maxlength=\"25\" value=\"{$DATA['pajak']['CPM_NO']}\" readonly>" : "..." ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="10">:</td>
                        <td> <input type="text" class="form-control" style="width:200px;height:30px;" name="PAJAK[SAVED_DATE]" id="SAVED_DATE1" value="<?php echo date("Y-m-d", strtotime(($DATA['pajak']['CPM_TGL_INPUT'] == "" ? date("Y-m-d") : $DATA['pajak']['CPM_TGL_INPUT']))) ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Tanggal Pelaporan">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            s/d
                            <input type="text" name="PAJAK_ATR[CPM_ATR_BATAS_AKHIR][]" id='CPM_ATR_BATAS_AKHIR' readonly style="width: 100px; display:inline-block; font-size:smaller;" value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_BATAS_AKHIR'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "class='datepicker form-control'" : "class='form-control' readonly"; ?> placeholder="Batas Akhir" tabindex="12" title="Batas Akhir">
                ...
                <table width="900" class="child" border="0">
                    ...
                    <tr>
                        ...
                        <td width="130" align="center" valign="top"><label id="load-type_1"></label>
                            <input class="form-control" style="width:150px;height:30px;display:inline-block;" name="PAJAK_ATR[CPM_ATR_PANJANG][]" type="text" class="number" tabindex="18" id="CPM_ATR_PANJANG" value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_PANJANG'] ?>" size="11" maxlength="11" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Panjang">
                        </td>
                        <td width="110" align="left" valign="top">Qty <b class="isi">*</b></td>
                        <td rowspan="3" align="center" valign="top"><label id="load-type_1"></label>

                            <input name="PAJAK_ATR[CPM_ATR_JUMLAH][]" type="text" class="number" tabindex="21" id="CPM_ATR_JUMLAH" value="<?php echo isset($DATA['pajak_atr'][0]['CPM_ATR_JUMLAH']) ? $DATA['pajak_atr'][0]['CPM_ATR_JUMLAH'] : 1 ?>" size="11" maxlength="11" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Jumlah">
                            <b class="isi">*</b>
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="center" valign="top"><input class="form-control" style="width:150px;height:30px;display:inline-block;" name="PAJAK_ATR[CPM_ATR_LEBAR][]" tabindex="19" type="text" class="number" id="CPM_ATR_LEBAR" value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_LEBAR'] ?>" size="11" maxlength="11" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Lebar" /></td>
                    ...
                    <tr>
                        ...
                        <td align="left" class="CPM_ATR_TINGGI_" valign="top">
                            <select class="form-control" style="height: 30px;" id="CPM_ATR_TINGGI" name="PAJAK_ATR[CPM_ATR_TINGGI][]">
                                ...
                                if (in_array($lapor->_mod, array("pel", ""))) {
                                    if (!in_array($lapor->_i, array(1, 3, ""))) {
                                        echo "<option value='{$type_tinggi}' selected>$type_tinggi</option>";
                                    } else {
                                    ...
                                    echo "<option value='{$type_tinggi}' selected>{$list_type_tinggi[$type_tinggi]}</option>";
                                }
                    ...
                    <tr>
                        ...
                        <td class="ID_JAM" align="center" valign="top">
                            ...
                            <input class="form-control" style="width:150px;height:30px;display:inline-block;" name="PAJAK_ATR[CPM_ATR_JAM][]" tabindex="3" type="text" class="number" id="CPM_ATR_JAM" size="11" minlength="" maxlength="11" onkeypress="" value="<?= $DATA['pajak_atr'][0]['CPM_ATR_JAM'] ?>" <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Jam/Hari" />
                    ...
                    <tr>
                        ...
                        <td>Lokasi Jalan </td>
                        <td>
                            <select class="form-control" style="height: 30px;" id="CPM_ATR_JALAN_TYPEE" class="CPM_ATR_JALAN_TYPE" name="PAJAK_ATR[CPM_ATR_JALAN_TYPE][]">
                                <?php
                        ...
                        <td class="BERADA" align="left" valign="top" colspan="3">
                            ...
                            <label><input type="radio" name="PAJAK_ATR[CPM_ATR_BANGUNAN][]" class="CPM_BANGUNAN" value="TANAH" <?= $DATA['pajak_atr'][0]['CPM_ATR_BANGUNAN'] == 'TANAH' ? ' checked' : '' ?> <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : " onclick=\"javascript:return false\""; ?> id="ForCheckBangunan1" /> DI ATAS TANAH</label> &nbsp;
                            <label><input type="radio" name="PAJAK_ATR[CPM_ATR_BANGUNAN][]" class="CPM_BANGUNAN" value="BANGUNAN" <?= $DATA['pajak_atr'][0]['CPM_ATR_BANGUNAN'] == 'BANGUNAN' ? ' checked' : '' ?> <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : " onclick=\"javascript:return false\""; ?> id="ForCheckBangunan2" /> DIATAS GEDUNG / BANGUNAN</label>
                        </td>
                    </tr>
                    <!-- kawasan -->
                    <tr>
                        ...
                        <td colspan="2">
                            Alkohol/Rokok <label><input type="radio" name="PAJAK_ATR[CPM_ATR_ALKOHOL_ROKOK][0]" id="CPM_ATR_ALKOHOL_ROKOK" class="CPM_ALKOHOL_ROKOK" value="1" <?= ($lapor->_id != "" && $lapor->_s != 1) ? 'onclick:javascript:return false"' : '' ?> <?= $DATA['pajak_atr'][0]['CPM_ATR_ALKOHOL_ROKOK'] == '1' ? 'checked' : '' ?> /> Ya</label> &nbsp;
                            <label><input type="radio" name="PAJAK_ATR[CPM_ATR_ALKOHOL_ROKOK][0]" name="CPM_ATR_ALKOHOL_ROKOK" id="CPM_ATR_ALKOHOL_ROKOK0" class="CPM_ALKOHOL_ROKOK" value="0" <?= ($lapor->_id != "" && $lapor->_s != 1) ? 'onclick:javascript:return false"' : '' ?> <?= $DATA['pajak_atr'][0]['CPM_ATR_ALKOHOL_ROKOK'] == '0' ? 'checked' : '' ?> /> Tidak</label>
                        </td>
                        <td colspan="2">
                            <label><input type="radio" name="PAJAK_ATR[CPM_ATR_GEDUNG][]" class="CPM_GEDUNG" value="LUAR" <?= $DATA['pajak_atr'][0]['CPM_ATR_GEDUNG'] == 'LUAR' ? ' checked' : '' ?> <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : " onclick=\"javascript:return false\""; ?> id="ForCheckGedung1" /> Luar Gedung</label> &nbsp;
                            <label><input type="radio" name="PAJAK_ATR[CPM_ATR_GEDUNG][]" class="CPM_GEDUNG" value="DALAM" <?= $DATA['pajak_atr'][0]['CPM_ATR_GEDUNG'] == 'DALAM' ? ' checked' : '' ?> <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : " onclick=\"javascript:return false\""; ?> id="ForCheckGedung2" /> Dalam Gedung</label>
                        </td>
                        ...
                        foreach ($DATA['pajak_atr'] as $atr) {
                            ...
                            echo '</td>
                                ...
                                <td width="130" align="center" valign="top"><label id="load-type-' . $no . '"></label>
                                    <input name="PAJAK_ATR[CPM_ATR_PANJANG][]" type="text" class="number" tabindex="' . ($idx + 4) . '" id="CPM_ATR_PANJANG-' . $no . '" size="11" maxlength="11" value="' . $atr['CPM_ATR_PANJANG'] . '" ' . $readonly . ' placeholder="Panjang" onkeyup="hitungDetail(' . $no . ')" />
                                </td>
                                <td rowspan="3" align="center" valign="top">
                                    <input name="PAJAK_ATR[CPM_ATR_JUMLAH][]" type="text" class="number" tabindex="' . ($idx + 7) . '" id="CPM_ATR_JUMLAH-' . $no . '" size="11" maxlength="11" value="' . $atr['CPM_ATR_JUMLAH'] . '" ' . $readonly . ' placeholder="Jumlah" onkeyup="hitungDetail(' . $no . ')" />
                                    <b class="isi">*</b>
                                </td>
                                <td rowspan="3" align="center" valign="top">
                            ...
                            echo '</select>
                                ...
                                <td align="left" valign="top">Lebar <b class="isi">*</b></td>
                                <td align="center" valign="top"><input name="PAJAK_ATR[CPM_ATR_LEBAR][]" tabindex="' . ($idx + 5) . '" type="text" class="number" id="CPM_ATR_LEBAR-' . $no . '" size="11" maxlength="11" value="' . $atr['CPM_ATR_LEBAR'] . '" ' . $readonly . ' placeholder="Lebar" onkeyup="hitungDetail(' . $no . ')" /></td>                                
                            </tr>
                            <td>Jenis Waktu Pemakaian</td>
                            <td>
...
<script>
    ...
    var dropdown = document.getElementById("CPM_NO_SEBELUMNYA");
    // Menambahkan event listener untuk mendengarkan perubahan dropdown
    dropdown.addEventListener("change", function() {
        // Mengambil nilai yang dipilih dari dropdown
        var selectedValue = dropdown.value;
        // Mengirim permintaan AJAX untuk mengambil data dari database berdasarkan nilai yang dipilih
        $.ajax({
            url: 'function/PATDA-V1/reklame/perpanjangan/get_data_reklame.php', // Ganti dengan URL Anda
            method: 'POST',
            data: {
            ...
            success: function(data) {
                if (Array.isArray(data)) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        console.log(i);
                        // Mengisi form-form di bawahnya dengan data yang diterima dari database
                        document.getElementById("CPM_ATR_BATAS_AWAL").value = currentItem.CPM_MASA_PAJAK1;
                        document.getElementById("CPM_ATR_BATAS_AKHIR").value = currentItem.CPM_MASA_PAJAK2;
                        document.getElementById("CPM_ATR_PANJANG").value = currentItem.CPM_ATR_PANJANG;
                        document.getElementById("CPM_ATR_LEBAR").value = currentItem.CPM_ATR_LEBAR;
                        document.getElementById("CPM_ATR_JUMLAH").value = currentItem.CPM_ATR_JUMLAH;
                        document.getElementById("CPM_ATR_JAM").value = currentItem.CPM_ATR_JAM;
                        document.getElementById("CPM_ATR_REKENING").value = currentItem.CPM_ATR_REKENING;
                        document.getElementById("CPM_ATR_TINGGI").value = currentItem.CPM_ATR_TINGGI;
                        document.getElementById("CPM_ATR_TYPE_MASA").value = currentItem.CPM_ATR_TYPE_MASA;
                        document.getElementById("CPM_ATR_JALAN_TYPEE").value = currentItem.CPM_ATR_JALAN_TYPE;
                        document.getElementById("CPM_ATR_JALAN").value = currentItem.CPM_ATR_JALAN;
                        document.getElementById("CPM_NOP").value = currentItem.CPM_ID_PROFIL;
                        document.getElementById("CPM_ATR_JUDUL").value = currentItem.CPM_ATR_JUDUL;
                        document.getElementById("CPM_ATR_LOKASI").value = currentItem.CPM_ATR_LOKASI;
                        document.getElementById("CPM_ATR_BIAYA").value = currentItem.CPM_ATR_BIAYA;
                        if (currentItem.CPM_ATR_ALKOHOL_ROKOK == "1") {
                            $("#CPM_ATR_ALKOHOL_ROKOK").prop("checked", true);
                        } else {
                            $("#CPM_ATR_ALKOHOL_ROKOK0").prop("checked", true);
                        }
                        if (currentItem.CPM_ATR_BANGUNAN == "TANAH") {
                            $("#ForCheckBangunan1").prop("checked", true);
                        } else {
                            $("#ForCheckBangunan2").prop("checked", true);
                        }
                        if (currentItem.CPM_ATR_GEDUNG == "LUAR") {
                            $("#ForCheckGedung1").prop("checked", true);
                        } else {
                            $("#ForCheckGedung2").prop("checked", true);
                        }
