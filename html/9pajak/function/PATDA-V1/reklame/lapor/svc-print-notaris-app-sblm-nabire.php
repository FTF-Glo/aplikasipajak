...
BEA PEROLEHAN HAK ATAS TANAH DAN BANGUNAN <br />
    ...
    <td width=\"142\" align=\"center\" style=\"vertical-align:center\" rowspan=\"2\">Jenis Perolehan: &nbsp;<br><strong>".$jenishakprint."</strong></td>
  </tr>
  <tr>
...
<br><br>
  ...
  <tr>
	...
	<table width=\"100%\" border=\"0\">
		    <tr>
		      <td align=\"center\" height=\"10\" colspan=\"3\">
			  <font size=\"-2\">TELAH DIVERIFIKASI <br>DINAS PENDAPATAN DAERAH<br> KOTA PEKANBARU</font>			  
			  </td>
	        </tr>
			<tr>
...
for ($i = 0; $i < $v; $i++) {
    ...
    $pdf->Image($sRootPath . 'view/Registrasi/configure/logo/' . $fileLogo, 12, 2, 25, '', '', '', '', false, 300, '', false);
    $pdf->SetAlpha(0.3);
    if ($draf == 1) {
        $bottomMargin = 0;
        for ($x = 1; $x <= 9; $x++) {
