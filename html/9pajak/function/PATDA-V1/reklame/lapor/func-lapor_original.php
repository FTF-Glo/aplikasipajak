            ...
            <td colspan="2">
                ...
                <table width="900" class="child" border="0">
                    ...
                    <tr>
                        ...
                        <td align="center" valign="top"><input class="form-control" style="width:150px;height:30px;display:inline-block;" name="PAJAK_ATR[CPM_ATR_MUKA][]" tabindex="19" type="text" class="number" id="CPM_ATR_MUKA" value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_MUKA'] ?>" size="11" maxlength="11" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Muka" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="left" valign="top">Tgl Jatuh Tempo <br><br><sup style="color:red; font-size:10px">(Tidak wajib)</sup></td>
                        <td align="left" valign="top">
                            <div align="left">
                    ...
                    <tr>
                        <td colspan="6" align="center" valign="top"></label></td>
                    </tr>
                </table>
                    ...
                    if (count($DATA['pajak_atr']) > 1) {
                        ...
                        foreach ($DATA['pajak_atr'] as $atr) {
                            ...
                            echo '</select>
                                ...
                                <td width="110" align="left" valign="top">Muka <b class="isi">*</b></td>
                                <td width="130" align="center" valign="top"><label id="load-type-' . $no . '"></label>
                                    <input name="PAJAK_ATR[CPM_ATR_MUKA][]" type="text" class="number" tabindex="' . ($idx + 4) . '" id="CPM_ATR_MUKA-' . $no . '" size="11" maxlength="11" value="' . $atr['CPM_ATR_MUKA'] . '" ' . $readonly . ' placeholder="MUuka" onkeyup="hitungDetail(' . $no . ')" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td width="130" align="center" valign="top"><label id="load-type-' . $no . '"></label>
                                    <input name="PAJAK_ATR[CPM_ATR_TINGGI][]" type="text" class="number" tabindex="' . ($idx + 4) . '" id="CPM_ATR_TINGGI-' . $no . '" size="11" maxlength="11" value="' . $atr['CPM_ATR_TINGGI'] . '" ' . $readonly . ' placeholder="Tinggi" onkeyup="hitungDetail(' . $no . ')" />
                                </td>
