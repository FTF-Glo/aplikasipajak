$(document).ready(function(){
	...
	/*init autonumeric*/
	$('#simpatda_dibayar, #patda_denda, #patda_admin_gw, #patda_total_bayar, #patda_total_sudahdibayar').autoNumeric('init',{aSign:'Rp.',mDec: '0'});
	...
	form_inquiry.validate({
        ...
        submitHandler: function(form) {
			...
			$.ajax({
				data:postData,
				url: "function/PATDA-V1/payment_kurangbayar/svc-payment.php",
				type:'post',
				dataType:'json',
				success:function(msg){
					
					$('#expired_date').html('');
					$('#simpatda_dibayar, #patda_denda, #patda_admin_gw, #patda_total_bayar, #patda_total_sudahdibayar').autoNumeric('set',0);
					...
					if(msg.RC == '00'){
						...
						$('#patda_total_sudahdibayar').autoNumeric('set',msg.patda_total_sudahdibayar);
					}else{
						alert(msg.MSG);
					}
				}
	...
	var cetakKwitansiPenbayaran = function(param){
		...
		window.open("function/PATDA-V1/payment_kurangbayar/svc-payment.php?param="+param,"_print");
	}
