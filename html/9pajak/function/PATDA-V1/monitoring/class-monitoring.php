...
class MonitoringPajak extends Pajak
{
	...
	public function filtering_sptpd($id)
	{
		...
		$html = "<div class=\"filtering\">
					<form>
						...
						<label style=\"margin-left: 10px\">NO. STPPD :</label> <input type=\"text\" name=\"CPM_NO-{$id}\" id=\"CPM_NO-{$id}\" class=\"form-control\" style=\"height: 32px; width: 144px; display: inline-block\"  >
						<label style=\"margin-left: 10px\">TAHUN :</label> <select name=\"CPM_TAHUN_PAJAK-{$id}\" id=\"CPM_TAHUN_PAJAK-{$id}\"  class=\"form-control\" style=\"height: 32px; width: 96px; display: inline-block\">";
		$html .= "<option value=''>All</option>";
		...
		$html .= "</select> <label style=\"margin-left: 10px\">Kecamatan :</label> <select name=\"CPM_KECAMATAN-{$id}\" id=\"CPM_KECAMATAN-{$id}\" class=\"form-control\" style=\"height: 32px; width: 144px; display: inline-block\">";
		$html .= "<option value=''>All</option>";
		foreach ($list_kecamatan as $x => $y) {
			$html .= "<option value='{$x}'>{$y}</option>";
		}
		$html .= "</select> <label style=\"margin-left: 10px\">Kelurahan :</label> <select name=\"CPM_KELURAHAN-{$id}\" id=\"CPM_KELURAHAN-{$id}\" class=\"form-control\" style=\"height: 32px; width: 144px; display: inline-block\">";
		$html .= "<option value=''>All</option></select>";


		$html .= "</select><br/> <label>MS PAJAK :</label> <select name=\"CPM_MASA_PAJAK-{$id}\" id=\"CPM_MASA_PAJAK-{$id}\" class=\"form-control\" style=\"height: 32px; width: 144px; display: inline-block\">";
		$html .= "<option value=''>All</option>";
		foreach ($this->arr_bulan as $x => $y) {
			$html .= "<option value='{$x}'>{$y}</option>";
		}
		$html .= "</select>
					<label style=\"margin-left: 10px\">TANGGAL LAPOR :</label>
					<input type=\"text\" name=\"CPM_TGL_LAPOR1\" id=\"CPM_TGL_LAPOR1-{$id}\" class=\"datepicker form-control\" size=\"10\" style=\"height: 32px; width: 144px; display: inline-block\"/>
					<input type=\"text\" name=\"CPM_TGL_LAPOR2\" id=\"CPM_TGL_LAPOR2-{$id}\" class=\"datepicker form-control\" size=\"10\" style=\"height: 32px; width: 144px; display: inline-block\"/>
					<label style=\"margin-left: 10px\">STATUS :</label> <select name=\"CPM_TRAN_STATUS-{$id}\" id=\"CPM_TRAN_STATUS-{$id}\" class=\"form-control\" style=\"height: 32px; width: 144px; display: inline-block\">";
		$html .= "<option value=''>All</option>";
		foreach ($this->arr_status as $x => $y) {
			$html .= "<option value='{$x}'>{$y}</option>";
		}
		$html .= "</select>
						<button type=\"submit\" id=\"cari-{$id}\" class=\"btn btn-primary lm-btn\" style=\"font-size: 0.7rem !important; margin-left: 10px; height: 32px\" ><i class=\"fa fa-search\"></i>  Cari</button>
						<button name=\"buttonToExcel\" id=\"buttonToExcel\" onClick=\"toExcel({$id})\" class=\"btn btn-success lm-btn\" style=\"font-size: 0.7rem !important; height: 32px\" ><i class=\"fa fa-download\"></i> Ekspor ke xls</button>
	...
	public function filtering_skpdkb($id)
	{
		$html = "<div class=\"filtering\">
					<form>
						Jenis Pajak : 
						<select name=\"CPM_JENIS_PAJAK-{$id}\" id=\"CPM_JENIS_PAJAK-{$id}\" class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\">
						<option value=\"\">All</option>";
		foreach ($this->arr_pajak as $x => $y) {
			$html .= "<option value=\"{$x}\">{$y}</option>";
		}
		$html .= "</select>
						<label style=\"margin-left: 10px\">No. Pelaporan :</label> <input type=\"text\" name=\"CPM_NO_SPTPD-{$id}\" id=\"CPM_NO_SPTPD-{$id}\"  class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\">  
						<label style=\"margin-left: 10px\">NPWPD :</label> <input type=\"text\" name=\"CPM_NPWPD-{$id}\" id=\"CPM_NPWPD-{$id}\"  class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\">                        
	...
	public function filtering_stpd($id)
	{
		...
		$html .= "</select>
						<label style=\"margin-left: 10px\">No. STPD :</label> <input type=\"text\" name=\"CPM_NO_STPD-{$id}\" id=\"CPM_NO_STPD-{$id}\" class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\">  
						<label style=\"margin-left: 10px\">NPWPD :</label> <input type=\"text\" name=\"CPM_NPWPD-{$id}\" id=\"CPM_NPWPD-{$id}\" class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\">                        
						<button type=\"submit\" id=\"cari-{$id}\" class=\"btn btn-primary lm-btn\" style=\"font-size: 0.7rem !important; margin-left: 10px\" ><i class=\"fa fa-search\"></i> Cari</button>
					</form>
				</div> ";
	...
	public function filtering_status_bayar($id)
	{
		...
		for ($b = 1; $b <= 12; $b++) {
			$bulan = str_pad($b, 2, '0', STR_PAD_LEFT); // Menambahkan leading zero
			$opt_bulan .= "<option value=\"{$bulan}\">{$this->arr_bulan[$b]}</option>";
		}
												...
												<form>
														<div class=\"row\">
															...
															<div class=\"form-group col-md-3\" >
																...
																<label>No. Pelaporan / NPWPD</label>
														...
														$html .=  "
															<div class=\" form-group col-md-12\">    
																<button type=\"submit\" class=\"btn btn-success\" name=\"button2\" id=\"cari-{$id}\" ><i class=\"fa fa-search\"></i> Tampilkan</button>
																<button class=\"btn btn-success\"  type=\"button\" name=\"buttonToExcel\" id=\"buttonToExcel\" onClick=\"toExcel({$id})\"><i class=\"fa fa-download\"></i> Ekspor ke xls</button>
					...
					$(document).ready(function() {
						...
						$('#laporanPajak-{$this->_i}').jtable({
							...
							fields: {
								...
								patda_denda: {title: 'Denda telat bayar',width: '7%',edit :false},
								patda_total_bayar: {title: 'Total Bayar',width: '7%',edit :false},
	...
	public function grid_data_status_bayar()
	{
		try {
			...
			$where .= $_REQUEST['simpatda_bulan_pajak'] == "" ? "" : " AND simpatda_bulan_pajak ='{$_REQUEST['simpatda_bulan_pajak']}'";
...
// var_dump($this->_s == 1);die;
			...
			// }else{
			$query = "select doc.pelaksana_kegiatan,permen.nmrek,jenis,op_nama,b.jenis_sw, patda_total_bayar,patda_denda,sptpd, npwpd,wp_nama, wp_alamat, simpatda_tahun_pajak,simpatda_bulan_pajak,
					date_format(expired_date,'%d-%m-%Y') as expired_date , simpatda_dibayar, simpatda_denda, IFNULL(payment_flag,0) as payment_flag, 
...
// var_dump($row['jenis_sw']);die;
				if ($row['jenis_sw'] == 'Reklame') {
									...
									<form>
										<table>
											<div class=\"row\">
												...
												<div class=\" form-group col-md-3\"> 
													<label>Kecamatan</label>
													<select class=\"form-control\" name=\"kecamatan-{$id}\" id=\"kecamatan-{$id}\">{$opt_kecamatan}</select>
												</div>

												<div class=\" form-group col-md-3\"> 
													<label>Kelurahan</label>
													<select class=\"form-control\" name=\"kelurahan-{$id}\" id=\"kelurahan-{$id}\">{$opt_kelurahan}</select>
												</div>

												<div class=\" form-group col-md-3\"> 
													<label>Jenis Pajak</label>
													<select class=\"form-control\" id=\"CPM_JENIS_PAJAK-{$id}\" name=\"CPM_JENIS_PAJAK-{$id}\">{$opt_jenis_pajak}</select>
												</div>
												
												<div class=\" form-group col-md-12\"> 
													<input class=\"btn btn-success\" type=\"button\" name=\"button2\" id=\"cari-{$id}\" value=\"Tampilkan\"/>
													<input class=\"btn btn-success\" type=\"button\" name=\"buttonToExcel\" id=\"buttonToExcel\" value=\"Ekspor ke xls\" onClick=\"javascript:toExcelBelumLapor({$id})\"/>
													<span id=\"loadlink-{$id}\" style=\"font-size: 10px; display: none;\">Loading...</span>	
												</div>
											</div>
										</table>
...
// var_dump($_REQUEST['jenis_lapor']);die;
		...
		if (!empty($_REQUEST['jenis'])) {
			...
			// var_dump($_REQUEST['jenis']);die;
			if (empty($_REQUEST['jenis_lapor']) || $_REQUEST['jenis_lapor'] == "undefined") {
				$where .= $_REQUEST['jenis'] == "" ? "" : " AND ( a.simpatda_type='{$jenis_reg}' OR a.simpatda_type='{$jenis_nonreg}' )";
			} else {
				if ($_REQUEST['jenis'] == 8) {
					$jenis = ($_REQUEST['jenis_lapor'] == 1) ? $jenis_reg : $tipe_pajak_restoran;
		...
		if ($tagihan == true) {
			...
			// $sheetName = $this->_i == 1 ? 'Sudah Bayar' : 'Belum bayar';
			if ($this->_i == 1) {
				$sheetName = 'Sudah Bayar';
			}elseif ($this->_i == 2) {
				$sheetName = 'Belum Bayar';
			}else{
