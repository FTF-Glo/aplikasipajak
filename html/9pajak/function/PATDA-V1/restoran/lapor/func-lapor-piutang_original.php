            ...
            <td colspan="2">
                ...
                <table width="950" border="0" align="center" class="child">
                    ...
                    <tr valign="top">
                        ...
                        <td width="300" rowspan="8">Keterangan :</br>
                            <textarea name="PAJAK[CPM_KETERANGAN]" class="form-control" style="width:250px;" id="CPM_KETERANGAN" style="display:block" rows="5" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Keterangan"><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <?php if ($DATA['profil']['CPM_REKENING'] == "4.1.01.07.07") { ?>
                        <tr>
                            <td>Pelaksana kegiatan <b class="isi">*</b></td>
                            <td colspan="2"> : <input type="text" name="PAJAK[PELAKSANA_KEGIATAN]" id="PELAKSANA_KEGIATAN" maxlength="17" value="<?php echo $DATA['pajak']['PELAKSANA_KEGIATAN'] ?>" placeholder="Pelaksanan Kegiatan" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>>
                            </td>
                        </tr>
                    <?php } ?>
                    <tr>
