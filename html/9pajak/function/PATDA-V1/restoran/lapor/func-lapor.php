    ...
    <form class="cmxform" autocomplete="off" id="form-lapor" method="post" enctype="multipart/form-data" action="function/<?php echo "{$DIR}/{$modul}"; ?>/lapor/svc-lapor.php?param=<?php echo base64_encode($json->encode(array("a" => $lapor->_a, "m" => $lapor->_m, "mod" => $lapor->_mod, "f" => $lapor->_f))) ?>">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        ?>
                            <a href="<?php echo $prm ?>" target="_blank" class="btn btn-primary lm-btn" style="margin-top:10px;" title="setelah data objek pajak diubah, refresh halaman ini (F5)">Ubah data objek pajak</a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="container lm-container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="PAJAK[CPM_KETERANGAN]" class="form-control" id="CPM_KETERANGAN" style="min-width: 100%" rows="5" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Keterangan"><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Pembayaran makanan / minuman<b class="isi">*</b></label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "<font id=\"tapbox\" class=\"alert alert-secondary\" style=\"display: block; width: 100%; margin-top: 25px; padding: 7px; text-align: center; border: 1px solid rgba(89,122,59, 0.5)\"><label id=\"val_tapbox\" style=\"margin-bottom: 0\"></label></font>" : ""; ?>
                    </div>
                </div>
                <div class="col-md-6" style="display:none">
                    <div class="form-group">
                        <label>Pembayaran Lain-lain</label>
                        <input type="text" name="PAJAK[CPM_BAYAR_LAINNYA]" id="CPM_BAYAR_LAINNYA" class="form-control number SUM" style="width: 100%" maxlength="17" value="<?php echo $DATA['pajak']['CPM_BAYAR_LAINNYA'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Pembayaran Lain-lain">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        ?>
                            <label>Pelaksana kegiatan <?php echo "<span id='cek'><b> " . $kegiatan . " </span> <!--<button id='ganti'>Ganti</button>-->"; ?></label>
                            ...
                            <?php if (empty($kegiatan)) : ?>
                                <div class="row">
                                    <div class="col-md-6">
                                        <select id="PELAKSANA_KEGIATAN1" name="PELAKSANA_KEGIATAN1" class="form-control d-none" style=" width: 100%;">
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <textarea style="display: none; min-width: 100%" name="PAJAK[PELAKSANA_KEGIATAN]" id="PELAKSANA_KEGIATAN" class="form-control" rows="2" placeholder="Pelaksana Kegiatan"><?php echo $DATA['pajak']['PELAKSANA_KEGIATAN'] ?></textarea>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="PAJAK[CPM_DENDA_TERLAMBAT_LAP]" id="CPM_DENDA_TERLAMBAT_LAP" class="form-control" <?php echo ($lapor->_s == 1 || $lapor->_s == ""  || $lapor->_s == 4) ?  "" : "readonly" ?> class="SUM2 number" value="<?php echo $DATA['pajak']['CPM_DENDA_TERLAMBAT_LAP'] ?>" placeholder="Sanksi Telat Lapor">
