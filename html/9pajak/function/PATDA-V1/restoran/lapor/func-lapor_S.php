                ...
                <table width="950" border="0" align="center" class="child">
                    ...
                    <tr>
                        ...
                        <?php if ($DATA['profil']['CPM_REKENING'] == "4.1.01.07.07") { ?>
                            <td width="300" colspan="2">Pelaksana kegiatan :
                                <!-- <input type="text" name="PAJAK[PELAKSANA_KEGIATAN]" id="PELAKSANA_KEGIATAN" maxlength="17" value="<?php echo $DATA['pajak']['PELAKSANA_KEGIATAN'] ?>" placeholder="Pelaksanan Kegiatan" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> > -->
                                <textarea name="PAJAK[PELAKSANA_KEGIATAN]" id="PELAKSANA_KEGIATAN" cols="50" rows="2" placeholder="Pelaksana Kegiatan"><?php echo $DATA['pajak']['PELAKSANA_KEGIATAN'] ?></textarea>
                            </td>
                        <?php } ?>
                    </tr>
                    <tr>
