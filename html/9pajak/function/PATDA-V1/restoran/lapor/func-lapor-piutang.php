    ...
    <div class="container lm-container">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <select name="PAJAK[CPM_TIPE_PAJAK]" id="CPM_TIPE_PAJAK" class="form-control">
                        <?php
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <textarea name="PAJAK[CPM_KETERANGAN]" id="CPM_KETERANGAN" class="form-control" rows="5" style="min-width: 100%" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Keterangan"><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    <label width="200">Tahun Pajak <b class="isi">*</b></label>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select id="CPM_MASA_PAJAK" class="form-control">
                        <?php
                        if (in_array($lapor->_mod, array("pel", ""))) {
                            if (!in_array($lapor->_i, array(1, 3, ""))) {
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" name="PAJAK[CPM_MASA_PAJAK1]" class="form-control" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "id=\"CPM_MASA_PAJAK1\"" : ""; ?> readonly value="<?php echo $DATA['pajak']['CPM_MASA_PAJAK1']; ?>" placeholder="Masa Awal">
                        </div>
                        <div class="col-md-1">
                            s.d
                        </div>
                        <div class="col-md-6">
                            <input type="text" name="PAJAK[CPM_MASA_PAJAK2]" class="form-control" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "id=\"CPM_MASA_PAJAK2\"" : ""; ?> readonly value="<?php echo $DATA['pajak']['CPM_MASA_PAJAK2']; ?>" placeholder="Masa Akhir">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php if ($DATA['profil']['CPM_REKENING'] == "4.1.01.07.07") { ?>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Pelaksana kegiatan <b class="isi">*</b></label>
                        <input type="text" class="form-control" name="PAJAK[PELAKSANA_KEGIATAN]" id="PELAKSANA_KEGIATAN" maxlength="17" value="<?php echo $DATA['pajak']['PELAKSANA_KEGIATAN'] ?>" placeholder="Pelaksanan Kegiatan" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>>
                    </div>
                </div>
            </div>
        <?php } ?>
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="PAJAK[CPM_TOTAL_PAJAK]" id="CPM_TOTAL_PAJAK" class="form-control number SUM" style="width: 100%" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> value="<?php echo $DATA['pajak']['CPM_TOTAL_PAJAK'] ?>" placeholder="Jumlah Pajak yang dibayar">
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group">
                    <label>Terbilang</label><input type="text" name="PAJAK[CPM_TERBILANG]" id="CPM_TERBILANG" class="form-control" readonly value="<?php echo $DATA['pajak']['CPM_TERBILANG'] ?>" placeholder="Terbilang">
                </div>
            </div>
        </div>
