		...
		<?php if (isset($npwpd)) : ?>
			<?php if (isset($nop)) : ?>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label>Menggunakan Cash Register <b class="isi">*</b></label><br />
							<label><input type="radio" name="PROFIL[CPM_CASHREGISTER]" value="1" <?php echo $value['CPM_CASHREGISTER'] == '1' ? 'checked' : '' ?> /> Ya</label>
							<label style="margin-left: 10px"><input type="radio" name="PROFIL[CPM_CASHREGISTER]" value="2" <?php echo $value['CPM_CASHREGISTER'] == '2' ? 'checked' : '' ?> /> Tidak</label>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label>Menggunakan Pembukuan / Pencatataan <b class="isi">*</b></label><br />
							<label><input type="radio" name="PROFIL[CPM_PEMBUKUAN]" value="1" <?php echo $value['CPM_PEMBUKUAN'] == '1' ? 'checked' : '' ?> /> Ya</label>
							<label style="margin-left: 10px"><input type="radio" name="PROFIL[CPM_PEMBUKUAN]" value="2" <?php echo $value['CPM_PEMBUKUAN'] == '2' ? 'checked' : '' ?> /> Tidak</label>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row" align="center" id="detail_rinci">
					<div class="col-md-12">
						<table width="900" class="table profil_detail">
							...
							if ($jml_detail > 0) {
								...
								<td>
									...
									<input type=\"number\" class=\"form-control number\" id=\"CPM_JUMLAH_MEJA-{$i}\" name=\"PROFIL_DETAIL[CPM_JUMLAH_MEJA][]\" value=\"{$det['CPM_JUMLAH_MEJA']}\" style=\"display:block;width:100%\" />
								</td>
								<td><input type=\"number\" class=\"form-control number\" id=\"CPM_JUMLAH_KURSI-{$i}\" name=\"PROFIL_DETAIL[CPM_JUMLAH_KURSI][]\" value=\"{$det['CPM_JUMLAH_KURSI']}\" style=\"display:block;width:100%\" /></td>
								<td><input type=\"number\" class=\"form-control number\" id=\"CPM_JUMLAH_PENGUNJUNG-{$i}\" name=\"PROFIL_DETAIL[CPM_JUMLAH_PENGUNJUNG][]\" value=\"{$det['CPM_JUMLAH_PENGUNJUNG']}\" style=\"display:block;width:100%\" /></td>
								<td align=\"center\"><a href=\"#\" class=\"btn btn-info lm-btn\" onclick=\"hapus_detail({$i});return false;\">[Hapus]</a></td>
							</tr>";
								}
							}
							?>
