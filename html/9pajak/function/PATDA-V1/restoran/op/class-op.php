...
class ObjekPajak extends Pajak {
    ...
    public function save() {
        ...
        #insert profil baru
        $query = sprintf("INSERT INTO PATDA_RESTORAN_PROFIL 
                    ...
                    VALUES ( '%s','%s','%s',
                             ...
                             '%s','%s','%s','%s','%s','%s','%s')",
                              ...
                              $this->CPM_APPROVE, $this->CPM_AUTHOR, $this->CPM_NOP, $this->CPM_TELEPON_WP, $this->CPM_TELEPON_OP, $this->longitude, $this->latitude
        );
    ...
    public function grid_data() {
        try {
			...
			$query = "SELECT * FROM {$this->PATDA_RESTORAN_PROFIL} WHERE {$where}
