...
class KartuData extends Pajak {
    ...
    public function filtering($id) {
        ...
        $html = "<div class=\"filtering\">
                    <form><table><tr valign=\"bottom\">
                        <td>Jenis Pajak :<br><select name=\"CPM_JENIS_PAJAK-{$id}\" id=\"CPM_JENIS_PAJAK-{$id}\" class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\" >{$opt_jenis_pajak}</select></td>
                        <td>NPWPD :<br><input type=\"text\" name=\"CPM_NPWPD-{$id}\" id=\"CPM_NPWPD-{$id}\" class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\" ></td>
                        <td>Tahun :<br><select name=\"CPM_TAHUN-{$id}\" id=\"CPM_TAHUN-{$id}\" class=\"form-control\" style=\"height: 32px; width: 96px; display: inline-block\" >{$opt_tahun}</select></td>
                        <td>Nama WP/OP :<br><input type=\"text\" name=\"CPM_NAMA-{$id}\" id=\"CPM_NAMA-{$id}\" class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\" ></td>
						<td>Alamat :<br><input type=\"text\" name=\"CPM_ALAMAT-{$id}\" id=\"CPM_ALAMAT-{$id}\" class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\" ></td>
                        <td>Tanggal :<br><input type=\"text\" name=\"date1-{$id}\" id=\"date1-{$id}\" class=\"datepicker form-control\" size=\"10\" style=\"height: 32px; width: 96px; display: inline-block\" /> s/d <input type=\"text\" name=\"date2-{$id}\" id=\"date2-{$id}\" class=\"datepicker form-control\" size=\"10\" style=\"height: 32px; width: 96px; display: inline-block\" /></td>
                    </tr></table>
                    <table><tr valign=\"bottom\">
                        <td>Kecamatan :<br><select name=\"CPM_KECAMATAN-{$id}\" id=\"CPM_KECAMATAN-{$id}\" class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\" >{$opt_kecamatan}</select></td>
                        <td>Kelurahan :<br><select name=\"CPM_KELURAHAN-{$id}\" id=\"CPM_KELURAHAN-{$id}\" class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\" ><option value=''>All</option></select></td>
                        <td>Kode Rekening :<br><select name=\"CPM_KODEREKENING-{$id}\" id=\"CPM_KODEREKENING-{$id}\" class=\"form-control\" style=\"height: 32px; width: 168px; display: inline-block\" >{$opt_rekening}</select></td>
                        <td><button type=\"submit\" id=\"cari-{$id}\" class=\"btn btn-primary lm-btn\" style=\"font-size: 0.7rem !important; margin-left: 10px\" ><i class=\"fa fa-search\"></i> Cari</button></td>
                        <td colspan=\"5\">
                            <button type=\"button\" id=\"cetak-{$id}\" onclick=\"javascript:download_excel_profilwp('{$id}','function/PATDA-V1/pelayanan/profilwp/svc-download.xls.php');\" class=\"btn btn-success lm-btn\" style=\"font-size: 0.7rem !important\" ><i class=\"fa fa-download\"></i> Cetak Excel data WP</button>
                            <button type=\"button\" id=\"cetak-kartudata-{$id}\" onclick=\"javascript:download_kartudata_excel('{$id}');\" class=\"btn btn-success lm-btn\" style=\"font-size: 0.7rem !important\" ><i class=\"fa fa-download\"></i> Cetak Excel Kartu Data</button>
                        </td>
                    </tr></table></form>
    ...
    public function grid_data() {
        try {
            ...
            $where.= (isset($_REQUEST['CPM_NPWPD']) && $_REQUEST['CPM_NPWPD'] != "") ? " AND a.CPM_NPWPD like \"{$_REQUEST['CPM_NPWPD']}%\" " : "";
            $where.= (isset($_REQUEST['CPM_NAMA']) && $_REQUEST['CPM_NAMA'] != "") ? " AND ( a.CPM_NAMA_WP like \"{$_REQUEST['CPM_NAMA']}%\" OR a.CPM_NAMA_OP like  \"{$_REQUEST['CPM_NAMA']}%\") " : "";
    ...
    function download_kartudata_xls() {
      ...
      // $objPHPExcel->setActiveSheetIndex($z)->setCellValue('B'.$row, $npwpd);
			$objPHPExcel->setActiveSheetIndex($z)->setCellValueExplicit('B'.$row, (string) $npwpd, PHPExcel_Cell_DataType::TYPE_STRING);
