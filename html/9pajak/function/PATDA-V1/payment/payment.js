$(document).ready(function(){
	...
	form_inquiry.validate({
        ...
        submitHandler: function(form) {
			...
			$.ajax({
				data:postData,
				url: "function/PATDA-V1/payment/svc-payment.php",
				type:'post',
				dataType:'json',
				success:function(msg){
					...
					if(msg.RC == '00'){
						...
						if(msg.simpatda_dibayar == 0) alert('Tagihan 0 Rupiah!');
						$('#area_identity').html(msg.html);
	...
	form_bayar.validate({
        ...
        submitHandler: function(form) {
			...
			if(confirm('Apakah anda yakin untuk memverifikasi transaksi ini?') == false) return false;
            var postData = {};
	...
	var cetakKwitansiPenbayaran = function(param){
		...
		window.open("function/PATDA-V1/payment/svc-payment.php?param="+param,"_print");
	}
