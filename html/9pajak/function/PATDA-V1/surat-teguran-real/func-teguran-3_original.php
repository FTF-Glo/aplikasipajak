        ...
        <tr>
		    ...
		    <tr>
					...
					<tr>
                        ...
                        <td>: <input type="text" name="PAJAK[CPM_KECAMATAN_OP]" id="CPM_KECAMATAN_OP" style="width: 200px;" value="<?php echo $DATA['pajak']['CPM_KECAMATAN_OP'] ?>" placeholder="Kecamatan"></td>
                    </tr>				
					<?php else : ?>
					<tr>
                        <td>Kecamatan <b class="isi">*</b></td>
					...
					<tr>
                        ...
                        <td>: <input type="text" name="PAJAK[CPM_KELURAHAN_OP]" id="CPM_KELURAHAN_OP" style="width: 200px;" value="<?php echo $DATA['pajak']['CPM_KELURAHAN_OP'] ?>" placeholder="Kelurahan"></td>
                    </tr>				
					<?php else : ?>
					<tr>
                        <td>Kelurahan <b class="isi">*</b></td>
            ...
            <td colspan="2">
                <table width="100%" border="0" align="center" class="child">                    
                    <tr valign="top">
                        ...
                        <td width="150"> : <input type="text" name="PAJAK[CPM_NO_SURAT]" id="CPM_NO_SURAT" maxlength="25" value="<?php echo $DATA['pajak']['CPM_NO_SURAT'] ?>" placeholder="Diisi Otomatis" readonly></td>
