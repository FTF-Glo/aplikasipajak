...
<form class="cmxform" id="form-lapor" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/svc-teguran.php?param=<?php echo base64_encode($json->encode(array("a" => $lapor->_a, "m" => $lapor->_m, "mod" => $lapor->_mod, "f" => $lapor->_f))) ?>">
    ...
    <table class="main" width="900"> 
        <tr>
            <td colspan="2" align="center" class="subtitle"><b>SURAT TEGURAN SPTPD</b></td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2">
                <table width="100%" border="0" align="center" class="child">                    
                    ...
                    <tr valign="top">
                        <td width="250">Sifat <b class="isi">*</b></td>
                        <td width="150"> : <input type="text" name="PAJAK[CPM_SIFAT]" id="CPM_SIFAT" maxlength="25" value="<?php echo $DATA['pajak']['CPM_SIFAT'] ?>" placeholder="Sifat"></td>
                        <td width="200"></td>
                    </tr>    
                    <tr valign="top">
                        <td width="250">Lampiran <b class="isi">*</b></td>
                        <td width="150"> : <input type="text" name="PAJAK[CPM_LAMPIRAN]" id="CPM_LAMPIRAN" maxlength="25" value="<?php echo $DATA['pajak']['CPM_LAMPIRAN'] ?>" placeholder="Lampiran"></td>
                        <td width="200"></td>
                    </tr>    
                    <tr>
