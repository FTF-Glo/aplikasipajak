$(document).ready(function () {
    ...
    form.validate({
        rules: {
            ...
            "PAJAK[CPM_SIFAT]": "required",
            "PAJAK[CPM_LAMPIRAN]": "required"
        },
        messages: {
            ...
            "PAJAK[CPM_SIFAT]": "harus diisi",
            "PAJAK[CPM_LAMPIRAN]": "harus diisi",
        }
    });
    ...
    $("#btn-search-npwpd").click(function () {
        ...
        $.ajax({
            ...
            url: "function/PATDA-V1/surat-teguran-real/svc-teguran.php",
            dataType: "json",
