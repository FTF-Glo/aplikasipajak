...
<form class="cmxform" id="form-lapor" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/svc-teguran.php?param=<?php echo base64_encode($json->encode(array("a" => $lapor->_a, "m" => $lapor->_m, "mod" => $lapor->_mod, "f" => $lapor->_f))) ?>">
    ...
    <input type="hidden" name="PAJAK[CPM_KELURAHAN_OP_ID]" value="<?php echo $DATA['pajak']['CPM_KELURAHAN_OP_ID']; ?>">surat-teguran-real/func-teguran-4.php

    <table class="main" width="900"> 
        <tr>
            <td colspan="2" align="center" class="subtitle"><b>SURAT TEGURAN 2</b></td>
        </tr>
        <tr>
            <td colspan="2">
                <table width="100%" border="0" align="center" class="child"> 
					...
					<tr>
                        ...
                        -->
							<input type="hidden" id="TBLJNSPJK">
							<input type="text" name="PAJAK[CPM_NPWPD]" id="CPM_NPWPD" style="width: 200px;" value="<?php echo Pajak::formatNPWPD($DATA['pajak']['CPM_NPWPD']) ?>" readonly>
                        </td>
                    </tr>
					<?php endif; ?>					
                    <tr>
                        <td>Nama Usaha <b class="isi">*</b></td>
                        <td>: <input type="text" name="PAJAK[CPM_NAMA_OP]" id="CPM_NAMA_OP" style="width: 200px;" value="<?php echo $DATA['pajak']['CPM_NAMA_OP'] ?>" readonly placeholder="Nama Usaha"></td>
                    </tr>
		    <tr>
                        <td>Pemilik / Pimpinan <b class="isi">*</b></td>
                        <td>: <input type="text" name="PAJAK[CPM_NAMA_WP]" id="CPM_NAMA_WP" style="width: 200px;" value="<?php echo $DATA['pajak']['CPM_NAMA_WP'] ?>" readonly placeholder="Pemilik / Pimpinan"></td>
                    </tr>	
                    <tr valign="top">
                        <td>Alamat <b class="isi">*</b></td>
                        <td>: <textarea name="PAJAK[CPM_ALAMAT_OP]" id="CPM_ALAMAT_OP" cols="70" rows="3" readonly placeholder="Alamat"><?php echo $DATA['pajak']['CPM_ALAMAT_OP'] ?></textarea></td>
                    </tr>
		    <tr>
                        <td>Kecamatan <b class="isi">*</b></td>
                        <td>: <input type="text" name="PAJAK[CPM_KECAMATAN_OP]" id="CPM_KECAMATAN_OP" style="width: 200px;" value="<?php echo $DATA['pajak']['CPM_KECAMATAN_OP'] ?>" readonly placeholder="Kecamatan"></td>
                    </tr>	
				<tr>
                        <td>Kelurahan <b class="isi">*</b></td>
                        <td>: <input type="text" name="PAJAK[CPM_KELURAHAN_OP]" id="CPM_KELURAHAN_OP" readonly style="width: 200px;" value="<?php echo $DATA['pajak']['CPM_KELURAHAN_OP'] ?>" placeholder="Kelurahan"></td>
                    </tr>					
                    <tr>
            ...
            <td colspan="2">
                <table width="100%" border="0" align="center" class="child">                    
                    <tr valign="top">
                        ...
                        <td width="150"> : <input type="text" name="PAJAK[CPM_NO_SURAT]" id="CPM_NO_SURAT" maxlength="25" value="<?php echo $DATA['pajak']['CPM_NO_SURAT'] ?>" readonly placeholder="No Teguran"></td>
                    ...
                    <tr>
                        ...
                        <td width="150"> : <input type="text" name="PAJAK[CPM_NO_SKPD]" id="CPM_NO_SKPD" maxlength="25" readonly value="<?php echo $DATA['pajak']['CPM_NO_SKPD'] ?>" placeholder="No SKPD"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> : <input type="text" name="PAJAK[CPM_JUMLAH_TUNGGAKAN]" id="CPM_JUMLAH_TUNGGAKAN" class="number SUM" maxlength="17" readonly value="<?php echo $DATA['pajak']['CPM_JUMLAH_TUNGGAKAN'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Jumlah Tunggakan"></td>
                    </tr>
                    <tr>
