            ...
            <td colspan="2">
                <table width="100%" border="0" align="center" class="child">                    
                    <tr valign="top">
                        ...
                        <td width="150"> : <input type="text" name="PAJAK[CPM_NO_SURAT]" id="CPM_NO_SURAT" readonly maxlength="25" value="<?php echo $DATA['pajak']['CPM_NO_SURAT'] ?>" placeholder="No Teguran"></td>
