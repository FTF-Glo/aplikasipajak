...
class ObjekPajak extends Pajak {
    ...
    public function update() {
        #update profil
        $query = sprintf("UPDATE PATDA_REKLAME_PROFIL SET
                    CPM_NPWPD = '%s',
                    CPM_NAMA_WP = '%s',
                    CPM_ALAMAT_WP = '%s',
                    CPM_KELURAHAN_WP = '%s',
    ...
    public function save() {
        ...
        if($this->CPM_NOP==''){
            // get last nop
            $res_nop = mysqli_query($this->Conn, "SELECT CPM_NOP FROM PATDA_REKLAME_PROFIL WHERE CPM_NPWPD = '{$this->CPM_NPWPD}' ORDER BY CPM_NOP DESC LIMIT 0, 1");
	...
	public function check_nop(){
		...
		$query = sprintf("SELECT COUNT(*) AS TOTAL FROM PATDA_REKLAME_PROFIL 
