...
function hitungDetail(id) {
	...
	var params = {
		...
		gedung: $(".CPM_GEDUNG-" + id + ":checked").val(),
		alkohol_rokok: $(".CPM_ALKOHOL_ROKOK-" + id + ":checked").val(),
		tol: $(".CPM_TOL-" + id + ":checked").val(),
		jam: $("#CPM_ATR_JAM-" + id).val(),

		// function: "get_hargadasar",
	};
	if (params.rumus == 'RMS2') {
		params.function = "get_hargadasarK2";
	} else {
		params.function = "get_hargadasar";
	}
	// console.log(params);
	if (
		params.panjang == "" ||
...
function calculation() {
	...
	var selectedValue = $('#RMS').val();
	// console.log(selectedValue);
	switch (true) {
		case selectedValue === 'RMS1':
			get_hargadasar();
			break;
		case selectedValue === 'RMS2':
			get_hargadasarK2();
			break;
	}
...
$(function () {
	...
	$('select#CPM_ATR_REKENING').change(function () {
		...
		$('#CPM_ATR_HARGA_DASAR_TIN').attr('readonly', 'readonly').val(data.tinggi);
		switch (true) {
			case kdrek === '4.1.01.09.01.03' || kdrek === '4.1.01.09.01.01' ||
				kdrek === '4.1.01.09.01.02':
				$('#CPM_ATR_PANJANG').removeAttr('readonly');
				$('#CPM_ATR_LEBAR').removeAttr('readonly');
				$('#CPM_ATR_TINGGI').removeAttr('readonly');
				break;
			case kdrek === '4.1.01.09.01.09' || kdrek === '4.1.01.09.02.02':
				$('#CPM_ATR_PANJANG').val('0').attr('readonly', true);
				$('#CPM_ATR_LEBAR').val('0').attr('readonly', true);
				$('#CPM_ATR_TINGGI').val('0').attr('readonly', true);
				break;
			case kdrek === '4.1.01.09.02.08' || kdrek === '4.1.01.09.02.07' ||
				kdrek === '4.1.01.09.02.06':
				$('#CPM_ATR_PANJANG').val('0').attr('readonly', true);
				$('#CPM_ATR_LEBAR').val('0').attr('readonly', true);
				$('#CPM_ATR_TINGGI').val('0').attr('readonly', true);
				break;
