            ...
            <td colspan="2">
                ...
                <table style="width:100%" border="0" align="center" class="child">
                    ...
                    <tr valign="top">
                        ...
                        <td width="302">: <input name="PAJAK[CPM_NO]" type="text" class="form-control" style="width:250px;height:30px;display:inline-block;font-size:small;" id="CPM_NO" value="<?php echo $DATA['pajak']['CPM_NO'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "") ? "" : "readonly"; ?> placeholder="No Pelaporan"></td>
                    ...
                    <tr>
                        ...
                        <td align="left" width="240" valign="top">:
                            <?php if (empty($DATA['pajak']['CPM_ID'])) : ?>
                                <select name="PAJAK_ATR[CPM_ATR_NOP][]" class="form-control" style="width:250px;height:30px;display:inline-block;font-size:small;" tabindex="14" id="CPM_NOP" class="CPM_NOP" style="max-width:260px">
                                    <?php
                                    if (count($DATA['list_nop']) == 0) echo "<option value=''>NOP Tidak tersedia</option>";
                                    else echo (empty($nop)) ? "<option value='' selected disabled>Pilih NOP</option>" : "";
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">:
                            <select tabindex="15" name="PAJAK_ATR[CPM_ATR_REKENING][]" id="CPM_ATR_REKENING" class="form-control" style="width:250px;height:30px;display:inline-block;font-size:small;">
                                <?php
                    ...
                    <tr>
                        ...
                        <td> :
                            <select class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" name="PAJAK[CPM_TAHUN_PAJAK]" tabindex="10">
                                <?php
