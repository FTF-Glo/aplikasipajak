            ...
            <td colspan="2">
                ...
                <table width="900" class="child" border="0">
                    <tr>
                        ...
                        <th width="80" id="label_jumlah">Jumlah (Qty)</th>
                    ...
                    <tr>
                        ...
                        <td rowspan="3" align="center" valign="top">
                            <input name="PAJAK_ATR[CPM_ATR_JUMLAH][]" type="text" class="number" tabindex="21" id="CPM_ATR_JUMLAH" value="1" size="11" maxlength="11" <?php echo  ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Jumlah">
                            <b class="isi">*</b>
                        </td>
                        <td rowspan="3" align="center" valign="top">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            ...
                            <input name="PAJAK_ATR[CPM_ATR_MUKA][]" tabindex="20" type="text" id="CPM_ATR_MUKA"  size="11" maxlength="11" value="<?php echo $DATA['pajak_atr'][0]['CPM_ATR_MUKA']?>" class="number" <?php echo  ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Muka" />
                        </td>
                    </tr>
                    <tr>
                        <td>Jenis Waktu Pemakaian</td>
                        <td>
							<select id="CPM_ATR_TYPE_MASA" tabindex="16" name="PAJAK_ATR[CPM_ATR_TYPE_MASA][]">
								<?php
                                ...
                                if(empty($DATA['pajak']['CPM_ID'])){
                                    ...
                                    echo "<option value='{$type_masa}'>{$list_type_masa[$type_masa]}</option>";
                                }
                        ...
                        <td align="left" colspan="4" rowspan="6" valign="top">
                            <div id="area_perhitungan">
                                ...
                                if (!empty($DATA['pajak']['CPM_ID'])) {
                                    ...
                                    $html .= 'Luas Reklame : ' . number_format($DATA['pajak_atr'][0]['CPM_ATR_PANJANG'] * $DATA['pajak_atr'][0]['CPM_ATR_LEBAR'],2) . " M<sup>2</sup> <br/>";
                                    $html .= 'Durasi : ' . intval($DATA['pajak']['CPM_MASA_PAJAK']).' '.$DATA['pajak']['CPM_JNS_MASA_PAJAK'] . " <br/>";
                                    $html .= 'Tarif Pajak : ' . number_format($DATA['pajak_atr'][0]['CPM_ATR_TARIF'],0) . "% <br/>";
                                    $html .= 'Besaran Pajak : Rp. ' . number_format($DATA['pajak_atr'][0]['CPM_ATR_HARGA'],0) . " / {$DATA['pajak']['CPM_JNS_MASA_PAJAK']}<br/>";
                                    $html .= "</td></tr></table>";
                    ...
                    <!--<tr>
                        ...
                        <td align="left" colspan="4" rowspan="7" valign="top">
                            <div id="area_perhitungan">
                                <?php
                                /* if ($lapor->_id != "" && $lapor->_s != 1) {
                                    ...
                                    $html .= "<div style='border-bottom:2px #999 dashed;padding:5px'>";
                                    $html .= "<table width='100%'><tr><td>";
                                    $html .= 'Luas Reklame : ' . number_format($DATA['pajak_atr'][0]['CPM_ATR_LEBAR'] * $DATA['pajak_atr'][0]['CPM_ATR_TINGGI'],0) . " m<sup>2</sup> <br/>";
                                    $html .= 'NJOP : ' . number_format($DATA['pajak_atr'][0]['CPM_ATR_NJOP'],0) . " m<sup>2</sup> <br/>";
                    ...
                    <!--<tr>
                        ...
                        <td>
                            <input name="PAJAK_ATR[CPM_ATR_HARGA_DASAR_UK][]" style="width: 260px;" placeholder="Biaya Harga Dasar" type="text" class="number" id="CPM_ATR_HARGA_DASAR_UK" readonly value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_HARGA_DASAR_UK'] ?>" <?php echo  ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>>
                        </td>
                    </tr>
                    <tr>
                        <td>Harga Dasar Ketinggian</td>
                        <td>
							<input name="PAJAK_ATR[CPM_ATR_HARGA_DASAR_TIN][]" style="width: 260px;" placeholder="Biaya Harga Dasar" type="text" class="number" id="CPM_ATR_HARGA_DASAR_TIN" readonly value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_HARGA_DASAR_TIN'] ?>" <?php echo  ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>>
						</td>
                    </tr>-->
                    <tr>
