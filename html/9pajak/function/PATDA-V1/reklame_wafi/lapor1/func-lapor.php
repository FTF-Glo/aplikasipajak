            ...
            <td colspan="2">
                ...
                <table style="width:100%" border="0" align="center" class="child">
					...
					<tr>
                        ...
                        <td> :
                            <input type="text"  name="PAJAK_ATR[CPM_ATR_JATUH_TEMPO][]" id='CPM_ATR_JATUH_TEMPO' style="width:100px" 
							value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_JATUH_TEMPO'] ?>"<?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "class='datepicker'" : "readonly"; ?> placeholder="Jatuh Tempo" tabindex="12" title="Jatuh Tempo">
                        </td>
                    </tr>
                </table>
                <table width="900" class="child" border="0">
                    ...
                    <tr>
						...
						<td>
							<select name="CPM_RUMUS_BARU" id="CPM_RUMUS_BARU">
