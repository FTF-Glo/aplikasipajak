	...
	{	
		...
		<tr>
			...
			<td align="left" width="240" valign="top">
				<select name="PAJAK_ATR[CPM_TIPE_PAJAK][]" tabindex="' . ($idx) . '" id="CPM_NOP-' . $no . '" class="CPM_NOP" onchange="hitungDetail(' . $no . ')" style="max-width:260px">' . $tipe_pajak . '</select>
			</td>
			...
			<td rowspan="3" align="center" valign="top">
				<input name="PAJAK_ATR[CPM_ATR_SISI][]" type="text" class="number" tabindex="' . ($idx + 7) . '" id="CPM_ATR_SISI-' . $no . '" value="" size="11" maxlength="11" placeholder="Jumlah" onkeyup="hitungDetail(' . $no . ')" />
				<b class="isi">*</b>
			</td>
			<td rowspan="3" align="center" valign="top">
		...
		<tr>
			...
			<td valign="top">
				...
				<input name="PAJAK_ATR[CPM_ATR_TINGGI][]" tabindex="' . ($idx + 6) . '" type="text" id="CPM_ATR_TINGGI-' . $no . '" class="number" size="11" maxlength="11" value="" placeholder="Tinggi" />
			</td>
		</tr>
		<tr>
            ...
            <td class="ID_JAM-<?= $no ?>" align="center" valign="top"><input class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" name="PAJAK_ATR[CPM_ATR_JAM][]" tabindex="3" type="text" class="number" id="CPM_ATR_JAM-<?= $no ?>" size="11" maxlength="11" value="<?= $DATA['pajak_atr'][0]['CPM_ATR_JAM'] ?>" <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Jam" /></td>
<?php	echo
'		</tr>
		<tr>
		<td>Jenis Waktu Pemakaian </td>
			...
			<td valign="top">
				<select class="form-control" style="height:30px;" id="CPM_ATR_SUDUT_PANDANG-' . $no . '" onchange="hitungDetail(' . $no . ')" name="PAJAK_ATR[CPM_ATR_SUDUT_PANDANG][]">' . $opt_sudut_pandang . '</select>
			</td>

			<td colspan="2">	
				<input type="radio" name="PAJAK_ATR[CPM_ATR_GEDUNG]['.$zz.']" class="CPM_GEDUNG" value="LUAR" style="margin-left:20px"> Luar Gedung &nbsp;
				<label><input type="radio" name="PAJAK_ATR[CPM_ATR_GEDUNG]['.$zz.']" class="CPM_GEDUNG" value="DALAM" id="ForCheck2" /> Dalam Gedung</label>
			</td>
		</tr>
		...
		<tr>	
			...
			<td>
				<select class="form-control" style="height:30px;" id="CPM_ATR_KAWASAN-' . $no . '" tabindex="' . ($idx + 3) . '" onchange="hitungDetail(' . $no . ')" name="PAJAK_ATR[CPM_ATR_KAWASAN][]">' . $opt_kawasan_1 . '</select>
			</td>
			<td colspan="2">
				<label>Alkohol/Rokok </label>
				<input type="radio" name="PAJAK_ATR[CPM_ATR_ALKOHOL_ROKOK]['.$zz.']" class="CPM_ALKOHOL_ROKOK"
					value="1" style="margin-left:20px"> Ya &nbsp;
				<label><input type="radio" name="PAJAK_ATR[CPM_ATR_ALKOHOL_ROKOK]['.$zz.']"
					class="CPM_ALKOHOL_ROKOK" value="0"
					id="ForCheck2" /> Tidak</label>
			</td>

			<td colspan="2">
				<label>Jalan Tol : </label>
				<input type="radio" name="PAJAK_ATR[CPM_ATR_TOL]['.$zz.']" class="CPM_TOL"
					value="1" style="margin-left:20px"> Ya &nbsp;
				<label><input type="radio" name="PAJAK_ATR[CPM_ATR_TOL]['.$zz.']"
					class="CPM_TOL" value="0"
					id="ForCheck2" /> Tidak</label>
			</td>
