...
*/
	...
	function addRow()
	{
		...
		<td>Jenis Waktu Pemakaian </td>
			...
			<td colspan="2">	
				<input type="radio" name="PAJAK_ATR[CPM_ATR_GEDUNG][]" class="CPM_GEDUNG" value="LUAR" style="margin-left:20px"> Luar Gedung &nbsp;
				<label><input type="radio" name="PAJAK_ATR[CPM_ATR_GEDUNG][]" class="CPM_GEDUNG" value="DALAM" id="ForCheck2" /> Dalam Gedung</label>
			</td>
		</tr>
		...
		<tr>	
			...
			<td colspan="2">
				...
				<input type="radio" name="PAJAK_ATR[CPM_ATR_ALKOHOL_ROKOK][]" class="CPM_ALKOHOL_ROKOK"
					value="1" style="margin-left:20px"> Ya &nbsp;
				<label><input type="radio" name="PAJAK_ATR[CPM_ATR_ALKOHOL_ROKOK][]"
			...
			<td colspan="2">
				...
				<input type="radio" name="PAJAK_ATR[CPM_ATR_TOL][]" class="CPM_TOL"
					value="1" style="margin-left:20px"> Ya &nbsp;
				<label><input type="radio" name="PAJAK_ATR[CPM_ATR_TOL][]"
