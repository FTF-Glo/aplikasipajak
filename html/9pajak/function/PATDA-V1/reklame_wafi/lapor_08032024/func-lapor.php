            ...
            <td colspan="2">
                ...
                <table style="width:100%" border="0" align="center" class="child">
					...
					<tr>
						...
						<td>: <input type="text" class="datepicker" style="width: 100px;" name="PAJAK_ATR[CPM_ATR_JATUH_TEMPO][]" id= "CPM_ATR_JATUH_TEMPO" readonly placeholder="JATUH TEMPO" tabindex="12" title="Batas Akhir"></td>
					</tr>
                </table>
                <table width="900" class="child" border="0">
                    ...
                    <tr>
                        ...
                        <td align="center" valign="top"><input name="PAJAK_ATR[CPM_ATR_LEBAR][]" class="form-control" style="width:150px;height:30px;display:inline-block;font-size:small;" tabindex="19" type="text" class="number" id="CPM_ATR_LEBAR" value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_LEBAR'] ?>" size="11" maxlength="11" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Lebar" />
						</td>
						<td>
							<select class="form-control" name="PAJAK_ATR[CPM_ATR_RUMUS][]" id="CPM_RUMUS">
								<option value="R1">RUMUS 1</option>
								<option value="R2">RUMUS 2</option>
							</select>
						</td>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
							<select class="form-control" id="CPM_ATR_SUDUT_PANDANG" name="PAJAK_ATR[CPM_ATR_SUDUT_PANDANG][]">
								<?php
						...
						<td align="left" valign="top">
							<select name="PAJAK_ATR[CPM_ATR_GEDUNG][]" class="form-control CPM_GEDUNG">
                    ...
                    <tr>
                        ...
                        <td>
							Alkohol/Rokok 
							<select name="PAJAK_ATR[CPM_ATR_ALKOHOL_ROKOK][]" class="form-control CPM_ALKOHOL_ROKOK" <?= ($lapor->_id != "" && $lapor->_s != 1) ? 'disabled' : '' ?>>
						...
						<td>
							Jalan Tol: 
							<select name="PAJAK_ATR[CPM_ATR_TOL][]" class="form-control CPM_TOL" <?= ($lapor->_id != "" && $lapor->_s != 1) ? 'disabled' : '' ?>>
					...
					<tr>
						...
						<td></td>
						<td colspan="2">
							<button  type="button" class="form-control btn btn-success" id="berhitung">
								HITUNG
							</button>
						</td>
                    </tr>
