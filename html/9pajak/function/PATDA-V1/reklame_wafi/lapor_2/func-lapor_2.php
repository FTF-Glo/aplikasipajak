    ...
    <table class="main" width="900">
        ...
        <tr>
            <td colspan="2">
				...
				<table style="width:100%" border="0" align="center" class="child">
                    ...
                    <tr>
                        ...
                        <td> :
                            ...
                            s/d
                            <input type="text" name="PAJAK_ATR[CPM_ATR_BATAS_AKHIR][]" id='CPM_ATR_BATAS_AKHIR' readonly style="width: 100px;" value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_BATAS_AKHIR'] ?>" <?php echo  ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "class='datepicker'" : "readonly"; ?> placeholder="Batas Akhir" tabindex="12" title="Batas Akhir"></td>
                    </tr>
                </table>
                <table width="900" class="child" border="0">
                    ...
                    <tr>
                        ...
                        <td width="130" align="center" valign="top"><label id="load-type_1"></label>
                            <input name="PAJAK_ATR[CPM_ATR_PANJANG][]" type="text" class="number" tabindex="18" id="CPM_ATR_PANJANG" value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_PANJANG'] ?>" size="11" maxlength="11" <?php echo  ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Panjang">
                        </td>
                        <td rowspan="3" align="center" valign="top">
                            ...
                            <input type="text" name="PAJAK_ATR[CPM_ATR_SISI][]" class="number" id="CPM_ATR_SISI" value="<?=$DATA['pajak_atr'][0]['CPM_ATR_SISI']?>" <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?>>
							<b class="isi">*</b>
                        </td>
                        <td rowspan="3" align="center" valign="top">
                    ...
                    <tr>
                        ...
                        <td align="center" valign="top"><input name="PAJAK_ATR[CPM_ATR_LEBAR][]" tabindex="19" type="text" class="number" id="CPM_ATR_LEBAR" value="<?php echo  $DATA['pajak_atr'][0]['CPM_ATR_LEBAR'] ?>" size="11" maxlength="11" <?php echo  ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Lebar"/></td>
                    ...
                    <tr>
                        ...
                        <td align="center" valign="top"><input name="PAJAK_ATR[CPM_ATR_TINGGI][]" tabindex="3" type="text" class="number" id="CPM_ATR_TINGGI"  size="11" maxlength="11" value="<?= $DATA['pajak_atr'][0]['CPM_ATR_TINGGI'] ?>" <?= ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Tinggi"/></td>
                    </tr>
					
					<tr>
                        <td>Kawasan Reklame</td>
                        <td>
                            <select id="CPM_ATR_KAWASAN" name="PAJAK_ATR[CPM_ATR_KAWASAN][]" style="max-width:250px">
                                <?php
                        ...
                        <td align="left" valign="top" colspan="3">
                            <select id="CPM_ATR_SUDUT_PANDANG" name="PAJAK_ATR[CPM_ATR_SUDUT_PANDANG][]">
                                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="CPM_ATR_KAWASAN" tabindex="17" name="PAJAK_ATR[CPM_ATR_KAWASAN][]">
                                <?php
                                $kawasan = $DATA['pajak_atr'][0]['CPM_ATR_KAWASAN'];
                                if (in_array($lapor->_mod, array("pel", ""))) {
                                    if (!in_array($lapor->_i, array(1, 3, ""))) {
                    ...
                    <tr>
                        <td>Kelas Jalan Reklame</td>
                        <td>
                            <select id="CPM_ATR_JALAN" name="PAJAK_ATR[CPM_ATR_JALAN][]">
                                <?php
                    ...
                    <tr>
                        ...
                        <td>
							<input name="PAJAK_ATR[CPM_CEK_PIHAK_KETIGA][]" style="width: 20px;" type="checkbox" id="CPM_CEK_PIHAK_KETIGA" value="1" <? echo ($DATA['pajak_atr'][0]['CPM_CEK_PIHAK_KETIGA']=='true') ? 'checked="checked"':''; ?>><input name="PAJAK_ATR[CPM_NILAI_PIHAK_KETIGA][]" style="width: 240px;" placeholder="Nilai Pihak Ketiga" type="text" id="CPM_NILAI_PIHAK_KETIGA" readonly="readonly" value="<?php echo $DATA['pajak_atr'][0]['CPM_NILAI_PIHAK_KETIGA'] ?>">
						</td>
                ...
                foreach($DATA['pajak_atr'] as $atr){
                    ...
                    echo '<table width="900" class="child" id="atr_rek-'.$no.'" border="0" style="margin-top:8px">
                            ...
                            <tr>
                                ...
                                <td rowspan="3" align="center" valign="top">
                                    <input name="PAJAK_ATR[CPM_ATR_JUMLAH][]" type="text" class="number" tabindex="'.($idx+7).'" id="CPM_ATR_JUMLAH-'.$no.'" value="1" size="11" maxlength="11" value="'.$atr['CPM_ATR_JUMLAH'].'" '.$readonly.' placeholder="Jumlah" onkeyup="hitungDetail('.$no.')" />
                                    <b class="isi">*</b>
                                </td>
                                <td rowspan="3" align="center" valign="top">
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <input name="PAJAK_ATR[CPM_ATR_MUKA][]" tabindex="'.($idx+6).'" type="text" id="CPM_ATR_MUKA-'.$no.'" class="number" size="11" maxlength="11" onkeyup="hitungDetail('.$no.')" value="'.$atr['CPM_ATR_MUKA'].'" '.$readonly.' placeholder="Muka" />
                                </td>
                            </tr>
                            <tr>
                                <td>Jenis Waktu Pemakaian</td>
                                <td>
                                    <select id="CPM_ATR_TYPE_MASA-'.$no.'" tabindex="'.($idx+2).'" onchange="hitungDetail('.$no.')" name="PAJAK_ATR[CPM_ATR_TYPE_MASA][]">';
                            ...
                            <tr>
                                <td>Lokasi Reklame</td>
                                <td>
                                    <select id="CPM_ATR_KAWASAN-'.$no.'" tabindex="'.($idx+3).'" onchange="hitungDetail('.$no.')" name="PAJAK_ATR[CPM_ATR_KAWASAN][]">';
				...
				<!-- <div style="text-align:center;padding:10px"><button type="button" class="btn btn-tambah">Tambah</button></div> -->
                <?php } ?>
                </br>
