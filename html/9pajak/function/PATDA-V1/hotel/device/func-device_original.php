...
<form class="cmxform" autocomplete="off" id="form-device" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/device/svc-device.php?param=<?php echo base64_encode($json->encode(array("a" => $op->_a, "m" => $op->_m))) ?>">
    ...
    <table class="main" width="900">        
        <tr>
            <td colspan="2" align="center" class="subtitle"><b>PENGATURAN DEVICE</b></td>
        </tr>
        ...
        <tr>
			...
			<?php if(empty($value['pajak']['CPM_ID'])):?>
				<select name="PROFIL[CPM_NOP]" id="CPM_NOP" style="width:200px;" onchange="javascript:selectOP()">
                    <?php
			...
			<?php else:?>
				<input type="text" name="PROFIL[CPM_NOP]" id="CPM_NOP" style="width: 200px;" value="<?php echo $value['CPM_NOP'] ?>" readonly>
			<?php endif;?>
			</td>
		</tr>
		...
		<tr>
            ...
            <td>: <input type="text" name="PROFIL[CPM_NAMA_OP]" id="CPM_NAMA_OP" style="width: 200px;" value="<?php echo $value['CPM_NAMA_OP'] ?>" readonly placeholder="Nama Objek Pajak"></td>
        </tr>
        <tr valign="top">
            <td>Alamat Objek Pajak <b class="isi">*</b></td>
            <td>: <textarea name="PROFIL[CPM_ALAMAT_OP]" id="CPM_ALAMAT_OP" cols="80" rows="3" readonly placeholder="Alamat Objek Pajak"><?php echo $value['CPM_ALAMAT_OP'] ?></textarea></td>
        </tr>
        
        <tr valign="top">
            <td>Device ID<b class="isi">*</b></td>
            <td>: 
				<select class="form-control" multiple="multiple" name="PROFIL[CPM_DEVICE_ID][]" id="CPM_DEVICE_ID" style="width:600px;">
					<?php 
        ...
        <tr class="button-area">
            <td align="center" colspan="2">
                ...
                <input type="button" id="btn-submit" action="update_device" value="Simpan Perubahan">
            </td>
        </tr>
    </table>
</form>
