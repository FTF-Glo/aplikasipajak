                ...
                <table width="100%" border="0" align="center" class="child">
                    ...
                    <tr valign="top">
                        ...
                        <td width="200" rowspan="9">Keterangan :</br>
                            <textarea name="PAJAK[CPM_KETERANGAN]" class="form-control" style="width:200px;" id="CPM_KETERANGAN" style="display:block" rows="5" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Keterangan"><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
                        </td>
                    </tr>
                    <tr>
