...
class LaporPajak extends Pajak
{
    ...
    public function filtering($id)
    {
        ...
        //                 <table>
        //                     <tr valign=\"bottom\">
        //                         <td><br><b>Pilih Jenis</b> : <select style=\"width:100px; height:30px;\" class=\"form-control\" name=\"CPM_PIUTANG-{$id}\" id=\"CPM_PIUTANG-{$id}\">{$opt_pilih}</select></td>
        ...
        //                         <td><br><button type=\"button\" style=\"width:150px; height:30px;\" class=\"btn btn-sm btn-secondary\" onclick=\"javascript:download_excel('{$id}','function/PATDA-V1/cetakpanjang/svc-download-bentang-panjang.xls.php')\">Cetak Bentang Panjang</button> </td>             
        //                     </tr>
        //                 </table>
        //             </form>
        //         </div> ";
        ...
        $html .=  "
                                        ...
                                        <div class=\" form-group col-md-3\"> 
                                            ...
                                            <select class=\"form-control\" name=\"CPM_KODE_REKENING-{$id}\" id=\"CPM_KODE_REKENING-{$id}\">{$opt_rekening}</select></td>
                                        </div>
                                        <div class=\" form-group col-md-12\">    
                                            <button type=\"submit\" class=\"btn btn-success\" id=\"cari-{$id}\"><i class=\"fa fa-search\"></i> Cari</button>                       
                                            <button type=\"button\" class=\"btn btn-success\" onclick=\"javascript:download_excel('{$id}','function/PATDA-V1/svc-download-pajak.xls.php')\"><i class=\"fa fa-download\"></i> Export to xls</button></td>
                                            <button type=\"button\" class=\"btn btn-success\" onclick=\"javascript:download_excel('{$id}','function/PATDA-V1/cetakpanjang/svc-download-bentang-panjang.xls.php')\"><i class=\"fa fa-print\"></i> Cetak Bentang Panjang</button> </td>             
                                        </div>
                                    </div>
                            </form>
                        </div>
