...
<form class="cmxform" autocomplete="off" id="form-lapor" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/lapor/svc-lapor.php?param=<?php echo base64_encode($json->encode(array("a" => $lapor->_a, "m" => $lapor->_m, "mod" => $lapor->_mod, "f" => $lapor->_f))) ?>">
    ...
    <table class="main" width="900">
        <tr>
            <td colspan="2" align="center" class="subtitle"><b>LAPOR REALISASI RETRIBUSI</b></td>
        </tr>
        <?php if (!empty($npwpd)) : ?>
            <tr>
        ...
        <tr>
            <td>Jenis Penerimaan<b class="isi">*</b></td>
            <td>
            <select class="form-control" style="width:400px" name="jenis_penerimaan" id="jenis_penerimaan">
                 <?php
        ...
        <tr>
            <td>Jenis Retribusi<b class="isi">*</b></td>
            <td>
            <select class="form-control" style="width:400px" name="jenis_retribusi" id="jenis_retribusi">
        ...
        <tr>
            <td>Rekening<b class="isi">*</b></td>
            <td>
                <input type="text" class="form-control" id="rekening" name="rekening" placeholder="Rekening" style="width: 400px;" readonly>
                <input type="hidden" class="form-control" id="jenis_penerimaan_id" name="jenis_penerimaan_id"  style="width: 400px;" readonly>
            </td>
        </tr>

        
        <tr>
            <td>Anggaran<b class="isi">*</b></td>
            <td>
                <input type="number" class="form-control" id="anggaran" name="anggaran" placeholder="Anggaran"  style="width: 400px;" readonly>
            </td>
        </tr>
        <tr>
            <td>target<b class="isi">*</b></td>
            <td>
                <input type="number" class="form-control" id="target" name="target" placeholder="Target"  style="width: 400px;" readonly>
            </td>
        </tr>
            ...
            <td colspan="2">
                ...
                <table style="width:100%" border="0" align="center" class="child">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            // var_dump(!in_array($lapor->_i, array(1, 3, "")));
                            ?>
                            <!-- <select class="form-control" style="width:200px;height:30px;" name="PAJAK[CPM_TAHUN_PAJAK]" tabindex="10" name="CPM_TAHUN_PAJAK"> -->
                            <select class="form-control" style="width:200px;height:30px;" name="PAJAK[CPM_TAHUN_PAJAK]" tabindex="10" id="CPM_TAHUN_PAJAK" name="CPM_TAHUN_PAJAK">
                                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="PAJAK_ATR[CPM_ATR_BATAS_AWAL][]" id='CPM_ATR_BATAS_AWAL' readonly style="width: 100px; display:inline-block; font-size:smaller;" value="<?php echo $DATA['pajak_atr'][0]['CPM_ATR_BATAS_AWAL'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "class='datepicker form-control'" : "class='form-control' readonly"; ?> placeholder="Batas Awalsaadasd" tabindex="11" title="Batas Awal" >
                            s/d
                    ...
                    if (count($DATA['pajak_atr']) > 1) {
                        ...
                        foreach ($DATA['pajak_atr'] as $atr) {
                            ...
                            echo '</select>
                                ...
                                <td width="110" align="left" valign="top">Tinggi <b class="isi">*</b></td>
                                <td width="130" align="center" valign="top"><label id="load-type-' . $no . '"></label>
                                    <input name="PAJAK_ATR[CPM_ATR_TINGGI][]" type="text" class="number" tabindex="' . ($idx + 4) . '" id="CPM_ATR_TINGGI-' . $no . '" size="11" maxlength="11" value="' . $atr['CPM_ATR_PANJANG'] . '" ' . $readonly . ' placeholder="Panjang" onkeyup="hitungDetail(' . $no . ')" />
                                </td>
                    ...
                    <td colspan=\"3\">
                        <table width=\"100%\" border=\"0\" align=\"center\" class=\"child\">
                            <tr>
                                ...
                                <td width=\"80\"><label><input type=\"radio\" name=\"PAJAK[AUTHORITY]\" class=\"AUTHORITY\" value=\"0\"> Tolak</label></td>
                                <td>  
                                {$linkberkas}
                                </td>
