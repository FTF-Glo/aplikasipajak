$(document).ready(function() {
    ...
    form.validate({
        rules: {
            ...
            "PROFIL[CPM_TOTAL_NILAI]": "required",
            "PROFIL[CPM_GOL_PARKIR]": "required"
        },
        messages: {
            ...
            "PROFIL[CPM_TOTAL_NILAI]": "harus diisi",
            "PROFIL[CPM_GOL_PARKIR]": "harus diisi"
        }
    });
    ...
    /* FUNGSI PADA PENGATURAN PROFIL DI PELAYANAN*/
    $("#CPM_NPWPD").keyup(function() {
        ...
        $("#CPM_NAMA_OP").val('');
        $("#CPM_ALAMAT_OP").val('');
        $("#CPM_GOL_PARKIR option").prop('selected', false);
        $("#CPM_DEVICE_ID").val('');
    })
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.result == 1) {
                    ...
                    $("#CPM_GOL_PARKIR option[value='" + res.CPM_GOL_PARKIR + "']").prop('selected', true);
