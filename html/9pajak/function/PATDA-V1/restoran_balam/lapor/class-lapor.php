...
class LaporPajak extends Pajak
{
    ...
    public function filtering($id)
    {
        ...
        $opt_jenis = '<option value="">All</option><option value="1">Restoran</option><option value="2">Katering</option>';
                    ...
                    <form>
                        ...
                        <table>
                            <tr valign=\"bottom\">
                                ...
                                <td>Nama  :<br><input type=\"text\" style=\"width:100px; height:30px;\" class=\"form-control\" name=\"CPM_NAMA_WP-{$id}\" id=\"CPM_NAMA_WP-{$id}\" placeholder=\"Nama WP\" /><br></td>
                                ...
                                <td>Kecamatan :<br><select style=\"width:100px; height:30px;\" class=\"form-control\" name=\"CPM_KECAMATAN-{$id}\" id=\"CPM_KECAMATAN-{$id}\">{$opt_kecamatan}</select><br></td>
                        ...
                        <table>
                            ...
                            <td><b>Jenis Pajak</b> : <select style=\"width:100px; height:30px;\" class=\"form-control\" name=\"CPM_JENIS_PJK-{$id}\" id=\"CPM_JENIS_PJK-{$id}\">{$opt_jenis}</select></td>
                                <td><button type=\"submit\" style=\"width:50px; height:30px;\" class=\"btn btn-sm btn-secondary\" id=\"cari-{$id}\">Cari</button></td>
                                <td><button type=\"button\" style=\"width:90px; height:30px;\" class=\"btn btn-sm btn-secondary\" onclick=\"javascript:download_excel('{$id}','function/PATDA-V1/svc-download-pajak.xls.php')\">Export to xls</button></td>
                            </tr>
    ...
    public function print_sptpd_base()
    {
        ...
        if ($flag == 0 && ($this->CPM_MASA_PAJAK2 != '' || $this->CPM_MASA_PAJAK2 != NULL)) {
            // Denda otomatis
            $total_pajak = $this->CPM_TOTAL_OMZET;
            $total_pajak = str_replace(',', '', $total_pajak);
            $tgl_jatuh_tempo = $this->CPM_MASA_PAJAK2;
            ...
            if ($this->CPM_TAHUN_PAJAK  > 2023 ) {
                $denda_per_bulan = 0.01; 
                $denda_max = 0.24;
            }else{
                $denda_per_bulan = 0.02;
                $denda_max = 0.48;
            }
            // Menerapkan denda
            if ($selisih_bulan > 0) {
            ...
            $angka_tanpa_koma = str_replace(',', '', $this->CPM_TOTAL_OMZET);
            $format_angka = number_format((float) $angka_tanpa_koma, 0, '', '');
            $selisih_bulan = '';
            $DENDA = $patda_denda;
            $total_pajak = $format_angka + $patda_denda;
        }
                                ...
                                <tr class=\"first\">
                                    <td width=\"440\" valign=\"top\" align=\"center\" colspan=\"2\">
                                        <b>
                                            ...
                                            PBJT MAKANANAN DAN/ATAU MINUMAN
                                        </b><br/>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td width=\"710\" colspan=\"2\"><table width=\"700\" align=\"center\" cellpadding=\"1\" border=\"1\" cellspacing=\"0\">
                                ...
                                <tr>
                                    ...
                                    <td width=\"30\" align=\"left\">Rp.</td>
                                    <td align=\"right\" width=\"400\"> " . number_format($DENDA, 0) . "</td>
                                </tr>
                                <tr>
    ...
    public function print_sptpd()
    {
        ...
        $npwdR = "P" . substr($DATA['profil']['CPM_NPWPD'], 1, 1) . "." . substr($DATA['profil']['CPM_NPWPD'], 2, 4) . "." . substr($DATA['profil']['CPM_NPWPD'], 6, 3) . "." . substr($DATA['profil']['CPM_NPWPD'], 9, 3) . "-" . substr($DATA['profil']['CPM_NPWPD'], 12, 3) . "." . substr($DATA['profil']['CPM_NPWPD'], 15, 2) . "."  . substr($DATA['profil']['CPM_NPWPD'], 17, 3) .  "." . substr($DATA['profil']['CPM_NPWPD'], 20, 2);
        // var_dump($npwdR);
        // die;
        $page1 = "<table width=\"710\" class=\"main\" cellpadding=\"0\" border=\"1\" cellspacing=\"0\">
                    ...
                    <table width=\"710\" border=\"0\" cellpadding=\"5\">
                        <tr>
                            <td width=\"400\" align=\"center\">  
                                ...
                                <td align=\"center\">
                                    <b style=\"font-size:50px\">SPTPD</b><br/>
                                    <span style=\"font-size:30px\">SURAT PEMBERITAHUAN TAGIHAN PAJAK DAERAH</span>
                                </td>
                                </table>
                            </td>
                            <td width=\"310\"><table width=\"310\" class=\"header\" border=\"0\">
                                <tr class=\"first\">
                                    <td align=\"center\"><br><br>
                                        <b style=\"font-size:35px\">PBJT MAKANANAN DAN/ATAU MINUMAN</b>
                                    </td>
                                </tr>
                                </table>
                            </td>
            ...
            <td width=\"710\" colspan=\"2\" align=\"center\"><table width=\"100%\" border=\"0\" align=\"left\" cellpadding=\"5\">
                <tr >
                <td style=\"font-size:28px\"><table width=\"400\" border=\"0\" align=\"left\">
                <tr>
                    <td>PERHATIAN : </td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;1. Harap diisi dalam rangkap 5 (lima) ditulis dengan hurufCETAK </td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;2. Beri tanda X  pada kotak yang tersedia untuk jawaban yang diberikan.</td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;3. Setelah Formulir SPTPD ini diisi dan ditandatangani, wajib <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; diserahkan kembali kepada. Badan pengelola Pajak dan Retribusi <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; daerah Kota Bandar Lampung paling lambat tanggal 10 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; sejak berakhirnya masa pajak.</td>
                </tr>
                <tr><br>
                    <td>&nbsp;&nbsp;&nbsp;{$DATA['profil']['CPM_NAMA_KECAMATAN_OP']}</td>
                </tr>
                <br>
            </table>
        </td>
                        <td width=\"310\"><table width=\"310\" class=\"header\" border=\"0\">
                            <tr class=\"first\">
                                <td>
                                    ...
                                    {$DATA['profil']['CPM_NAMA_OP']}<br/>
                                    {$DATA['profil']['CPM_ALAMAT_OP']}, Kec. {$DATA['profil']['CPM_NAMA_KECAMATAN_OP']}, kel. {$DATA['profil']['CPM_NAMA_KELURAHAN_OP']}<br/>
                                    NPWPD:  " . $npwdR . "
                                </td>
                            </tr>
                            </table>
        ...
        <tr>
            <td colspan=\"2\" align=\"center\" style=\"background-color:#CCC\">
                <b>DI ISI OLEH PENGUSAHA RESTORAN</b>
            </td>
        </tr>
            <tr style=\"font-size:30px\">
                <td width=\"710\" colspan=\"8\" align=\"center\"><table width=\"100%\" border=\"0\" align=\"left\" cellpadding=\"14\">
                    <tr>
                    <td>
                    <tr>
                        <td width=\"400\">1. Tarif dan Jumlah Fasilitas Restoran :</td>
                    </tr>
                    <br>
                    <table width=\"780\" border=\"1\" align=\"left\">
                            <tr>
                                <td width=\"30\"  align=\"center\">No.</td>
                                <td align=\"center\">Meja yang tersedia</td>
                                <td align=\"center\">Jumlah Kursi</td>
                                <td align=\"center\">Jumlah Pengunjung rata-rata perhari</td>
                            </tr>
                            <tr align=\"center\">
                                <td>1</td>
                                <td></td>
                ...
                <tr>
                <td width=\"200\">&nbsp;&nbsp;&nbsp;&nbsp;2. Menggunakan Cash Register :</td>
                <td align=\"left\" width=\"220\">
                        <table width=\"80\" border=\"0\">
                            <tr>
                                ...
                                <td width=\"100\">2. Tidak</td>
                            </tr>
                        </table>
                    </td>
            </tr><br>
            <tr>
                <td width=\"200\">&nbsp;&nbsp;&nbsp;&nbsp;3. Menggandakan Pembukuan/Catatan :</td>
                <td align=\"left\" width=\"220\">
                    <table width=\"80\" border=\"0\">
                        <tr>
                            <td width=\"30\">
        ...
        <tr>
            <td colspan=\"2\" align=\"center\" style=\"background-color:#CCC\" width=\" 100% \">
                <b>OMSET YANG HARUS DIISI OLEH PENGUSAHA RESTORAN </b>
            </td>
        </tr>
        <tr style=\"font-size:32px\">
            <td width=\"710\" colspan=\"2\" align=\"center\"><table width=\"700\" align=\"center\" cellpadding=\"1\" border=\"0\" cellspacing=\"0\">
                    <tr>
                        <td align=\"left\" width=\"100%\">&nbsp;&nbsp; 1. Jumlah Pembayaran dan Pajak Terutang untuk Masa Pajak sebelumnya (Akumulasi dari awal masa pajak dalam tahun pajak tertentu)</td>
                    </tr>
                    <tr>
                        <td align=\"left\" width=\"30\">&nbsp;&nbsp;&nbsp;&nbsp;a.</td>
                        <td align=\"left\" width=\"290\">Masa Pajak</td>
                        <td align=\"left\" width=\"420\" colspan=\"2\">:</td>
                    </tr>
                    <tr>
                        <td align=\"left\" width=\"30\">&nbsp;&nbsp;&nbsp;&nbsp;b.</td>
                        <td align=\"left\" width=\"290\">Dasar Pengenaan ( Jumlah Pembayaran yang diterima ) </td>
                        <td align=\"left\" width=\"420\" colspan=\"2\">:  </td>
                    </tr>
                    <tr>
                        <td align=\"left\" width=\"30\">&nbsp;&nbsp;&nbsp;&nbsp;c.</td>
                        <td align=\"left\" width=\"290\">Tarif Pajak( Sesuai Perda)</td>
                        <td align=\"left\" width=\"420\" colspan=\"2\">:  </td>
                    </tr>
                    <tr>
                        <td align=\"left\" width=\"30\">&nbsp;&nbsp;&nbsp;&nbsp;d.</td>
                        <td align=\"left\" width=\"290\">Pajak Terutang( b x c)</td>
                        <td align=\"left\" width=\"420\" colspan=\"2\">:  </td>
                    </tr>
                    <tr>
                        <td align=\"left\" width=\"100%\">&nbsp;&nbsp; 2. Jumlah Pembayaran dan Pajak Terutang untuk Masa Pajak Sekarang </td>
                    </tr>
                    <tr>
                        <td align=\"left\" width=\"30\">&nbsp;&nbsp;&nbsp;&nbsp;a.</td>
                        <td align=\"left\" width=\"290\">Masa Pajak</td>
                        <td align=\"left\" width=\"420\" colspan=\"2\">:  {$DATA['pajak']['CPM_MASA_PAJAK1']} - {$DATA['pajak']['CPM_MASA_PAJAK2']}</td>
                    </tr>
                    <tr>
                        <td align=\"left\" width=\"30\">&nbsp;&nbsp;&nbsp;&nbsp;b.</td>
                        <td align=\"left\" width=\"290\">Dasar Pengenaan ( Jumlah Pembayaran yang diterima ) </td>
                        <td align=\"left\" width=\"420\" colspan=\"2\">: " . number_format($DATA['pajak']['CPM_TOTAL_OMZET'], 2) . "</td>
                    </tr>
                    <tr>
                        <td align=\"left\" width=\"30\">&nbsp;&nbsp;&nbsp;&nbsp;c.</td>
                        <td align=\"left\" width=\"290\">Tarif Pajak( Sesuai Perda)</td>
                        <td align=\"left\" width=\"420\" colspan=\"2\">:  " . number_format($DATA['pajak']['CPM_TARIF_PAJAK'], -2) . "%</td>
                    </tr>
                    <tr>
                        <td align=\"left\" width=\"30\">&nbsp;&nbsp;&nbsp;&nbsp;d.</td>
                        <td align=\"left\" width=\"290\">Pajak Terutang( b x c)</td>
                        <td align=\"left\" width=\"420\" colspan=\"2\">:  " . number_format($DATA['pajak']['CPM_BAYAR_TERUTANG'], -2) . "</td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <tr>
        <td colspan=\"2\"><table width=\"100%\" border=\"0\" align=\"left\" cellpadding=\"10\">
                    ...
                    <td><table width=\"700\" cellpadding=\"0\" border-right=\"0\" cellspacing=\"0\"><br><br>
                            ...
                            <tr align=\"center\">
                                <td width=\"300\"><i>Self Assesment(Menghitung dan menentukan pajak Sendiri)</i></td>
                            </tr>
                        </table>
                    </td>
    ...
    <td colspan=\"2\"><table width=\"100%\" border=\"0\" align=\"left\" cellpadding=\"10\">
                ...
                <tr align=\"left\">
                    <td width=\"80\">NAMA</td>
                    <td width=\"260\" colspan=\"2\">:  {$DATA['profil']['CPM_NAMA_OP']}</td>
                </tr>
                <tr align=\"left\">
                    <td width=\"80\">ALAMAT</td>
                    <td width=\"260\" colspan=\"2\">:  {$DATA['profil']['CPM_ALAMAT_OP']}</td>
                </tr>
                    </table>
                </td>
                <td><table width=\"700\" cellpadding=\"0\" border=\"0\" cellspacing=\"0\">     
                        <tr>
                            ...
                            <td width=\"260\" colspan=\"2\">: {$DATA['pajak']['CPM_NO']}</td>
                        </tr>
                        <tr>
    ...
    <span style=\"font-size:24px\"><i>BAPENDA BANDAR LAMPUNG {$tgl_cetak}</i></span>
        ...
        $pdf->Image("{$sRootPath}view/Registrasi/configure/logo/{$LOGO_CETAK_PDF}", 7, 8, 17, '', '', '', '', false, 300, '', false);
