$(document).ready(function() {
    ...
    form.validate({
        rules: {
            ...
            "PROFIL[CPM_GOL_RESTORAN]": "required",
        },
        messages: {
            ...
            "PROFIL[CPM_GOL_RESTORAN]": "harus diisi",
        }
    });
    ...
    $("#CPM_NPWPD").keyup(function() {
        ...
        $("#CPM_NAMA_OP").val('');
        $("#CPM_ALAMAT_OP").val('');        
        $("#CPM_GOL_RESTORAN option").prop('selected', false);
        $("#CPM_DEVICE_ID").val('');
    })
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.result == 1) {
                    ...
                    $("#CPM_GOL_RESTORAN option[value='" + res.CPM_GOL_RESTORAN + "']").prop('selected', true);
