...
<form class="cmxform" autocomplete="off"id="form-lapor" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/lapor/svc-lapor.php?param=<?php echo base64_encode($json->encode(array("a" => $lapor->_a, "m" => $lapor->_m, "mod" => $lapor->_mod, "f" => $lapor->_f))) ?>">
    ...
    <table class="main" width="900">        
        ...
        <tr>
            ...
            <td>: <input type="text" name="PAJAK[CPM_NOP]" id="CPM_NOP" style="width: 200px;" value="<?php echo $DATA['profil']['CPM_NOP'] ?>" readonly placeholder="NOP"></td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                <table width="100%" border="0" align="center" class="child">                    
                    ...
                    <tr valign="top">
                        ...
                        <td width="100"> : <input type="text" name="PAJAK[CPM_NO]" id="CPM_NO" class="" maxlength="25" readonly value="<?php echo $DATA['pajak']['CPM_NO'] ?>"></td>
                        <td width="200" rowspan="4">Keterangan :</br> 
                            <textarea name="PAJAK[CPM_KETERANGAN]" id="CPM_KETERANGAN" rows="4" cols="40" <?php echo $readonly ?>><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td> :
                            <select name="PAJAK[CPM_TIPE_PAJAK]" id="CPM_TIPE_PAJAK">
                                <?php
                                foreach ($DATA['pajak']['CPM_TIPE_PAJAK'] as $x => $y) {
                ...
                <table width="900" class="child">
                    ...
                    foreach ($DATA['pajak_atr'] as $pajak_atr) {
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <select name="PAJAK_ATR[CPM_ATR_NAMA][]" id="CPM_ATR_NAMA_<?php echo $xx ?>" onchange="javascript:getHarga(this, <?php echo $xx ?>)" idsum="<?php echo $xx ?>">                                    
                                    <?php
                                    if (in_array($lapor->_mod, array("pel", ""))) {
                                        if (!in_array($lapor->_i, array(1, 3, ""))) {
                                            echo "<option value='{$pajak_atr['kdrek']}' selected>{$pajak_atr['kdrek']} - {$pajak_atr['nmrek']}</option>";
                                        } else {
                                            echo "<option selected></option>";
                                            foreach ($DATA['pajak']['golongan'] as $x => $y) {
                                                echo ($x == $pajak_atr['CPM_ATR_NAMA']) ? "<option value='{$x}' selected>{$y}</option>" : "<option value='{$x}'>{$y}</option>";
                                            }
                                        }
                                    } else {
                                        echo "<option value='{$pajak_atr['kdrek']}' selected>{$pajak_atr['kdrek']} - {$pajak_atr['nmrek']}</option>";
