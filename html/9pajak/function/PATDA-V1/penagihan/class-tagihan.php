...
class TagihanPajak extends Pajak {
    ...
    public function filtering($id) {
        if ($id == 6) {
            ...
            $html = "<div class=\"filtering\">
                    <form>                        
                        NPWPD : <input type=\"text\" name=\"CPM_NPWPD-{$id}\" id=\"CPM_NPWPD-{$id}\" class=\"form-control\" style=\"width: 168px; display: inline-block\" >                 
                        <label style=\"margin-left: 10px\">Nama WP :</label> <input type=\"text\" name=\"CPM_NAMA_WP-{$id}\" id=\"CPM_NAMA_WP-{$id}\" class=\"form-control\" style=\"width: 168px; display: inline-block\" >    
