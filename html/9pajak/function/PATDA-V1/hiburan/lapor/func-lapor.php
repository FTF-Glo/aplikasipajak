...
<form class="cmxform" autocomplete="off" id="form-lapor" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/lapor/svc-lapor.php?param=<?php echo base64_encode($json->encode(array("a" => $lapor->_a, "m" => $lapor->_m, "mod" => $lapor->_mod, "f" => $lapor->_f))) ?>" enctype="multipart/form-data">
    ...
    <div class="container lm-container">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label>Pembayaran Hiburan <b class="isi">*</b></label>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="PAJAK[CPM_TARIF_PAJAK]" id="CPM_TARIF_PAJAK" class="form-control" style="width: 90%; display: inline-block" readonly value="<?php echo $DATA['tarif']; ?>"> %
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="PAJAK[CPM_DENDA_TERLAMBAT_LAP]" id="CPM_DENDA_TERLAMBAT_LAP" class="form-control number SUM2" style="width: 100%" maxlength="17" placeholder="Sanksi Telat Lapor" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || $lapor->_s == 4) ?  "" : "readonly" ?> value="<?php echo $DATA['pajak']['CPM_DENDA_TERLAMBAT_LAP'] ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
