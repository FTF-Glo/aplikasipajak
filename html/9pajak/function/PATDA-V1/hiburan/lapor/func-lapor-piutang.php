        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input name="PAJAK[CPM_NO]" class="form-control" type="text" id="CPM_NO" value="<?php echo $DATA['pajak']['CPM_NO'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "") ? "" : "readonly"; ?> placeholder="No Pelaporan">
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea name="PAJAK[CPM_KETERANGAN]" class="form-control" style="min-width:100%;" id="CPM_KETERANGAN" style="display:block" rows="5" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Keterangan"><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
                </div>
            </div>
        </div>
        <div class="row">
