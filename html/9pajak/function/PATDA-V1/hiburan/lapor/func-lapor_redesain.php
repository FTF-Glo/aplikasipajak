  ...
  <div class="form-container">
    ...
    <input type="hidden" name="function" id="function" value="save">
        ...
        if (in_array($s, array(2, 3, 5))) {
            ...
            <tr>
                ...
                <td>: <input type='date' class=\"form-contro\" style=\"width:150px;height:30px;display:inline-block;font-size:small;\" name=\"PAJAK[tgl_cetak]\" value='{$defaultdate}' ></td>
            </tr>";
        }
        ?>
      <div class="row">
        <div class="col-md-6">
            <div div class="form-group row">
                <label for="npwpd" class="col-sm-3 col-form-label required">NPWPD</label>

                <?php if (!empty($npwpd)) : ?>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="PAJAK[CPM_NPWPD]" id="CPM_NPWPD" value="<?php echo Pajak::formatNPWPD($DATA['profil']['CPM_NPWPD']) ?>" readonly>
                    </div>   
                    <div class="col-sm-4">
                        <?php if (empty($DATA['pajak']['CPM_ID'])) :
                            ...
                            ?>
                                <input type="button" class="btn btn-info" value="Cari NPWPD Lainnya" onclick="location.href='<?php echo $prm ?>'">
                            <?php endif;
                        endif; ?>
                    </div> 
                ...
                <?php else : ?>
                    <div class="col-sm-9">
                        <input type="hidden" id="TBLJNSPJK" value="HIBURAN">
                        <select class="form-control" name="PROFIL[CPM_NPWPD]" id="CPM_NPWPD"></select>
          ...
          <div class="form-group row">
            <label for="CPM_NAMA_WP" class="col-sm-3 col-form-label required">Nama Wajib Pajak</label>
            <div class="col-sm-9">
            <input type="text" class="form-control" name="PAJAK[CPM_NAMA_WP]" id="CPM_NAMA_WP" value="<?php echo $DATA['profil']['CPM_NAMA_WP'] ?>" readonly placeholder="Nama Wajib Pajak">
            </div>
          </div>
          <div class="form-group row">
            <label for="CPM_ALAMAT_WP" class="col-sm-3 col-form-label required">Alamat Wajib Pajak</label>
            <div class="col-sm-9">
                <textarea class="form-control" name="PAJAK[CPM_ALAMAT_WP]" id="CPM_ALAMAT_WP" rows="2" readonly placeholder="Alamat Wajib Pajak"><?php echo $DATA['profil']['CPM_ALAMAT_WP'] ?></textarea>
              
            </div>
          </div>
          <div class="form-group row">
            <label for="CPM_KECAMATAN_WP" class="col-sm-3 col-form-label required">Kecamatan Wajib Pajak</label>
            <div class="col-sm-9">
                <input type="text"  class="form-control" name="PAJAK[CPM_KECAMATAN_WP]" id="CPM_KECAMATAN_WP" value="<?php echo $DATA['profil']['CPM_KECAMATAN_WP'] ?>" readonly placeholder="Kecamatan Wajib Pajak">
                    <?php
                    if (
                        !empty($npwpd) &&
          ...
          <div class="form-group row">
            <label for="CPM_KELURAHAN_WP" class="col-sm-3 col-form-label required">Kelurahan Wajib Pajak</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="PAJAK[CPM_KELURAHAN_WP]" id="CPM_KELURAHAN_WP" value="<?php echo $DATA['profil']['CPM_KELURAHAN_WP'] ?>" readonly placeholder="Kelurahan Wajib Pajak">
            </div>
          </div>

          <div class="form-group row">
            <label for="CPM_NOP" class="col-sm-3 col-form-label required">NOP</label>

            <?php if (empty($DATA['pajak']['CPM_ID'])) : ?>
                <div class="col-sm-6">
                    <select name="PAJAK[CPM_NOP]" id="CPM_NOP" class="form-control" onchange="javascript:selectOP()">
                        <?php
                            if (count($DATA['list_nop']) == 0) {
                                echo "<option value=''>NOP Tidak tersedia</option>";
                            }
                            else {
                                echo (empty($nop)) ? "<option value='' selected disabled>Pilih NOP</option>" : "";
                            }
                ...
                <div class="col-sm-3">
                    <?php
                        if (!empty($DATA['profil']['CPM_NPWPD'])) {
                            ...
                            if (empty($DATA['pajak']['CPM_ID'])) echo '<input class="btn btn-info" type="button" value="Tambah NOP" onclick="location.href=\'' . $prm . '\'">';
                        } ?>
                </div>
                <?php else : ?>
                      <input type="text" class="form-control" name="PAJAK[CPM_NOP]" id="CPM_NOP" value="<?php echo $DATA['profil']['CPM_NOP'] ?>" readonly placeholder="NOP">
                <?php endif; ?>
        ...
        <div class="col-md-6">
          <div class="form-group row">
            <label for="CPM_NAMA_OP" class="col-sm-3 col-form-label required">Nama Objek Pajak</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="PAJAK[CPM_NAMA_OP]" id="CPM_NAMA_OP" value="<?php echo $DATA['profil']['CPM_NAMA_OP'] ?>" readonly placeholder="Nama Objek Pajak">
            </div>
          </div>
          <div class="form-group row">
            <label for="CPM_ALAMAT_OP" class="col-sm-3 col-form-label required">Alamat Objek Pajak</label>
            <div class="col-sm-9">
                <textarea class="form-control" name="PAJAK[CPM_ALAMAT_OP]" id="CPM_ALAMAT_OP" rows="2" readonly placeholder="Alamat Objek Pajak"><?php echo $DATA['profil']['CPM_ALAMAT_OP'] ?></textarea>
            </div>
          </div>
          <div class="form-group row">
            <label for="CPM_NAMA_KECAMATAN_OP" class="col-sm-3 col-form-label required">Kecamatan Objek Pajak</label>
            <div class="col-sm-9">
                
                    <input type="text" class="form-control" name="PAJAK[CPM_NAMA_KECAMATAN_OP]" id="CPM_NAMA_KECAMATAN_OP" value="<?php echo $DATA['profil']['CPM_NAMA_KECAMATAN_OP'] ?>" readonly placeholder="Kecamatan Objek Pajak">
                    ...
                    if (
                        ...
                        $prm = 'main.php?param=' .
                            base64_encode('a=' . $a . '&m=mPatdaPelayananPelapor1&f=fPatdaPelayananLaporOP2&npwpd=' . $npwpd . '&npwpd=' . $npwpd . '&nop=' . $nop);
                    ?>
          ...
          <div class="form-group row">
            <label for="CPM_NAMA_KELURAHAN_OP" class="col-sm-3 col-form-label required">Kelurahan Objek Pajak</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="PAJAK[CPM_NAMA_KELURAHAN_OP]" id="CPM_NAMA_KELURAHAN_OP" value="<?php echo $DATA['profil']['CPM_NAMA_KELURAHAN_OP'] ?>" readonly placeholder="Kelurahan Objek Pajak">
                <input type="hidden" name="PAJAK[CPM_KELURAHAN_OP]" id="KELURAHAN_OP" value="<?php echo $DATA['profil']['CPM_KELURAHAN_OP'] ?>">
            </div>
          </div>
          <div class="form-group row">
            <label for="rekeningPajak" class="col-sm-3 col-form-label">Rekening Pajak</label>
            <div class="col-sm-9">
      ...
      <div class="form-header">
        <p>LAPOR PAJAK HIBURAN</p>
      </div>
      <div class="row">
            <div class="col-md-6">
         
                <div class="form-group row">
                    <label for="CPM_NO" class="col-sm-3 col-form-label required">No Pelaporan Pajak</label>
                    <div class="col-sm-9">
                        <?php echo ($DATA['pajak']['CPM_NO'] != "") ? "<input class=\"form-control\" type=\"text\" name=\"PAJAK[CPM_NO]\" id=\"CPM_NO\" maxlength=\"25\" value=\"{$DATA['pajak']['CPM_NO']}\" readonly>" : "..." ?>
  
                    </div>
                </div>

                <div class="form-group row">
                    <label for="tahunPajak" class="col-sm-3 col-form-label required">Tahun Pajak</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <label for="masaPajak" class="col-sm-3 col-form-label required">Masa Pajak</label>
                    <div class="col-sm-4">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group row">
                <label for="tipePajak" class="col-sm-3 col-form-label required">Tipe Pajak</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="bulanPajak" class="col-sm-3 col-form-label required">Bulan Pajak</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control" name="PAJAK[CPM_KETERANGAN]" id="CPM_KETERANGAN" rows="2" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Keterangan"><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
            ...
            <div class="form-group row">
                <label for="tanggalJatuhTempo" class="col-sm-3 col-form-label">Tanggal Jatuh Tempo</label>
                <div class="col-sm-9">
                <input type="text" class="form-control" id="tanggalJatuhTempo" placeholder="dd/mm/yyyy">
                </div>
            </div>
        ...
        <div class="form-group row" style="margin-left:5px">
            <label for="CPM_TOTAL_OMZET" class="col-sm-2 col-form-label required">pembayaran Hiburan</label>
            <div class="col-sm-9">
            <input type="text" name="PAJAK[CPM_TOTAL_OMZET]" id="CPM_TOTAL_OMZET" class=" form-control" maxlength="17" value="<?php echo $DATA['pajak']['CPM_TOTAL_OMZET'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Pembayaran Pemakaian">
                                    
            </div>
        </div>

        <div class="form-group row" style="margin-left:5px">
            <label for="CPM_BAYAR_TERUTANG" class="col-sm-2 col-form-label required">Dasar Pengenaan Pajak (DPP)</label>
            <div class="col-sm-9">
                <input type="text" name="PAJAK[CPM_DPP]" id="CPM_DPP" class="form-control" readonly maxlength="17" value="<?php echo $DATA['pajak']['CPM_DPP'] ?>" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Dasar Pengenaan Pajak (DPP)">
               
            </div>
        </div>

        <div class="form-group row" style="margin-left:5px">
            <label for="CPM_TARIF_PAJAK" class="col-sm-2 col-form-label required">Tarif Pajak</label>
            <div class="col-sm-9">
                <input type="text" name="PAJAK[CPM_TARIF_PAJAK]" id="CPM_TARIF_PAJAK" class="form-control" readonly value="<?php echo $DATA['tarif']; ?>">  
            </div>
        </div>

        <div class="form-group row" style="margin-left:5px">
            <label for="CPM_BAYAR_TERUTANG" class="col-sm-2 col-form-label required">Pembayaran Terutang (Tarif x DPP)</label>
            <div class="col-sm-9">
                <input type="text" name="PAJAK[CPM_BAYAR_TERUTANG]" id="CPM_BAYAR_TERUTANG" readonly class=" form-control" maxlength="17" value="<?php echo $DATA['pajak']['CPM_BAYAR_TERUTANG'] ?>" readonly placeholder="Pembayaran Terutang">
               
            </div>
        </div>

        <div class="form-group row" style="margin-left:5px">
            <label for="CPM_DENDA_TERLAMBAT_LAP" class="col-sm-2 col-form-label required">Sanksi Telat Lapor <?= ($persen_terlambat_lap == 0 ? '' : "({$persen_terlambat_lap}%)") ?> x bulan keterlambatan</label>
            <div class="col-sm-9">
                <input type="text" name="PAJAK[CPM_DENDA_TERLAMBAT_LAP]" id="CPM_DENDA_TERLAMBAT_LAP" class=" SUM form-control" maxlength="17" placeholder="Sanksi Telat Lapor" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "readonly" : "readonly"; ?> value="<?php echo $DATA['pajak']['CPM_DENDA_TERLAMBAT_LAP'] ?>">
            </div>
        </div>
        <div class="form-group row" style="margin-left:5px">
                <label for="CPM_TOTAL_PAJAK" class="col-sm-2 col-form-label required">Jumlah Pajak yang dibayar</label>
                <div class="col-sm-9">
                    <input type="text" name="PAJAK[CPM_TOTAL_PAJAK]" id="CPM_TOTAL_PAJAK" readonly class="form-control" value="<?php echo $DATA['pajak']['CPM_TOTAL_PAJAK'] ?>" placeholder="Jumlah Pajak yang dibayar">
                </div>
        
        </div>
        <div class="form-group row" style="margin-left:1px">
            <label for="CPM_TERBILANG" class="col-sm-2 col-form-label required">Terbilang</label>
            <div class="col-sm-9">
      ...
      <div class="form-group row">
        <div class="col-sm-12">
          ...
          <button type="submit" class="btn btn-success">Simpan dan Finalkan</button>
        </div>
      </div>
    </form>
  </div>
    ...
    <form class="cmxform" autocomplete="off" id="form-lapor" method="post" action="function/<?php echo "{$DIR}/{$modul}"; ?>/lapor/svc-lapor.php?param=<?php echo base64_encode($json->encode(array("a" => $lapor->_a, "m" => $lapor->_m, "mod" => $lapor->_mod, "f" => $lapor->_f))) ?>" enctype="multipart/form-data">
        ...
        <table class="main" width="900">
            ...
            <tr>
                <td colspan="2" align="center" class="subtitle"><b>LAPOR PAJAK HIBURAN</b></td>
            </tr>
            <tr>
                <td colspan="2">
                    <?php
                    ...
                    <table width="100%" border="0" align="center" class="child">
                        ...
                        <tr valign="top">
                            ...
                            <td width="250"> : <?php echo ($DATA['pajak']['CPM_NO'] != "") ? "<input class=\"form-control\" style=\"width:150px;height:30px;display:inline-block;font-size:small;\" type=\"text\" name=\"PAJAK[CPM_NO]\" id=\"CPM_NO\" maxlength=\"25\" value=\"{$DATA['pajak']['CPM_NO']}\" readonly>" : "..." ?></td>
                            ...
                            <td width="400" rowspan="4">Keterangan :</br>
                                <textarea class="form-control" style="width:300px;" name="PAJAK[CPM_KETERANGAN]" id="CPM_KETERANGAN" style="display:block" rows="6" <?php echo ($lapor->_s == 1 || $lapor->_s == "" || ($lapor->_s == "4" && $lapor->_mod == "pel")) ? "" : "readonly"; ?> placeholder="Keterangan"><?php echo $DATA['pajak']['CPM_KETERANGAN'] ?></textarea>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <?php
                                ...
                                <td width="400" rowspan="4">Taggal Jatuh Tempo <span style="color:red; font-size:10px">(Tidak wajib)</span></br>                            
                        ...
                        <tr>
                            <td>Pembayaran Hiburan <b class="isi">*</b></td>
                        ...
                        <tr>
                            ...
                            <td> : <input type="text" name="PAJAK[CPM_TARIF_PAJAK]" id="CPM_TARIF_PAJAK" style="width: 50px;" readonly value="<?php echo $DATA['tarif']; ?>"> %</td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td colspan="4">Terbilang : <b><input type="text" name="PAJAK[CPM_TERBILANG]" id="CPM_TERBILANG" readonly class="form-control" style="width:800px;height:30px;display:inline-block;font-size:small;" value="<?php echo ucwords($DATA['pajak']['CPM_TERBILANG']) ?>" placeholder="Terbilang"></b></td>
            </tr>
            <?php
        ...
        if ($payment_info['payment_flag'] == 1) {
            ...
            echo "<tr>
                    ...
                    <tr >
                        <td colspan=\"2\" >
                            <table width=\"100%\" border=\"1\" align=\"center\" class=\"child\" >
                                <tr>";
                            
                                if ( $payment_info['payment_flag'] == 1) {
                                echo "<td width=\"100px\"><label><input type=\"radio\" name=\"PAJAK[AUTHORITY]\" class=\"AUTHORITY\" value=\"1\" checked> Setujui</label></td>";
                                }
