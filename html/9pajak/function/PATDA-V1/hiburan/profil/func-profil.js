$(document).ready(function() {
    ...
    form.validate({
        rules: {
            ...
            "PROFIL[CPM_GOL_HIBURAN]": "required",
        },
        messages: {
            ...
            "PROFIL[CPM_GOL_HIBURAN]": "harus diisi",
        }
    });
    ...
    $("#CPM_NPWPD").keyup(function() {
        ...
        $("#CPM_NAMA_OP").val('');
        $("#CPM_ALAMAT_OP").val('');        
        $("#CPM_GOL_HIBURAN option").prop('selected', false);
        $("#CPM_DEVICE_ID").val('');
    });
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.result == 1) {
                    ...
                    $("#CPM_GOL_HIBURAN option[value='" + res.CPM_GOL_HIBURAN + "']").prop('selected', true);
