                        ...
                        <td width="700">: 
                            <select name="SKPDKB[CPM_JENIS_PAJAK]">
                                ...
                                if ($edit) {
                                    ...
                                    foreach ($lapor->arr_pajak as $pjk_id => $pjk_name) {
                            ...
                            <select name="SKPDKB[CPM_MASA_PAJAK]">
                                ...
                                if ($edit) {
                                    ...
                                    foreach ($lapor->arr_bulan as $x => $y) {
                                        echo ($x == $SKPDKB['CPM_MASA_PAJAK']) ? "<option value='{$x}' selected>{$y}</option>" : "<option value='{$x}'>{$y}</option>";
                                    }
                                }
                                ?>
                            </select>
                            ...
                            <select name="SKPDKB[CPM_TAHUN_PAJAK]">
                                ...
                                if ($edit) {
                                    ...
                                    for ($th = date("Y") - 5; $th <= date("Y"); $th++) {
                                        echo ($th == $SKPDKB['CPM_TAHUN_PAJAK']) ? "<option value='{$th}' selected>{$th}</option>" : "<option value='{$th}'>{$th}</option>";
                                    }
                                }
                                ?>
                            </select>
