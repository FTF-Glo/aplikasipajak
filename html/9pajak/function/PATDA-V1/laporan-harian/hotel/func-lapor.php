...
<form class="cmxform" autocomplete="off"id="form-lapor" method="post" action="function/<?php echo "{$DIR}/laporan-harian/{$modul}"; ?>/svc-lapor.php?param=<?php echo base64_encode($json->encode(array("a" => $lapor->_a, "m" => $lapor->_m, "mod" => $lapor->_mod, "f" => $lapor->_f))) ?>">
    ...
    <table class="main" width="900">        
        ...
        <tr>
            <td colspan="2" align="center" class="subtitle"><b>TRANSAKSI HOTEL</b></td>
        </tr>         
        <tr>
            <td colspan="2">
                <table width="100%" border="0" align="center" class="child">                    
                    ...
                    <tr>
                        <td width="220">Jenis Kamar <b class="isi">*</b></td>
                        <td width="780"> :
                            <select name="PAJAK[JenisKamar]" id="JenisKamar" style="width:300px">                                
                                <?php
                                foreach ($list_jenis_kamar as $x) {
									echo $DATA['pajak']['CPM_TAHUN_PAJAK'] == $x->Kode? "<option value='{$x->Kode}' selected>{$x->Jenis}</option>" : "<option value='{$x->Kode}'>{$x->Jenis}</option>";
								}
                                ?>
                            </select>
                    ...
                    <tr>
                        <td>Tarif Kamar <b class="isi">*</b></td>
                        <td> : <input type="text" name="PAJAK[TarifKamar]" id="TarifKamar" class="number SUM" maxlength="17" placeholder="Tarif Kamar"></td>
                    </tr>
                    <tr>
                        <td>Jumlah Kamar <b class="isi">*</b></td>
                        <td> : <input type="text" name="PAJAK[JumlahKamar]" id="JumlahKamar" class="number SUM" maxlength="17" placeholder="Jumlah Kamar"></td>
                    </tr>
                    <tr>
                        <td>Jumlah Hari <b class="isi">*</b></td>
                        <td> : <input type="text" name="PAJAK[JumlahHari]" id="JumlahHari" class="number SUM" maxlength="17" placeholder="Jumlah Hari"></td>
                    </tr>                    
                    <tr>
                        <td>Nominal Transaksi <b class="isi">*</b></td>
                        <td> : <input type="text" name="PAJAK[TransactionAmount]" id="TransactionAmount" class="number" placeholder="Nominal Transaksi" style="width:300px" readonly></td>
                    </tr>
                    <tr>
