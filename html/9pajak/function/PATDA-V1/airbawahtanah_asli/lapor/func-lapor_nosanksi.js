$(document).ready(function() {
    ...
    $('.CPM_VOLUME_AIR').autoNumeric('init');
...
//
// 		var sum1 = eval($('#CPM_ATR_TOTAL-1').val());
// 		var sum2 = eval($('#CPM_ATR_TOTAL-2').val());
// 		var sum3 = eval($('#CPM_ATR_TOTAL-3').val());
// 		//tambahan
// 		// var bulan_sanksi = selisih_bulan - 2;
// 		var bulan_sanksi = selisih_bulan - 1;
//
// 		var total_sum1 = 0;
// 		var total_sum2 = 0;
// 		var total_sum3 = 0;
...
// 		if(bulan_sanksi > 0){
// 			if(sum1){
// 				total_sum1 = sum1 * (0.02 *bulan_sanksi);
// 			}
// 			if(sum2) {
// 				total_sum2 = sum2 * (0.02 *bulan_sanksi);
// 			}
// 			if(sum3) {
// 				total_sum3 = sum3 * (0.02 *bulan_sanksi);
// 			}
// 			var total_sanksi = total_sum1 + total_sum2 + total_sum3;
// 			// var total_sanksi = 0;
// 		}else{
// 			var total_sanksi = 0;
// 		}
//         var sanksi = total_sanksi;
//     }
...
function function_sum(obj) {
    ...
    var sanksi = Number($('#CPM_DENDA_TERLAMBAT_LAP').autoNumeric('get'));
    $('#CPM_DENDA_TERLAMBAT_LAP').autoNumeric('set', sanksi);
