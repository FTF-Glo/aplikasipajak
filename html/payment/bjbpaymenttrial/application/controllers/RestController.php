...
class RestController extends REST_Controller
{
    ...
    protected function inquiryPBB($nop, $tahun = '', $now = null, $returnRow = false)
    {
        ...
        foreach ($rows as $row) {
            ...
            $result = array(
                ...
                "jatuh_tempo"            => $row->SPPT_TANGGAL_JATUH_TEMPO ?: '-',
    ...
    protected function inquiryPajakSPajak($id)
    {
        ...
        $this->spajak->select('payment_code as kode_billing,
            ...
            simpatda_denda as denda,expired_date,
    ...
    protected function inquiryPajakBPTHB($id)
    {
        ...
        op_luas_tanah AS luas_tanah,
        op_luas_bangunan AS luas_bangunan,
        bphtb_npop AS NPOP,
        LPAD(bphtb_jenis_hak,2,0) AS jenis_hak,
        bphtb_notaris AS nama_notaris,
        wp_kabupaten AS kota_wp,
        wp_kecamatan AS kecamatan_wp,
        wp_kelurahan AS kelurahan_wp,
        wp_rt AS rt_wp,
        wp_rw AS rw_wp,
        wp_kodepos AS kode_pos_wp,
        op_kelurahan AS kelurahan_op,
        op_kecamatan AS kecamatan_op,
        YEAR(saved_date)AS tahun_pajak,
      
        wp_alamat as alamat_wajib_pajak,
        wp_nama as nama_objek_pajak,
        op_letak As alamat_objek_pajak,expired_date,
        bphtb_dibayar as jumlah_pajak_dibayar,
        saved_date as masa_pajak,
        IF(payment_flag=1, "LUNAS", "BELUM LUNAS") AS status_bayar'
