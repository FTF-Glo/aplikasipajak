                                ...
                                if($kode_16 == 0){
                                    ...
                                    if($kode_13 == 0){
                                        ...
                                        if($kode_12 == 0){
                                                ...
                                                foreach ($hasil as $has => $h) {
                                                    ...
                                                    if($h['payment_flag'] == '1'){
                                                        ...
                                                        if($total_semua == $total_jumlah_bayar){
                                                            ...
                                                            $response['code']= '99';
                                                            $response['description']= 'SUDAH LUNAS';
                                                            ...
                                                            $response['code']= '15';
                                                            $response['description']= 'Jumlah total bayar tidak sama';
                                                        }
                                                        ...
                                                        if($total_semua == $total_jumlah_bayar){
                                                           $update_bayar = $this->db3->update("PBB_SPPT", $data, $where);
                                                           ...
                                                           if($update_bayar){
                                                            ...
                                                            $response['code']= '06';
                                                            $response['description']= 'Pembayaran PBB berhasil';
                                                            $response['details']= $details;                                                
                                                           }else{
                                                                // $description[] = array(
                                                                //     "code" => '88',
                                                                //     "description" => 'NOP ' . $nop . ' Tahun ' . $h['tahun_pajak'] . ' Pembayaran Gagal',                                      
                                                                // );
                                                                // $response['data']= $description;
                                                                $response['code']='88'; 
                                            ...
                                            $response['code']= '12';
                                            $response['description']= 'Jumlah bayar tidak sama';
                                        }
                                    }else{
                                        $response['code']= '13';
                                        $response['description']= 'Data tidak ditemukan, Mohon cek kembali Tahun dan Jumlah bayar';
                                    }
                                }else{
                                    $response['code']= '16';
                                    $response['description']= 'Tahun atau Jumlah bayar tidak sesuai format, hanya boleh angka';
                                }
                            // }else{
                            //     $description[] = array(
                            //         "code" => '12',
