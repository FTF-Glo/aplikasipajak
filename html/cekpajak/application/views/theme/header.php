...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url("ext/style.css?x"); ?>">
...
<body>
	...
	<div class="header head-menu fixed-top" id="myHeader">
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="padding:.5rem .5rem">
            <div class="d-flex w-100 align-items-center">
                <a style="" class="navbar-header" href="<?php echo base_url(); ?>">
                    <img style="max-width: 300px;" src="<?php echo base_url('images/logo-small.png'); ?>">
                </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="nav navbar-nav ml-auto">
                    <li>
                        <a href="<?= base_url() ?>" class="btn btn-primary m-1 btn-sm" style="background-color : #68a0ff">Home</a>
                    </li>
                    <li>
                        <div class="dropdown">
                            <button class="btn btn-primary dropdown-toggle m-1 btn-sm " style="background-color : #68a0ff" type="button" id="dropdownPendaftaran" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Pendaftaran
                            </button>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownPendaftaran">
                                <a class="dropdown-item" target="_blank" href="<?= getConfig('external_link_daftar_wp') ?>">Pendaftaran Wajib Pajak (9PAJAK)</a>
