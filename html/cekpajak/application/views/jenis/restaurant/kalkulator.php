...
<div class="container">
    <div class="content bg-light p-4">
        <h3><strong>Pajak <?=$title?></strong></h3>
        ...
        <a href="<?=base_url('jenis/'.$code)?>" class="btn btn-secondary"><i class="icon-arrow-left mr-2"></i>Kembali</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <table>
                        <tr><td>NOP</td><td width=3>:</td><td><b class="text-success modal_nop"></b></td></tr>
                        <tr><td>NAMA&nbsp;OP</td><td width=3>:</td><td><b class="text-success modal_nama_op"></b></td></tr>
                        <tr><td>ALAMAT&nbsp;OP</td><td width=3>:</td><td><b class="text-success modal_alamat"></b></td></tr>
                        <tr><td>TAGIHAN</td><td width=3>:</td><td><b class="text-success modal_tagihan"></b></td></tr>
                    </table>
                </div>
...
<script>
    ...
    $("#btnCheckTagihan").click(function() {
        ...
        $.ajax({
            ...
            url: "<?=base_url('api/checkTagihanKodeBayar')?>",
...
<script type="text/javascript" src="<?=base_url()?>ext/custom/autoNumeric.js"></script>
<script>
    jQuery(function($) {
