...
<div class="container">
    <div class="content bg-light p-4">
        ...
        <div class="row my-2">
            ...
            <div class="col-md-6">
                <div class="border p-3">
                    ...
                    <div>
                        <button class="btn btn-primary" style="background-color: #dc3545" id="btnCheckTagihan">Periksa</button>
        ...
        <button class="btn btn-success qris-btn" data-toggle="modal" data-target="#qrisModal" style="display:none">Bayar dengan QRIS</button>
        <h6 id="notif-qris"> Pembayaran lain bisa lewat Indomaret, Alfamart, Tokopedia dan L Online</h6>
        <span class="text-danger pl-4 msgrespon" style="display:none;font-size:large;font-weight:bold"></span>
    </div>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <table>
                        <tr><td>PBB&nbsp;NOP</td><td width=3>:</td><td><b class="text-success modal_nop"></b></td></tr>
                        <tr><td>TAHUN</td><td width=3>:</td><td><b class="text-success modal_tahun"></b></td></tr>
                        <tr><td>ALAMAT&nbsp;OP</td><td width=3>:</td><td><b class="text-success modal_alamat"></b></td></tr>
                        <tr><td>NAMA&nbsp;WP</td><td width=3>:</td><td><b class="text-success modal_nama"></b></td></tr>
                        <tr><td>BAYAR</td><td width=3>:</td><td><b class="text-success modal_bayar"></b></td></tr>
                    </table>
                </div>
    ...
    $('#btnCheckTagihan').click(function() {
        ...
        if (iValue == "" || iValue2 == "") {
            ...
            $.ajax({
                ...
                url: "<?=base_url('api/checkTagihanPBB')?>",
                success: function(msg) {
                    ...
                    if(arr.modal.length!=0){
                        ...
                        if(q.status==0) {
                            ...
                            $('.modal_tahun').html(q.tahun);
                            $('.modal_nama').html(q.nama);
                            $('.modal_alamat').html(q.alamat);
                            $('.modal_bayar').html(q.total);
                            if(q.qr){
                            ...
                            $('.msgrespon').show().html('* Jika Nilai Tagihan lebih dari 10jt tidak bisa Generate QRIS..!');
                        }
                    }
                    scrollToResult();
                },
