...
<div class="container">
    <div class="content bg-light p-4">
        <?php echo form_open('users/add_sppt_minerba'); ?>
        <input name="txTax" value="<?php echo $tax;?>" hidden>
        <h3>Formulir Hitung Pajak Minerba</h3>
        <hr />
        <?php
            ...
            <div class="col-md-7">
                <div class="px-3">
                    ...
                    <div class="form-group">
                        ...
                        <input class="datepicker form-control font-size-small" name="txMasa" id="txMasa" autocomplete="off"  placeholder="">
                    </div>
  ...
  modAddLoc.modal('show');
    ...
    $('#btnCount').click(function(){
        ...
        if(sValue == true || sType == true){
            ...
            $.ajax({
    			type: "POST",
                data:{iValue:iValue,iType:iType,iTax:iTax,iFine:iFine,iMasa:iMasa},
