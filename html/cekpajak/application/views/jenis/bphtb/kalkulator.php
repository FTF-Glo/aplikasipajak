...
<script>
    $("#btnCheckTagihan").click(function() {
        alert('Maaf, Layanan ini belum tersedia di aplikasi cek pajak Lampung Utara');
        return false;

        var iValue = $("#txKodebayar").val();
        if (iValue == "" || iValue.substr(-2)!=='02') {
    ...
    sleep(2000).then(() => { alert('Maaf, Layanan ini belum tersedia di aplikasi cek pajak Lampung Utara'); });
</script>
