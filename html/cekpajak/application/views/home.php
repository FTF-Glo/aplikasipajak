...
<div class="tax-type" style="background-color: #68a0ff;">
  <div class="container">
    <div class="text-center pt-3 pb-4" id="jenispajak">
        <h3 class="c-white bold mt-3">JENIS PAJAK <a href="#jenispajak" style="opacity: 0">#</a>
        </h3>
        <div class="row">
          <?php
