        ...
        <tr >
	        <td>
                ...
                <div>   
                    ...
                    <div class="col" >: <?php echo $main['npwpd'];?></div>
                </div>
                <div>   
                    <div class="col" style=" width:100px;">Nama Usaha</div>
                    <div class="col" >: <?php echo $main['name_usaha'];?></div>
                </div>
                <div>   
                    <div class="col" style=" width:100px;">Masa Pajak</div>
                    <div class="col" >: <?php echo $main['masa_date'];?></div>
                </div>
                <div>   
                ...
                <div>   
                    <div class="col" style=" width:100px;">Jatuh Tempo</div>
                    <div class="col" >: <?php echo $this->format->fulldate($main['created_date']);?></div>
                </div>
                <div class="tax">
                     <table class="table">
