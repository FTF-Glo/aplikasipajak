...
<div>
            <div>NOP : <strong><?php echo $main['nop'];?></strong> </div>
            <div>Tahun : <strong><?php echo $main['masa'];?></strong></div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="img-qrcode px-3 py-1" >   
                                        ...
                                        <div class="text-center" style="margin-top:20px;"><h3><strong><?php echo $sppt['token'];?></strong></h3></div>
                                    </div>
                                </td>
                            </tr>
                        </table>
