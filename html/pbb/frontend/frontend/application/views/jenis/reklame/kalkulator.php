    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <table>
                        <tr><td>NOP</td><td width=3>:</td><td><b class="text-primary modal_nop"></b></td></tr>
                        <tr><td>NAMA&nbsp;OP</td><td width=3>:</td><td><b class="text-primary modal_nama_op"></b></td></tr>
                        <tr><td>ALAMAT&nbsp;OP</td><td width=3>:</td><td><b class="text-primary modal_alamat"></b></td></tr>
                        <tr><td>TAGIHAN</td><td width=3>:</td><td><b class="text-primary modal_tagihan"></b></td></tr>
                    </table>
                </div>
...
<script>
    ...
    $('.qris-btn').click(function() {
        if(token){
            ...
            var url = "http://103.140.188.162";
                url+= ":5051";
                url+= "/function";
                url+= "/curl";
                url+= "/get-Old-Inquiry.php";
            $.ajax({
                type: "POST",
                data: {
                    token: token,
