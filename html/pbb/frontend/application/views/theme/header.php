...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url("ext/style.css?f"); ?>">
...
<body>
	...
	<?php if (getConfig('contact_whatsapp_enabled')): ?>
		<a style="z-index: 999992;" href="https://api.whatsapp.com/send?phone=<?= getConfig('contact_whatsapp') ?>&text=<?= urlencode(getConfig('contact_whatsapp_msg')) ?>" class="float-wa">
