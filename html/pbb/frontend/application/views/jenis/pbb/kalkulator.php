    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <table>
                        <tr><td>PBB&nbsp;NOP</td><td width=3>:</td><td><b class="text-danger modal_nop"></b></td></tr>
                        <tr><td>TAHUN</td><td width=3>:</td><td><b class="text-danger modal_tahun"></b></td></tr>
                        <tr><td>ALAMAT&nbsp;OP</td><td width=3>:</td><td><b class="text-danger modal_alamat"></b></td></tr>
                        <tr><td>NAMA&nbsp;WP</td><td width=3>:</td><td><b class="text-danger modal_nama"></b></td></tr>
                        <tr><td>BAYAR</td><td width=3>:</td><td><b class="text-danger modal_bayar"></b></td></tr>
                    </table>
                </div>
...
<script>
    ...
    $('.qris-btn').click(function() {
        if(token){
            ...
            var url = "http://36.92.151.83";
                url+= ":2010";
                url+= "/function";
                url+= "/PBB";
                url+= "/func-get-qris.php";
            $.ajax({
                type: "POST",
                data: {
                    sha1: token,
