...
class dbMonitoring
{
		...
		if ($this->dbType == 1) {
			while ($row = $this->getDataFromPostgres()) {
				...
				for ($i = 0; $i < $c; $i++) {
					...
					$xalign = $align!='' ? ' align='.$align : '';
					$html .= "<td$xalign>" . $row[$this->fields[$i]["name"]] . "</td>";
				}
				$html .= "</tr>";
			}
		}
	...
	public function showHTML()
	{
		...
		$html = "<div id=\"frame-tbl-monitoringg\" class=\"tbl-monitoring\"><table class=\"table table-bordered table-striped\">";
	...
	public function showHTMLMundur()
	{
		...
		$html = "<div id=\"frame-tbl-monitoring\" class=\"tbl-monitoring\"><table class=\"table table-bordered table-striped\">";
