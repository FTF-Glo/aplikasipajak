...
<div class="modal fade" id="modAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <form action="<?php echo base_url();?>parameter/minerba_range_act" method="post" accept-charset="utf-8">
...
<div class="modal fade" id="modDel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <form action="<?php echo base_url();?>parameter/minerba_range_del" method="post" accept-charset="utf-8">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
...
<script>
    ...
    $('.btn-edit').on('click', function(){
        ...
        $.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>api_master/getPajakMinerbaID/"+id,
