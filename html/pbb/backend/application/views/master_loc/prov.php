        ...
        <div class="content-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-1 menu-right">
                    <button class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Tambah Provinsi</button>
                </div>
            </div>
...
<div class="modal fade" id="modAct" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <form action="<?php echo base_url();?>master_loc/prov_act" method="post" accept-charset="utf-8">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
    		    ...
    		    <div class="form-group">
    		        <label for="txName">Nama Provinsi:</label>
    		        <input type="text" id="txName" name="txName" class="form-control" required />
    		    </div>
    		    <div class="form-group">
    		        <label for="txCode">Kode:</label>
    		        <textarea name="txCode" id="txCode" class="form-control"></textarea>
    		    </div>
...
<div class="modal fade" id="modDel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <form action="<?php echo base_url();?>master_loc/prov_del" method="post" accept-charset="utf-8">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
...
$('.btn-edit').on('click', function(){
    ...
    $.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>api_master/getProvID/"+id,
