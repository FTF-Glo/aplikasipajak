...
<div class="app-content content">
	<div class="content-wrapper">
        <div class="content-body">
            <div class="row">
                <div class="col-md-8">
                    <h3>Master Bidang Usaha</h3>
                </div>
                <div class="col-md-4 mb-1 menu-right">
                    <button class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Tambah Bidang Usaha</button>
                </div>
            </div>
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
		        ...
		        <div class="form-group">
		            ...
		            <select name="cbClass" id="cbClass" class="form-control">
...
$('.btn-add').on('click', function(){
    modAct.find('#exampleModalLabel').html('Tambah Bidang Usaha');
    modAct.modal('show');
    return false;
});
