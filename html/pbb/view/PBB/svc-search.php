...
//if ($status!="") array_push($arrWhere,"(payment_flag = 0 OR payment_flag = 2 OR payment_flag = 1)");            
...
if(stillInSession($DBLink,$json,$sdata)){			
	...
	$monPBB->query("select payment_flag, nop, wp_nama, wp_alamat, wp_kelurahan, op_alamat, op_kecamatan, op_kelurahan, op_rt, op_rw,
					op_luas_bumi, op_luas_bangunan,op_njop_bumi,op_njop_bangunan,sppt_tahun_pajak, sppt_tanggal_jatuh_tempo , sppt_pbb_harus_dibayar, payment_paid
					");
	$monPBB->setTitleHeader($jsonTitle);
	$monPBB->showHTMLsearch();
}else{
