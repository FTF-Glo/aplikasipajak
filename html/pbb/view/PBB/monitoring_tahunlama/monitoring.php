...
?>
    ...
    <script>
        ...
        function setPage(pg, sts) {
            ...
            if (sts == '7') {
                //   alert("export 7");
                $("#monitoring-content-" + sts).load("view/PBB/monitoring_tahunlama/svc-monitoring-dph.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 's':'23','uid':'$uid'}"); ?>&p=" + pg, {
                    na: nama,
                    t1: tempo1,
                    t2: tempo2,
                    th: tahun,
                ...
                $("#monitoring-content-" + sts).load("view/PBB/monitoring_tahunlama/svc-monitoring.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 's':'23','uid':'$uid'}"); ?>&p=" + pg, {
                    na: nama,
                    t1: tempo1,
                    t2: tempo2,
                    th: tahun,
        ...
        function showKelurahan(sts) {
            ...
            var request = $.ajax({
                url: "view/PBB/monitoring_tahunlama/svc-kecamatan.php",
                type: "POST",
                data: {
                    id: id,
                    kel: mode
        ...
        function showRW(sts) {
            ...
            var appID = APPID;
            var request = $.ajax({
                url: "view/PBB/monitoring_tahunlama/svc-rw.php",
                type: "POST",
                data: {
                    id: id,
                    appID: appID,
        ...
        function showBank(sts) {
            var request = $.ajax({
                url: "view/PBB/monitoring_tahunlama/svc-bank.php",
                type: "POST",
                data: "q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 's':'23','uid':'$uid'}"); ?>",
                dataType: "json",
                success: function(data) {
        ...
        <div id="div-search">
            <div id="tabs">
                <ul>
					...
					<li><a href="#tabs-1"><?php echo $statusBayar->pembatalanLabel; ?></a></li>
                </ul>
                <div id="tabs-2">
                    <?php $statusBayar->printFormBelumBayar($a, $m, $uid); ?>
                </div>
				<div id="tabs-1">
                    <?php $statusBayar->printFormPembatalan($a, $m, $uid); ?>
                </div>
            </div>
