...
function headerMonitoringRealisasi($mod, $nama) {
    ...
    $html = "<table cellspacing=\"0\" cellpadding=\"4\" border=\"1\" class='table table-bordered'><tr><th colspan=\"7\"><b>{$dl}<b></th></tr>
	  <col width=\"28\" />
	  <col width=\"187\" />
	  <col width=\"47\" />
	  <col width=\"89\" span=\"3\" />
	  ...
	  <tr>
		...
		<th rowspan=\"2\" width=\"136\" align=\"center\">SISA PIUTANG</th>
		<th colspan=\"3\" width=\"136\" align=\"center\">REALISASI</th>
		<th rowspan=\"2\" width=\"47\" align=\"center\">SALDO PIUTANG</th>
	  </tr>
	  <tr>
...
function showTable($mod = 0, $nama = "") {
    ...
    $html .= " <tr>
            ...
            <td align=\"right\">" . number_format($summary['sisa'], 0, ',', '.') . "</td>
          </tr>";
