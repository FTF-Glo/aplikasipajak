...
class Piutang
{
    ...
    public function printForm($a, $m, $uid)
    {
        ...
        if ($this->idRole == "rmKelurahan") {
            $filterWilayah = '<div class="col-md-2"><div class="form-group"><label for="">' . $lblKelurahan . '</label><select id="kelurahan-piutang" class="form-control"><option value="' . $this->dtUser['kelurahan'] . '">' . $this->dtUser['CPC_TKL_KELURAHAN'] . '</option></select></div></div>';
            ...
            $filterWilayah = '<div class="col-md-2"><div class="form-group"><label for="">Kecamatan</label><select id="kecamatan-piutang" class="form-control"></select></div></div><div class="col-md-2"><div class="form-group"><label for="">' . $lblKelurahan . '</label><select id="kelurahan-piutang" class="form-control"></select></div></div>';
        }
        echo '
            <div class="row">
                <div class="col-md-12">
...
<script>
    function showModelPiutang() {
        ...
        if ($("#piutang-tgl-bayar-awal").val() == "") {
            ...
            $("#monitoring-piutang").html("loading ...");
