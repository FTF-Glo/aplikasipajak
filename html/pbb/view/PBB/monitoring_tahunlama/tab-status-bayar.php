                        ...
                        <div class="collapse" id="collapsepenghapusan">
                            <div class="card card-body">
                                <div class="row" style="margin-left:5px; margin-top:10px">
                                    ...
                                    <button type="button" name="button2" class="btn btn-primary btn-info" onClick="onSubmit(2)">Tampilkan</button>
                                    <button type="button" name="buttonToExcel" class="btn btn-primary btn-blue" onClick="toExcel(2)">Ekspor ke xls</button>
                                    <span id="loadlink1" style="font-size: 10px; display: none;">Loading...</span>
									</div>
