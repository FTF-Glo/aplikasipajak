...
if (isset($_REQUEST['btn-finalize']) && $_REQUEST['btn-finalize'] == "Finalkan") {
	...
	$data = $dbGwCurrent->changeStimulusReal($checkall, $tahun, $pengurangan, $appConfig);
...
function displayMenuPenerimaan()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"function/PBB/pbb-minimum/page-pbb-minimum.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'10'}") . "\">Tertunda</a></li>\n";
	echo "\t</ul>\n";
}
...
function displayMenuVerifikasi()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"function/PBB/pbb-minimum/page-pbb-minimum.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'20'}") . "\">Tertunda</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/pbb-minimum/page-pbb-minimum.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'11'}") . "\">Dalam Proses</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/pbb-minimum/page-pbb-minimum.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'22'}") . "\">Ditolak</a></li>\n";
	echo "\t</ul>\n";
}
...
function displayMenuPersetujuan()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"function/PBB/pbb-minimum/page-pbb-minimum.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'30'}") . "\">Tertunda</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/pbb-minimum/page-pbb-minimum.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'11'}") . "\">Dalam Proses</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/pbb-minimum/page-pbb-minimum.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'32'}") . "\">Ditolak</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/pbb-minimum/page-pbb-minimum.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'33'}") . "\">Disetujui</a></li>\n";
	echo "\t</ul>\n";
}
