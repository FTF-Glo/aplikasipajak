...
function updateFinal()
{
	...
	$query = "UPDATE cppmod_pbb_sppt_final SET CPM_OT_ZONA_NILAI = '{$new_znt}' WHERE CPM_NOP in ($string_nop) ";
...
function updateSusulan()
{
	...
	// 		  AND (CPM_SPPT_THN_PENETAPAN <> '{$thn_tagihan}' OR CPM_SPPT_THN_PENETAPAN IS NULL)
	// 		  AND CPM_OT_ZONA_NILAI = '{$old_znt}' ";
	$query = "UPDATE cppmod_pbb_sppt_susulan SET CPM_OT_ZONA_NILAI = '{$new_znt}' WHERE CPM_NOP in ($string_nop) ";
		...
		<div class=\"col-md-12\" style=\"margin-top: 20px\">
			<form  name=\"form-penerimaan-multi\" id=\"form-penerimaan-multi\" method=\"post\" action=\"\">
				...
				<div class=\"col-md-12\" id=\"info_lengkap\">
					<div class=\"row\">
						<div class=\"col-md-3\">
							<label for=\"kelurahanOP\" style=\"margin-top: 7px\">NOP</label>
						</div>
						<div class=\"col-md-5\">
					...
					<div class=\"row\" style=\"margin-top: 20px\">
						<div class=\"col-md-12\">
							<input type=\"submit\" class=\"btn btn-primary btn-orange\" name=\"btn-cari\" id=\"btn-cari\" value=\"Cari\" />
						</div>
					</div>
				</div>
			</form>
...
<script>
	...
	$(document).ready(function() {
		...
		$('#tgl_pendataan_multi').datepicker({
			dateFormat: 'yy-mm-dd'
		});
		$('#tgl_pemeriksaan_multi').datepicker({
			dateFormat: 'yy-mm-dd'
		});
