...
function getData()
{
	global $DBLinkGW, $appConfig, $kd_kel, $tahun, $blok, $blok2, $kd_buku;
	...
	$query = "SELECT
				...
				PBB_SPPT A
				WHERE
					NOP >= '" . $kd_kel . $blok . "00000' AND NOP <= '" . $kd_kel . $blok2 . "99999'
				AND A.SPPT_TAHUN_PAJAK = '" . $tahun . "' 
				{$qBuku} ";
	// echo $query; exit; SUBSTR(A.NOP,1,10) = '".$kd_kel."'
...
{
	global $kd_kel, $blok, $blok2, $kd_buku, $path, $jumlahNOP, $maxNopPerFile, $tahun, $totalFileSize, $arrFiles;
