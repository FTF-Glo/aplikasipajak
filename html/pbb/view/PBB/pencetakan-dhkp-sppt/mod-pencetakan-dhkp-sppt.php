...
function displayMenuPelayanan() {  // srch
	...
	echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/PBB/pencetakan-dhkp-sppt/svc-pencetakan-dhkp.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 'tab':'0', 'n':'1', 'u':'$data->uname'}") . "\">Pencetakan DHKP</a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/pencetakan-dhkp-sppt/svc-pencetakan-sppt.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 'tab':'1', 'n':'2', 'u':'$data->uname'}") . "\">Pencetakan SPPT</a></li>\n";
    //Add by ZNK : Tab STTS (21-12-2016)
	echo "\t\t<li><a href=\"view/PBB/pencetakan-dhkp-sppt/svc-pencetakan-stts.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 'tab':'2', 'n':'3', 'u':'$data->uname'}") . "\">Pencetakan STTS</a></li>\n";
    //End
	echo "\t</ul>\n";
}
?>
