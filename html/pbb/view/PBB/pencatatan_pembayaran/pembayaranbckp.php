		...
		<table border="0" cellpadding="4" cellspacing="1" width="900px">
			<tbody>
				...
				<tr>
					...
					<td style="background-color:transparent;">:</td>
					<td style="background-color:transparent;" width="15%"><input class="form-control" class="srcTgl" name="tgl-bayar" id="tgl-bayar" readonly="readonly" type="text" size="9" maxlength="10" value="<?php echo $tgl; ?>"></td>
