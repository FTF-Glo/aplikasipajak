...
//require_once($sRootPath."view/PBB/penagihan_uptd/svc-count-notif.php");
...
$validator_sp_nm         = $appConfig['VALIDATOR_SP_NAMA'];
$validator_sp_nip        = $appConfig['VALIDATOR_SP_NIP'];
$validator_sp_jabatan    = $appConfig['VALIDATOR_SP_JABATAN'];
...
{  // srch
    global $validator_sp_nm, $validator_sp_nip, $validator_sp_jabatan, $a, $m, $data, $countSP1, $countSP2, $countSP3, $dbhost, $dbuser, $dbpwd, $dbname, $kabid_nama, $kabid_nip, $kabid_jabatan, $kadis_nama, $kadis_nip, $kadis_jabatan, $kota, $sp1, $sp2, $sp3, $lblkel, $bank, $denda, $perpage, $kodekota, $kd_dispenda, $kd_bidang, $kd_seksi, $isAdminPenagihan, $tahun_tagihan;
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan_uptd_khusus_2016/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'1', 'n':'1', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$validator_sp_nm','nip':'$validator_sp_nip','jabatan':'$validator_sp_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"sp1\" class=\"notif\">SP1<font color=\"" . $clrSP1 . "\"> </font></div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan_uptd_khusus_2016/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'2', 'n':'2', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$validator_sp_nm','nip':'$validator_sp_nip','jabatan':'$validator_sp_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"sp2\" class=\"notif\">SP2<font color=\"" . $clrSP2 . "\"> </font></div></a></li>\n";
    // echo "\t\t<li><a href=\"view/PBB/penagihan_uptd/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'3', 'n':'3', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$validator_sp_nm','nip':'$validator_sp_nip','jabatan':'$validator_sp_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"sp3\" class=\"notif\">SP3<font color=\"".$clrSP3."\"> </font></div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan_uptd_khusus_2016/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'4', 'n':'4', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$validator_sp_nm','nip':'$validator_sp_nip','jabatan':'$validator_sp_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"all\" class=\"notif\">ALL SP<font color=\"" . $clrAll . "\"> </font></div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan_uptd_khusus_2016/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'5', 'n':'5', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$validator_sp_nm','nip':'$validator_sp_nip','jabatan':'$validator_sp_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"stpd\" class=\"notif\">STPD</div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan_uptd_khusus_2016/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'6', 'n':'6', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$validator_sp_nm','nip':'$validator_sp_nip','jabatan':'$validator_sp_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"psp1\" class=\"notif\">Proses SP1</div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan_uptd_khusus_2016/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'7', 'n':'7', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$validator_sp_nm','nip':'$validator_sp_nip','jabatan':'$validator_sp_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"psp2\" class=\"notif\">Proses SP2</div></a></li>\n";
    // echo "\t\t<li><a href=\"view/PBB/penagihan_uptd/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'8', 'n':'8', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$validator_sp_nm','nip':'$validator_sp_nip','jabatan':'$validator_sp_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"psp2\" class=\"notif\">Proses SP3</div></a></li>\n";
    echo "\t</ul>\n";
}
...
{  // srch
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan_uptd_khusus_2016/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'9', 'n':'9', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$validator_sp_nm','nip':'$validator_sp_nip','jabatan':'$kadis_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"psp2\" class=\"notif\">Persetujuan SP</div></a></li>\n";
    echo "\t</ul>\n";
}

?>
<link rel="stylesheet" href="view/PBB/penagihan_uptd_khusus_2016/sppgh.css" type="text/css">
...
<script type="text/javascript">
    ...
    function refreshNotif() {
        ...
        $.ajax({
            type: "POST",
            url: "./view/PBB/penagihan_uptd_khusus_2016/svc-count-notif-jv.php",
