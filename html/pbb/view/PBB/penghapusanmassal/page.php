...
function displayContent($selected)
{
    ...
    if ($selected == 50) {
        ...
        echo "<button class=\"btn btn-primary btn-orange\" type=\"button\" value=\"Hapus NOP\" name=\"btn-print-preview\"/ onclick=\"javascript:hapusNOP()\">Hapus NOP</button>&nbsp;&nbsp;\n";
        echo "&nbsp;&nbsp;&nbsp;\n";
...
function getData($selected)
{
    ...
    if ($selected == 5) {
        ...
        if ($selected == 60) {
            ...
            $data = $dbGwCurrent->get70ss($filter, $srch, $qBuku, $jumlah, $perpage, $page, $tahun, $appConfig);
            $totalrows = $dbGwCurrent->totalrows;
