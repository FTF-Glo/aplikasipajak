...
function headerMonitoringRealisasi($mod, $namaKec) {
    ...
    $html = "<table class=\"table table-bordered table-striped\"><tr><th colspan=21 class=tleft>{$dl}</th></tr>
	  <col width=\"28\" />
	  <col width=\"187\" />
	  <col width=\"47\" />
	  <col width=\"89\" />
	  ...
	  <tr>
		...
		<th colspan=\"4\">REALISASI BULAN LALU (RP)</th>
		<th rowspan=\"2\">%</th>
		<th colspan=\"4\">REALISASI BULAN INI</th>
		<th colspan=\"4\">REALISASI S/D BULAN INI</th>
		<th rowspan=\"2\">%</th>
		<th colspan=\"2\">SISA KETETAPAN</th>
...
//	$dtsisa = getSisaSampaiBulanSekarang($mod);
    ...
    foreach ($list as $list){ 
        ...
        $html .= "<tr class=tright>
	            ...
	            <td>" . number_format($list["WPSISA"], 0, ",", ".") . "</td>
	            <td>" . number_format($list["RPSISA"], 0, ",", ".") . "</td>
	            <td>{$PRC3}</td>
              </tr>";
    ...
    $html .= " <tr class='tright tbold'>
            ...
            <td>" . number_format($summary['ketetapan_wp'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['ketetapan_rp'], 0, ',', '.') . "</td>
            
            <td>" . number_format($summary['rbl_wp'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['rbl_pokok'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['rbl_denda'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['rbl_total'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['percent1'], 2, ',', '.') . "</td>
                
            <td>" . number_format($summary['rbi_wp'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['rbi_pokok'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['rbi_denda'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['rbi_total'], 0, ',', '.') . "</td>
                
            <td>" . number_format($summary['kom_rbi_wp'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['kom_rbi_pokok'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['kom_rbi_denda'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['kom_rbi_total'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['percent2'], 2, ',', '.') . "</td>
                
            <td>" . number_format($summary['sk_wp'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['sk_rp'], 0, ',', '.') . "</td>
            <td>" . number_format($summary['percent3'], 2, ',', '.') . "</td>
          </tr>";
     return $html . "</table>";
