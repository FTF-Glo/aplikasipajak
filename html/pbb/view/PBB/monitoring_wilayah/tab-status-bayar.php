...
<script>
    function onSubmit(sts) {
        ...
        $("#monitoring-content-" + sts).load("view/PBB/monitoring_wilayah/svc-monitoring.php?q=<?php echo  base64_encode("{'a':'$a', 'm':'$m', 's':'23','uid':'$uid'}"); ?>", {
            na: nama,
            almt: alamat,
            t1: tempo1,
            t2: tempo2,
    ...
    function toExcel(sts) {
        ...
        $.ajax({
            type: "POST",
            url: "./view/PBB/monitoring_wilayah/svc-countforlink.php",
            ...
            success: function(msg) {
                ...
                var strOfLink = "";
                if (msg < 20000)
                    strOfLink += '<a href="view/PBB/monitoring_wilayah/svc-toexcel.php?q=<?php echo  base64_encode("{'a':'$a', 'm':'$m', 's':'23','uid':'$uid'}"); ?>' + '&na=' + nama + '&almt=' + alamat + '&t1=' + tempo1 + '&t2=' + tempo2 + '&th=' + tahun + '&n1=' + nop1 + '&n2=' + nop2 + '&n3=' + nop3 + '&n4=' + nop4 + '&n5=' + nop5 + '&n6=' + nop6 + '&n7=' + nop7 + '&st=' + sts + '&kc=' + kc + '&kl=' + kl + "&rw=" + rw + "&buku=" + buku + "&LBL_KEL=" + LBL_KEL + '&p=all&total=' + msg + '">' + nmfileAll + '</a><br/>';
                else {
                    for (var page = 1; page <= sumOfPage; page++) {
                        strOfLink += '<a href="view/PBB/monitoring_wilayah/svc-toexcel.php?q=<?php echo  base64_encode("{'a':'$a', 'm':'$m', 's':'23','uid':'$uid'}"); ?>' + '&na=' + nama + '&almt=' + alamat + '&t1=' + tempo1 + '&t2=' + tempo2 + '&th=' + tahun + '&n1=' + nop1 + '&n2=' + nop2 + '&n3=' + nop3 + '&n4=' + nop4 + '&n5=' + nop5 + '&n6=' + nop6 + '&n7=' + nop7 + '&st=' + sts + '&kc=' + kc + '&kl=' + kl + "&rw=" + rw + "&buku=" + buku + "&LBL_KEL=" + LBL_KEL + '&p=' + page + '">' + nmfile + page + '</a><br/>';
                    }
                }
