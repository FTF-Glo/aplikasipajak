...
function headerRekapPokok($mod,$nama) {
	...
	<tr>
		<th colspan=11 class=tleft>{$dl}</td>
	</tr>
	  <tr>
		<th rowspan=2 width=9>NO</td>
		<th rowspan=2>{$model}</td>
		<th colspan=3>PEDESAAN</td>
		<th colspan=3>PERKOTAAN</td>
		<th colspan=3>PEDESAAN - PERKOTAAN</td>
	  </tr>
	  <tr>
		<th>OP</td>
		<th>DHKP</td>
...
function showTable ($mod=0,$nama="") {
	...
	$summary = array('name'=>'TOTAL','op_pedesaan'=>0, 'dhkp_pedesaan'=>0, 'pbb_pedesaan'=>0, 'op_perkotaan'=>0, 'dhkp_perkotaan'=>0, 'pbb_perkotaan'=>0, 'op_all'=>0,'dhkp_all'=>0, 'pbb_all'=>0);
		...
		$html .= "<tr class='tright tbold'>
            ...
            <td>".number_format($summary['op_pedesaan'],0,',','.')."</td>
            <td>".number_format($summary['dhkp_pedesaan'],0,',','.')."</td>
            <td>".number_format($summary['pbb_pedesaan'],0,',','.')."</td>
			
            <td>".number_format($summary['op_perkotaan'],0,',','.')."</td>
            <td>".number_format($summary['dhkp_perkotaan'],0,',','.')."</td>
            <td>".number_format($summary['pbb_perkotaan'],0,',','.')."</td>
			
            <td>".number_format($summary['op_all'],0,',','.')."</td>
            <td>".number_format($summary['dhkp_all'],0,',','.')."</td>
            <td>".number_format($summary['pbb_all'],0,',','.')."</td>
          </tr>";
...
function getOpPedesaan($kel) {
	global $DBLink,$kd,$thn,$bulan, $appConfig,$where_plus;
...
$where_plus = count($arrWhere)>0 ? " AND".$where : '';
