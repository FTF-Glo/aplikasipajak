...
?>
    ...
    <script type="text/javascript">
		...
		function changeKecAll(kec) {
            var  kel = "kec="+kec.value;
			console.log($kel);
            //$('#form1').trigger("submit");
        }
            ...
            <?php foreach ($aKecamatan as $row) {
                ...
                if (val == "<?php echo $row['CPC_TKC_ID']; ?>") {
                    document.getElementById('sKel').innerHTML = "<?php
                                                                    ...
                                                                    echo "<option value='" . $kecs . "' " . ((isset($OP_KELURAHAN) && $OP_KELURAHAN == $kecs) ? "selected" : "") . ">Semua Kelurahan</option>";
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class=\"form-control\" name=\"kec\" id=\"kec\" onchange=\"showKelFilter(this)\">
                                        <option>Pilih</option>
										<option value=\"all\" " . ((isset($kec) && $kec == "all") ? "selected" : "") . ">Semua Kecamatan</option>";
                                    ...
                                    foreach ($aKecamatan as $row) {
                                        if ($kec == $row['CPC_TKC_ID']) {
                                            ...
                                            echo "<select class=\"form-control\" name='OP_KELURAHAN' id='OP_KELURAHAN' onchange='changeKelFilter(this);'>
                                                <option>Pilih</option>
												<option value=\"{$kecs}\" " . ((isset($kel) && $kel == $kecs) ? "selected" : "") . ">Semua Kelurahan</option>";
                                            foreach ($aKelurahan as $row2) {
                                                if ($row['CPC_TKC_ID'] == $row2['CPC_TKL_KCID']) {
                                                    $digit3 = substr($row2['CPC_TKL_ID'], 7, 3);
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-md-12">
                            ...
                            ON rpad(B.CPM_KELAS,3,' ')= rpad(A.CPM_KODE_ZNT,3,' ') ";
								...
								//if(strlen($kel) == 7){
								//    $sqlTampil .= "WHERE A.CPM_KODE_LOKASI LIKE '" .'%'. $kel .'%'. "'  ";
								//}else{
								//	if ($kel)
                                //        $sqlTampil .= "WHERE A.CPM_KODE_LOKASI = '" . $kel . "'  ";
								//}
								if($kec == 'all'){
                                        $sqlTampil .= "WHERE A.CPM_TAHUN = '" . $thn . "'  ";
								}else{
								    if ($kel)
										$sqlTampil .= "WHERE A.CPM_KODE_LOKASI LIKE '" .'%'. $kel .'%'. "'  ";
                                    if ($thn)
