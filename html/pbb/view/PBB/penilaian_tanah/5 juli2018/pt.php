...
//                });
        ...
        function prosesDel(a,a_link){
            var b=confirm("Anda akan menghapus kode ZNT "+a+" ?");
            if(b==false){
                return false;
            }else{
    ...
    <?php } ?>
        ...
        function excelKlasifikasiZNT(){
                ...
                window.open("function/PBB/penilaian_tanah/print-excel-klasifikasiznt.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m'}"); ?>&nkel="+namakel+"&nkec="+namakec+"&kel="+kelurahan+"&th="+thn+"&kota="+namakota);
        }
        ...
        function excelZNT(){
                ...
                var namakec = $("#kec option:selected").text();
                var namakel = $("#OP_KELURAHAN option:selected").text();
                window.open("function/PBB/penilaian_tanah/print-excel-znt.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m'}"); ?>&nkel="+namakel+"&nkec="+namakec+"&kel="+kelurahan+"&th="+thn+"&kota="+namakota);
        }
    </script>
...
<!--                        <th scope="col" width='120'>KODE KELURAHAN</th>-->
                    ...
                    $sqlTampil = "SELECT CPM_ID, CPM_KODE_ZNT, IFNULL(CPM_NIR2,CPM_NIR) AS CPM_NIR FROM (
...
<!--                            <td align='center'><?php echo $r['CPM_KODE_LOKASI']; ?></td>-->
                            ...
                            <td class="<?php echo $class; ?>" align='center'>
                                ...
                                <a href="#" onclick="prosesDel('<?php echo $r['CPM_KODE_ZNT']; ?>','main.php?param=<?php echo base64_encode("a=$a&m=$m&f=$f&btHapus=1&ID2=$r[CPM_ID]"); ?>')">Hapus</a>
                            </td>
                        </tr>
                        <?php
                        $n++;
