...
class taxClass {
	...
	private function createBody() {
		...
		$body .= "\t <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"820px\">\n";
		$body .= "\t\t <tr>\n";
		$body .= "\t\t\t <td colspan=\"3\"  style=\"background-color:transparent;\"><font color=\"#999999\"><b>Nama Wajib Pajak</font><b></td>\n";
		$body .= "\t\t\t <td width = \"40%\" colspan=\"3\"  style=\"background-color:transparent;\"><font color=\"#999999\"><b>Tanggal Jatuh Tempo<b></font></td>\n";
		$body .= "\t\t </tr>\n";
		$body .= "\t\t <tr>\n";
		$body .= "\t\t\t <td colspan=\"3\" width=\"20%\" style=\"background-color:transparent;\"><span id='wp-name' name='wp-name'>-</span></td>\n";
		$body .= "\t\t\t <td colspan=\"3\" width=\"20%\" style=\"background-color:transparent;\"><span id='wp-duedate' name='wp-duedate'>0000-00-00</span></td>\n";
		$body .= "\t\t </tr>\n";
		$body .= "\t\t <tr>\n";
		$body .= "\t\t\t <td colspan=\"3\" style=\"background-color:transparent;\"><font color=\"#999999\"><b>Alamat Wajib Pajak</font><b></td>\n";
		$body .= "\t\t\t <td colspan=\"3\" style=\"background-color:transparent;\"><font color=\"#999999\"><b>Tagihan</font><b></td>\n";
		$body .= "\t\t </tr>\n";
		$body .= "\t\t <tr>\n";
		...
		$body .= "\t\t\t <td colspan=\"3\" style=\"background-color:transparent;\"><span id='wp-amount' name='wp-amount'>Rp.</span></td>\n";
		$body .= "\t\t </tr>\n";
		$body .= "\t\t <tr>\n";
		...
		$body .= "\t\t\t <td colspan=\"3\" style=\"background-color:transparent;\"><font color=\"#999999\"><b>Biaya Denda</font><b></td>\n";
		$body .= "\t\t </tr>\n";
		$body .= "\t\t <tr>\n";
		$body .= "\t\t\t <td style=\"background-color:transparent;\">RT/RW</td>\n";
		$body .= "\t\t\t <td style=\"background-color:transparent;\">:</td>\n";
		$body .= "\t\t\t <td width = \"40%\" style=\"background-color:transparent;\"><span id='wp-rtRw' name='wp-rtRw'>-</span></td>\n";
		$body .= "\t\t\t <td colspan=\"3\" style=\"background-color:transparent;\"><span id='wp-penalty' name='wp-penalty'>Rp.</span></td>\n";
		$body .= "\t\t </tr>\n";
		$body .= "\t\t <tr>\n";
		...
		$body .= "\t\t\t <td colspan=\"3\" style=\"background-color:transparent;\"><font color=\"#999999\"><b>Biaya Admin</font><b></td>\n";
		$body .= "\t\t </tr>\n";
		$body .= "\t\t <tr>\n";
		...
		$body .= "\t\t\t <td colspan=\"3\" style=\"background-color:transparent;\"><span id='wp-admin' name='wp-admin'>Rp.</span></td>\n";
		$body .= "\t\t </tr>\n";
		$body .= "\t\t <tr>\n";
		...
		$body .= "\t\t\t <td colspan=\"3\" style=\"background-color:transparent;\"><font color=\"#999999\"><b>Total Tagihan</b></font></td>\n";
		$body .= "\t\t </tr>\n";
		$body .= "\t\t <tr>\n";
		$body .= "\t\t\t <td colspan=\"3\" style=\"background-color:transparent;\">&nbsp;</td>\n";
		$body .= "\t\t\t <td colspan=\"3\" style=\"background-color:transparent;\"><span id='wp-totalamount' name='wp-totalamount'>Rp.</span></td>\n";
		$body .= "\t\t </tr>\n";
		$body .= "\t </table>";
		$body .= "</div>";
		return $body;
	...
	private function createHeader() {
		...
		$header = "<script language='javascript' src='view/pbb/mod-pbb.js'></script>\n"; 
		...
		$optionyear .= "<option value='".(date("Y"))."'>".(date("Y"))."</option>\n";
		$optionyear .= "<option value='".(date("Y")-1)."'>".(date("Y")-1)."</option>\n";
		...
		$header .= "\t\t <table border=\"0\" cellpadding=\"4\" cellspacing=\"1\" width=\"820px\">\n";
		$header .= "\t\t\t <tr><td colspan=\"4\" style=\"background-color:transparent;\"><b>Pencarian</b></td><tr>\n";
		$header .= "\t\t\t <tr>\n";
		$header .= "\t\t\t\t <td width=\"10%\" style=\"background-color:transparent;\"><input type=\"radio\" name=\"radiogroup\" value=\"0\" id=\"radiogroup0\" checked /> NOP </td>\n";
		...
		$header .= "\t\t\t\t <td width=\"25%\" style=\"background-color:transparent;\">Tahun : <select name=\"year\" id=\"year\"> \n";
		$header .= "\t\t\t\t".$optionyear."\n";
		$header .= "\t\t\t\t\t </select>\n";
		$header .= "\t\t\t\t </td>\n";
...
if ($data) {
	...
	SCANPayment_Pref_GetAllWithFilter($appDbLink,$data->ppid.".PP.pbb.PC.print.%",$PPID_setting);
	
	$printername = $PPID_setting[$data->ppid.".PP.pbb.PC.print.printer"];
