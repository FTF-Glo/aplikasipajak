...
function getHTML ($op) {
    global $uname,$lastTagihan,$kepala,$nip, $jabatan,$kota,$bank, $SP, $listTahun,$thnArr,$appID, $month,$listTagihan,$listDenda,$tagihanPlusDenda,$listTahun;
                ...
                <tr>
					...
					<table width=\"100%\" border=\"0\">
                        <tr>
							...
							<td width=\"10\">:</td>
							<td width=\"350\">973/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/Dispenda-II/".$angkaRomawi[date("m")]."/".$tahun."</td><td width=\"25\"></td>
