...
{  // srch
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan_khusus_2016/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'9', 'n':'9', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$validator_sp_nm','nip':'$validator_sp_nip','jabatan':'$validator_sp_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"psp2\" class=\"notif\">Persetujuan SP</div></a></li>\n";
    echo "\t</ul>\n";
}
