<?php
    ...
    if(!empty($_POST['nop']) && !empty($_POST['thnpajak']) && !empty($_POST['keterangan'])  && !empty($_POST['sp'])){
        ...
        if($result){
            ...
            $sql = "UPDATE PBB_SPPT_PENAGIHAN_KHUSUS SET $field='".$_POST['keterangan']."' WHERE NOP='".$_POST['nop']."' AND SPPT_TAHUN_PAJAK='".$_POST['thnpajak']."'";
            $result = mysqli_query($DBLinkLookUp, $sql);
            if(!$result){
