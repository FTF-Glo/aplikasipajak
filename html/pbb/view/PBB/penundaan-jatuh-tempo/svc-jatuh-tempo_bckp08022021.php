...
<div id=\"main-content\" class=\"tab1\">
	...
	<table width=\"747\" border=\"0\" cellspacing=\"1\" cellpadding=\"8\">
		...
		<tr>
		  ...
		  <td width=\"60%\">
			<input type=\"text\" name=\"tahun-1\" id=\"tahun-1\" size=\"5\" onkeypress=\"return iniAngka(event, this)\"  maxlength=\"4\" value=\"".(($initData['CPM_SPPT_YEAR']!='')? $initData['CPM_SPPT_YEAR']:$appConfig['tahun_tagihan'])."\" placeholder=\"Tahun\" />
			s/d
			<input type=\"text\" name=\"tahun-2\" id=\"tahun-2\" size=\"5\" onkeypress=\"return iniAngka(event, this)\"  maxlength=\"4\" value=\"".(($initData['CPM_SPPT_YEAR']!='')? $initData['CPM_SPPT_YEAR']:$appConfig['tahun_tagihan'])."\" placeholder=\"Tahun\" />
		</td>
		</tr>
		<tr>
		...
		<tr>
		  <td width=\"\">File CSV</td>
		  <td width=\"\" colspan=\"4\"><input id=\"csv\" type=\"file\"><input type=\"hidden\" name=\"output\" id=\"out\"><br>
