...
function displayMenuPenerimaan()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'10'}") . "\">Tertunda</a></li>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'11'}") . "\">Dalam Proses</a></li>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'12'}") . "\">Ditolak</a></li>\n";
	echo "\t</ul>\n";
}
...
function displayMenuVerifikasi()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'20'}") . "\">Tertunda</a></li>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'11'}") . "\">Dalam Proses</a></li>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'22'}") . "\">Ditolak</a></li>\n";
	echo "\t</ul>\n";
}

function displayMenuRekomendasi()
{
	global $a, $m;

	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'40'}") . "\">Tertunda</a></li>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'11'}") . "\">Dalam Proses</a></li>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'42'}") . "\">Ditolak</a></li>\n";
	echo "\t</ul>\n";
}
...
function displayMenuPersetujuan()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'30'}") . "\">Tertunda</a></li>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'11'}") . "\">Dalam Proses</a></li>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'32'}") . "\">Ditolak</a></li>\n";
	echo "\t\t<li><a href=\"view/PBB/keberatan/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'33'}") . "\">Disetujui</a></li>\n";
	echo "\t</ul>\n";
}
	...
	<div align="center" id="setnomor" style="width: 400px; height: auto; margin: auto; margin-top: 200px; border: 1px solid #eaeaea; background-color: #fff; z-index: 10;">
		...
		<div style="margin: 10px;margin-left: 10px;">
			<table>
				...
				<tr>
					<td colspan="2">
						<div align="center"><button id="simpannomorsk">Simpan</button></div>
					</td>
				<tr>
					<input type="hidden" id="spop" name="spop" />
...
<div class="col-md-12">
	<div id="tabsContent">
		<?php
		if ($arConfig['usertype'] == "keberatan") {
			displayMenuPenerimaan();
		} else if ($arConfig['usertype'] == "verifikasi-keberatan") {
			displayMenuVerifikasi();
		} else if ($arConfig['usertype'] == "rekomendasi") {
			displayMenuRekomendasi();
