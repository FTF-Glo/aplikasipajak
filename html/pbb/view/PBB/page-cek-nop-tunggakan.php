...
function displayContent($selected)
{
	...
	echo "\t<table border=0 width=100% style=\"margin:10px;\"><tr><td>";

	echo "<input type=\"button\" style=\"height:30px;\" value=\"Proses Pengecekan Tunggakan\" name=\"btn-cek-tunggakan\"/ onClick=\"return actionPengecekanTunggakan();\">\n";
	echo "Masukan Kata Kunci Pencarian <input type=\"text\"  style=\"height:30px\" onKeydown=\"Javascript: if (event.keyCode==13) setTabs(" . $selected . "," . $selected . ");\" id=\"srch-" . $selected . "\" name=\"srch-" . $selected . "\" size=\"30\" placeholder=\"NOP/Nama\" value=\"" . $srch . "\"/> ";
	echo "&nbsp;&nbsp;Tahun <select  style=\"height:30px\" name=\"tahun-" . $selected . "\" id=\"tahun-" . $selected . "\">";
	...
	echo "</select> &nbsp;";
	echo "<input type=\"button\" onclick=\"setTabs(" . $selected . "," . $selected . ")\"  style=\"height:30px\" value=\"Cari\" id=\"btn-src-tunggakan\"/>";
	echo "\t</td><td align=\"right\">";
	echo "</td></tr></table>";
	echo "<table cellpadding=\"4\" cellspacing=\"1\" border=\"0\" width=\"100%\" class=\"table table-responsive\">\n";
	echo "\t<tr>\n";
