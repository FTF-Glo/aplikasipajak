...
function displayContent($selected)
{
    ...
    if ($selected == 50) {
        ...
        if ($m == $appConfig['id_mdl_susulan']) {
            echo "<div class=\"col-md-2\"><button class=\"btn btn-primary bg-maka\" type=\"button\" value=\"Proses Penetapan\" name=\"btn-penetapan\"/ onClick=\"return actionPenetapanSusulan('" . $PenilaianParam . "', '" . $appConfig['tahun_tagihan'] . "', '1','" . $uname . "');\">Proses Penetapan</button></div>\n";
            ...
            if (!$srch) {
                ...
                echo '<div class="col-md-2 text-right" style="padding-top: 7px; margin-left:30px;">Tanggal Penetapan</div>
                <div class="col-md-2">
            <input type="text" id="tgl_penetapan" class="form-control" readonly="true" name="tgl_penetapan" value="' . date('d-m-Y') . '" maxlength="10" size="12"></div>
            <div class="col-md-1" style="padding-top: 7px;">Tampilkan</div>
            <div class="col-md-1">
                <select id="tampilkan_data" class="form-control" style="width:100px" name="tampilkan_data" onchange="displayDat(\'' . $selected . '\', this)">
    ...
    } else if ($selected == 26) { //Tab Tertunda Modul Penetapan Mundur
        ...
        $datKel = $aKelurahan;
        echo "
                <link href=\"view/PBB/monitoring.css?v0001\" rel=\"stylesheet\" type=\"text/css\"/>";
        ...
        echo "<form name=\"form-penerimaan\" nilai='btn-save' id=\"form-penerimaan\" method=\"post\" action=\"\">
            <table width=\"747\" border=\"0\" cellspacing=\"1\" cellpadding=\"8\">
                ...
                <td width=\"60%\">
                    <select class='form-control' name=\"propinsiOP\" id=\"propinsiOP\" style=\"width:150px\">
                ...
                <td width=\"60%\">
                    <select class='form-control' name=\"kabupatenOP\" id=\"kabupatenOP\" style=\"width:200px\">$optionCityOP</select>
                </td>
                </tr>
                <tr>
                <td width=\"39%\"><label for=\"kecamatanOP\">Kecamatan</label></td>
                <td width=\"60%\">
                    <select class='form-control' name=\"kecamatanOP\" id=\"kecamatanOP\" style=\"width:220px\" onchange=\"showKel(this)\">
        ...
        echo "</select>
                  ...
                  <tr>
                    ...
                    <td width=\"60%\">
                    <div id=\"sKel26\">
                      <select class='form-control' name=\"kel\" id=\"kel\" style=\"width:100%\">
                  ...
                  <tr>
                    <td width=\"39%\">Blok</td>
                    <td width=\"60%\">
                        <input class='form-control text-center' type=\"text\" name=\"blok\" id=\"blok\" size=\"5\" onkeypress=\"return iniAngka(event, this)\"  maxlength=\"3\" style=\"width:60px\" placeholder=\"Blok\" />
                    </td>
                    </tr>
                    <tr>
                        <td width=\"39%\">No Urut</td>
                        <td width=\"60%\">
                            <input class='form-control text-center' type=\"text\" name=\"urut-1\" id=\"urut-1\" size=\"5\" onkeypress=\"return iniAngka(event, this)\"  maxlength=\"4\" style=\"width:80px\" placeholder=\"No Urut\" />
                  ...
                  <tr>
                    ...
                    <td width=\"60%\">
                        <div class=row>
                            <div class=\"col-md-3\">
                                <input class='form-control text-center' type=\"text\" name=\"tahun-penilaian-1\" id=\"tahun-penilaian-1\" size=\"5\" onkeypress=\"return iniAngka(event, this)\" maxlength=\"4\" value=\"" . ((isset($initData['CPM_SPPT_YEAR']) && $initData['CPM_SPPT_YEAR'] != '') ? $initData['CPM_SPPT_YEAR'] : ($appConfig['tahun_tagihan']-1)) . "\" placeholder=\"Tahun\" />
                            </div>
                            <div class=\"col-md-1\" style=\"text-align:center;padding:9px 0px 0px 0px\">s/d</div>
                            <div class=\"col-md-3\">
                                <input class='form-control text-center' type=\"text\" name=\"tahun-penilaian-2\" id=\"tahun-penilaian-2\" size=\"5\" onkeypress=\"return iniAngka(event, this)\" maxlength=\"4\" value=\"" . ((isset($initData['CPM_SPPT_YEAR']) && $initData['CPM_SPPT_YEAR'] != '') ? $initData['CPM_SPPT_YEAR'] : ($appConfig['tahun_tagihan']-1)) . "\" placeholder=\"Tahun\" />
                            </div>
                        </div>
                        <input type=\"hidden\" id=\"tgl_penetapan\" readonly=\"true\" name=\"tgl_penetapan\" value=\"" . date('d-m-Y') . "\" maxlength=\"10\" size=\"12\">
                     </td>
                  </tr>
        ...
        if ($isSusulan) {
            echo "<div class='text-right'><input type=\"button\" class=\"btn btn-primary bg-orange\" value=\"Proses Penilaian\" name=\"btn-penilaian-mundur\" onClick=\"penilaianMundur(1);\">\n";
            echo "<input type=\"button\" class=\"btn btn-primary bg-blue\" value=\"Proses Penetapan Mundur\" name=\"btn-penetapan-mundur\" id=\"btn-penetapan-mundur\" onClick=\"return actionPenetapanMundur('" . $PenilaianParam . "', '1','" . $uid . "');\"  disabled=\"disabled\" ></div>";
        } else {
            echo "<div class='text-right'><input type=\"button\" class=\"btn btn-primary bg-orange\" value=\"Proses Penilaian\" name=\"btn-penilaian-mundur\" onClick=\"penilaianMundur(0)\">\n";
            echo "<input type=\"button\" class=\"btn btn-primary bg-blue\" value=\"Proses Penetapan Mundur\" name=\"btn-penetapan-mundur\" id=\"btn-penetapan-mundur\" onClick=\"return actionPenetapanMundur('" . $PenilaianParam . "', '0','" . $uid . "');\"  disabled=\"disabled\" ></div>";
        }
        echo '<br><br><div id="monitoring-content-5" class="monitoring-content"></div></div>';
    } else if ($selected == 70) {
        echo '<script>enableGroupSelection("body .check-all")</script>';
        ...
        echo "<div style=\"display:inline-block\">
                <span>Tahun</span>
                    <select class=\"form-control\" name=\"tahun\" id=\"tahun\" style=\"width:150px;display:inherit\" onchange=\"setTabs(" . $selected . "," . $selected . ")\">";
                        $sql = "SELECT REPLACE(table_name,'cppmod_pbb_sppt_cetak_','') as `table` FROM information_schema.tables WHERE `table_schema`='sw_pbb' AND `table_name` LIKE 'cppmod_pbb_sppt_cetak%' ORDER BY 1 DESC";
                        $DBLink = mysqli_connect($appConfig['ADMIN_DBHOST'], $appConfig['ADMIN_DBUSER'], $appConfig['ADMIN_DBPWD'], $appConfig['ADMIN_SW_DBNAME'], ($appConfig['ADMIN_DBPORT'] ? $appConfig['ADMIN_DBPORT'] : '3306'));
                    ...
                    <div style="display:inline-block">
                        <span>Tampilkan</span>
                        <select id="tampilkan_data" class="form-control" style="width:150px;display:inherit" name="tampilkan_data" onchange="displayDat(\'' . $selected . '\',\'' . $selected . '\', this)">
                            <option value="25" ' . ((!isset($displayDat) || empty($displayDat) || $displayDat == 25) ? 'selected' : '') . '>25</option>
                            <option value="50" ' . ((isset($displayDat) && $displayDat == 50) ? 'selected' : '') . '>50</option>
                            <option value="100" ' . ((isset($displayDat) && $displayDat == 100) ? 'selected' : '') . '>100</option>
                            <option value="200" ' . ((isset($displayDat) && $displayDat == 200) ? 'selected' : '') . '>200</option>
                    ...
                    echo "<input type=\"radio\" name=\"tipeFilter\" id=\"single\" value=\"single\"> <label for=single>Filter Kelurahan</label>&nbsp;&nbsp;&nbsp;";
                    echo "<input type=\"radio\" name=\"tipeFilter\" id=\"multi\" value=\"multi\"> <label for=multi>Filter Multiple NOP</label><br>";
                    echo '</div></div>';
                    ...
                    echo "<div class=\"form-group\">
                            ...
                            <div class=\"col-md-2\">
                                <button type=\"button\" class=\"btn btn-primary btn-orange mb5\" style=\"margin-top: 25px;\" onclick=\"searchMultiNOP(" . $selected . "," . $selected . ")\" id=\"btn-src\">Cari</button>
                            </div></div>";
                    echo "</span>";
                    ...
                    <p style=\"display:flex; align-items:center;justify-content:end;\">
                            <button class=\"btn btn-primary\" style=\"border-radius:8px\" type=\"button\" data-toggle=\"collapse\" data-target=\"#collapsCetak-\" aria-expanded=\"false\" aria-controls=\"collapsCetak-\">
                            Cetak
                            </button>
                            <button class=\"btn btn-primary\" style=\"margin-left:10px; border-radius:8px\" type=\"button\" data-toggle=\"collapse\" data-target=\"#collapsFilter-$selected\" aria-expanded=\"false\" aria-controls=\"collapsFilter-$selected\">
                                Filter Data
                            </button>
                    </p>
                    ...
                    <div class=\"p-2\">
                            <div class=\"row\"> ";
                                ...
                                //     <button class=\"btn btn-primary\" type=\"button\" style=\"border-radius:8px\" data-toggle=\"collapse\" data-target=\"#collapsCetak-\" aria-expanded=\"false\" aria-controls=\"collapsCetak-\">
                                //         Cetak
                                //     </button>
                                // </div>
                                
                        echo"     <div class=\"col-12\"> 
                                    <div class=\"collapse\" id=\"collapsCetak-\">
                                        <div class=\"form-filtering\">
                                            <button class=\"btn btn-primary btn-orange\" type=\"button\" value=\"Pratinjau SPPT\" name=\"btn-print-preview\"/ onclick=\"javascript:printpreviewdata()\">Pratinjau SPPT</button>
                                            <button class=\"btn btn-primary btn-blue\" type=\"button\" value=\"Cetak PDF\" name=\"btn-print-pdf\"/ onclick=\"javascript:exportPDF(true)\">Cetak PDF</button>
                                            <button class=\"btn btn-primary bg-maka\" type=\"button\" value=\"Cetak PDF\" name=\"btn-print-pdf\"/ onclick=\"javascript:exportPDF(true, true)\">Cetak PDF Double</button>
                                            <button class=\"btn btn-primary btn-orange\" type=\"button\" value=\"Cetak\" name=\"btn-print\"/ onclick=\"javascript:newPrintData(this)\">Cetak</button>
                                            <button class=\"btn btn-primary btn-blue\" type=\"button\" value=\"Cetak\" name=\"btn-print\"/ onclick=\"javascript:newPrintData(this, true)\">Cetak Double</button>
                                            <button class=\"btn btn-primary bg-maka\" type=\"button\" value=\"STTS\" name=\"btn-print-stts\"/ onclick=\"javascript:printsttsdata()\">STTS</button>
                                            <button class=\"btn btn-primary btn-orange\" type=\"button\" value=\"DHKP\" name=\"btn-print-dhkp\"/ onclick=\"javascript:printDHKP()\">Cetak DHKP (beta)</button>
                                            <button class=\"btn btn-primary btn-blue\" type=\"button\" value=\"e-SPPT\" name=\"btn-print-preview-e-sppt\"/ onclick=\"javascript:printpreviewdataESPPT()\">E-SPPT</button>";
                                            echo "<div style=\"display:inline-block\"><span style=\"margin-left:10px;\">Printer</span>
                                            <select class=\"form-control\" name=\"selectedPrinterNew\" id=\"selectedPrinterNew\" style=\"margin-left:10px;width:150px;display:inherit\">";
        ...
        if ($isSusulan) {
            ...
            if ($kel != '') {
                ...
                echo "<div class=\"col-md-2\"><input type=\"button\" class=\"btn btn-primary bg-orange\" value=\"Proses Penilaian\" id=\"btn-penilaian\" name=\"btn-penilaian\"/ onClick=\"return actionPenilaian('" . $PenilaianParam . "', '" . $appConfig['tahun_tagihan'] . "', '2', '0');\"></div>\n";
            } else echo "<div class=\"col-md-2\"><input type=\"button\" class=\"btn btn-primary bg-orange\" value=\"Proses Penilaian\" id=\"btn-penilaian\" name=\"btn-penilaian\"/ onClick=\"return actionPenilaian('" . $PenilaianParam . "', '" . $appConfig['tahun_tagihan'] . "', '2', '0');\" disabled=\"disabled\"></div>\n";
        }
        ...
        echo "<button type='button' id=\"btn-cetak-prev\" class=\"btn btn-primary btn-orange mb5\" name=\"btn-cetak-prev\"/ onClick=\"return printSKPrev();\">Preview</button> ";
        echo "<button type='button' id=\"btn-cetak\" class=\"btn btn-primary btn-blue mb5\" name=\"btn-cetak\"/ onClick=\"return printSK();\">Cetak</button>";
        echo '</div></div>';
    } else if ($selected == 82) { //Fungsi Cetak SK
        echo '<div class="row"><div class="col-md-2">';
        echo "<button type='button' class=\"btn btn-primary btn-orange mb5\" id=\"btn-cetak-prev\" name=\"btn-cetak-prev\"/ onClick=\"return printSKPrevMasal();\">Preview</button> ";
        echo "<button type='button' class=\"btn btn-primary btn-blue mb5\" id=\"btn-cetak\" name=\"btn-cetak\"/ onClick=\"return printSKMasal();\">Cetak</button>";
        echo '</div></div>';
    } else if ($selected == 5) {
    ...
    if ($selected == 24 || $selected == 82) {
        if ($selected == 70) echo "<br><br>";
        echo '<div class="row" style="margin-top: 10px;margin-left:0px;"><div class="col-md-4">';
        echo "<input type=\"radio\" name=\"tipeFilter\" id=\"single\" value=\"single\"> <label for=single>Filter Kelurahan</label>&nbsp;&nbsp;&nbsp;";
        echo "<input type=\"radio\" name=\"tipeFilter\" id=\"multi\" value=\"multi\"> <label for=multi>Filter Multiple NOP</label><br>";
        echo '</div></div>';
        echo "<span id=\"multiFilter\">";
        echo '<div class="row"><div class="col-md-4">';
        echo "<div class=\"form-group\" style=\"margin-top: 10px;margin-left:15px;\">
				<label>Masukan NOP </label>
				<textarea class=\"form-control\" maxlength=\"1900\" rows=\"5\" id=\"daftarNOP\"></textarea>
                <br><font size=\"-4\">Gunakan koma (,) untuk pemisah</font>
                </div></div>
                <div class=\"col-md-2\">
                    <button type=\"button\"  style=\"margin-top: 38px;\" class=\"btn btn-primary btn-orange mb5\" style=\"margin-top: 25px;\" onclick=\"searchMultiNOP(" . $selected . "," . $selected . ")\" id=\"btn-src\">Cari</button>
                </div></div>";
        echo "</span>";
    }
    if ($selected == 26) {
    ...
    if ($selected != 26) {
        ...
        <div class=\"p-2\">
                <div class=\"row\"> 
                    <div class=\"col-12 pb-1\" style=\"display:flex; align-items:center;justify-content:end;\">  ";
                    if ($selected != 70) {
                    echo"    <button class=\"btn btn-primary\" type=\"button\" style=\"border-radius:8px; margin-right:30px\" data-toggle=\"collapse\" data-target=\"#collapsFilter-{$selected}\" aria-expanded=\"false\" aria-controls=\"collapsFilter-$selected\">
                            Filter Data
                        </button>";
                    }
                  echo"  </div>
                            ...
                            <div class=\"form-filtering-penetapan\">
                                <div class=\"row \">
                                    ...
                                    <div class=\"form-group col-md-3\" >
                                        ...
                                        <button type=\"button\" class=\"btn btn-primary mb5\" style=\"margin-top: 4px\" onclick=\"setTabs(" . $selected . "," . $selected . ")\" id=\"btn-src\">Cari</button>
                                    </div>
        ...
        //add by d3Di - add button generate
        if($selected == 70){
            echo '<div class="col-md-12 mb5">
                    <button class="btn btn-success" type="button" title="Klik tombol ini untuk data yang belum&#10;ada QRIS-nya&#10;&#10;Data yang status-nya SUDAH BAYAR tidak&#10;bisa generate QRIS" name="btn-gen-qris" onclick="javascript:generateAll()">Generate QRIS</button>&nbsp;&nbsp;
                    <button class="btn btn-info bg-maka" type="button" name="btn-replace-qris" title="Klik tombol ini untuk mengulang generate&#10;QRIS yang sudah ada&#10;&#10;Perubahan data dan TAGIHAN di QRIS&#10;mengikuti data sekarang setelah di re-generate.&#10;berikan SPPT cetakan yang terbaru untuk&#10;wajib pajak" onclick="javascript:repGenerate()">Re-Generate QRIS</button>
                </div>';
        }

        echo "<div class=\"col-md-12\"><div class=\"table-responsive\"><table class=\"table table-bordered table-striped\" data-selected=$selected>";
        echo "<thead><tr>";
    }
    if ($selected == 10 || ($selected == 24) || /*($selected == 80 && $isSusulan)*/ $selected == 80 || $selected == 81 || $selected == 70) {
        echo "<td width=10 class=\"tdheader\"><input name=\"all-check-button\" id=\"all-check-button\" type=\"checkbox\"/></td>";
    } else if ($selected == 50 && $isSusulan) {
        echo "<td width=10 class=\"tdheader\"><input name=\"all-check-button\" id=\"all-check-button-tab-ditetapkan\" type=\"checkbox\"/></td>";
    } else if ($selected == 82) {
        echo "<td width=10 class=\"tdheader\"><input name=\"all-check-button\" id=\"all-check-button-masal\" type=\"checkbox\"/></td>";
    } else if ($selected == 5) {
        echo "<td width=10 class=\"tdheader\"><input name=\"all-check-button\" id=\"all-check-button-tertunda\" type=\"checkbox\"/></td>";
    } else if ($selected == 26) {
        echo "";
    } else {
        echo "<td width=10 class=\"tdheader\">&nbsp;</td>";
    }
...
function createHeader($selected)
{
    ...
    //variable header set
    $hBasic =
        "<td class=tdheader width=30>NOP</td>
    ...
    $hService =
        ...
        <td class=tdheader width=30>NOP Induk</td>
        <td class=tdheader>Nama WP</td>
        <td class=tdheader>Alamat Wajib Pajak</td>
        <td class=tdheader>Alamat Objek Pajak</td>
        <td class=tdheader>Kecamatan - Desa OP</td>
    ...
    switch ($selected) {
        ...
        case 50:
            ...
            break;
        case 60:
            $header .= "<td class=tdheader width=30>NJKP</td>";
            $header .= "<td class=tdheader>Kecamatan - Desa OP</td>";
            break;
        case 70:
            $header .= "<td class=tdheader width=30>NJKP</td>";
            $header .= "<td class=tdheader>Kecamatan - Desa OP</td>";
            $header .= "<td class=tdheader width=30>Tahun Pajak</td>";
            break;
        case 80:
        case 81:
            $header .= "<td class=tdheader>Kecamatan - Desa OP</td>";
    ...
    if ($aData != null && !empty($aData) && count($aData) > 0)
        foreach ($aData as $data) {
            ...
            if ($selected == 10 || $selected == 42) {
                $HTML .= "<td width=9 class=$class align=center><input name=\"check-all[]\" class=\"check-all\" type=checkbox value=\"" . (isset($data['CPM_TRAN_ID']) ? $data['CPM_TRAN_ID'] : '') . "\" /></td>";
            } else if (($selected == 60 && $data['FLAG'] == 2) || $selected == 70) {
                $HTML .= "<td width=9 class=$class align=center><input name=\"check-all[]\" class=\"check-all\" type=checkbox value=\"" . $data['NOP'] . "\" /></td>";
            } else if ($selected == 24) {
                $HTML .= "<td width=9 class=$class align=center><input name=\"check-all[]\" class=\"check-all\" type=checkbox value=\"" . $data['CPM_NOP'] . "\" /></td>";
            } else if ((($selected == 80) /*&& $isSusulan*/) || ($selected == 81)) {
                $HTML .= "<td width=9 class=$class align=center><input name=\"check-all[]\" class=\"check-all\" type=checkbox value=\"" . $data['CPM_NOP'] . "\" /></td>";
            } else if (($selected == 82)) {
                $HTML .= "<td width=9 class=$class align=center><input name=\"check-all-masal[]\" class=\"check-all-masal\" type=checkbox value=\"" . $data['CPM_NOP'] . "\" /></td>";
            } else if ($selected == 50 && $isSusulan) {
                $HTML .= "<td width=9 class=$class align=center><input name=\"check-all[]\" class=\"check-all\" type=checkbox value=\"" . $data['CPM_NOP'] . "\" /></td>";
            } else if ($selected == 5) {
                $HTML .= "<td width=9 class=$class align=center><input name=\"check-all-tertunda[]\" class=\"check-all-tertunda\" type=checkbox value=\"" . $data['CPM_ID'] . "\" /></td>";
            } else if ($selected == 26) {
                $HTML .= "";
            } else {
...
function getData($selected)
{
    ...
    if ($selected == 5) {
        ...
        $filter['CPM_TYPE'][] = 2;
        $filter['CPM_TYPE'][] = 12;
        $additionalWhereQuery = " AND op.CPM_NEW_SID IS NULL";
        ...
        if ($selected == 60) {
            $data = $dbGwCurrent->get($filter, $srch, $jumlah, $displayDat, $page);
        } else if ($selected == 70) {
            if ($daftarNOP) {
                $filter['NOP'] = trim($daftarNOP);
            }
            $data = $dbGwCurrent->get70s($filter, $srch, $qBuku, $jumlah, $displayDat, $page, $tahun, $appConfig);
        }
        ...
        // VALID OP ONLY
        $filter["VALID_DAFNOM"] = 4;
        $filter['CPM_SPPT_THN_PENETAPAN !'] = $appConfig['tahun_tagihan'];
        if ($daftarNOP) $filter['CPM_NOP'] = trim($daftarNOP);
        if ($kel) $filter['CPM_OP_KELURAHAN'] = $kel;

        $data = $dbFinalSppt->get_where_new($filter, $srch, $jumlah, $displayDat, $page, null, ($isSusulan ? 'cppmod_pbb_sppt_susulan' : 'cppmod_pbb_sppt_final'));
...
{
    // if($data['NOP']!='') { print_r(json_encode($data));exit; }
    // var_dump($selected);
    ...
    /// Added By d3Di   - check table pbb_sppt_QRIS
    // if($selected==70){
    //     // cek table qris
    //     $datenow = date('Y-m-d H:i:s');
    //     $DBLink = mysqli_connect($appConfig['ADMIN_DBHOST'], $appConfig['ADMIN_DBUSER'], $appConfig['ADMIN_DBPWD'], $appConfig['ADMIN_GW_DBNAME'], ($appConfig['ADMIN_DBPORT'] ? $appConfig['ADMIN_DBPORT'] : '3306'));
    //     $nopcek = $data['NOP'];
    //     $yearcek = $data['SPPT_TAHUN_PAJAK'];
    //     $queryw = "SELECT id FROM pbb_sppt_qris WHERE tax_object ='$nopcek' AND `year`='$yearcek' AND expired_date_time>='$datenow'";
    //     $rescari = mysqli_query($DBLink, $queryw);
    ...
    //                     SPPT_TANGGAL_JATUH_TEMPO AS exp 
    //                 FROM pbb_sppt 
    //                 WHERE 
    //                     NOP ='$nopcek' AND 
    //                     SPPT_TAHUN_PAJAK='$yearcek' AND 
    //                     LEFT(SPPT_TANGGAL_JATUH_TEMPO,10)>='$datenow' 
    //                 LIMIT 0,1";
    //     $rescari = mysqli_query($DBLink, $queryw);
    //     $cek = mysqli_num_rows($rescari);
    //     if($cek>0){
    //         $r = mysqli_fetch_array($rescari);
    //         $flagis = ($r['flag']=='0' || $r['flag']==null) ? 0 : 1;
    //         $bayar = ($r['bayar'] <= 0) ? 0:$r['bayar'];
    //         $dateexp = $r['exp'];
    //     }

    //     if($adaqris && $flagis==0){
    //         $imgQRIS = '<img id="idico'.$nopcek.'" src="./image/icon/qr.png" width="20px" height="20px">';
    //     }elseif($adaqris){
    //         $imgQRIS = '.';
    //     }else{
    ...
    //         if(($bayar>0 && $bayar<=10000000 && $flagis==0 && $dateexp>=$datenow)){
    //             $sha1 = sha1('#PBB#LAMPUNG#SELATAN#'.$nopcek.'#'.date('Ymd').'#');
    //             $parPOST = "'$nopcek','$sha1',$yearcek,'$exprdx'";
    //             $imgQRIS = '<div id="divico'.$nopcek.'"><a href="javascript:;" onclick="getQRCode('.$parPOST.')"><img id="idico'.$nopcek.'" src="./image/icon/qr_disable.png" width="20px" height="20px"></a>';
    //         }else{
    //             $imgQRIS = '';
    //         }
    //     }
    ...
    if ($selected != 60 && $selected != 70) {
		...
		*/
        ...
        /*$dBasic = '<td><a href="main.php?param=' . base64_encode($params) . '">' . isset($data['CPM_NOP']) ? $data['CPM_NOP'] : '' . '</a> </td>
        <td> ' . $data['CPM_WP_NAMA'] . '</td>
        <td> ' . $data['CPM_WP_ALAMAT'] . '</td>
        <td> ' . $data['CPM_OP_ALAMAT'] . ' ' . $data['CPM_OP_NOMOR'] . ' </td>';*/

        $dBasic =
            "<td><a href=\"main.php?param=" . base64_encode($params) . "\">" . (isset($data['CPM_NOP']) ? $data['CPM_NOP'] : '') . " </a></td>
            <td>" . (isset($data['CPM_WP_NAMA']) ? $data['CPM_WP_NAMA'] : '') . " </td>
            <td>" . (isset($data['CPM_WP_ALAMAT']) ? $data['CPM_WP_ALAMAT'] : '') . " </td>
            <td>" . (isset($data['CPM_OP_ALAMAT']) ? $data['CPM_OP_ALAMAT'] : '') . " " . (isset($data['CPM_OP_NOMOR']) ? $data['CPM_OP_NOMOR'] : '') . " </td>";

        $dTolak =
            "<td> " . (isset($data['CPM_TRAN_STATUS']) && isset($status[$data['CPM_TRAN_STATUS']]) ? $status[$data['CPM_TRAN_STATUS']] : '') . " </td>
        <td> " . ((isset($data['CPM_TRAN_INFO']) && strlen($data['CPM_TRAN_INFO']) > 25) ? "<label class=\"tipclass\" title=\"" . (isset($data['CPM_TRAN_INFO']) ? $data['CPM_TRAN_INFO'] : '') . "\">" . (isset($data['CPM_TRAN_INFO']) ? substr($data['CPM_TRAN_INFO'], 0, 25) : '') . "...</label>" : (isset($data['CPM_TRAN_INFO']) ? $data['CPM_TRAN_INFO'] : '')) . " </td>";

        $dVerifikasi =
            "<td> " . (isset($data['CPM_TRAN_STATUS']) && isset($status[$data['CPM_TRAN_STATUS']]) ? $status[$data['CPM_TRAN_STATUS']] : '') . " </td>";

        $dAdv =
            "<td> " . (isset($data['CPM_OP_KECAMATAN']) ? kecShow($data['CPM_OP_KECAMATAN']) : '') . " -  " . (isset($data['CPM_OP_KELURAHAN']) ? kelShow($data['CPM_OP_KELURAHAN']) : '') . " </td>
            <td> " . (isset($data['CPM_OPR_NIP']) ? $data['CPM_OPR_NIP'] : '') . " </td>";

        // $dAdv =
        "<td> " . kecShow($data['CPM_OP_KECAMATAN']) . "-" . kelShow($data['CPM_OP_KELURAHAN']) . " </td>
        <td> " . isset($data['CPM_OPR_NIP']) ? $data['CPM_OPR_NIP'] : '' . " </td>";
        ...
        $dService =
            "<td align=\"center\"><a href='main.php?param=" . base64_encode($params) . "'>" . (isset($data['CPM_ID']) ? $data['CPM_ID'] : '') . "</a></td>
            <td>" . (isset($data['CPM_OP_NUMBER']) ? $data['CPM_OP_NUMBER'] : '') . "</td>
            <td>" . (isset($data['CPM_WP_NAME']) ? $data['CPM_WP_NAME'] : '') . "</td>
			<td>" . (isset($data['CPM_WP_ADDRESS']) ? $data['CPM_WP_ADDRESS'] : '') . "</td>
            <td>" . (isset($data['CPM_OP_ADDRESS']) ? $data['CPM_OP_ADDRESS'] : '') . "</td>
            <td>" . (isset($data['CPC_TKC_KECAMATAN']) && isset($data['CPC_TKL_KELURAHAN']) ? $data['CPC_TKC_KECAMATAN'] . " - " . $data['CPC_TKL_KELURAHAN'] : '') . "</td>
            <td align=\"center\">" . (isset($data['CPM_TYPE']) && isset($statusService[$data['CPM_TYPE']]) ? $statusService[$data['CPM_TYPE']] : '') . "</td>
            ";
    ...
    switch ($selected) {
        ...
        case 60:
            ...
            $parse = "";
            $parse .= "<td>" . $data['NOP'] . "</td>";
            $parse .= "<td>" . $data['WP_NAMA'] . "</td>";
            $parse .= "<td>" . $data['WP_ALAMAT'] . "</td>";
            $parse .= "<td>" . $data['OP_ALAMAT'] . "</td>";
            $parse .= "<td>" . number_format($data['OP_NJKP'], 0, ',', '.') . "</td>";
            $parse .= "<td>" . $data['OP_KECAMATAN'] . " - " . $data['OP_KELURAHAN'] . "</td>";
            // $parse .= "<td>$sStatus </td>";
            break;
        case 70:
            $data['QRIS'] = isset($data['QRIS']) ? $data['QRIS'] : 'dev';
            $parse = "";
            $parse .= "<td>" . $data['QRIS'] . "</td>";
            $parse .= "<td>" . $data['NOP'] . "</td>";
            $parse .= "<td>" . $data['WP_NAMA'] . "</td>";
            $parse .= "<td>" . $data['WP_ALAMAT'] . "</td>";
            $parse .= "<td>" . $data['OP_ALAMAT'] . "</td>";
            $parse .= "<td align=\"right\">" . number_format($data['OP_NJKP'], 0, ',', '.') . "</td>";
            $parse .= "<td>" . $data['OP_KECAMATAN'] . " - " . $data['OP_KELURAHAN'] . "</td>";
            $parse .= "<td>" . $data['SPPT_TAHUN_PAJAK'] . "</td>";
            break;
        case 80:
        case 81:
            $parse = "";
            $parse .= "<td>" . $data['CPM_NOP'] . "</td>";
            $parse .= "<td>" . $data['CPM_WP_NAMA'] . "</td>";
            $parse .= "<td>" . $data['CPM_WP_ALAMAT'] . " </td>";
            $parse .= "<td>" . $data['CPM_OP_ALAMAT'] . " </td>";
            $parse .= "<td>" . kecShow($data['CPM_OP_KECAMATAN']) . "-" . kelShow($data['CPM_OP_KELURAHAN']) . " </td>";
            $parse .= "<td align=\"right\">" . number_format($data['CPM_NJOP_TANAH'] + $data['CPM_NJOP_BANGUNAN'], 0, ',', '.') . " </td>";
            break;
        case 82:
            $parse = "";
            $parse .= "<td>" . $data['CPM_NOP'] . "</td>";
...
$displayDat     = @isset($_REQUEST['displayDat']) ? substr($_REQUEST['displayDat'], 0, 7) : 25;
...
$dbFinalSppt = new DbFinalSppt($dbSpec, $appConfig);
    ...
    function showKel2(val) {
        ...
        <?php foreach ($aKecamatan as $row) { ?>
            if (val == "<?php echo $row['CPC_TKC_ID']; ?>") {
                document.getElementById('sKel' + s).innerHTML = "<?php echo "<select name='kel' class='form-control kel{$s}' id='kel' onchange='filKel(" . $s . ",this);'><option value=''>" . $appConfig['LABEL_KELURAHAN'] . "</option>";
