...
$kolektif  = @isset($_REQUEST['kolektif']) ? $_REQUEST['kolektif'] : "";
...
{\"field\":\"kode_kolektif\", \"length\" : \"200px\", \"title\" : \"Kode Bayar Kolektif\", \"align\":\"center\"}
]}";
...
if (stillInSession($DBLink, $json, $sdata)) {
    ...
    if ($status == '1') {
        ...
        LEFT JOIN CDCCORE_BANK D ON A.PAYMENT_BANK_CODE = D.CDC_B_ID  ");
        $monPBB->setWhere("A.COLL_PAYMENT_CODE IS NOT NULL AND A.payment_flag = '1' AND B.CPM_CG_STATUS = '2' AND " . $where);
        $monPBB->query("SELECT
        A.nop,
        A.wp_nama,
        A.wp_alamat,
