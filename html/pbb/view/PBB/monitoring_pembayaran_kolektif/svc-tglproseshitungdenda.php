...
$query = "SELECT TANGGAL_HITUNG_DENDA FROM PBB_DENDA ORDER BY TANGGAL_HITUNG_DENDA DESC LIMIT 0,1";
...
while ($row = mysqli_fetch_assoc($res)) {
    //print_r($row);        
    $tgl = ($row["TANGGAL_HITUNG_DENDA"] != "") ? $row["TANGGAL_HITUNG_DENDA"] : '-';
}
mysqli_close($myDBLink);
echo $tgl;
