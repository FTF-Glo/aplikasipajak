...
{
	global $isSusulan, $kec, $jumhal, $srch, $aKecamatan, $a, $appConfig, $buku, $tahun, $kel;
	...
	if ($selected == 10) {
		...
		<input type=\"text\" class=\"form-control\" name=\"pengurangan-val\" id=\"pengurangan-val\" placeholder=\"Pengurangan\">
		</div>
		<div class=\"col-md-1\">
			<input type=\"submit\" class=\"btn btn-primary bg-maka\" style=\"border-radius: 0; margin-top: 7px;\" value=\"Finalkan\" name=\"btn-finalize\" onclick=\"return confirm('Anda yakin akan melakukan pengurangan stimulus?')\">
		</div>
	...
	echo "</div><div class=\"row\" style=\"margin-bottom: 20px\"><div class=\"col-md-2\">Masukan Kata Kunci Pencarian</div>
	<div class=\"col-md-2\">
		<input type=\"text\" class=\"form-control\" onKeydown=\"Javascript: if (event.keyCode==13) setTabs(" . $selected . "," . $selected . ");\" id=\"srch-" . $selected . "\" name=\"srch-" . $selected . "\" placeholder=\"Nomor/Nama/NOP\" size=\"60\" value=\"" . $srch . "\"/>
	</div>
	<div class=\"col-md-1\">
	...
	echo "</div>
	<div class=\"col-md-1\" style=\"margin-top: 10px; text-align: right;\">Filter</div>
	<div class=\"col-md-2\">
