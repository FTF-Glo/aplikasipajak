<?php
$sRootPath = str_replace('\\', '/', str_replace(DIRECTORY_SEPARATOR . 'view' . DIRECTORY_SEPARATOR . 'PBB' . DIRECTORY_SEPARATOR . 'dbkb', '', dirname(__FILE__))) . '/';
...
class DBKBJPB2
{
			...
			$HTML .= "
				...
				<div class=\"table-responsive\" style=\"margin-top: 20px\">
					<table class=\"table table-bordered\" id=\"tableAdd\">
						...
						<tr>
							<td><input name=\"kelas[]\" maxlength=\"1\" class=\"form-control\" type=\"text\" id=\"kelas[]\" value=\"" . (isset($val[0]) && $val[0] != "" ? $val[0] : "") . "\" " . (!empty($modeInput) ? "" : "readonly") . "></td>
							<td><input name=\"nilaiBawah[]\" type=\"text\" class=\"form-control\" id=\"nilaiBawah[0]\" value=\"" . (isset($val[1]) && $val[1] != "" ? $val[1] : "") . "\" maxlength=\"9\" onkeypress=\"return iniAngka(event)\" " . (!empty($modeInput) ? "" : "readonly") . " /></td>
							<td><input name=\"nilaiAtas[]\" type=\"text\" class=\"form-control\" id=\"nilaiAtas[0]\" value=\"" . (isset($val[2]) && $val[2] != "" ? $val[2] : "") . "\" maxlength=\"9\" onkeypress=\"return iniAngka(event)\" " . (!empty($modeInput) ? "" : "readonly") . " /></td>
							<td><input name=\"nilai[]\" type=\"text\" class=\"form-control\" id=\"nilai[0]\" value=\"" . (isset($val[4]) && $val[4] != "" ? $val[4] : "") . "\" maxlength=\"9\" onkeypress=\"return iniAngka(event)\"/></td>
						</tr>
						<tr>
							<td colspan=\"3\">&nbsp;</td>
							<td><div align=\"right\">
	...
	public function displayDataDBKB()
	{
		...
		// print_r($_REQUEST);
		echo "<div class=\"col-md-12\" style=\"margin-top: 15px\">"; //622px
		echo $this->view();
