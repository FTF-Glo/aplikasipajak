...
function getData(){
	global $DBLink,$page,$perpage,$srcNOP,$srcAlamat,$srcNama;
	...
	$query 	= "SELECT * FROM
				(SELECT CPM_SPPT_DOC_ID,CPM_SPPT_DOC_VERSION,CPM_NOP,CPM_WP_NAMA,CPM_OP_ALAMAT, CPM_OP_KELURAHAN, CPM_OP_KECAMATAN  FROM cppmod_pbb_sppt
				UNION
				SELECT CPM_SPPT_DOC_ID,CPM_SPPT_DOC_VERSION,CPM_NOP,CPM_WP_NAMA,CPM_OP_ALAMAT, CPM_OP_KELURAHAN, CPM_OP_KECAMATAN  FROM cppmod_pbb_sppt_final
				UNION
				SELECT CPM_SPPT_DOC_ID,CPM_SPPT_DOC_VERSION,CPM_NOP,CPM_WP_NAMA,CPM_OP_ALAMAT, CPM_OP_KELURAHAN, CPM_OP_KECAMATAN  FROM cppmod_pbb_sppt_susulan
				) AS TBL_NOP $whr LIMIT $hal,$perpage";
	...
	$qCount   = "SELECT COUNT(*) AS TOTALROWS FROM
				(SELECT CPM_NOP, CPM_OP_ALAMAT, CPM_OP_KELURAHAN, CPM_OP_KECAMATAN  FROM cppmod_pbb_sppt
				UNION
				SELECT CPM_NOP, CPM_OP_ALAMAT, CPM_OP_KELURAHAN, CPM_OP_KECAMATAN  FROM cppmod_pbb_sppt_final
				UNION
				SELECT CPM_NOP, CPM_OP_ALAMAT, CPM_OP_KELURAHAN, CPM_OP_KECAMATAN  FROM cppmod_pbb_sppt_susulan
				) AS TBL_NOP";
...
function headerContentWP() {
    ...
    $HTML .= "\t<tr>\n";
    $HTML .= "\t\t<td class=\"tdheader\" width=\"210\"> NOP </td> \n";
	$HTML .= "\t\t<td class=\"tdheader\" width=\"210\"> Nama WP </td> \n";
    $HTML .= "\t\t<td class=\"tdheader\"> Alamat </td> \n";
    $HTML .= "\t\t<td class=\"tdheader\"> Kecamatan </td> \n";
    $HTML .= "\t\t<td class=\"tdheader\"> ".$appConfig['LABEL_KELURAHAN']." </td> \n";
    $HTML .= "\t\t<td class=\"tdheader\"> List Tagihan </td> \n";
    $HTML .= "\t</tr>\n";
