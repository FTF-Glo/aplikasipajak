...
{  // srch
    ...
    echo "\t\t<li><a href=\"view/PBB/nop/svc-list-nop.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 'tab':'3', 'n':'4', 'u':'$data->uname'}") . "\">Register</a></li>\n";
    echo "\t</ul>\n";
}
...
<script type="text/javascript">
    ...
    function setTabs(sel) {
        ...
        var kecamatan = $("#kecamatannop" + sel).val();
        var desa = $("#desanop" + sel).val();
        var tahun = (sel==0) ? '' : $("#tahunpajaknop" + sel).val();
        var srcAlamat = $("#srcAlamat-" + sel).val();
        var srcNama = $("#srcNama-" + sel).val();
        var srcNOP1 = $("#srcNOP-" + sel + "-1").val();
        var srcNOP2 = $("#srcNOP-" + sel + "-2").val();
        var srcNOP3 = $("#srcNOP-" + sel + "-3").val();
        var srcNOP4 = $("#srcNOP-" + sel + "-4").val();
        var srcNOP5 = $("#srcNOP-" + sel + "-5").val();
        var srcNOP6 = $("#srcNOP-" + sel + "-6").val();
        var srcNOP7 = $("#srcNOP-" + sel + "-7").val();

        var param = {};
        param.selectby = selectzwxby;
        param.kec = kecamatan;
        param.desa = desa;
        param.tahun = tahun;
        param.srcAlamat = srcAlamat;
        param.srcNama = srcNama;
        param.srcNOP1 = srcNOP1;
        param.srcNOP2 = srcNOP2;
        param.srcNOP3 = srcNOP3;
        param.srcNOP4 = srcNOP4;
        param.srcNOP5 = srcNOP5;
        param.srcNOP6 = srcNOP6;
        param.srcNOP7 = srcNOP7;
