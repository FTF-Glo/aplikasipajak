                    ...
                    <form id="TheForm-1" method="post" action="view/PBB/monitoring/svc-export.php?q=' . base64_encode("{'a':'$a', 'm':'$m', 's':'23','uid':'$uid'}") . '" target="TheWindow">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5" style="padding-right:0">
                                                            <select name="tahun-pajak-1-awal" class="form-control" id="tahun-pajak-1-awal">';
                                                                for ($t = $thn; $t >= 1994; $t--) {
                                                        ...
                                                        <div class="col-md-5" style="padding-left:0">
                                                            <select name="tahun-pajak-1-akhir" class="form-control" id="tahun-pajak-1-akhir">';
                                                            for ($t = $thn; $t >= 1994; $t--) {
                                                                $selected = ($t == $thnTagihan) ? ' selected' : '';
                                                                echo '<option value="'.$t.'"'.$selected.'>'.$t.'</option>';
                                                            }
						...
						<div class="row">
                            <div class="col-md-12" style="text-align:right">
                                <button type="button" name="button2" style="margin-bottom: 5px;" class="btn btn-primary btn-orange" onClick="onSubmit(1)">Tampilkan</button>
                                <button type="button" name="buttonToExcel" class="btn btn-primary btn-blue" onClick="toExcel(1)" style="margin-bottom: 5px">Ekspor ke xls</button>
                                <span id="loadlink1" style="font-size: 10px; display: none;">Loading...</span>
                            </div>
						</div>
                    </form>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5" style="padding-right:0">
                                            <select name="tahun-pajak-2-awal" class="form-control" id="tahun-pajak-2-awal">';
                                                for ($t = $thn; $t >= 1994; $t--) {
                                                    $selected = ($t == $thnTagihan) ? ' selected' : '';
                                                    echo '<option value="'.$t.'"'.$selected.'>'.$t.'</option>';
                                                }
                                        ...
                                        <div class="col-md-2" style="padding:7px 0 0 0;text-align:center">s/d</div>
                                        <div class="col-md-5" style="padding-left:0">
                                            <select name="tahun-pajak-2-akhir" class="form-control" id="tahun-pajak-2-akhir">';
                                            for ($t = $thn; $t >= 2018; $t--) {
                                                $selected = ($t == $thnTagihan) ? ' selected' : '';
                                                echo '<option value="'.$t.'"'.$selected.'>'.$t.'</option>';
                                            }
