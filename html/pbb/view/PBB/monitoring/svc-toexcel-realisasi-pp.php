...
{
	global $myDBLink, $kd, $thn, $bulan, $appConfig, $qBuku;
...
$row = 7;
$summary = array('SUM_T_PEDESAAN' => 0, 'SUM_T_PERKOTAAN' => 0, 'GRAND_TOTAL_T' => 0, 'SUM_R_PEDESAAN' => 0, 'SUM_R_PERKOTAAN' => 0, 'GRAND_TOTAL_R' => 0, 'GRAND_TOTAL_PERCENT' => 0);
for ($i = 0; $i < $sumRows; $i++) {
