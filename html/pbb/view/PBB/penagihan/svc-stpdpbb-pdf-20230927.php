...
function getHTML($op)
{
    ...
    $html = "<table width=\"700\" border=\"1\" cellpadding=\"2\">
                <tr>
                    ...
                    <td align=\"center\">
                        <br/><b>S T P D</b><br/>
                        (SURAT TAGIHAN PAJAK DAERAH)<br/><br/>
                    ...
                    <td colspan=\"3\">
                        <table width=\"100%\" >
                            <tr>
                                <td width=\"30%\"></td>
                                <td width=\"30%\"></td>
                                <td width=\"40%\" align=\"left\">$kota,<br/>
...
$pdf->Image($sRootPath . 'image/' . $fileLogo, 29, 10, 17, '', '', '', '', false, 300, '', false);
