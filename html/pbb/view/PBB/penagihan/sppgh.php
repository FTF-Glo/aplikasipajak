...
//require_once($sRootPath."view/PBB/penagihan/svc-count-notif.php");
...
{  // srch
    ...
    $clrSP3 = "#ff0000";
    $clrAll = "#ff0000";
    if (!isset($countSP1['TOTALROWS']) || $countSP1['TOTALROWS'] == 0) {
        $clrSP1 = "";
    }
    if (!isset($countSP2['TOTALROWS']) || $countSP2['TOTALROWS'] == 0) {
        $clrSP2 = "";
    }
    if (!isset($countSP3['TOTALROWS']) || $countSP3['TOTALROWS'] == 0) {
        $clrSP3 = "";
    }
    if ((!isset($countSP1['TOTALROWS']) && !isset($countSP2['TOTALROWS']) && !isset($countSP3['TOTALROWS'])) || ($countSP1['TOTALROWS'] + $countSP2['TOTALROWS'] + $countSP3['TOTALROWS']) == 0) {
        $clrAll = "";
    }

    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'1', 'n':'1', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$kabid_nama','nip':'$kabid_nip','jabatan':'$kabid_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"sp1\" class=notif>Beri SP1<font color=\"" . $clrSP1 . "\"> </font></div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'2', 'n':'2', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$kabid_nama','nip':'$kabid_nip','jabatan':'$kabid_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"sp2\" class=notif>Beri SP2<font color=\"" . $clrSP2 . "\"> </font></div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'3', 'n':'3', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$kabid_nama','nip':'$kabid_nip','jabatan':'$kabid_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"sp3\" class=notif>Beri SP3<font color=\"" . $clrSP3 . "\"> </font></div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'4', 'n':'4', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$kabid_nama','nip':'$kabid_nip','jabatan':'$kabid_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"all\" class=notif>ALL SP<font color=\"" . $clrAll . "\"> </font></div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'5', 'n':'5', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$kadis_nama','nip':'$kadis_nip','jabatan':'$kadis_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"stpd\" class=notif>STPD</div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'6', 'n':'6', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$kadis_nama','nip':'$kadis_nip','jabatan':'$kadis_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"psp1\" class=notif>Proses SP1</div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'7', 'n':'7', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$kadis_nama','nip':'$kadis_nip','jabatan':'$kadis_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"psp2\" class=notif>Proses SP2</div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'8', 'n':'8', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$kadis_nama','nip':'$kadis_nip','jabatan':'$kadis_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"psp2\" class=notif>Proses SP3</div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan/svc-list-penagihan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'10', 'n':'10', 'u':'$data->uid', 'adm':'$isAdminPenagihan', 'dbhost':'$dbhost', 'dbuser':'$dbuser', 'dbpwd':'$dbpwd', 'dbname':'$dbname', 'kepala':'$kabid_nama','nip':'$kabid_nip','jabatan':'$kabid_jabatan','kota':'$kota','sp1':'$sp1','sp2':'$sp2','sp3':'$sp3', 'perpage':'$perpage', 'kodekota':'$kodekota', 'lblkel':'$lblkel', 'thn':'$tahun_tagihan'}") . "\"><div id=\"panggilan\" class=notif>Panggilan<font color=\"" . $clrSP1 . "\"> </font></div></a></li>\n";
    echo "\t\t<li><a href=\"view/PBB/penagihan/svc-himbauan.php?q=\" class=\"notif\">Himbauan</div></a></li>\n";
    echo "\t</ul>\n";
}
...
<link href="view/PBB/spop.css?v.0.0.3" rel="stylesheet" type="text/css" />
...
<script type="text/javascript">
    ...
    function setTabs(sts, clearStatus) {
        ...
        if (sts == 8) sel = 7;
        if (!clearStatus) {
            find = $("#src-approved-" + sts).val() + "&" + $("#src-tagihan-" + sts).val() + "&" + $("#src-kecamatan-" + sts).val() + "&" + $("#src-kelurahan-" + sts).val() + "&" + $("#src-tahun-" + sts).val() + "&" + $("#src-nop-" + sts + "-1").val() + "&" + $("#src-nop-" + sts + "-2").val() + "&" + $("#src-nop-" + sts + "-3").val() + "&" + $("#src-nop-" + sts + "-4").val() + "&" + $("#src-nop-" + sts + "-5").val() + "&" + $("#src-nop-" + sts + "-6").val() + "&" + $("#src-nop-" + sts + "-7").val();
        }
    ...
    // function setPage (sts,np) {
    // var tahun = $("#src-tahun-"+sts).val();
    // var nop = $("#src-nop-"+sts).val();
    // var kec = $("#src-kecamatan-"+sts).val();
    // var kel = $("#src-kelurahan-"+sts).val();
    // var nm = $("#src-approved-"+sts).val();
    ...
    // var find = $("#src-approved-"+sts).val()+"&"+$("#src-tagihan-"+sts).val()+"&"+$("#src-kecamatan-"+sts).val()+"&"+$("#src-kelurahan-"+sts).val()+"&"+$("#src-tahun-"+sts).val()+"&"+$("#src-nop-"+sts).val();
    // $( "#tabsContent" ).tabs( "option", "ajaxOptions", { async: false, data: { find: find,page:page,np:np} } );
    // $( "#tabsContent" ).tabs( "option", "selected", sel );
    // $( "#tabsContent" ).tabs('load', sel);
    ...
    function refreshNotif() {
        ...
        $.ajax({
            type: "POST",
            url: "./view/PBB/penagihan/svc-count-notif-jv.php",
