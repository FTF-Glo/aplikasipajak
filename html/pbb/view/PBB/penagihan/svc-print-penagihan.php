...
require_once($sRootPath . "inc/central/user-central.php"); //print_r($sRootPath);exit;
...
function getTunggakan($nop)
{
    ...
    $qry = "SELECT SPPT_PBB_HARUS_DIBAYAR, SPPT_TAHUN_PAJAK, SPPT_TANGGAL_JATUH_TEMPO FROM gw_pbb.pbb_sppt WHERE NOP = '" . $nop . "' AND NOW() > SPPT_TANGGAL_JATUH_TEMPO AND (PAYMENT_FLAG != '1' OR PAYMENT_FLAG IS NULL) ORDER BY SPPT_TAHUN_PAJAK ASC";
    // echo $qry; exit;   
    $res = mysqli_query($DBLink, $qry);
    if ($res === false) {
        echo $qry . "<br>";
...
function getHTML($op)
{
    global $SP, $listTahun, $thnArr, $appID, $month, $listTagihan, $listDenda, $tagihanPlusDenda;
    ...
    $bank           = getConfigValue($appID, 'TEMPAT_PEMBAYARAN');

    // echo end($listTagihan);
                ...
                <tr>
					...
					<table width=\"100%\" border=\"0\">
                        <tr>
							...
							<td width=\"10\">:</td>
							<td width=\"350\">900/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/BPPRD-II/" . $angkaRomawi[date("m")] . "/" . $tahun . "</td>
							<td width=\"250\">Kalianda, " . $tanggalSurat . "</td>
						</tr>
						<tr>
                            <td>Sifat</td>
							<td>:</td>
						...
						<tr>
                            <td></td><td></td><td></td><td>Lampung Selatan</td>
						</tr>
					</table>		
					<br/>
					<br/>
                    ...
                    <br/><br/>
                    Diminta untuk segera melunasi kewajiban membayar PBB diatas guna menghindari penerapan sanksi lebih lanjut sesuai dengan peraturan perundang-undangan yang berlaku, karenanya akan dikenakan denda sebesar 2 % perbulan sejak tanggal Jatuh tempo.
                    <br/>
                    <br/>
                            ...
                            <tr>
                                <td width=\"57%\">
                                    <table border=\"1\" width=\"100%\" cellpadding=\"5\">
                                        <tr>
                                            <td align=\"center\">PAJAK HARUS DILUNASI DALAM WAKTU 7 (TUJUH) HARI
                                            <br>SETELAH TANGGAL SURAT TEGURAN INI DITERIMA, UNTUK
                                            <br>MENGHINDARI SANKSI SESUAI DENGAN KETENTUAN
                                            <br>PERUNDANG-UNDANGAN YANG BERLAKU
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td width=\"2%\">&nbsp;</td>
                                <td width=\"41%\" align=\"center\">Kepala Badan Pengelolaan Pajak Dan Retibusi
                                    <br/>
...
{
    global $DBLink, $DBLink, $denda, $totalBulanPajak, $tipeKalkulasiPajak;
    $data = array();
