	...
	<div class="table-responsive">
		...
		$no=0;
				...
				<tr>
					...
					<td><?=$dataTampil['LAST_ACCESS']?></td>
					<td align="center"><?=$dataTampil['IP']?></td>
					<td align="center">
					<a href="main.php?param=<?=base64_encode("a=$a&m=$m&f=$f&dataId=".$dataTampil['id']."&nameUser=".addslashes($dataTampil['userId'])."&pwdUser=".$dataTampil['password']."&email=".$dataTampil['email'])?>"><img src="./image/icon/accept.png" alt="AKTIFKAN" title="AKTIFKAN"></img></a></td>
				</tr>
				<?php 
				}
		}
