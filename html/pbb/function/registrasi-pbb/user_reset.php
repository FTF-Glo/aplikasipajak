...
if ($data) {
	...
	if(isset($simpan))
	{
		...
		$keterangan="aktif";
		$sqlSimpan="UPDATE tbl_reg_user_pbb SET password='$pwd' where userId='$userId'";
	...
	if(isset($_REQUEST["dataId"])){
		$sqlCari="SELECT * FROM tbl_reg_user_pbb WHERE id='".$_REQUEST["dataId"]."' AND areapajak='$IdKK' ORDER BY id";
		//var_dump($sqlCari);
