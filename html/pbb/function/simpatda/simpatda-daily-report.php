...
$printercopy=$PPID_setting[$data->ppid.".PP.simpatda.PC.print.copy"];
if(!$printercopy) 
	$printercopy=0;
else
...
echo "<SCRIPT LANGUAGE='JavaScript' src='function/simpatda/simpatda-reprint.js'></SCRIPT> \n";
...
echo "</table>\n";
echo "<div id='simpatda-report-result'></div>";
