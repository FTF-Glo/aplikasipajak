...
$printercopy=isset($PPID_setting[$data->ppid.".PP.voucher.PC.print.copy"])?intval($PPID_setting[$data->ppid.".PP.voucher.PC.print.copy"]):1;
if(!$printercopy) 
	$printercopy=0;
else
...
// echo "<div style='font-size:18pt;'>Voucher Pulsa Seluler</div>\n<div style='font-size:14pt;'>Laporan Harian/Bulanan</div> \n";
...
echo "<span id='input_harian'><input readonly type='text' id='filtertgl'  name='filtertgl' value='".$filtertgl."' datepicker='true' datepicker_format='YYYY-MM-DD'><a href='#'><img src='image/icon/textfield_delete.png' width='24' height='24' alt='Kosongkan' onclick='document.getElementById(\"filtertgl\").value=\"\"'></a>";
echo "</span>\n";
...
echo "<tr>\n<td class='transparent'>Jenis Laporan</td>\n<td class='transparent'><select name='jenis-laporan' id='jenis-laporan' onchange='HandlerFilterjenisChange()'>";
//echo "<option value='0'>Harian</option><option value='1'>Bulanan</option></select></td>\n<td class='transparent'><input name='btnSend' type='button' value='Submit' onclick='sendReport();'></td>\n";
// echo "<option value='0'>Harian</option></select></td>\n<td class='transparent'><input name='btnSend' type='button' value='Submit' onclick='sendReport();'><input type=\"button\" id=\"btnUnduh\" value=\"Unduh Detail\" onclick=\"downloadFile();\"><iframe id=\"download-file\" src=\"_blank\" style=\"width:0;height:0;display:block\"></iframe></td>\n";
echo "<option value='0'>Harian</option>\n";
if (!isset($arAppConfig["MONTHLY_REPORT"]) || $arAppConfig["MONTHLY_REPORT"] != "disabled") {
	echo "<option value='1'>Bulanan</option>\n";
}
echo "</select></td>\n<td class='transparent'><input name='btnSend' type='button' value='Submit' onclick='sendReport();'><input type=\"button\" id=\"btnUnduh\" value=\"Unduh Detail\" onclick=\"downloadFile();\"><iframe id=\"download-file\" src=\"_blank\" style=\"width:0;height:0;display:block\"></iframe></td>\n";
echo "</tr>\n";
