...
//		$query="SELECT CONCAT(SUBSTRING(NOP,11,3),'.',SUBSTRING(NOP,14,4),'-',SUBSTRING(NOP,18,1)) AS NOP, LEFT(WP_NAMA, 35) AS WP_NAMA, LEFT(OP_ALAMAT, 35) AS OP_ALAMAT, OP_RT, OP_RW, LEFT(WP_ALAMAT, 35) AS WP_ALAMAT, SPPT_PBB_HARUS_DIBAYAR, OP_KECAMATAN_KODE, OP_KELURAHAN_KODE, OP_KECAMATAN, OP_KELURAHAN, '' AS TGL_BAYAR, SPPT_TANGGAL_TERBIT FROM cppmod_pbb_sppt_current ";
		$query="SELECT A.NOP, LEFT(A.WP_NAMA, 20) AS WP_NAMA, LEFT(A.OP_ALAMAT, 22) AS OP_ALAMAT, A.OP_RT, A.OP_RW, LEFT(A.WP_ALAMAT, 22) AS WP_ALAMAT, A.SPPT_PBB_HARUS_DIBAYAR, A.OP_LUAS_BUMI, A.OP_LUAS_BANGUNAN, 
                    A.OP_KECAMATAN_KODE, A.OP_KELURAHAN_KODE, A.OP_KECAMATAN, A.OP_KELURAHAN, '' AS TGL_BAYAR, A.SPPT_TANGGAL_TERBIT, B.CPM_NOP_INDUK AS NOP_INDUK, A.OP_KELAS_BUMI AS KELAS_BUMI from cppmod_pbb_sppt_current A
