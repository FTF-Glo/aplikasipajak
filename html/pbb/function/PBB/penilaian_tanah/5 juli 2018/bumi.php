...
//        if(v<10){ v="00"+v; }else if(v<100){ v="0"+v; }
        ...
        row.insertCell(1).innerHTML="<input name='tahunawal[]' type='text' id='tahunawal["+id+"]' maxlength='9' onkeypress='return iniAngka(event)'/>";
        row.insertCell(2).innerHTML="<input name='tahunakhir[]' type='text' id='tahunakhir["+id+"]' maxlength='9' onkeypress='return iniAngka(event)'/>";
        row.insertCell(3).innerHTML="<input name='nilaiBawah[]' type='text' id='nilaiBawah["+id+"]' maxlength='9' onkeyup=hNJOP(this.id,'nilaiBawah')  onkeypress='return iniAngka(event)'/>";
        row.insertCell(4).innerHTML="<input name='nilaiAtas[]' type='text' id='nilaiAtas["+id+"]' maxlength='9' onkeyup=hNJOP(this.id,'nilaiAtas') onkeypress='return iniAngka(event)'/>";
        row.insertCell(5).innerHTML="<input name='njop[]' type='text' id='njop["+id+"]' maxlength='9' onkeypress='return iniAngka(event)' />";
        n++;
        y++;
        id++;
    }
    ...
    if (empty($_REQUEST['tambahData']) and empty($_REQUEST['editData'])) {
        ...
        <form id="form1" name="form1" method="post" action="main.php?param=<?php echo base64_encode("a=$a&m=$m&f=$f"); ?>">
            ...
            <table border="0" cellspacing="1" cellpadding="4">
				<tbody>
                <tr>
                    <th class="tdheader"><input onclick="Check()" type="button" value="Pilih Semua" id="tombolCheck" /></th>
        ...
        <form id="form2" name="form2" method="post" action="main.php?param=<?php echo base64_encode("a=$a&m=$m&f=$f"); ?>">
            ...
            <table width="500" border="0" cellpadding="3" cellspacing="0" id="tableAdd">
                <tr>
...
//                    }
                    ?>
                    <tr>
                        <td><input name="kelas[]" type="text" id="kelas[]" value=""></td>
                        <td><input name="tahunawal[]" type="text" id="tahunawal[<?php echo $i; ?>]" maxlength="9" onkeypress="return iniAngka(event)" /></td>
                        <td><input name="tahunakhir[]" type="text" id="tahunakhir[<?php echo $i; ?>]" maxlength="9" onkeypress="return iniAngka(event)"/></td>
                        <td><input name="nilaiBawah[]" type="text" id="nilaiBawah[<?php echo $i; ?>]" onkeyup="hNJOP(this.id,'nilaiBawah')" maxlength="9" onkeypress="return iniAngka(event)" /></td>
                        <td><input name="nilaiAtas[]" type="text" id="nilaiAtas[<?php echo $i; ?>]" onkeyup="hNJOP(this.id,'nilaiAtas')" maxlength="9" onkeypress="return iniAngka(event)"/></td>
                        <td><input name="njop[]" type="text" id="njop[<?php echo $i; ?>]" maxlength="9" onkeypress="return iniAngka(event)" /></td>
                    </tr>
    <?php } ?>
                <tr>
                    <td colspan="5">&nbsp;</td>
