...
<font size="4"><b>Klik Copy Data untuk melakukan copy Master Data Penilaian Tanah</b></font> <br><br>
...
function copyMaster(tahun) {
	// global $area;
        var params = "{\"TAHUN\":\""+tahun+"\",'area': <?php echo "'$area'" ?>}";
        params = Base64.encode(params);
        Ext.Ajax.request({
                url : 'inc/PBB/svc-copy-master-data-tanah.php',
