...
function formPenerimaan($initData,$initDataRed) {   
  ...
  $optionKelWP = '';
	...
	<input type=\"hidden\" name=\"attachment\" id=\"attachment\" value=\"\"/>
                      <table class=\"table table-sm table-borderless\" border=\"0\" cellspacing=\"1\" cellpadding=\"10\">
                            <tr>
                            ...
                            <tr>
                              <td align=\"center\"><table width=\"auto\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
                                    <tr>
                                      ...
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" type=\"text\" name=\"nomor\" id=\"nomor\" readonly=\"readonly\"  size=\"50\" maxlength=\"50\" value=\"".(($initData['CPM_ID']!='')? $initData['CPM_ID']:$nomor)."\" placeholder=\"Nomor\" />
                                      </td>
									  <td width=\"30\">&nbsp</td>
									...
									<tr>
                                      ...
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" name=\"nmKuasa\" id=\"nmKuasa\"  size=\"50\" maxlength=\"50\" value=\"".(($initData['CPM_REPRESENTATIVE']!='')? str_replace($bSlash,$ktip,$initData['CPM_REPRESENTATIVE']):'')."\" placeholder=\"Nama Kuasa\" />
                                      </td>
									  <td width=\"30\">&nbsp</td>
									  <td width=\"auto\"></td>
                                      <td width=\"auto\">
									...
									<tr>
                                      ...
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" name=\"nmWp\" readonly=\"readonly\" id=\"nmWp\"  size=\"50\" maxlength=\"50\" value=\"".(($initData['CPM_WP_NAME']!='')? str_replace($bSlash,$ktip,$initData['CPM_WP_NAME']):'')."\" placeholder=\"Nama Wajib Pajak\" />
                                      </td>
									  <td width=\"30\">&nbsp</td>
                                      ...
                                      <td width=\"auto\">
										...
										<textarea class=\"form-control\" rows=\"2\" cols=\"40\" readonly=\"readonly\" name=\"almtOP\" id=\"almtOP\" placeholder=\"Alamat\">".(($initData['CPM_OP_ADDRESS']!='')? str_replace($bSlash,$ktip,$initData['CPM_OP_ADDRESS']):'')."</textarea>
                                      </td>
                                    </tr>
									<tr>
                                      <td width=\"auto\"><label for=\"tglMasuk\">Tanggal Surat Masuk</label></td>
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" name=\"tglMasuk\" id=\"tglMasuk\"  value=\"".(($initData['CPM_DATE_RECEIVE']!='')? $initData['CPM_DATE_RECEIVE']:$today)."\" size=\"10\" maxlength=\"10\" placeholder=\"Tgl Masuk\"/>                                      
                                      </td>
                                <td width=\"30\">&nbsp</td>
                                <td width=\"auto\"><label for=\"rtOP\">RT/RW</label></td>
                                      <td width=\"auto\">
                                        <div style=\"display: flex\">
                                          <input style=\"width: 60px\" class=\"form-control\" type=\"text\" name=\"rtOP\" readonly=\"readonly\" id=\"rtOP\"  size=\"3\" maxlength=\"3\" value=\"".(($initData['CPM_OP_RT']!='')? $initData['CPM_OP_RT']:'')."\" placeholder=\"00\"/>
                                          <span style=\"margin: 10px 10px 0 10px\">/</span>
                                          <input style=\"width: 60px\" class=\"form-control\" type=\"text\" name=\"rwOP\" readonly=\"readonly\" id=\"rwOP\"  size=\"3\" maxlength=\"3\" value=\"".(($initData['CPM_OP_RW']!='')? $initData['CPM_OP_RW']:'')."\" placeholder=\"00\"/>
                                        </div>
									...
									<tr>
                                      ...
                                      <td width=\"auto\">
                                            <textarea class=\"form-control\" rows=\"2\" cols=\"40\" name=\"almtWP\" id=\"almtWP\" readonly=\"readonly\" placeholder=\"Alamat\">".(($initData['CPM_WP_ADDRESS']!='')? str_replace($bSlash,$ktip,$initData['CPM_WP_ADDRESS']):'')."</textarea>
                                        </td>
                                        <td width=\"30\">&nbsp</td>
                                        <td width=\"auto\"><label for=\"provinsiOP\">Provinsi</label></td>
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"hidden\" name=\"propinsiOP\" value=\"".$appConfig['KODE_PROVINSI']."\">
                                        <input class=\"form-control\" type=\"text\" name=\"propinsiOPname\" readonly=\"readonly\"  size=\"25\" value=\"".$appConfig['NAMA_PROVINSI']."\">
                                      </td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td width=\"auto\">
                                        <div style=\"display: flex\">
                                        <input style=\"width: 60px\" class=\"form-control\" type=\"text\" name=\"rtWP\" readonly=\"readonly\" id=\"rtWP\"  size=\"3\" maxlength=\"3\" value=\"".(($initData['CPM_WP_RT']!='')? $initData['CPM_WP_RT']:'')."\" placeholder=\"00\"/>
                                        <span style=\"margin: 10px 10px 0 10px\">/</span>
                                        <input style=\"width: 60px\" class=\"form-control\" type=\"text\" name=\"rwWP\" readonly=\"readonly\" id=\"rwWP\"  size=\"3\" maxlength=\"3\" value=\"".(($initData['CPM_WP_RW']!='')? $initData['CPM_WP_RW']:'')."\" placeholder=\"00\"/>
                                        </div>
                                      </td>
									  <td width=\"30\">&nbsp</td>
                                      ...
                                      <td width=\"auto\">
                                        ...
                                        <input class=\"form-control\" type=\"text\" name=\"kabupatenOPname\" readonly=\"readonly\" size=\"25\" value=\"".$appConfig['NAMA_KOTA']."\">
                                      </td>
                                    </tr>
                                    <tr>
                                      <td width=\"auto\"><label for=\"propinsi\">Provinsi</label></td>
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" name=\"propinsi\" id=\"propinsi\"  readonly=\"readonly\" size=\"25\" value=\"".(($initData['CPM_WP_PROVINCE']!='')? $initData['CPM_WP_PROVINCE']:'')."\" placeholder=\"Provinsi\"/>
                                      </td>
									  <td width=\"30\">&nbsp</td>
									  <td width=\"auto\"><label for=\"kecamatanOP\">Kecamatan</label></td>
                                      <td width=\"auto\">
                                        <input type=\"hidden\" name=\"kecamatanOP\" value=\"".$initData['CPM_OP_KECAMATAN']."\">
                                        <input class=\"form-control\" type=\"text\" name=\"kecamatanOPname\" readonly=\"readonly\" size=\"25\" value=\"".$kecOP[0]['name']."\">
                                      </td>
                                    </tr>
                                    <tr>
                                      <td width=\"auto\"><label for=\"kabupaten\">Kabupaten/Kota</label></td>
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" name=\"kabupaten\" readonly=\"readonly\" id=\"kabupaten\"  size=\"25\" value=\"".(($initData['CPM_WP_KABUPATEN']!='')? $initData['CPM_WP_KABUPATEN']:'')."\" placeholder=\"Kabupaten\"/>
                                      </td>
                                        <td width=\"30\">&nbsp</td>
                                      ...
                                      <td width=\"auto\">
                                        ...
                                        <input class=\"form-control\" type=\"text\" name=\"kelurahanOPname\" readonly=\"readonly\" size=\"25\" value=\"".$kelOP[0]['name']."\">
                                      </td>
                                    </tr>
                                    <tr>
                                      <td width=\"auto\"><label for=\"kecamatan\">Kecamatan</label></td>
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" name=\"kecamatan\" id=\"kecamatan\"  readonly=\"readonly\" size=\"25\" value=\"".(($initData['CPM_WP_KECAMATAN']!='')? $initData['CPM_WP_KECAMATAN']:'')."\" placeholder=\"Kecamatan\"/>
                                      </td>
                                        <td width=\"30\">&nbsp</td>
                                        <td width=\"auto\"><label for=\"PBBterutang\">PBB yang terutang</label></td>
                                      <td width=\"auto\">
                                            <input class=\"form-control\" type=\"text\" name=\"PBBterutang\" id=\"PBBterutang\" readonly=\"readonly\" size=\"25\" maxlength=\"50\" value=\"".(($initData['CPM_SPPT_DUE']!='')? $initData['CPM_SPPT_DUE']:'')."\" placeholder=\"PBB yang terutang\" />
                                      </td>
                                    </tr>
                                    <tr>
                                      <td width=\"auto\"><label for=\"kelurahan\">".$appConfig['LABEL_KELURAHAN']."</label></td>
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" name=\"kelurahan\" id=\"kelurahan\"  readonly=\"readonly\" size=\"25\" value=\"".(($initData['CPM_WP_KELURAHAN']!='')? $initData['CPM_WP_KELURAHAN']:'')."\" placeholder=\"".$appConfig['LABEL_KELURAHAN']."\"/>
                                      </td>
									  <td width=\"30\">&nbsp</td>
									  <td width=\"auto\"><label for=\"tglSPPT\">Tahun Pajak</label></td>
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" name=\"thnPajak\" id=\"thnPajak\" readonly=\"readonly\"  size=\"10\" maxlength=\"10\" value=\"".(($initData['CPM_SPPT_YEAR']!='')? $initData['CPM_SPPT_YEAR']:'')."\" placeholder=\"Tahun Pajak\"/>                                      
                                      </td>
                                    </tr>
                                    <tr>
                                      <td width=\"auto\">No. HP WP</td>
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" name=\"hpWP\" id=\"hpWP\"  size=\"15\" maxlength=\"15\" value=\"".(($initData['CPM_WP_HANDPHONE']!='')? $initData['CPM_WP_HANDPHONE']:'')."\" placeholder=\"Nomor HP\" />
                                      </td>
									  <td width=\"30\">&nbsp</td>
									  <td width=\"auto\"><label for=\"tglSPPT\">Pengurangan PBB sebesar</label></td>
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" name=\"persenPengurangan\" id=\"persenPengurangan\"  size=\"10\" maxlength=\"3\" value=\"".(($initDataRed['CPM_RE_PERCENT']!='')? $initDataRed['CPM_RE_PERCENT']:'')."\"/>   
									...
									<tr>
                                      ...
                                      <td width=\"auto\">
                                        <input class=\"form-control\" type=\"text\" name=\"nop\" id=\"nop\" readonly=\"readonly\" size=\"50\" maxlength=\"50\" value=\"".(($initData['CPM_OP_NUMBER']!='')? $initData['CPM_OP_NUMBER']:'')."\" placeholder=\"NOP\" />
                                      </td>
									    <td width=\"30\">&nbsp</td>
                                      <td width=\"auto\" colspan=\"2\" rowspan=\"2\">
									Alasan mengajukan permohonan <br><br> 
										<div style=\"display: flex\"><label for=\"alasan1\">*</label><input class=\"form-control\" type=\"text\" name=\"alasan1\" id=\"alasan1\"  size=\"80\" maxlength=\"500\" value=\"".$pisAlasan[0]."\" placeholder=\"Alasan 1\" /><br><br></div>
										<div style=\"display: flex\"><label for=\"alasan2\">*</label><input class=\"form-control\" type=\"text\" name=\"alasan2\" id=\"alasan2\"  size=\"80\" maxlength=\"500\" value=\"".$pisAlasan[1]."\"placeholder=\"Alasan 2\" /><br><br></div>
										<div style=\"display: flex\"><label for=\"alasan3\">*</label><input class=\"form-control\" type=\"text\" name=\"alasan3\" id=\"alasan3\"  size=\"80\" maxlength=\"500\" value=\"".$pisAlasan[2]."\"placeholder=\"Alasan 3\" /><br><br></div>
										<div style=\"display: flex\"><label for=\"alasan4\">*</label><input class=\"form-control\" type=\"text\" name=\"alasan4\" id=\"alasan4\"  size=\"80\" maxlength=\"500\" value=\"".$pisAlasan[3]."\"placeholder=\"Alasan 4\" /></div>
                                      </td>
                                    </tr>
                                    <tr>
									...
									<tr>
										<td colspan=\"2\">
											Besar penghasilan perbulan <input class=\"form-control\" type=\"text\" name=\"bsrPenghasilan\" id=\"bsrPenghasilan\"  size=\"15\" maxlength=\"15\" value=\"".(($initDataRed['CPM_RE_INCOME']!='')? $initDataRed['CPM_RE_INCOME']:'')."\"/><br><br>
											Besar penghasilan diatas diperoleh dari: <br><br>
											<div style=\"display: flex\"><label for=\"sbrPenghasilan1\">*</label><input class=\"form-control\" type=\"text\" name=\"sbrPenghasilan1\" id=\"sbrPenghasilan1\"  size=\"80\" maxlength=\"500\" value=\"".$pisSbrPenghasilan[0]."\" placeholder=\"Sumber Penghasilan 1\" /><br><br></div>
											<div style=\"display: flex\"><label for=\"sbrPenghasilan2\">*</label><input class=\"form-control\" type=\"text\" name=\"sbrPenghasilan2\" id=\"sbrPenghasilan2\"  size=\"80\" maxlength=\"500\" value=\"".$pisSbrPenghasilan[1]."\" placeholder=\"Sumber Penghasilan 2\" /><br><br></div>
											<div style=\"display: flex\"><label for=\"sbrPenghasilan3\">*</label><input class=\"form-control\" type=\"text\" name=\"sbrPenghasilan3\" id=\"sbrPenghasilan3\"  size=\"80\" maxlength=\"500\" value=\"".$pisSbrPenghasilan[2]."\" placeholder=\"Sumber Penghasilan 3\" /><br><br></div>
											<div style=\"display: flex\"><label for=\"sbrPenghasilan4\">*</label><input class=\"form-control\" type=\"text\" name=\"sbrPenghasilan4\" id=\"sbrPenghasilan4\"  size=\"80\" maxlength=\"500\" value=\"".$pisSbrPenghasilan[3]."\" placeholder=\"Sumber Penghasilan 4\" /><br><br></div>
											<div style=\"display: flex\"><label for=\"sbrPenghasilan5\">*</label><input class=\"form-control\" type=\"text\" name=\"sbrPenghasilan5\" id=\"sbrPenghasilan5\"  size=\"80\" maxlength=\"500\" value=\"".$pisSbrPenghasilan[4]."\" placeholder=\"Sumber Penghasilan 5\" /></div>
										</td>
									</tr>
                              </table></td>
                            </tr>";
			...
			$persenApp = "<tr align=\"center\">
								...
								<form name=\"form\" id =\"form\" method=\"post\">
										<table border=0 cellpadding=5>
											...
											<input class=\"btn btn-primary bg-maka\" type=\"button\" name = \"btn-cancel\" id = \"btn-cancel\" value=\"Batal\" onclick='window.location.href=\"main.php?param=".base64_encode("a=".$a."&m=".$m."")."\"' /></td></tr>
										</table>
									</form>
								</td>
                            </tr>";
                  $simpan = "<tr>
                              <td colspan=\"2\" align=\"center\" valign=\"middle\">
                                  <input class=\"btn btn-primary bg-maka\" type=\"submit\" name=\"btn-save\" id=\"btn-save\" value=\"Simpan\" />
                                  &nbsp;
                                  <input class=\"btn btn-primary bg-maka\" type=\"submit\" name=\"btn-save\" id=\"btn-save\" value=\"Finalkan\" />
                                  &nbsp;
								  <input class=\"btn btn-primary bg-maka\" type=\"button\" name = \"btn-cancel\" id = \"btn-cancel\" value=\"Batal\" onclick='window.location.href=\"main.php?param=".base64_encode("a=".$a."&m=".$m."")."\"' />
                              </td>
                            </tr>";
					 $end = "<tr>
...
function insertToSPPTPengurangan($nomorHidden,$nopHidden,$persenTerVerifikasi){
  ...
  $tgl = date('Y-m-d H:i:s');
	$qry = "REPLACE INTO cppmod_pbb_sppt_pengurangan (CPM_PNG_NOP, CPM_PNG_TAHUN, CPM_PNG_NILAI, CPM_PNG_PERSEN, CPM_CREATE_AT) 
          VALUES (SELECT 
                  CPM_OP_NUMBER,
                  CPM_SPPT_YEAR,
                  ((CPM_SPPT_DUE/100)*$persenTerVerifikasi) AS NILAI,
                  '$persenTerVerifikasi' AS PERCENT,
                  '$tgl' AS TANGGAL
                FROM cppmod_pbb_services 
                WHERE CPM_ID = '{$nomorHidden}')";
	//echo $qry."<br>";exit;
	$res = mysqli_query($DBLink, $qry);
	if ($res === false){
		echo "Terjadi kesalahan pada saat menyimpan pengurangan data, silahkan coba lagi nanti";
    echo "<br>";
    echo $qry;
		exit;
  } 
...
function save($status){
  ...
  $attachment 		= $_REQUEST['attachment'];
	...
	if($tab==33){
		...
		if(($selectedRadio == 'a')&&($tab==30)){ // jika setuju dan pada saat persetujuan 
			#INSERT KE TABEL cppmod_pbb_sppt_pengurangan-->OK
			if (!empty($persenTerVerifikasi)){	
      ...
      // end by 35utech
        ...
        die(var_dump($status,$res3));
				echo "gagal boz";
			}
			$params = "a=".$_REQUEST['a']."&m=".$_REQUEST['m'];
			
			/*ARD+- : setelah difinalkan maka akan menuju form LHP*/
			$params = ($status == 2)? "a={$_REQUEST['a']}&m={$_REQUEST['m']}&f=fPengurangan4&dis=0&tab=90&svcid={$nomor}" : $params;
...
*/
// UPDATED 29 10 2018 BY 35UTECH 



function execute($nop,$tahun){
    ...
    $getReduce = getReduce2($nop, $tahun);
...
function updateGatewayCurrent($nop, $aValue) 
{
        ...
        // var_dump(array_keys($aValue));
        // die;

        $last_key = array_keys($aValue);
        $last_key = end($last_key); // aldes
...
function updateGateWayPBBSPPT($nop, $tahun, $aValue) {
        ...
        $LDBLink = mysqli_connect($newHost,$C_USER,$C_PWD,$C_DB, $newPort) or die(mysqli_error($DBLink));
