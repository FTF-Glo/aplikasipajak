...
<body>
	...
	<table border=\"0\" width=\"650\" cellpadding=\"8\">
		<tr>
			<td align=\"center\" colspan=\"3\"><b>" . $judul . "<br>NOMOR : " . (!empty($SKNumber) ? $SKNumber : "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $SKFormat) . " </b></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td align=\"justify\" width=\"480\">bahwa sehubungan dengan Surat Permohonan Pengurangan Pajak Bumi dan Bangunan Perkotaan, atas nama Wajib Pajak <b>" . $data->CPM_WP_NAME . "</b><br>
			Nomor : " . $data->CPM_ID . " Tanggal <i>" . tgl_indo($data->TGL_MASUK) . "</i> atas SPPT PBB NOP <i>" . $data->CPM_OP_NUMBER . "</i> Tahun Pajak " . $data->CPM_SPPT_YEAR . " yang diterima oleh petugas dan dengan mempertimbangkan hasil penelitian yang dituangkan
			dalam Laporan Hasil Penelitian Pengurangan PBB<br>
			Nomor : " . $data->CPM_RE_LHP_NUMBER . " Tanggal <i>" . tgl_indo($data->LHP_DATE) . "</i> perlu diterbitkan keputusan atas permohonan pengurangan PBB dimaksud;</td></tr>
		<tr>
			<td valign=\"top\">b.</td>
			<td align=\"justify\">bahwa berdasarkan pertimbangan sebagaimana dimaksud dalam huruf a, perlu menetapkan Keputusan Kepala BP2RD  tentang Pengurangan Pajak Bumi dan Bangunan Perkotaan;</td>
		</tr>
		<tr>
	...
	<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
		...
		<tr>
			<td valign=\"top\">b.</td>
			<td valign=\"top\">Asli keputusan ini disampaikan kepada Wajib Pajak dan Salinan Keputusan ini disimpan sebagai arsip BP2RD Bangka Barat.</td>
		</tr>
		<tr>
