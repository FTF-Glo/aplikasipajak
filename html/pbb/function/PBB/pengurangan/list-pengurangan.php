...
?>
  ...
  <script>
    ...
    function showKecamatanAll() {
      var request = $.ajax({
        url: "function/PBB/pengurangan/svc-kecamatan.php",
        type: "POST",
        data: {
    ...
    function showPengurangan() {
      ...
      $("#monitoring-content-4").load("function/PBB/pengurangan/svc-list-pengurangan.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 's':'4','uid':'$uid'}"); ?>", {
        st: sts,
        kc: kecamatan,
        n: namakec,
        th: tahun
    ...
    function excelPengurangan() {
      var kecamatan = $("#kecamatan-4").val();
      var namakec = $("#kecamatan-4 option:selected").text();
      window.open("function/PBB/pengurangan/svc-to-excel.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 's':'4','uid':'$uid'}"); ?>" + "&nkc=" + namakec + "&kc=" + kecamatan);
    }
    ...
    <div class="row">
      <div class="col-md-12">
        <div id="div-search">
          <div id="tabs">
            <ul>
              <li><a href="#tabs-4">Daftar Pengurangan</a></li>
            </ul>
            <div id="tabs-4" class="tbl-monitoring">
              <fieldset>
