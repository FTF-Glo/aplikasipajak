...
<body>
	<table border=\"0\" width=\"650\" cellpadding=\"3\">
		<tr>
			...
			<td align=\"center\" colspan = \"2\" width=\"565\">".$header."
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align=\"center\" colspan=\"3\"><font size=\"15\"><u>Laporan Hasil Pemeriksaan</u></font><br>Nomor : ".($otomatis == "1" ? $LHPNumber : "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$formatLHP)."</td>
		</tr>
		<tr>
			<td colspan=\"3\"></td>
		</tr>
...
$HTML = "";
	...
	$pdf->Image($sRootPath.'image/'.$fileLogo, 20, 13, 18, '', '', '', '', false, 300, '', false);
	...
	$pdf->SetAlpha(0.3);
		$bottomMargin =0;
            ...
            //     $rightMargin = 0;
            //     for($y=1;$y<=7;$y++){
            //         $pdf->Image($sRootPath.'image/DRAF.png', $rightMargin-5, $bottomMargin-37, 35,  '', '', '', true, false, 300, '', false);
            //         $rightMargin +=35;
            //     }
            //     $bottomMargin +=35;
