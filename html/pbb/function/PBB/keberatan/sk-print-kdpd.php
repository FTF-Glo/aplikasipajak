...
{
	global $data, $DBLink;
	$query = "SELECT (CPM_NIR * 1000) as CPM_NIR FROM cppmod_pbb_znt WHERE CPM_KODE_LOKASI = '$kodeLok' AND CPM_KODE_ZNT='$kodeZNT'";
	//echo $query;
	$res = mysqli_query($DBLink, $query);
	$json = new Services_JSON();
...
{
	global $uname, $NOP, $appId, $dbUtils, $appConfig;
	$data 				= getData($idssb);
	...
	$jabatanPejabatSK	= getConfigValue($appId, 'NAMA_PEJABAT_SK2_JABATAN');
	...
	$vObjection['CPM_NJOP_BANGUNAN']   	= $data->CPM_OB_NJOP_BANGUNAN_APP;

	$aValue['CPM_NJOP_TANAH'] = $data->CPM_OB_NJOP_TANAH_APP;
	$aValue['CPM_NJOP_BANGUNAN'] = $data->CPM_OB_NJOP_BANGUNAN_APP;
	$aValue['CPM_NJOP_BUMI_BERSAMA'] = 0;
	$aValue['CPM_NJOP_BANGUNAN_BERSAMA'] = 0;
	$tagihan = $dbUtils->hitungTagihan($aValue, $appConfig);
	...
	if ($data->CPM_OB_LUAS_TANAH == 0) {
		...
		$njopTanahSemula 	= number_format(floor(($data->CPM_OB_NJOP_TANAH / $data->CPM_OB_LUAS_TANAH)), 0, ',', '.');
		$njopTanahAkhir     = number_format(floor($data->CPM_OB_NJOP_TANAH_APP / (($data->CPM_OB_LUAS_TANAH_APP != NULL) ? $data->CPM_OB_LUAS_TANAH_APP : $data->CPM_OB_LUAS_TANAH)), 0, ',', '.');
	}
	if ($data->CPM_OB_LUAS_BANGUNAN == 0) {
		$njopBangunanSemula = 0;
		$njopBangunanAkhir = 0;
	} else {
		$njopBangunanSemula = number_format(floor(($data->CPM_OB_NJOP_BANGUNAN / $data->CPM_OB_LUAS_BANGUNAN)), 0, ',', '.');
		$njopBangunanAkhir  = number_format(floor($data->CPM_OB_NJOP_BANGUNAN_APP / (($data->CPM_OB_LUAS_BANGUNAN_APP != NULL) ? $data->CPM_OB_LUAS_BANGUNAN_APP : $data->CPM_OB_LUAS_BANGUNAN)), 0, ',', '.');
	}

	$ketetapanSemula	= number_format(($data->CPM_OB_NJOP_TANAH + $data->CPM_OB_NJOP_BANGUNAN), 0, ',', '.');
	$ketetapanMenjadi	= number_format(($data->CPM_OB_NJOP_TANAH_APP + $data->CPM_OB_NJOP_BANGUNAN_APP), 0, ',', '.');
...
<body>
	...
	<table border=\"0\" width=\"650\" cellpadding=\"8\">
		<tr>
			<td align=\"center\" colspan=\"3\"><b>" . $judul . "<br>NOMOR : NOMOR : " . (!empty($SKNumber) ? $SKNumber : "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $SKFormat) . " </b></td>
		</tr>
		<tr>
		...
		<tr>
			<td valign=\"top\">3.</td>
			<td align=\"justify\">Peraturan Daerah Kab. Bangka Barat Nomor 3 Tahun 2011 tentang Pajak Bumi dan Bangunan Perkotaan (Lembaran Daerah Kab Bangka Barat Tahun 2011 Nomor 3 Seri B).</td>
		</tr>
		<tr>
			<td valign=\"top\">4.</td>
			<td align=\"justify\">Peraturan Bupati Kab. Bangka Barat Nomor 12.a Tahun 2013 tentang Tata Cara Pemberian Pengurangan dan Penyelesaian Keberatan Pajak Bumi dan Bangunan Perkotaan.</td>
		</tr>
	</table>
	<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
		...
		<tr>
			...
			<td valign=\"top\">:</td>
			<td align=\"justify\" colspan=\"2\">Penghitungan Besarnya Pajak Bumi dan Bangunan Perkotaan yang terutang sebagaimana dimaksud pada diktum KEDUA adalah sebagai berikut :</td>
		</tr>
		<tr>
			<td colspan=\"4\">
				<font size=\"9\">
				<table border=\"1\" width=\"100%\" cellpadding=\"4\">
					...
					<tr align=\"center\">
						<td>MENJADI</td>
						<td align=\"right\">" . ($data->CPM_OB_LUAS_TANAH_APP != NULL ? number_format($data->CPM_OB_LUAS_TANAH_APP, 0, ',', '.') : number_format($data->CPM_OB_LUAS_TANAH, 0, ',', '.')) . "</td>
						<td align=\"right\">" . ($data->CPM_OB_LUAS_BANGUNAN_APP != NULL ? number_format($data->CPM_OB_LUAS_BANGUNAN_APP, 0, ',', '.') : number_format($data->CPM_OB_LUAS_BANGUNAN, 0, ',', '.')) . "</td>
		...
		<tr>
			<td valign=\"top\">b.</td>
			<td valign=\"top\">Asli keputusan ini disampaikan kepada Wajib Pajak dan Salinan Keputusan ini disimpan sebagai arsip Badan Pengelolahan Pajak dan Retribusi Daerah Kab. Bangka Barat.</td>
		</tr>
		<tr>
			<td colspan=\"4\" align=\"left\">
				...
				<tr>
					...
					<td width=\"250\">
						...
						<b>" . $jabatanPejabatSK . "</b><br>
						<b>NIP. " . $NIPPejabatSK . "</b><br>
					</td>
				</tr>
				</table>
			</td>
...
$appConfig['minimum_njoptkp'] =  getConfigValue($appId, 'minimum_njoptkp');
$appConfig['minimum_sppt_pbb_terhutang'] =  getConfigValue($appId, 'minimum_sppt_pbb_terhutang');
...
$pdf->Image($sRootPath . 'image/' . $fileLogo, 10, 16, 20, '', '', '', '', false, 300, '', false);
