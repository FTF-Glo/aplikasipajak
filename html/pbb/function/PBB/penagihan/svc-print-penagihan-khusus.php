...
$dbsw = getConfigValue($appID, 'ADMIN_SW_DBNAME');
// var_dump($dbsw);
// exit;
...
{
    global $DBLink, $appID, $dbsw;
    $id = $appID;
    //$qry = "select * from central_app_config where CTR_AC_KEY = '$key'";
    $qry = "select * from $dbsw.central_app_config where CTR_AC_AID = '" . $id . "' and CTR_AC_KEY = '$key'";
...
function getTunggakan($nop)
{
    ...
    $qry = "SELECT SPPT_PBB_HARUS_DIBAYAR,SPPT_TAHUN_PAJAK,SPPT_TANGGAL_JATUH_TEMPO FROM PBB_SPPT WHERE NOP = '" . $nop . "' AND SPPT_TAHUN_PAJAK='" . $thnpajak . "' AND (PAYMENT_FLAG != '1' OR PAYMENT_FLAG IS NULL) ORDER BY SPPT_TAHUN_PAJAK ASC";
...
function getHTML($op)
{
    global $kepala, $nip, $jabatan, $kota, $bank, $SP, $listTahun, $thnArr, $appID, $month, $listTagihan, $listDenda, $tagihanPlusDenda, $listTahun;
                ...
                <tr>
					...
					<table width=\"100%\" border=\"0\">
                        <tr>
							...
							<td width=\"10\">:</td>
							<td width=\"300\">973/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/Dispenda-II/" . $angkaRomawi[date("m")] . "/" . $tahun . "</td>
							<td width=\"30\"></td>
							<td width=\"270\">" . ucfirst(strtolower($kota)) . ", &nbsp;&nbsp;&nbsp;&nbsp;" . $month[date("m")] . " " . $tahun . "</td>
						</tr>
						<tr>
                            <td>Sifat</td>
							<td>:</td>
                    ...
                    <br/><br/>
                    Diminta untuk segera melunasi kewajiban membayar PBB diatas guna menghindari penerapan sanksi lebih lanjut sesuai dengan peraturan perundang-undangan yang berlaku, Jatuh tempo pada tanggal " . $tgl[2] . " " . $namaBulan[$tgl[1]] . " " . $tgl[0] . " karenanya akan dikenakan denda sebesar 2 % perbulan sejak tanggal Jatuh tempo.
                    <br/>
                    <br/>
                    ...
                    <br/>
                        <table border=\"0\">
                            <tr>
                                <td>&nbsp;</td>
                                <td align=\"left\"><b>KEPALA DINAS PENDAPATAN DAERAH</b>
                                    <br/>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <b>KOTA " . ucwords($kota) . ",</b>
                                    <br/>
                                    <br/>
                                    <br/>
                                    <br/>
...
$pdf->Image($sRootPath . 'image/' . $fileLogo, 20, 12, 20, '', '', '', '', false, 300, '', false);
$pdf->SetAlpha(0.3);
