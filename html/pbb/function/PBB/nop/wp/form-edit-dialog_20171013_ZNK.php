...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($bOK = $dbWajibPajak->save($WP_ID,$contentWP)){
        if($bOK = $dbWajibPajak->saveToSPPT($WP_ID,$contentWP)){
...
<form method="post" name="formWpDialog" id="formWpDialog">
    ...
    <span id="spacer">Nomor KTP</span><input type="text" name="WP_ID" maxlength="30" disabled value="<?php echo  isset($WP_ID) ? $WP_ID : "" ?>" size=30> <span id="div-loadwp-dialog-save-wait"></span><div id="newl"></div>
    <span id="spacer">Pekerjaan</span><label><input type="radio" name="WP_PEKERJAAN" value="PNS" <?php echo  ($WP_PEKERJAAN == "PNS") ? "checked" : "" ?> checked> PNS *)</label><div id="newl"></div>
    <span id="spacer">&nbsp;</span><label><input type="radio" name="WP_PEKERJAAN" value="TNI" <?php echo  ($WP_PEKERJAAN == "TNI") ? "checked" : "" ?>> TNI *)</label><div id="newl"></div>
    <span id="spacer">&nbsp;</span><label><input type="radio" name="WP_PEKERJAAN" value="Pensiunan" <?php echo  ($WP_PEKERJAAN == "Pensiunan") ? "checked" : "" ?>> Pensiunan *)</label><div id="newl"></div>
    <span id="spacer">&nbsp;</span><label><input type="radio" name="WP_PEKERJAAN" value="Badan" <?php echo  ($WP_PEKERJAAN == "Badan") ? "checked" : "" ?>> Badan</label><div id="newl"></div>
    <span id="spacer">&nbsp;</span><label><input type="radio" name="WP_PEKERJAAN" value="Lainnya" <?php echo  ($WP_PEKERJAAN == "Lainnya") ? "checked" : "" ?>> Lainnya</label><div id="newl"></div>
    <span id="spacer">&nbsp;</span><label>*)Yang penghasilannya semata-mata berasal dari gaji atau uang pensiunan</label><div id="newl"></div>
    ...
    <span id="spacer">Nama Jalan</span><input type="text" name="WP_ALAMAT" id="WP_ALAMAT" maxlength="70" id="WP_ALAMAT" value="<?php echo  isset($WP_ALAMAT) ? str_replace($bSlash,$ktip,$WP_ALAMAT) : "" ?>" size=27><div id="newl"></div>
    <span id="spacer">RT</span><input type="text" name="WP_RT" id="WP_RT" maxlength="3" value="<?php echo  isset($WP_RT) ? $WP_RT : "" ?>" size=6 onkeypress="return iniAngka(event, this)"><div id="newl"></div>
    ...
    <div id="newl"></div>
    <span id="spacer">Kode Pos</span><input type="text" name="WP_KODEPOS" id="WP_KODEPOS" value="<?php echo  isset($WP_KODEPOS) ? $WP_KODEPOS : "" ?>" maxlength="5" size=27 onkeypress="return iniAngka(event, this)"><div id="newl"></div>
    <span id="spacer">Nomor HP</span><input type="text" name="WP_NO_HP" id="WP_NO_HP" value="<?php echo  isset($WP_NO_HP) ? $WP_NO_HP : "" ?>" maxlength="15" size=27 onkeypress="return iniAngka(event, this)"><div id="newl"></div>
    <br>
