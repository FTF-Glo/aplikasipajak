					...
					<tr>
						<td>
							<table border=\"0\" width=\"550\">
								...
								<tr>
									<td align=\"right\" colspan=\"8\">(" . SayInIndonesian(($data->CPM_NJOP_TANAH + $data->CPM_NJOP_BANGUNAN)) . " rupiah)</td>
								</tr>
							</table>
							<br>
						</td>
...
class MYPDF extends TCPDF
{
	public function Header()
	{
		...
		$this->Image($image_file, 17, 10, 18, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
	}
}
