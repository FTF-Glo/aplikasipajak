...
<script type="text/javascript">
	...
	function setTabs (sel,sts,np) {     
		...
		$( "#tabsContent" ).tabs( "option", "ajaxOptions", { async: false, data: {srch:srch} } );
		$( "#tabsContent" ).tabs( "option", "selected", sel );
		$( "#tabsContent" ).tabs('load', sel); 
	}
	...
	function setPage (sel,sts,np) {
		...
		if (sel==82) sel = 1; 
        var srch = $("#srch-"+sts).val();
		$( "#tabsContent" ).tabs( "option", "ajaxOptions", { async: false, data: {page:page,np:np, srch:srch} } );
		$( "#tabsContent" ).tabs( "option", "selected", sel );
		$( "#tabsContent" ).tabs('load', sel); 
	}
	...
	function printToPDF(nop) {
            var params = {nop:nop, uname:'<?php echo $a; ?>', appID:'<?php echo $a; ?>'};
