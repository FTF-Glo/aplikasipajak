...
function generateSKNJOPNumber()
{
	...
	return '973/' . str_pad($newNumber, 4, '0', STR_PAD_LEFT) . '/SK/TAHUN/' . $appConfig['tahun_tagihan'];
}
...
function getHTML($nop)
{
	...
	$namaPejabatSK		= getConfigValue($appID, 'KABID_NAMA');
	$jabatanPejabatSK	= getConfigValue($appID, 'KABID_JABATAN');
	$NIPPejabatSK		= getConfigValue($appID, 'KABID_NIP');
		...
		<tr>
			<td colspan=\"3\" height=\"800\">
				<table border=\"0\" cellspacing=\"5\"> 
					...
					<tr>
						<td>
							<table border=\"0\" width=\"1400\">
								...
								<tr>
									<td></td><td>Jabatan</td><td>:</td><td align=\"left\">" . $NIPPejabatSK . "</td>
								</tr>
							</table>
					...
					<tr>
						<td align=\"justify\">
							Sesuai dengan ketentuan Undang-undang No.28 tahun 2009 tentang Pajak Daerah dan Retribusi Daerah, Peraturan Daerah No 3 Tahun 2011 Tentang Pajak Daerah dan 
						</td>
					</tr>
					<tr>
						<td>
							<table border=\"0\" width=\"500\">
								<tr>
									<td width=\"25\">1.</td><td width=\"600\" align=\"justify\">Peraturan Bupati Bangka Barat Nomor 11 Tahun 2013 Tentang Sistem dan Prosedur Pemungutan Bea Perolehan Hak Atas Tanah dan Bangunan Kabupaten Bangka Barat</td><td></td><td></td>
								</tr>
								<tr>
									<td width=\"25\">2.</td><td>Peraturan Bupati Bangka Barat Nomor 10 Tahun 2016 Tentang Standar Operasional Prosedur Tata Cara Pelayanan Pajak Bumi dan Bangunan Sektor Pedesaan dan Perkotaan Kabupaten Bangka Barat.</td><td></td><td></td>
								</tr>
								<tr>
									<td>
									</td>
								...
								<tr>
									<td width=\"600\">dengan ini menerangkan bahwa sesuai basis data WP yang ada di BP2RD atas objek pajak :</td><td></td><td></td><td></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						<td align=\"justify\">
							Demikian Surat Keterangan NJOP ini dibuat untuk dapat dipergunakan seperlunya. Apabila di kemudian hari terdapat kekeliruan akan diperbaiki dan ditindak lanjuti sesuai dengan ketentuan yang berlaku.
						</td>
					</tr>
					<tr>
						<td>
							<br><br><br>
							<table border=\"0\" width=\"550\" cellspacing=\"5\">
								<tr>
                                                                    <td width=\"200\"></td>
                                                                    <td width=\"150\"></td>
                                                                    <td width=\"300\" align=\"center\">
                                                                            Dibuat di Muntok<br>
                                                                            Pada tanggal, " . TanggalIndo(date("Y-m-d")) . " <br>
                                                                            Kepala Bidang Pendataan Penilaian dan Penetapan<br>
                                                                            <br>
                                                                            <br>
                                                                            <br>
                                                                            <br>
