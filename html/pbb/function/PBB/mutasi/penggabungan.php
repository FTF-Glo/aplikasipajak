	...
	<div id="tabsContent">
		<ul>
			<?php if ($arConfig['usertype'] == "pendata") { ?>
				<li><a href="view/PBB/mutasi/page.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 'f':'$f', 't':'3', 's':'1'}"); ?>">Tertunda</a></li>
				<li><a href="view/PBB/mutasi/page.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 'f':'$f', 't':'3', 's':'23'}"); ?>">Dalam Proses</a></li>
				<li><a href="view/PBB/mutasi/page.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 'f':'$f', 't':'3', 's':'56'}"); ?>">Ditolak</a></li>
			<?php } elseif ($arConfig['usertype'] == "verifikator") { ?>
				<li><a href="view/PBB/mutasi/page.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 'f':'$f', 't':'3', 's':'2'}"); ?>">Tertunda</a></li>
				<li><a href="view/PBB/mutasi/page.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 'f':'$f', 't':'3', 's':'23'}"); ?>">Dalam Proses</a></li>
				<li><a href="view/PBB/mutasi/page.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 'f':'$f', 't':'3', 's':'5'}"); ?>">Ditolak</a></li>
				<li><a href="view/PBB/mutasi/page.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 'f':'$f', 't':'3', 's':'3'}"); ?>">Disetujui</a></li>
			<?php } elseif ($arConfig['usertype'] == "penyetuju") { ?>
				<li><a href="view/PBB/mutasi/page.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 'f':'$f', 't':'3', 's':'33'}"); ?>">Tertunda</a></li>
				<li><a href="view/PBB/mutasi/page.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 'f':'$f', 't':'3', 's':'23'}"); ?>">Dalam Proses</a></li>
				<li><a href="view/PBB/mutasi/page.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 'f':'$f', 't':'3', 's':'6'}"); ?>">Ditolak</a></li>
				<li><a href="view/PBB/mutasi/page.php?q=<?php echo base64_encode("{'a':'$a', 'm':'$m', 'f':'$f', 't':'3', 's':'4'}"); ?>">Disetujui</a></li>
			<?php } ?>
		</ul>
	</div>
</div>