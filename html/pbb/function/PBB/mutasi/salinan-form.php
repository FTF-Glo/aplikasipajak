...
function formPenerimaan($initData)
{
    ...
    if ($initData['CPM_ID'] != '') {
        ...
        $kecOP = getKecamatan($appConfig["KODE_KOTA"]);
...
<div id=\"main-content\">
    <form name=\"form-penerimaan\" id=\"form-penerimaan\" method=\"post\" action=\"\">
        ...
        <table width=\"450\" border=\"0\" cellspacing=\"1\" cellpadding=\"8\">
            <tr>
                <td colspan=\"4\"><strong><font size=\"+2\">Penerimaan Berkas Salinan PBB-P2</font></strong><br /><hr><br /></td>
            </tr>
            <tr>
                ...
                <td width=\"49%\"><table width=\"450\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
                        ...
                        <tr>
                            ...
                            <td width=\"10%\">
                                ...
                                <input " . (($readonly) ? 'disabled' : null) . " type=\"text\" name=\"nomor\" id=\"nomor\" size=\"40\" maxlength=\"50\" value=\"" . (($initData['CPM_ID'] != '') ? $initData['CPM_ID'] : $nomor) . "\" readonly=\"readonly\" placeholder=\"Nomor\" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width=\"10%\">
                                <input " . (($readonly) ? 'disabled' : null) . " type=\"text\" name=\"nmKuasa\" id=\"nmKuasa\" size=\"40\" maxlength=\"50\" value=\"" . (($initData['CPM_REPRESENTATIVE'] != '') ? str_replace($bSlash, $ktip, $initData['CPM_REPRESENTATIVE']) : '') . "\" placeholder=\"Nama Kuasa\" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width=\"10%\">
                                <input " . (($readonly) ? 'disabled' : null) . " type=\"text\" name=\"nmWp\" id=\"nmWp\" size=\"40\" maxlength=\"50\" value=\"" . (($initData['CPM_WP_NAME'] != '') ? str_replace($bSlash, $ktip, $initData['CPM_WP_NAME']) : '') . "\" placeholder=\"Nama Wajib Pajak\" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width=\"10%\">
                                <input " . (($readonly) ? 'disabled' : null) . " type=\"text\" name=\"almtWP\" id=\"almtWP\" size=\"40\" maxlength=\"500\" value=\"" . (($initData['CPM_WP_ADDRESS'] != '') ? str_replace($bSlash, $ktip, $initData['CPM_WP_ADDRESS']) : '') . "\" placeholder=\"Alamat\" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width=\"10%\">
                                <input " . (($readonly) ? 'disabled' : null) . " type=\"text\" name=\"rtWP\" id=\"rtWP\" size=\"3\" maxlength=\"3\" value=\"" . (($initData['CPM_WP_RT'] != '') ? $initData['CPM_WP_RT'] : '') . "\" placeholder=\"00\"/>&nbsp;/
                                <input " . (($readonly) ? 'disabled' : null) . " type=\"text\" name=\"rwWP\" id=\"rwWP\" size=\"3\" maxlength=\"3\" value=\"" . (($initData['CPM_WP_RW'] != '') ? $initData['CPM_WP_RW'] : '') . "\" placeholder=\"00\"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width=\"10%\">
                                <input type=\"text\" " . (($readonly) ? 'disabled' : null) . " name=\"propinsi\" id=\"propinsi\" size=\"40\" maxlength=\"50\" value=\"" . (($initData['CPM_WP_PROVINCE'] != '') ? $initData['CPM_WP_PROVINCE'] : '') . "\" placeholder=\"Provinsi\"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width=\"10%\">
                                <input type=\"text\" " . (($readonly) ? 'disabled' : null) . " name=\"kabupaten\" id=\"kabupaten\" size=\"40\" maxlength=\"50\" value=\"" . (($initData['CPM_WP_KABUPATEN'] != '') ? $initData['CPM_WP_KABUPATEN'] : '') . "\" placeholder=\"Kabupaten\"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width=\"10%\">
                                <input type=\"text\" " . (($readonly) ? 'disabled' : null) . " name=\"kecamatan\" id=\"kecamatan\" size=\"40\" maxlength=\"50\" value=\"" . (($initData['CPM_WP_KECAMATAN'] != '') ? $initData['CPM_WP_KECAMATAN'] : '') . "\" placeholder=\"Kecamatan\"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width=\"10%\">
                                <input type=\"text\" " . (($readonly) ? 'disabled' : null) . " name=\"kelurahan\" id=\"kelurahan\" size=\"40\" maxlength=\"50\" value=\"" . (($initData['CPM_WP_KELURAHAN'] != '') ? $initData['CPM_WP_KELURAHAN'] : '') . "\" placeholder=\"" . $appConfig['LABEL_KELURAHAN'] . "\"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width=\"10%\">
                                <input " . (($readonly) ? 'disabled' : null) . " readonly=\"readonly\" type=\"text\" name=\"nop\" id=\"nop\" size=\"40\" maxlength=\"50\" value=\"" . (($initData['CPM_OP_NUMBER'] != '') ? $initData['CPM_OP_NUMBER'] : '') . "\" placeholder=\"NOP\" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width=\"10%\" valign=\"top\" colspan=\"2\">
                                ...
                                <ol id=\"lampiran\" style=\"margin-left: -20px;\">
                                    <li id=\"berkas4\" class=\"berkas\" ><input type=\"checkbox\" " . (($readonly) ? 'disabled' : null) . " name=\"lampiran[]\" value=\"8\" class=\"attach\" " . (($initData['CPM_ATTACHMENT'] & 8) ? "checked=\"checked\"" : "") . "> Fotocopi KTP / Kartu Keluarga.</li>
                                    <li id=\"berkas10\" class=\"berkas\" ><input type=\"checkbox\" " . (($readonly) ? 'disabled' : null) . " name=\"lampiran[]\" value=\"512\" class=\"attach\" " . (($initData['CPM_ATTACHMENT'] & 512) ? "checked=\"checked\"" : "") . "> Surat Setoran Pajak Daerah (SSPD).</li>
                                    <li id=\"berkas12\" class=\"berkas\" ><input type=\"checkbox\" " . (($readonly) ? 'disabled' : null) . " name=\"lampiran[]\" value=\"2048\" class=\"attach\" " . (($initData['CPM_ATTACHMENT'] & 2048) ? "checked=\"checked\"" : "") . "> Fotocopi SPPT PBB / SKP tahun lalu.</li>
                                    <li id=\"berkas13\" class=\"berkas\" ><input type=\"checkbox\" " . (($readonly) ? 'disabled' : null) . " name=\"lampiran[]\" value=\"4096\" class=\"attach\" " . (($initData['CPM_ATTACHMENT'] & 4096) ? "checked=\"checked\"" : "") . "> Fotocopi bukti pembayaran PBB yang terakhir.</li>
                                </ol>
                            </td>
                        </tr>
                    </table></td>
                ...
                <td width=\"49%\" valign=\"top\"><table width=\"450\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
                        ...
                        <tr>
                            ...
                            <td width=\"60%\">
                                <input " . (($readonly) ? 'disabled' : null) . " type=\"text\" name=\"almtOP\" id=\"almtOP\" size=\"50\" maxlength=\"500\" value=\"" . (($initData['CPM_OP_ADDRESS'] != '') ? str_replace($bSlash, $ktip, $initData['CPM_OP_ADDRESS']) : '') . "\" placeholder=\"Alamat\" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width=\"60%\">
                                <input " . (($readonly) ? 'disabled' : null) . " type=\"text\" name=\"rtOP\" id=\"rtOP\" size=\"3\" maxlength=\"3\" value=\"" . (($initData['CPM_OP_RT'] != '') ? $initData['CPM_OP_RT'] : '') . "\" placeholder=\"00\"/>&nbsp;/
                                <input " . (($readonly) ? 'disabled' : null) . " type=\"text\" name=\"rwOP\" id=\"rwOP\" size=\"3\" maxlength=\"3\" value=\"" . (($initData['CPM_OP_RW'] != '') ? $initData['CPM_OP_RW'] : '') . "\" placeholder=\"00\"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width=\"15%\"><label for=\"spptTahun\">SPPT Tahun</label></td>
                            <td width=\"10%\">
                                <input " . (($readonly) ? 'disabled' : null) . " type=\"text\" name=\"spptTahun\" id=\"spptTahun\" size=\"4\" maxlength=\"4\" value=\"" . (($initData['CPM_CP_YEAR'] != '') ? $initData['CPM_CP_YEAR'] : $appConfig['tahun_tagihan']) . "\" placeholder=\"0000\"/>                    
                            </td>
                        </tr>
                    </table></td>
            </tr>
    ...
    $simpan = "
            <tr>
				...
				<hr><br>
                    ...
                    &nbsp;
                    <input type=\"button\" name = \"btn-cancel\" id = \"btn-cancel\" value=\"Batal\" onclick='window.location.href=\"main.php?param=" . base64_encode("a=" . $a . "&m=" . $m . "&f=" . $arConfig['id_salinan']) . "\"' />
                </td>
            </tr>";
    $kirim = "
            <tr>
...
function getInitData($id)
{
    ...
    $qry = "SELECT * FROM cppmod_pbb_service_copy where CPM_CP_SID = '{$id}'";
    $res = mysqli_query($DBLink, $qry);
    $row = mysql_numrows($res);
    if ($row == 0) {
        return getDataDefault($id);
    } else {
        $qry = "SELECT * FROM cppmod_pbb_services a, cppmod_pbb_service_copy b WHERE CPM_ID = '{$id}' AND a.CPM_ID = b.CPM_CP_SID";
        $res = mysqli_query($DBLink, $qry);
        if (!$res) {
            echo $qry . "<br>";
            echo mysqli_error($DBLink);
...
function getDataDefault($id)
{
    ...
    if (!$res) {
        ...
        $additional = array('CPM_CP_ID' => '', 'CPM_CP_SID' => '', 'CPM_CP_YEAR' => '');
...
function save($status)
{
    ...
    if (!$readonly) {
        $aVal['CPM_CP_YEAR'] = $_REQUEST['spptTahun'];
    }
    if (!$readonly) {
        $bVal['CPM_REPRESENTATIVE'] = mysql_real_escape_string($_REQUEST['nmKuasa']);
        $bVal['CPM_WP_NAME'] = mysql_real_escape_string($_REQUEST['nmWp']);
        $bVal['CPM_DATE_RECEIVE'] = substr($_REQUEST['tglMasuk'], 6, 4) . '-' . substr($_REQUEST['tglMasuk'], 3, 2) . '-' . substr($_REQUEST['tglMasuk'], 0, 2);
        $bVal['CPM_WP_ADDRESS'] = mysql_real_escape_string($_REQUEST['almtWP']);
        $bVal['CPM_WP_RT'] = $_REQUEST['rtWP'];
        $bVal['CPM_WP_RW'] = $_REQUEST['rwWP'];
        $bVal['CPM_WP_PROVINCE'] = $_REQUEST['propinsi'];
        $bVal['CPM_WP_KABUPATEN'] = $_REQUEST['kabupaten'];
        $bVal['CPM_WP_KECAMATAN'] = $_REQUEST['kecamatan'];
        $bVal['CPM_WP_KELURAHAN'] = $_REQUEST['kelurahan'];
        $bVal['CPM_WP_HANDPHONE'] = $_REQUEST['hpWP'];
        $bVal['CPM_OP_NUMBER'] = $_REQUEST['nop'];
        $bVal['CPM_ATTACHMENT'] = $_REQUEST['attachment'];
        $bVal['CPM_OP_ADDRESS'] = mysql_real_escape_string($_REQUEST['almtOP']);
        $bVal['CPM_OP_ADDRESS_NO'] = $_REQUEST['almtOP'];
    ...
    if (!$readonly) {
        if ($mode == 'edit') {
            $res = $dbServices->editSalinan($nomor, $aVal);
        } else {
            $res = $dbServices->addSalinan($uuid, $nomor, $aVal);
        }
    } else {
        $res = true;
    }
    ...
    if ($res && $res2) {
        ...
        $params = "a=" . $_REQUEST['a'] . "&m=" . $_REQUEST['m'] . "&f=" . $arConfig['id_salinan'];
