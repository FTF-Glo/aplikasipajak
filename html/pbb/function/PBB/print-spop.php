...
function doPrint($id, &$strHTML, $tahunCetak)
{
...
function createHTML($row)
{
    ...
    <tr>
        <td width="100">&nbsp;</td>
        <td align="left" width="auto"><font size="12">PEMERINTAH KOTA BENGKULU<br>DINAS PENDAPATAN, PENGELOLAAN KEUANGAN DAN ASET
...
$pdf->AddPage('P', 'F4');
$pdf->Image($sRootPath . 'image/logo_bw.jpg', 6, 3, 20, '', '', '', '', false, 300, '', false);
