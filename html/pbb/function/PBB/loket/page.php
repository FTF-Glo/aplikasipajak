...
function displayContent($type, $status)
{
    ...
    echo "<div class=\"form-inline mb5\">";
    echo "<div class=\"form-group\">";
    echo "<input type=\"text\" id=\"srch-" . $status . "\" name=\"srch-" . $status . "\" placeholder=\"Nama\" size=\"35\" class=\"form-control\" style=\"margin-right:10px\" />";
    echo "</div>";
    echo "<div class=\"form-group\">";
    echo "<input type=\"text\" id=\"srchAlmt-" . $status . "\" name=\"srchAlmt-" . $status . "\" placeholder=\"Alamat\" size=\"50\" class=\"form-control\" style=\"margin-right:10px\" />";
    echo "</div>";
    echo "<div class=\"form-group\">";
    echo "<button type=\"button\" onclick=\"setTabs(" . $status . "," . $status . ")\" value=\"Cari\" id=\"btn-src\" class=\"btn btn-primary bg-maka\">Cari</button>";
    echo "</div>";
    echo "</div>";
