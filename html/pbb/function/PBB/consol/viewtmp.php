...
<div class="row">
	...
	<div class="col-md-10" style="max-width:690px;background:#FFF;padding:25px;box-shadow:0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border:solid 1px #54936f">
		<table border=0 width=60% cellspacing=0 cellpadding=2>
			...
			<tr><td>21.</td><td>Jumlah Bangunan</td>
			...
			<tr><td colspan=3>Saya menyatakan bahwa informasi yang telah saya berikan dalam formulir ini termasuk lampirannya adalah benar, jelas dan lengkap menurut keadaan yang sebenarnya, sesuai dengan pasal 83 ayat (2) Undang-Undang Nomor 28 Tahun 2009</td></tr>
			<tr><td>22.</td><td>Nama <?php echo isset($PP_TIPE)?$PP_TIPE:""?></td>
				<td><?php echo isset($PP_NAMA)?$PP_NAMA:""?></td></tr>
			<tr><td>23.</td><td>Tanggal</td>
			...
			<tr>
				<td colspan=3>
					...
					<tr>
						...
						<td align="right"><?php echo isset($NJOP_BANGUNAN)?number_format($NJOP_BANGUNAN/$OP_LUAS_BANGUNAN,0,',','.'):"0"?></td>
