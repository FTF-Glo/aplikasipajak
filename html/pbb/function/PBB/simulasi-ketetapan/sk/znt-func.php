...
{  // srch
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/PBB/simulasi-ketetapan/svc-perubahan-znt-massal.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 'tab':'0', 'n':'1', 'u':'$data->uname'}") . "\">Perubahan ZNT Massal</a></li>\n";

    echo "\t\t<li><a href=\"view/PBB/simulasi-ketetapan/svc-perubahan-znt-massal-multi.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 'tab':'0', 'n':'1', 'u':'$data->uname'}") . "\">Perubahan ZNT Massal CSV</a></li>\n";
    echo "\t</ul>\n";
}
