...
{  // srch
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'10'}") . "\">Sementara (Draft)</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'5'}") . "\">Tertunda</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'20'}") . "\">Dalam Proses</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'30'}") . "\">Ditolak</a></li>\n";
	echo "\t</ul>\n";
}
...
function displayMenuKelurahan()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'21'}") . "\">Tertunda</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'20'}") . "\">Dalam Proses</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'31'}") . "\">Ditolak</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'41'}") . "\">Disetujui</a></li>\n";
	echo "\t</ul>\n";
}
...
function displayMenuDispenda()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'22'}") . "\">Tertunda</a>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'20'}") . "\">Dalam Proses</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'32'}") . "\">Ditolak</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'42'}") . "\">Disetujui</a></li>\n";
	echo "\t</ul>\n";
}
...
function displayMenuPenilaian()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'25'}") . "\">Tertunda</a>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'20'}") . "\">Dalam Proses</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'35'}") . "\">Ditolak</a></li>\n";
	echo "\t</ul>\n";
}
...
function displayMenuPenetapan()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'24'}") . "\">Tertunda</a>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'20'}") . "\">Dalam Proses</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'50'}") . "\">Telah Ditetapkan</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'60'}") . "\">SPPT</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'65'}") . "\">OP Fasilitas Umum</a></li>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page-cek-nop-tunggakan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'77'}") . "\">Cek NOP Tunggakan</a></li>\n";
	echo "\t</ul>\n";
}
...
function displayMenuPenetapanMundur()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'26'}") . "\">Penetapan Mundur</a>\n";
	// echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'20'}") . "\">Dalam Proses</a></li>\n";
	// echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'50'}") . "\">Telah Ditetapkan</a></li>\n";
	// echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'60'}") . "\">SPPT</a></li>\n";
	// echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'65'}") . "\">OP Fasilitas Umum</a></li>\n";
...
function displayMenuPenilaianMassal()
{
	...
	echo "\t<ul>\n";
	echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'80'}") . "\">Daftar Objek Pajak</a>\n";
	echo "\t</ul>\n";
}
