...
if (isset($_REQUEST['btn-finalize']) && $_REQUEST['btn-finalize'] == "Finalkan") {
    $checkall = $_REQUEST['check-all'];
    $pengurangan = $_REQUEST['pengurangan-val'];
    $tahun = $_REQUEST['tahun'];

    $data = $dbGwCurrent->changeStimulusTemp($checkall, $tahun, $pengurangan, $appConfig);

    header("Refresh:0");
    echo '<script language="javascript">';
    echo 'alert("Perubahan PBB minimum berhasil")';
    echo '</script>';
    exit();
}
...
function displayMenuPenerimaan()
{
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page-stimulus.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'10'}") . "\">Tertunda</a></li>\n";
    echo "\t</ul>\n";
}
...
function displayMenuVerifikasi()
{
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page-stimulus.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'20'}") . "\">Tertunda</a></li>\n";
    echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page-stimulus.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'11'}") . "\">Dalam Proses</a></li>\n";
    echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page-stimulus.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'22'}") . "\">Ditolak</a></li>\n";
    echo "\t</ul>\n";
}
...
function displayMenuPersetujuan()
{
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page-stimulus.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'30'}") . "\">Tertunda</a></li>\n";
    echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page-stimulus.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'11'}") . "\">Dalam Proses</a></li>\n";
    echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page-stimulus.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'32'}") . "\">Ditolak</a></li>\n";
    echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page-stimulus.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'33'}") . "\">Disetujui</a></li>\n";
    echo "\t</ul>\n";
}
...
<script type="text/javascript">
    ...
    /*function setPengurangan(sel, sts) {
        var srch = $("#srch-" + sel).val();
        ...
        var kel = $("#kel").val();
        var buku = $("#buku").val();
        var pengurangan = $("#pengurangan-val").val();

        var ask = 'Anda yakin akan melakukan pengurangan stimulus?';
        if (confirm(ask) === false) return false;

        //console.log(pengurangan);

        $.ajax({
            url: './view/PBB/stimulus/mod-stimulus.php',
            dataType: "json",
            data: {
                srch: srch,
                tahun: tahun,
