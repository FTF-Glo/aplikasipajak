...
if(isset($_REQUEST['btn-finalize']) && $_REQUEST['btn-finalize'] == "Cetak") {
...
function displayMenuPenerimaan()
{
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"function/PBB/simulasi-ketetapan/sk/page-rekap-buku.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'10'}") . "\">Rekap Buku</a></li>\n";
    echo "\t</ul>\n";
}
