...
function displayContent($selected)
{
    ...
    if ($selected == 50) {
        ...
        echo '<div class="col-md-2 text-right" style="padding-top: 7px;">Tanggal Penetapan</div>
        <div class="col-md-2"><input type="text" id="tgl_penetapan" class="form-control" readonly="true" name="tgl_penetapan" value="' . date('d-m-Y') . '" maxlength="10" size="12"></div>
        </div>
        ...
        if ($isSusulan) {
            echo "<div class=\"col-md-2\"><input type=\"button\" class=\"btn btn-primary bg-orange\" value=\"Proses Penilaian\" id=\"btn-penilaian\" name=\"btn-penilaian\"/ onClick=\"return actionPenetapanTerseleksi('" . $PenilaianParam . "', '" . $appConfig['tahun_tagihan'] . "', '2', '1');\"></div>";
        } else {
            if ($kel != '') {
                ...
                echo "<div class=\"col-md-2\"><input type=\"button\" class=\"btn btn-primary bg-orange\" value=\"Proses Penilaian\" id=\"btn-penilaian\" name=\"btn-penilaian\"/ onClick=\"return actionPenetapanTerseleksi('" . $PenilaianParam . "', '" . $appConfig['tahun_tagihan'] . "', '1', '');\"></div>\n";
            } else echo "<div class=\"col-md-2\"><input type=\"button\" class=\"btn btn-primary bg-orange\" value=\"Proses Penilaian\" id=\"btn-penilaian\" name=\"btn-penilaian\"/ onClick=\"return actionPenetapanTerseleksi('" . $PenilaianParam . "', '" . $appConfig['tahun_tagihan'] . "', '1', '');\" disabled=\"disabled\"></div>\n";
        }
    ...
    if ($selected == 24 || $selected == 70 || $selected == 82) {
        ...
        echo "<div class=\"form-group\">
                ...
                <div class=\"col-md-2\">
                    <button class=\"btn btn-primary btn-orange mb5\" style=\"margin-top: 25px;\" onclick=\"searchMultiNOP(" . $selected . "," . $selected . ")\" id=\"btn-src\">Cari</button>
                </div></div>";
        echo "</span>";
    }
    if ($selected == 26) {
