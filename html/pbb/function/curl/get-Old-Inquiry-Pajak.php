...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $code   = (@isset($_POST['code'])   && is_numeric($_POST['code']))  ? $_POST['code']: false;
    if(!$token || !$code || !$exp) die(json_encode(['status'=>false,'msg'=>'PARAMETER FALSE']));
}else{
