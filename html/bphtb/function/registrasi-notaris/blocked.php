...
<div class='spacer10'></div>
	  <div class='subTitle'>Sudah diblokir (tidak aktif)</div>
...
echo "
		...
		$sqlCek1="SELECT *FROM tbl_reg_user_notaris WHERE status='4' AND areapajak='$IdKK' ORDER BY id DESC LIMIT 10";
			...
			if($jumlah>0){
				...
				?>
						<tr>
							...
							<td align='center'>
							<a href="main.php?param=<?php echo base64_encode("a=$a&m=$m&f=$func&dataId=".$dataTampil1['id']."&nameUser=".addslashes($dataTampil1['userId'])."&pwdUser=".$dataTampil1['password']."&email=".$dataTampil1['email'])?>"><img src='./image/icon/accept.png' height='15' width='15' alt='AKTIFKAN' title='AKTIFKAN'></img></a>
							</td>
