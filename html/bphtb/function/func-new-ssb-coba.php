...
echo "<script src=\"function/BPHTB/notaris/func-new-ssb-pel-coba.js?ver=1a\"></script>\n"; // function
			  ...
			  <td width=\"3%\" align=\"center\" valign=\"top\"><div  id='rcorners3'><font size='+1' color=\"white\"><b>A. </b></font></div></td>
			   <td width=\"97%\"><table width=\"900\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
				<tr>
				  ...
				  <td width=\"30%\"><input type=\"text\" name=\"name2\" id=\"name2\" value=\"" . getConfigValue('KODE_DAERAH') . "" . $value[12] . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"25\" title=\"NOP PBB\" \"/> <input type=\"button\" value=\"cek NOP\" onclick=\"cek_allow();checkNOP();\" id=\"ceknop\"> <label id=\"load-pbb\"></label></td>
				  <!-- <td>Nama WP Lama :</td> -->
				...
				<tr>
				  ...
				  <td><textarea name=\"address2\" id=\"address2\" cols=\"35\" rows=\"4\" title=\"Lain-lain\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\">" . $value[13] . "</textarea>
				  </tr>
				</tr>
				<tr>
				  <td><div align=\"right\">3.</div></td>
				  <td>Kelurahan/Desa</td>
				  <td><input type=\"text\" name=\"kelurahan2\" id=\"kelurahan2\" value=\"" . $value[15] . "\" onKeyPress=\"return nextFocus(this, event);\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\" size=\"20\" maxlength=\"20\" title=\"Kelurahan Objek Pajak\"/></td>
				  <td>&nbsp;</td>
				...
				<tr>
				  ...
				  <td>RT/RW</td>
				  <td><input type=\"text\" name=\"rt2\" id=\"rt2\" maxlength=\"3\" size=\"3\" value=\"" . $value[16] . "\" onKeyPress=\"return nextFocus(this, event)\" title=\"RT Objek Pajak\"/>
					/
					<input type=\"text\" name=\"rw2\" id=\"rw2\" maxlength=\"3\" size=\"3\" value=\"" . $value[17] . "\" onKeyPress=\"return nextFocus(this, event)\" title=\"RW Wajib Pajak\"/></td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				</tr>
				<tr>
				  ...
				  <td>Kecamatan</td>
				  <td><input type=\"text\" name=\"kecamatan2\" id=\"kecamatan2\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\" value=\"" . $value[18] . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"20\" maxlength=\"20\" title=\"Kecamatan Objek Pajak\"/></td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				</tr>
				<tr>
				  ...
				  <td><input type=\"text\" name=\"kabupaten2\" id=\"kabupaten2\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\" value=\"" . $value[19] . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"20\" maxlength=\"20\" title=\"Kabupaten/Kota Objek Pajak\"/></td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				</tr>
				<tr>
				  ...
				  <td>Kode Pos</td>
				  <td><input type=\"text\" name=\"zip-code2\" id=\"zip-code2\" value=\"" . $value[20] . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"5\" maxlength=\"5\" title=\"Kode Pos Objek Pajak\"/></td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				</tr>
				<tr>
				  ...
				  <td><input type=\"text\" name=\"certificate-number\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\" id=\"certificate-number\" value=\"" . $value[28] . "\" size=\"50\" maxlength=\"80\" title=\"Nomor Sertifikat Tanah\"/></td>
				</tr>
				<tr>
					<td><div align=\"right\">9.</div></td>
					<td>Nama WP Sesuai Sertifikat</td> 
					  <td><input type=\"text\" name=\"nama-wp-cert\" id=\"nama-wp-cert\" value=\"" . $value[41] . "\" size=\"30\" maxlength=\"30\" title=\"Nama WP Sesuai Sertifikat\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\"/>
					  </td>
				</tr>	
				<tr>
					<td><div align=\"right\">10.</div></td>
					<td>Nama WP Lama</td> 
					  <td><input type=\"text\" name=\"nama-wp-lama\" id=\"nama-wp-lama\" value=\"" . $value[40] . "\" size=\"30\" maxlength=\"30\" title=\"Nama WP Lama\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\"/>
					  </td>
				</tr>	
			  </table>
			...
			<tr>
			  ...
			  <td width=\"97%\"><table width=\"900\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
				...
				<tr>
				  <td width=\"2%\"><div align=\"right\">1.</div></td>
				  <td>Nomor KTP</td>
				  <td><input type=\"text\" name=\"noktp\" id=\"noktp\" value=\"" . $value[38] . "\" onkeypress=\"return nextFocus(this,event)\" size=\"16\" maxlength=\"24\" title=\"No KTP wajib di isi\" onblur=\"checkTransLast();\" />&nbsp;&nbsp;<input type=\"button\" style=\"display:none\" name=\"checkKTP\" id=\"checkKTP\" value=\"Ambil Data Dukcapil\" class=\"myButton\" onclick=\"checkDukcapil();checkTransLast();\"><img src=\"./image/icon/loading.gif\" id=\"loaderCek\"><div id=\"newl\"></div></td>
				</tr>
				<tr>
				  <td><div align=\"right\">2.</div></td>
				  <td>NPWP</td>
				  <td><input type=\"text\" name=\"npwp\" id=\"npwp\" value=\"" . $value[3] . "\" onkeypress=\"return nextFocus(this,event)\" size=\"15\" maxlength=\"15\" title=\"NPWP\"/></td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				</tr>
				<tr>
				  ...
				  <td width=\"40%\"><input type=\"text\" name=\"name\" id=\"name\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\" value=\"" . $value[2] . "\" onkeypress=\"return nextFocus(this,event)\" size=\"60\" maxlength=\"60\" title=\"Nama Wajib Pajak\"/></td>
				   <td colspan=\"2\">&nbsp;</td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				</tr>
				<tr>
				  ...
				  <td><textarea  name=\"address\" id=\"address\" cols=\"35\" rows=\"4\" title=\"Lain-lain\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\">" . $value[4] . "</textarea>
				  <td></td>
				  <td></td>
				</tr>
				<tr>
				  <td><div align=\"right\">5.</div></td>
				  <td>Kelurahan/Desa</td>
				  <td><input type=\"text\" name=\"kelurahan\" id=\"kelurahan\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\" value=\"" . $value[6] . "\" onkeypress=\"return nextFocus(this,event)\" size=\"20\" maxlength=\"20\" title=\"Kelurahan/Desa Wajib Pajak\"/></td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				</tr>
				<tr>
				  <td><div align=\"right\">6.</div></td>
				  <td>RT/RW</td>
				  <td><input type=\"text\" name=\"rt\" id=\"rt\" maxlength=\"3\" size=\"3\"  value=\"" . $value[7] . "\" onkeypress=\"return nextFocus(this,event)\" title=\"RT Wajib Pajak\"/>/<input type=\"text\" name=\"rw\" id=\"rw\" maxlength=\"3\" size=\"3\"  value=\"" . $value[8] . "\" onkeypress=\"return nextFocus(this,event)\" title=\"RW Wajib Pajak\"/></td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				</tr>
				<tr>
				  <td><div align=\"right\">7.</div></td>
				  <td>Kecamatan</td>
				  <td><input type=\"text\" name=\"kecamatan\" id=\"kecamatan\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\"  value=\"" . $value[9] . "\" onkeypress=\"return nextFocus(this,event)\" size=\"20\" maxlength=\"20\" title=\"Kecamatan Wajib Pajak\"/></td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				</tr>
				<tr>
				  <td><div align=\"right\">8.</div></td>
				  <td>Kabupaten/Kota</td>
				  <td><input type=\"text\" name=\"kabupaten\" id=\"kabupaten\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\"  value=\"" . $value[10] . "\" onkeypress=\"return nextFocus(this,event)\"  size=\"20\" maxlength=\"20\" title=\"Kabupaten/Kota Wajib Pajak\"/></td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				</tr>
				<tr>
				  <td><div align=\"right\">9.</div></td>
				  <td>Kode Pos</td>
				  <td><input type=\"text\" name=\"zip-code\" id=\"zip-code\"  value=\"" . $value[11] . "\" onKeyPress=\"return numbersonly(this, event)\"  size=\"5\" maxlength=\"5\" title=\"Kode Pos Wajib Pajak\"/></td>
				  <td>&nbsp;</td>
				  <td>&nbsp;</td>
				</tr>
			  </table>
			  <table width=\"747\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
				<tr>
				  ...
				  <td><input type=\"text\" name=\"Koordinat\" id=\"Koordinat\" value=\"" . $value[47] . "\" onkeyup=\"javascript:{this.value = this.value.toUpperCase(); }\" value=\"\" onkeypress=\"return nextFocus(this,event)\" size=\"20\" title=\"Titik Koordinat Wajib diisi\" isdatepicker=\"true\"></td>
			    <tr>
                <tr>
		  ...
		  <tr>
			...
			<td align=\"right\" valign=\"middle\" bgcolor=\"#CCCCCC\" id=\"t3\">&nbsp;</td>
			  ...
			  <div id=\"nilai-pasar\">
				...
				<br>
				12. Nilai Pasar/Harga Transaksi Lelang  Rp. <input type=\"text\" name=\"trans-value\" id=\"trans-value\" value=\"" . $value[27] . "\" onKeyPress=\"return numbersonly(this, event)\"  onchange=\"checkTransaction()\" onkeyup=\"checkTransaction();\" title=\"Harga Transaksi\"/ onblur=\"loadLaikPasar();\">
			  </td>
			</tr>
			<tr>
			<tr>
...
$html .="			      </select></td>
				...
				<tr>
				  ...
				  <td align=\"right\" valign=\"top\"></td>
				  <td valign=\"top\"><!-- Khusus untuk waris dan Hibah Pengurangan dihitung sendiri menjadi --> 
                    <input type=\"text\" name=\"jsb-choose-fraction1\" id=\"jsb-choose-fraction1\" size=\"1\" maxlength=\"2\" value=\"".$value[43]."\" title=\"pecahan 1\" onkeyup=\"checkTransaction()\" onKeyPress=\"return numbersonly(this, event)\" hidden=\"hidden\"/>
                    <input type=\"text\" name=\"jsb-choose-fraction2\" id=\"jsb-choose-fraction2\" size=\"1\" maxlength=\"2\" value=\"".$value[44]."\" title=\"pecahan 2\" onkeyup=\"checkTransaction()\" onKeyPress=\"return numbersonly(this, event)\" hidden=\"hidden\"/></td>
				</tr>
			  </table>
			  </td>
			</tr>
			...
			<tr><input type=\"hidden\" id=\"jsb-total-before\" name=\"jsb-total-before\"><input type=\"hidden\" id=\"hd-npoptkp\" name=\"hd-npoptkp\"><input type=\"hidden\" name=\"role\" id=\"role\" name=\"role\" value=\"".getRole()."\">
...
//echo "<pre>";print_r($_REQUEST);exit;
    ...
    if (validation($data, $err)) {
        ...
        //--------------cppmod_ssb_doc_log
        // please note %d in the format string, using %s would be meaningless
        $query = sprintf("INSERT INTO cppmod_ssb_doc_log (
                ...
                mysqli_real_escape_string($DBLink, $version), mysqli_real_escape_string($DBLink, $opr),mysqli_real_escape_string($DBLink, $trdate),
                mysqli_real_escape_string($DBLink, $trdate), mysqli_real_escape_string($DBLink, $opr),mysqli_real_escape_string($DBLink, $trdate),
                mysqli_real_escape_string($DBLink, $iddoc), '', '', mysqli_real_escape_string($DBLink, $data[2]), 
                mysqli_real_escape_string($DBLink, $data[3]), mysqli_real_escape_string($DBLink, nl2br($data[4])), 
                mysqli_real_escape_string($DBLink, $data[7]), mysqli_real_escape_string($DBLink, $data[8]), 
                mysqli_real_escape_string($DBLink, $data[6]), mysqli_real_escape_string($DBLink, $data[9]), 
                mysqli_real_escape_string($DBLink, $data[10]), mysqli_real_escape_string($DBLink, $data[11]), 
                mysqli_real_escape_string($DBLink, $data[12]), mysqli_real_escape_string($DBLink, nl2br($data[13])), 
                mysqli_real_escape_string($DBLink, $data[16]), mysqli_real_escape_string($DBLink, $data[17]), 
                mysqli_real_escape_string($DBLink, $data[15]), mysqli_real_escape_string($DBLink, $data[18]), 
                mysqli_real_escape_string($DBLink, $data[19]), mysqli_real_escape_string($DBLink, $data[20]), 
                mysqli_real_escape_string($DBLink, $data[21]), mysqli_real_escape_string($DBLink, $data[22]), 
                mysqli_real_escape_string($DBLink, $data[24]), mysqli_real_escape_string($DBLink, $data[23]), 
                mysqli_real_escape_string($DBLink, $data[25]), mysqli_real_escape_string($DBLink, $data[26]), 
                mysqli_real_escape_string($DBLink, $data[27]), mysqli_real_escape_string($DBLink, $data[28]), 
                mysqli_real_escape_string($DBLink, $data[29]), mysqli_real_escape_string($DBLink, $data[30]), 
                mysqli_real_escape_string($DBLink, $typeSurat), mysqli_real_escape_string($DBLink, $typeSuratNomor), 
                mysqli_real_escape_string($DBLink, $typeSuratTanggal), mysqli_real_escape_string($DBLink, $pengurangan), 
                mysqli_real_escape_string($DBLink, $typeLainnya),mysqli_real_escape_string($DBLink, $typePecahan), mysqli_real_escape_string($DBLink, $kdpengurangan));
        ...
        if($isPBB == 1){
            // please note %d in the format string, using %s would be meaningless
            $query = sprintf("INSERT INTO cppmod_ssb_doc_OLD (
                    CPM_SSB_ID,CPM_KPP,
                    CPM_KPP_ID,CPM_WP_NAMA,
                    CPM_WP_NPWP,CPM_WP_ALAMAT,
                    CPM_WP_RT,CPM_WP_RW,
                    ...
                    mysqli_real_escape_string($DBLink, $iddoc), '', '', mysqli_real_escape_string($DBLink, $dataOld[0]), 
                    mysqli_real_escape_string($DBLink, $dataOld[1]), mysqli_real_escape_string($DBLink, nl2br($dataOld[3])), 
                    mysqli_real_escape_string($DBLink, $dataOld[5]), mysqli_real_escape_string($DBLink, $dataOld[6]), 
                    mysqli_real_escape_string($DBLink, $dataOld[4]), mysqli_real_escape_string($DBLink, $dataOld[7]), 
                    mysqli_real_escape_string($DBLink, $dataOld[8]), mysqli_real_escape_string($DBLink, $dataOld[9]), 
                    mysqli_real_escape_string($DBLink, $dataOld[10]), mysqli_real_escape_string($DBLink, nl2br($dataOld[11])), 
                    mysqli_real_escape_string($DBLink, $dataOld[13]), mysqli_real_escape_string($DBLink, $dataOld[14]), 
                    mysqli_real_escape_string($DBLink, $dataOld[12]), mysqli_real_escape_string($DBLink, $dataOld[15]), 
                    mysqli_real_escape_string($DBLink, $dataOld[16]), mysqli_real_escape_string($DBLink, $dataOld[17]), 
                    mysqli_real_escape_string($DBLink, $dataOld[22]), mysqli_real_escape_string($DBLink, $dataOld[18]), 
                    mysqli_real_escape_string($DBLink, $dataOld[20]), mysqli_real_escape_string($DBLink, $dataOld[19]), 
                    mysqli_real_escape_string($DBLink, $dataOld[21]), mysqli_real_escape_string($DBLink, $data[26]), 
                    mysqli_real_escape_string($DBLink, $data[27]), mysqli_real_escape_string($DBLink, $data[28]), 
                    mysqli_real_escape_string($DBLink, $data[29]), mysqli_real_escape_string($DBLink, $data[30]), 
                    mysqli_real_escape_string($DBLink, $typeSurat), mysqli_real_escape_string($DBLink, $typeSuratNomor), 
                    mysqli_real_escape_string($DBLink, $typeSuratTanggal), mysqli_real_escape_string($DBLink, $pengurangan), 
                    mysqli_real_escape_string($DBLink, $typeLainnya), mysqli_real_escape_string($DBLink, $trdate), 
                    mysqli_real_escape_string($DBLink, $opr), mysqli_real_escape_string($DBLink, $version), 
                    mysqli_real_escape_string($DBLink, $data[36]), mysqli_real_escape_string($DBLink, $nokhd), 
                    mysqli_real_escape_string($DBLink, $dataOld[2]), mysqli_real_escape_string($DBLink, $data[40]), 
                    mysqli_real_escape_string($DBLink, $data[41]), mysqli_real_escape_string($DBLink, $bphtb_terutang),mysqli_real_escape_string($DBLink, $typePecahan), mysqli_real_escape_string($DBLink, $kdpengurangan));
