...
function save ($final) {
	...
	$query = sprintf("INSERT INTO cppmod_ssb_doc (
		...
		CPM_SSB_AUTHOR,CPM_SSB_VERSION,CPM_SSB_AKUMULASI,CPM_PAYMENT_TIPE_KHD_NOMOR,CPM_WP_NOKTP,CPM_WP_NAMA_LAMA,CPM_WP_NAMA_CERT,CPM_OP_BPHTB_TU) 
		...
		mysqli_real_escape_string($appDbLink, $data[36]),mysqli_real_escape_string($appDbLink, $nokhd),mysqli_real_escape_string($appDbLink, $data[38]),mysqli_real_escape_string($appDbLink, $data[40]),
                mysqli_real_escape_string($appDbLink, $data[41]),mysqli_real_escape_string($appDbLink, $bphtb_terutang));
