                        ...
                        <td width=\"100%\" colspan=\"2\" valign=\"top\">
                            <ul id=\"lampiran\" style=\"margin-left: -20px;\">
								<table border='0'><tr>
										...
										<tr>
										<td>
											<li> 4. Fotocopy Bukti Pembayaran/Lunas PBB 5 tahun kebelakang </li></td><td> 																																					  <input onchange='check_extension(this.value)' type='file' name='file_lamp6' id='file_lamp6'><input type='button' id='btn_6' name='btn_6' value='Upload'  onclick=\"upload('file_lamp6',6,  6);\"><span   id='uploaded_image_6'>".$berkas_lamp6."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 5. SSPD Yang Sudah Ditanda Tangani Oleh Wajib Pajak Dan PPAT</li></td><td> 																																						<input onchange='check_extension(this.value)' type='file' name='file_lamp1' id='file_lamp1'><input type='button' id='btn_1' name='btn_1' value='Upload'  onclick=\"upload('file_lamp1',1,1);\"><span id='uploaded_image_1'>".$berkas_lamp1."</span></td>
										</tr>
										
										
										<tr>
										<td>
											<li> 6. Fotocopy Surat Keterangan Kepemilikan</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp150' id='file_lamp150'><input type='button' id='btn_150' name='btn_150' value='Upload'  onclick=\"upload('file_lamp150',33,  150);\"><span   id='uploaded_image_150'>".$berkas_lamp33."</span></td>
										</tr>
										...
										<tr>
										<td>
											<li> 10. Sertifikat Lampiran</li></td><td> 				</td>
										</tr>
                        ...
                        <td width=\"100%\" colspan=\"2\" valign=\"top\">
                            <ul id=\"lampiran\" style=\"margin-left: -20px;\">
								<table border='0'>
									...
									<tr>    
									<td>	
										<li>2. Fotocopy SPPT PBB Tahun Yang Bersangkutan </li></td><td><input onchange='check_extension(this.value)' type='file' name='file_lamp22' id='file_lamp22' >                                                                             <input type='button' id='btn_22' name='btn_22' value='Upload'  onclick=\"upload('file_lamp22',5, 22);\"><span  id='uploaded_image_22'>".$berkas_lamp5."</span></td>
									</tr>  
									...
									<tr>    
									<td>
										<li>5. SSPD Yang Sudah Ditanda Tangani Oleh Wajib Pajak Dan PPAT </li></td><td> <input onchange='check_extension(this.value)' type='file' name='file_lamp18' id='file_lamp18' >																				<input type='button' id='btn_18' name='btn_18' value='Upload'  onclick=\"upload('file_lamp18',1, 18);\"><span  id='uploaded_image_18'>".$berkas_lamp1."</span></td>
									</tr> 
									
									<tr>
									<td>
										<li>6. Fotocopy Surat Keterangan Kepemilikan</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp152' id='file_lamp152'><input type='button' id='btn_152' name='btn_152' value='Upload'  onclick=\"upload('file_lamp152',33,  152);\"><span   id='uploaded_image_152'>".$berkas_lamp33."</span></td>
									</tr>
									
									<tr>    
									<td>	
										<li>7. Fotocopy Surat Keterangan Waris atau Akta Hibah </li></td><td><input onchange='check_extension(this.value)' type='file' name='file_lamp26' id='file_lamp26' >                                      <input type='button' id='btn_26' name='btn_26' value='Upload'  onclick=\"upload('file_lamp26',12, 26);\"><span  id='uploaded_image_26'>".$berkas_lamp12."</span></td>
									</tr>
									...
									<tr>
										<td>
											<li> 8. Foto Rumah/Objek</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp163' id='file_lamp163'><input type='button' id='btn_163' name='btn_163' value='Upload'  onclick=\"upload('file_lamp163',38,  163);\"><span   id='uploaded_image_163'>".$berkas_lamp38."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 9. Foto Lokasi Google Map/Denah</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp164' id='file_lamp164'><input type='button' id='btn_164' name='btn_164' value='Upload'  onclick=\"upload('file_lamp164',39,  164);\"><span   id='uploaded_image_164'>".$berkas_lamp39."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 11. Sertifikat Lampiran 1</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp165' id='file_lamp165'><input type='button' id='btn_165' name='btn_165' value='Upload'  onclick=\"upload('file_lamp165',40,  165);\"><span   id='uploaded_image_165'>".$berkas_lamp40."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 12. Sertifikat Lampiran 2</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp166' id='file_lamp166'><input type='button' id='btn_166' name='btn_166' value='Upload'  onclick=\"upload('file_lamp166',41,  166);\"><span   id='uploaded_image_166'>".$berkas_lamp41."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 13. Sertifikat Lampiran 3</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp167' id='file_lamp167'><input type='button' id='btn_167' name='btn_167' value='Upload'  onclick=\"upload('file_lamp167',42,  167);\"><span   id='uploaded_image_167'>".$berkas_lamp42."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 14. Sertifikat Lampiran 4</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp168' id='file_lamp168'><input type='button' id='btn_168' name='btn_168' value='Upload'  onclick=\"upload('file_lamp168',43,  168);\"><span   id='uploaded_image_168'>".$berkas_lamp43."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 15. Sertifikat Lampiran 5</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp169' id='file_lamp169'><input type='button' id='btn_169' name='btn_169' value='Upload'  onclick=\"upload('file_lamp169',44,  169);\"><span   id='uploaded_image_169'>".$berkas_lamp44."</span></td>
										</tr>
                        ...
                        <td width=\"100%\" colspan=\"2\" valign=\"top\">
                             <ul id=\"lampiran\" style=\"margin-left: -20px;\">
								...
								<tr>
									...
									<tr>    
									<td>	
										<li>2. Fotocopy SPPT PBB Tahun Yang Bersangkutan </li></td><td><input onchange='check_extension(this.value)' type='file' name='file_lamp39' id='file_lamp39' >                                                                             <input type='button' id='btn_39' name='btn_39' value='Upload'  onclick=\"upload('file_lamp39',5, 39);\"><span  id='uploaded_image_39'>".$berkas_lamp5."</span></td>
									</tr>  
									...
									<tr>    
									<td>
										<li>5. SSPD Yang Sudah Ditanda Tangani Oleh Wajib Pajak Dan PPAT </li></td><td> <input onchange='check_extension(this.value)' type='file' name='file_lamp42' id='file_lamp42' >																				<input type='button' id='btn_42' name='btn_42' value='Upload'  onclick=\"upload('file_lamp42',1, 42);\"><span  id='uploaded_image_42'>".$berkas_lamp1."</span></td>
									</tr> 
									
									<tr>
									<td>
										<li>6. Fotocopy Surat Keterangan Kepemilikan</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp43' id='file_lamp43'><input type='button' id='btn_43' name='btn_43' value='Upload'  onclick=\"upload('file_lamp43',33,  43);\"><span   id='uploaded_image_43'>".$berkas_lamp33."</span></td>
									</tr>
									
									<tr>    
									<td>	
										<li>7. Fotocopy Surat Keterangan Waris atau Akta Hibah </li></td><td><input onchange='check_extension(this.value)' type='file' name='file_lamp44' id='file_lamp44' >                                      <input type='button' id='btn_44' name='btn_44' value='Upload'  onclick=\"upload('file_lamp44',12, 44);\"><span  id='uploaded_image_44'>".$berkas_lamp12."</span></td>
									</tr>
									...
									<tr>
										<td>
											<li> 8. Foto Rumah/Objek</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp170' id='file_lamp170'><input type='button' id='btn_170' name='btn_170' value='Upload'  onclick=\"upload('file_lamp170',38,  170);\"><span   id='uploaded_image_170'>".$berkas_lamp38."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 9. Foto Lokasi Google Map/Denah</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp171' id='file_lamp171'><input type='button' id='btn_171' name='btn_171' value='Upload'  onclick=\"upload('file_lamp171',39,  171);\"><span   id='uploaded_image_171'>".$berkas_lamp39."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 11. Sertifikat Lampiran 1</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp172' id='file_lamp172'><input type='button' id='btn_172' name='btn_172' value='Upload'  onclick=\"upload('file_lamp172',40,  172);\"><span   id='uploaded_image_172'>".$berkas_lamp40."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 12. Sertifikat Lampiran 2</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp173' id='file_lamp173'><input type='button' id='btn_173' name='btn_173' value='Upload'  onclick=\"upload('file_lamp173',41,  173);\"><span   id='uploaded_image_173'>".$berkas_lamp41."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 13. Sertifikat Lampiran 3</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp174' id='file_lamp174'><input type='button' id='btn_174' name='btn_174' value='Upload'  onclick=\"upload('file_lamp174',42,  174);\"><span   id='uploaded_image_174'>".$berkas_lamp42."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 14. Sertifikat Lampiran 4</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp175' id='file_lamp175'><input type='button' id='btn_175' name='btn_175' value='Upload'  onclick=\"upload('file_lamp175',43,  175);\"><span   id='uploaded_image_175'>".$berkas_lamp43."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 15. Sertifikat Lampiran 5</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp176' id='file_lamp176'><input type='button' id='btn_176' name='btn_176' value='Upload'  onclick=\"upload('file_lamp176',44,  176);\"><span   id='uploaded_image_176'>".$berkas_lamp44."</span></td>
										</tr>
                        ...
                        <td width=\"100%\" colspan=\"2\" valign=\"top\">
                            <ul id=\"lampiran\" style=\"margin-left: -20px;\">
								<table border='0'>
									...
									<tr>    
									<td>	
										<li>2. Fotocopy SPPT PBB Tahun Yang Bersangkutan </li></td><td><input onchange='check_extension(this.value)' type='file' name='file_lamp71' id='file_lamp71' >                                                                             <input type='button' id='btn_71' name='btn_71' value='Upload'  onclick=\"upload('file_lamp71',5,71);\"><span id='uploaded_image_71'>".$berkas_lamp5."</span></td>
									</tr>   
									...
									<tr>    
									<td>	
										<li>5. SSPD Yang Sudah Ditanda Tangani Oleh Wajib Pajak Dan PPAT </li></td><td><input onchange='check_extension(this.value)' type='file' name='file_lamp74' id='file_lamp74' >																				<input type='button' id='btn_74' name='btn_74' value='Upload'  onclick=\"upload('file_lamp74',1,74);\"><span id='uploaded_image_74'>".$berkas_lamp1."</span></td>
									</tr>   
									
									<tr>
									<td>
										<li>6. Fotocopy Surat Keterangan Kepemilikan</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp75' id='file_lamp75'><input type='button' id='btn_75' name='btn_75' value='Upload'  onclick=\"upload('file_lamp75',33,  75);\"><span   id='uploaded_image_75'>".$berkas_lamp33."</span></td>
									</tr>
									
									<tr>
									<td>
										<li>7. Fotocopy Keterangan Badan Hukum, Hadiah, Lelang</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp76' id='file_lamp76'><input type='button' id='btn_76' name='btn_76' value='Upload'  onclick=\"upload('file_lamp76',36,  76);\"><span   id='uploaded_image_76'>".$berkas_lamp36."</span></td>
									</tr>
									
									
									<tr>
										<td>
											<li> 8. Foto Rumah/Objek</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp184' id='file_lamp184'><input type='button' id='btn_184' name='btn_184' value='Upload'  onclick=\"upload('file_lamp184',38,  184);\"><span   id='uploaded_image_184'>".$berkas_lamp38."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 9. Foto Lokasi Google Map/Denah</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp185' id='file_lamp185'><input type='button' id='btn_185' name='btn_185' value='Upload'  onclick=\"upload('file_lamp185',39,  185);\"><span   id='uploaded_image_185'>".$berkas_lamp39."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 11. Sertifikat Lampiran 1</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp186' id='file_lamp186'><input type='button' id='btn_186' name='btn_186' value='Upload'  onclick=\"upload('file_lamp186',40,  186);\"><span   id='uploaded_image_186'>".$berkas_lamp40."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 12. Sertifikat Lampiran 2</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp187' id='file_lamp187'><input type='button' id='btn_187' name='btn_187' value='Upload'  onclick=\"upload('file_lamp187',41,  187);\"><span   id='uploaded_image_187'>".$berkas_lamp41."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 13. Sertifikat Lampiran 3</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp188' id='file_lamp188'><input type='button' id='btn_188' name='btn_188' value='Upload'  onclick=\"upload('file_lamp188',42,  188);\"><span   id='uploaded_image_188'>".$berkas_lamp42."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 14. Sertifikat Lampiran 4</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp189' id='file_lamp189'><input type='button' id='btn_189' name='btn_189' value='Upload'  onclick=\"upload('file_lamp189',43,  189);\"><span   id='uploaded_image_189'>".$berkas_lamp43."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 15. Sertifikat Lampiran 5</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp190' id='file_lamp190'><input type='button' id='btn_190' name='btn_190' value='Upload'  onclick=\"upload('file_lamp190',44,  190);\"><span   id='uploaded_image_190'>".$berkas_lamp44."</span></td>
										</tr>
                        ...
                        <td width=\"100%\" colspan=\"2\" valign=\"top\">
                            <ul id=\"lampiran\" style=\"margin-left: -20px;\">
								<table border='0'>
									...
									<tr>    
									<td>	
										<li>2. Fotocopy SPPT PBB Tahun Yang Bersangkutan </li></td><td><input onchange='check_extension(this.value)' type='file' name='file_lamp120' id='file_lamp120' >                                                                             <input type='button' id='btn_120' name='btn_120' value='Upload'  onclick=\"upload('file_lamp120',5,120);\"><span id='uploaded_image_120'>".$berkas_lamp5."</span></td>
									</tr>   
									...
									<tr>    
									<td>	
										<li>5. SSPD Yang Sudah Ditanda Tangani Oleh Wajib Pajak Dan PPAT </li></td><td><input onchange='check_extension(this.value)' type='file' name='file_lamp116' id='file_lamp116' >																				<input type='button' id='btn_116' name='btn_116' value='Upload'  onclick=\"upload('file_lamp116',1,116);\"><span id='uploaded_image_116'>".$berkas_lamp1."</span></td>
									</tr>   
									
									<tr>
									<td>
										<li>6. Fotocopy Surat Keterangan Kepemilikan</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp154' id='file_lamp154'><input type='button' id='btn_154' name='btn_154' value='Upload'  onclick=\"upload('file_lamp154',33,  154);\"><span   id='uploaded_image_154'>".$berkas_lamp33."</span></td>
									</tr>
									
									<tr>
									<td>
										<li>7. Fotocopy Keterangan Badan Hukum, Hadiah, Lelang</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp155' id='file_lamp155'><input type='button' id='btn_155' name='btn_155' value='Upload'  onclick=\"upload('file_lamp155',36,  155);\"><span   id='uploaded_image_155'>".$berkas_lamp36."</span></td>
									</tr>
									
									<tr>
										<td>
											<li> 8. Foto Rumah/Objek</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp177' id='file_lamp177'><input type='button' id='btn_177' name='btn_177' value='Upload'  onclick=\"upload('file_lamp177',38,  177);\"><span   id='uploaded_image_177'>".$berkas_lamp38."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 9. Foto Lokasi Google Map/Denah</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp178' id='file_lamp178'><input type='button' id='btn_178' name='btn_178' value='Upload'  onclick=\"upload('file_lamp178',39,  178);\"><span   id='uploaded_image_178'>".$berkas_lamp39."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 11. Sertifikat Lampiran 1</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp179' id='file_lamp179'><input type='button' id='btn_179' name='btn_179' value='Upload'  onclick=\"upload('file_lamp179',40,  179);\"><span   id='uploaded_image_179'>".$berkas_lamp40."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 12. Sertifikat Lampiran 2</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp180' id='file_lamp180'><input type='button' id='btn_180' name='btn_180' value='Upload'  onclick=\"upload('file_lamp180',41,  180);\"><span   id='uploaded_image_180'>".$berkas_lamp41."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 13. Sertifikat Lampiran 3</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp181' id='file_lamp181'><input type='button' id='btn_181' name='btn_181' value='Upload'  onclick=\"upload('file_lamp181',42,  181);\"><span   id='uploaded_image_181'>".$berkas_lamp42."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 14. Sertifikat Lampiran 4</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp182' id='file_lamp182'><input type='button' id='btn_182' name='btn_182' value='Upload'  onclick=\"upload('file_lamp182',43,  182);\"><span   id='uploaded_image_182'>".$berkas_lamp43."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 15. Sertifikat Lampiran 5</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp183' id='file_lamp183'><input type='button' id='btn_183' name='btn_183' value='Upload'  onclick=\"upload('file_lamp183',44,  183);\"><span   id='uploaded_image_183'>".$berkas_lamp44."</span></td>
										</tr>
                        ...
                        <td width=\"100%\" colspan=\"2\" valign=\"top\">
                            <ul id=\"lampiran\" style=\"margin-left: -20px;\">
								<table border='0'>
										...
										<tr>
										<td>
											<li> 4. Fotocopy Bukti Pembayaran/Lunas PBB 5 tahun kebelakang </li></td><td> 																																					  <input onchange='check_extension(this.value)' type='file' name='file_lamp127' id='file_lamp127'><input type='button' id='btn_127' name='btn_127' value='Upload'  onclick=\"upload('file_lamp127',6,  127);\"><span   id='uploaded_image_127'>".$berkas_lamp6."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 5. SSPD Yang Sudah Ditanda Tangani Oleh Wajib Pajak Dan PPAT</li></td><td> 																																						<input onchange='check_extension(this.value)' type='file' name='file_lamp128' id='file_lamp128'><input type='button' id='btn_128' name='btn_128' value='Upload'  onclick=\"upload('file_lamp128',1,128);\"><span id='uploaded_image_128'>".$berkas_lamp1."</span></td>
										</tr>
										
										
										<tr>
										<td>
											<li> 6. Fotocopy Surat Keterangan Kepemilikan</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp129' id='file_lamp129'><input type='button' id='btn_129' name='btn_129' value='Upload'  onclick=\"upload('file_lamp129',33,  129);\"><span   id='uploaded_image_129'>".$berkas_lamp33."</span></td>
										</tr>
										...
										<tr>
										<td>
											<li> 12. Sertifikat Lampiran 1</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp193' id='file_lamp193'><input type='button' id='btn_193' name='btn_193' value='Upload'  onclick=\"upload('file_lamp193',40,  193);\"><span   id='uploaded_image_193'>".$berkas_lamp40."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 13. Sertifikat Lampiran 2</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp194' id='file_lamp194'><input type='button' id='btn_194' name='btn_194' value='Upload'  onclick=\"upload('file_lamp194',41,  194);\"><span   id='uploaded_image_194'>".$berkas_lamp41."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 14. Sertifikat Lampiran 3</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp195' id='file_lamp195'><input type='button' id='btn_195' name='btn_195' value='Upload'  onclick=\"upload('file_lamp195',42,  195);\"><span   id='uploaded_image_195'>".$berkas_lamp42."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 15. Sertifikat Lampiran 4</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp196' id='file_lamp196'><input type='button' id='btn_196' name='btn_196' value='Upload'  onclick=\"upload('file_lamp196',43,  196);\"><span   id='uploaded_image_196'>".$berkas_lamp43."</span></td>
										</tr>
										
										<tr>
										<td>
											<li> 16. Sertifikat Lampiran 5</li></td><td> 																																							  <input onchange='check_extension(this.value)' type='file' name='file_lamp197' id='file_lamp197'><input type='button' id='btn_197' name='btn_197' value='Upload'  onclick=\"upload('file_lamp197',44,  197);\"><span   id='uploaded_image_197'>".$berkas_lamp44."</span></td>
										</tr>
