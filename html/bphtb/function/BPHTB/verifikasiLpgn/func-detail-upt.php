<?php
$sRootPath = str_replace('\\', '/', str_replace(DIRECTORY_SEPARATOR . 'function' . DIRECTORY_SEPARATOR . 'BPHTB' . DIRECTORY_SEPARATOR . 'VerifikasiLpgn', '', dirname(__FILE__))) . '/';
...
echo "<link rel=\"stylesheet\" href=\"function/BPHTB/VerifikasiLpgn/func-detail-upt.css\" type=\"text/css\">\n";
...
function formSSB($dat, $edit) {
    ...
    echo "<script src=\"function/BPHTB/VerifikasiLpgn/func-detail-ssb.js?ver=0\"></script>\n";
	...
	$(function(){
        ...
        $(\"#nama-wp-lama\").focus(function(eve){
            ...
            if(isFocus){
                ...
                $.ajax({
                    type: \"POST\",
                    url: \"".$sRootPath."function/BPHTB/VerifikasiLpgn/func-cekNOPPBB.php\",
                    data: \"nop=\"+nop,
...
function checkDukcapil(){
		...
		$.ajax({
			...
			url: './function/BPHTB/VerifikasiLpgn/svcCheckDukcapil.php',
...
function formSSBKB($data) {
    ...
    echo "<script src=\"function/BPHTB/VerifikasiLpgn/func-kurang-bayar.js?ver=0\"></script>\n";
