...
//                if ((i != 54) && (i != 55) && (i != 56) && (i != 58) && (i != 59)) {
				  if ((i != 30) && (i != 37)  && (i != 38)&&(i != 3)&&(i != 11)&&(i != 46)&&(i != 47)) {
                    var ge = document.getElementById('err_' + i);
                    if (!ge) {
                        imgEx[i] = document.createElement("img");
                        imgEx[i].setAttribute("src", "./image/icon/exclamation.png");
...
//                    if ((i == 55) || (i == 56)) {
                        ...
                        if (!ge) {
                            imgEx[i] = document.createElement("img");
                            imgEx[i].setAttribute("src", "./image/icon/exclamation.png");
                            imgEx[i].setAttribute("title", x.title + ' belum diisi!2');
                            imgEx[i].setAttribute("id", 'err_' + i);
                            x.parentNode.appendChild(imgEx[i]);
                        }
...
//                    if ((i == 63) || (i == 64)) {
                    if ((i == 46) || (i == 47)) {
                        ...
                        if (!ge) {
                            imgEx[i] = document.createElement("img");
                            imgEx[i].setAttribute("src", "./image/icon/exclamation.png");
                            imgEx[i].setAttribute("title", x.title + ' belum diisi!3');
                            imgEx[i].setAttribute("id", 'err_' + i);
                            x.parentNode.appendChild(imgEx[i]);
                        }
            ...
            if (x.name == 'jsb-etc') {
                if (x.value == "") {
                    ...
                    if (!ge) {
                        imgEx[i] = document.createElement("img");
                        imgEx[i].setAttribute("src", "./image/icon/exclamation.png");
                        imgEx[i].setAttribute("title", x.title + ' belum diisi!5');
                        imgEx[i].setAttribute("id", 'err_' + i);
                        x.parentNode.appendChild(imgEx[i]);
                    }
