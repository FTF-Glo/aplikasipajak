...
echo "<script src=\"function/BPHTB/pengurangan/func-new-ssb-pel.js?ver=1a\"></script>\n"; // function
          ...
          <input type=\"hidden\" name=\"tahunSPPTOld\" id=\"tahunSPPTOld\"/>
            ...
            <tr>
              ...
              <tr>
                ...
                <td><textarea name=\"address2\" readonly id=\"address2\" cols=\"35\" rows=\"4\" title=\"Lain-lain\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\">" . $value[13] . "</textarea>
                </tr>
              </tr>
              <tr>
                <td><div align=\"right\">3.</div></td>
                <td>Kelurahan/Desa</td>
                <td><input type=\"text\" readonly name=\"kelurahan2\" id=\"kelurahan2\" value=\"" . $value[15] . "\" onKeyPress=\"return nextFocus(this, event);\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\" size=\"20\" maxlength=\"20\" title=\"Kelurahan Objek Pajak\"/></td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td>RT/RW</td>
                <td><input readonly type=\"text\" name=\"rt2\" id=\"rt2\" maxlength=\"3\" size=\"3\" value=\"" . $value[16] . "\" onKeyPress=\"return nextFocus(this, event)\" title=\"RT Objek Pajak\"/>
                /
                <input readonly type=\"text\" name=\"rw2\" id=\"rw2\" maxlength=\"3\" size=\"3\" value=\"" . $value[17] . "\" onKeyPress=\"return nextFocus(this, event)\" title=\"RW Wajib Pajak\"/></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                ...
                <td>Kecamatan</td>
                <td><input readonly type=\"text\" name=\"kecamatan2\" id=\"kecamatan2\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\" value=\"" . $value[18] . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"20\" maxlength=\"20\" title=\"Kecamatan Objek Pajak\"/></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                ...
                <td><input readonly type=\"text\" name=\"kabupaten2\" id=\"kabupaten2\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\" value=\"" . $value[19] . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"20\" maxlength=\"20\" title=\"Kabupaten/Kota Objek Pajak\"/></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                ...
                <td>Kode Pos</td>
                <td><input readonly type=\"text\" name=\"zip-code2\" id=\"zip-code2\" value=\"" . $value[20] . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"5\" maxlength=\"5\" title=\"Kode Pos Objek Pajak\"/></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>Nama WP Sesuai Sertifikat</td> 
                  <td><input readonly type=\"text\" name=\"nama-wp-cert\" id=\"nama-wp-cert\" value=\"" . $value[41] . "\" size=\"30\" maxlength=\"30\" title=\"Nama WP Sesuai Sertifikat\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\"/>
                  </td>
              </tr>	
              <tr>
            ...
            <tr>
              ...
              <tr>
                <td><div align=\"right\">5.</div></td>
                        <td>Kecamatan</td>
                        <td><input type=\"text\" name=\"kecamatan\" id=\"kecamatan\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\" onkeypress=\"return nextFocus(this,event)\" size=\"20\" maxlength=\"20\" title=\"Kecamatan Wajib Pajak\"/></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><div align=\"right\">7.</div></td>
                        <td>Kelurahan/Desa</td>
                        <td>
                          <input type=\"text\" name=\"kelurahan\" id=\"kelurahan\" onKeyUp=\"javascript:{this.value = this.value.toUpperCase(); }\" value=\"" . $value[6] . "\" onkeypress=\"return nextFocus(this,event)\" size=\"20\" maxlength=\"20\" title=\"Kelurahan/Desa Wajib Pajak\"/>
                        </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
            ...
            <tr>
            <td align=\"center\" valign=\"middle\" bgcolor=\"#CCCCCC\"><input readonly type=\"text\" name=\"land-area\" id=\"land-area\" value=\"" . $value[22] . "\" onKeyPress=\"return numbersonly(this, event)\" onkeyup=\"addSN();addET();checkTransaction();\" title=\"Luas Tanah\"/>
              m²</td>
            <td align=\"center\" valign=\"middle\" bgcolor=\"#999999\"><input readonly type=\"text\" name=\"land-njop\" id=\"land-njop\" value=\"" . $value[23] . "\" onKeyPress=\"return numbersonly(this, event)\"  onkeyup=\"addSN();addET();checkTransaction();\" title=\"NJOP Tanah\"/></td>
            ...
            <tr>
            <td align=\"center\" valign=\"middle\" bgcolor=\"#CCCCCC\"><input readonly type=\"text\" name=\"building-area\" id=\"building-area\" value=\"" . $value[24] . "\" onKeyPress=\"return numbersonly(this, event)\" onkeyup=\"addET();addSN();checkTransaction();\" title=\"Luas Bangunan\"/>
          m²</td>
            <td align=\"center\" valign=\"middle\" bgcolor=\"#999999\"><input readonly type=\"text\" name=\"building-njop\" id=\"building-njop\" value=\"" . $value[25] . "\" onKeyPress=\"return numbersonly(this, event)\" onkeyup=\"addET();addSN();checkTransaction();\" title=\"NJOP Bangunan\"/></td>
