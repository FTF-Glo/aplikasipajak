...
// console.log(bnjop);
    ...
    var sts_kurangbayar = document.getElementById('sts_kurangbayar').value;
    ...
    var valueharusbayar = document.getElementById('harusbayar').textContent;
...
//  console.log(jnsperolehan); 
		...
		if((jnsperolehan=="4")||(jnsperolehan=="5")||(jnsperolehan=="31")){
           ...
           // console.log(cek);
            ...
            // console.log(sts_kurangbayar == "" || empty(sts_kurangbayar));
            if (sts_kurangbayar == "" || sts_kurangbayar == null) {
                bphtbt1= (NPOPKP * 0.05)+denda;
                bphtbt = document.createTextNode(number_format((NPOPKP * 0.05)+denda, 0, '.', ','));
            }else{
                // bphtbt1= valueharusbayar;
                cleanedValue = valueharusbayar.replace(/,/g, '');
                bphtbt1 = parseInt(cleanedValue, 10);
                bphtbt = document.createTextNode(number_format((cleanedValue), 0, '.', ','));
                // console.log(bphtbt);
            }
            // bphtbt = "100";
            var cek=$("#tBPHTB_BAYAR").val();
...
// console.log(bphtbt);
    ...
    // }else{
    //     var bphtbkb = bphtbt - bphtbsb;
    // }

	if (isNaN(bphtbkb)) {
		document.getElementById('tBPHTBTU').value=50;
	}else{
