...
function getConfigPrint(&$dataConnect,$ppid,$module,$appDbLink) {
	...
	$configCode = $ppid.".PP.bphtb.PC.print.printer";
	$query = sprintf( "SELECT *	FROM c_registry	WHERE C_R_KEY LIKE '%s'", mysqli_real_escape_string($appDbLink, $configCode));
	$result = mysqli_query($appDbLink, $query);
	if ($row = mysqli_fetch_array($result)) {
		$dataConnect['printer'] = $row['C_R_VALUE'];
		$OK = true;
	}else{
		$query = sprintf( "INSERT INTO c_registry(C_R_KEY,C_R_VALUE)	VALUES('%s','Epson LX-300+ /II')", mysqli_real_escape_string($appDbLink, $configCode));
		if(mysqli_query($appDbLink, $query)){
			$dataConnect['printer'] = "Epson LX-300+ /II";
			$OK = true;
		}
	}
	$configCode = $ppid.".PP.bphtb.PC.print.driver";
	$query = sprintf( "SELECT *	FROM c_registry	WHERE C_R_KEY = '%s'", mysqli_real_escape_string($appDbLink, $configCode));
	$result = mysqli_query($appDbLink, $query);
	if ($row = mysqli_fetch_array($result)) {
	...
	$configCode = $ppid.".PP.bphtb.PC.print.copy";
	$query = sprintf( "SELECT *	FROM c_registry	WHERE C_R_KEY LIKE '%s'", mysqli_real_escape_string($appDbLink, $configCode));
	$result = mysqli_query($appDbLink, $query);
	if ($row = mysqli_fetch_array($result)) {
		...
		$query = sprintf( "INSERT INTO c_registry(C_R_KEY,C_R_VALUE)	VALUES('%s','1')", mysqli_real_escape_string($appDbLink, $configCode));
		if(mysqli_query($appDbLink, $query)){
			$dataConnect['copy'] = "1";
			$OK = true;
		}
	}
	$configCode = $ppid.".PP.bphtb.PC.print.a4";
	$query = sprintf( "SELECT *	FROM c_registry	WHERE C_R_KEY LIKE '%s'", mysqli_real_escape_string($appDbLink, $configCode));
	$result = mysqli_query($appDbLink, $query);
	if ($row = mysqli_fetch_array($result)) {
		...
		$query = sprintf( "INSERT INTO c_registry(C_R_KEY,C_R_VALUE)	VALUES('%s','0')", mysqli_real_escape_string($appDbLink, $configCode));
		if(mysqli_query($appDbLink, $query)){
			$dataConnect['a4'] = "0";
			$OK = true;
		}
	...
	$configCode = $ppid.".PP.bphtb.PC.kabkot";
	$query = sprintf( "SELECT *	FROM c_registry	WHERE C_R_KEY LIKE '%s'", mysqli_real_escape_string($appDbLink, $configCode));
	$result = mysqli_query($appDbLink, $query);
	if ($row = mysqli_fetch_array($result)) {
...
function getDataTestPrint(&$testPrintValue) {
    ...
    $query = sprintf( "SELECT * FROM csccore_bank A, csccore_bank_downline B
        ...
        GROUP BY A.CSC_B_ID LIMIT 0,1", mysqli_real_escape_string($appDbLink, $cid));
    $result = mysqli_query($appDbLink, $query);
...
function displayPrintForm($module,$application,$enable=true,$printer=null,$copy=null,$a4=null,$kabkot,$driver=null) {
	...
	<?php
	echo "\n<script language='JavaScript' src='function/bphtb/bphtb-config.js'></script>\n";
	echo "  <script>\n";
...
function updatePrint($ppid,$module,$appDbLink,$printer,$copy,$a4,$kabkot,$driver) {
	...
	$query = sprintf("INSERT INTO c_registry (C_R_KEY,C_R_VALUE) VALUES ('%s','%s') ON DUPLICATE KEY UPDATE C_R_VALUE = '%s'",
		mysqli_real_escape_string($appDbLink, $configCode),
		mysqli_real_escape_string($appDbLink, $printer),
		mysqli_real_escape_string($appDbLink, $printer)
	);
	$result = mysqli_query($appDbLink, $query);
	$configCode = $ppid.".PP.bphtb.PC.print.copy";
	$query = sprintf("INSERT INTO c_registry (C_R_KEY,C_R_VALUE) VALUES ('%s','%s') ON DUPLICATE KEY UPDATE C_R_VALUE = '%s'",
		mysqli_real_escape_string($appDbLink, $configCode),
		mysqli_real_escape_string($appDbLink, $copy),
		mysqli_real_escape_string($appDbLink, $copy)
	);
	$result = mysqli_query($appDbLink, $query);
	$configCode = $ppid.".PP.bphtb.PC.print.driver";
	$query = sprintf("INSERT INTO c_registry (C_R_KEY,C_R_VALUE) VALUES ('%s','%s') ON DUPLICATE KEY UPDATE C_R_VALUE = '%s'",
		mysqli_real_escape_string($appDbLink, $configCode),
		mysqli_real_escape_string($appDbLink, $driver),
		mysqli_real_escape_string($appDbLink, $driver)
	);
	$result = mysqli_query($appDbLink, $query);
	$configCode = $ppid.".PP.bphtb.PC.print.a4";
	$query = sprintf("INSERT INTO c_registry (C_R_KEY,C_R_VALUE) VALUES ('%s','%s') ON DUPLICATE KEY UPDATE C_R_VALUE = '%s'",
		mysqli_real_escape_string($appDbLink, $configCode),
		mysqli_real_escape_string($appDbLink, $a4),
		mysqli_real_escape_string($appDbLink, $a4)
	);
	$result = mysqli_query($appDbLink, $query);
	...
	$query = sprintf("INSERT INTO c_registry (C_R_KEY,C_R_VALUE) VALUES ('%s','%s') ON DUPLICATE KEY UPDATE C_R_VALUE = '%s'",
		mysqli_real_escape_string($appDbLink, $configCode),
		mysqli_real_escape_string($appDbLink, $kabkot),
		mysqli_real_escape_string($appDbLink, $kabkot)
	);
	$result = mysqli_query($appDbLink, $query);
