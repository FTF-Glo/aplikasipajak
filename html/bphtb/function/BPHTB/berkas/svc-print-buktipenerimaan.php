...
function getHTML($idssb, $initData, $fileLogo) {
    ...
    $parse1 = "";
    $parse2 = "";
	$tgl=explode("-",$data->CPM_BERKAS_TANGGAL);
	$tgl_create =date_create($tgl[2]."-".$tgl[1]."-".$tgl[0]);
	$tgl_perkiraan =date_add($tgl_create,date_interval_create_from_date_string("4 days"));
	$tgl_selesai = date_format($tgl_perkiraan,"d-m-Y");
    $html = "
	<html>
        ...
        <tr>
			...
			<td colspan=\"3\">
				...
				<table border=\"0\" cellpadding=\"1\" cellspacing=\"5\">
					...
					<tr>
                        <td>Tanggal Perkiraan Selesai</td><td>:</td>
                        <td>" . $tgl_selesai . "</td>
                    </tr>";
...
for ($i = 0; $i < $v; $i++) {
    ...
    $pdf->Image($sRootPath . 'view/Registrasi/configure/logo/' . $fileLogo, 9, 7, 15, '', '', '', '', false, 300, '', false);
    $pdf->SetAlpha(0.3);
}
