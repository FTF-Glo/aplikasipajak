...
function formSSB ($dat,$edit) {
	global $data,$uname,$a,$DBLink;
	echo "<script language=\"javascript\">var axx='".base64_encode($a)."';</script>\n";
	echo "<script src=\"function/BPHTB/updateBPHTB/expired/func-form-update-bphtb.js?ver=0\"></script>\n";
...
.myButton:active {
	...
	<div id=\"main-content\"><form id=\"form-notaris\" name=\"form-notaris\" method=\"post\" action=\"\" onsubmit=\"return checkform();\">
			...
			<tr>
			  <td colspan=\"2\" align=\"center\" style=\"border-radius: 10px 10px 0px 0px;\"><strong><font size=\"+2\">Update Expired<br>(Tanggal Kadaluarsa)</font></strong></td>
			</tr>
			<tr>
			  ...
			  <td><table width=\"850\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
				...
				<tr>
				  ...
				  <td width=\"220\"><input type=\"date\" name=\"expired_date\" id=\"expired_date\" value=\"" . $dat->expired_date . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"25\"  " . $readonly . " title=\"Expired\"/></td>
