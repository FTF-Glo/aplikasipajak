...
class displayDocument
{
	...
	function setSubmit($type, $info, $info_disetujui, $vers)
	{
		...
		/* ini codingan asli jika tagihannya masuk ke table ssb sehabis verifikasi 2 */
		// if ($status == 5) {
		// 	if ($cekGW != 1) {
		...
		// 	}
		// }
		/* end ini codingan asli jika tagihannya masuk ke table ssb sehabis verifikasi 2	*/
