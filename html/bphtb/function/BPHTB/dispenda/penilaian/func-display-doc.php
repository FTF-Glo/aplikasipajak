...
// var_dump();die; 
  ...
  function display()
  {
    $verifPenilaian= $this->viewVerifPenilaian();
    return $verifPenilaian;
   
  }

  function viewVerifPenilaian(){
    ...
    $html .= "<script type=\"text/javascript\" src=\"inc/PBB/jquery-ui-1.8.18.custom/js/jquery-1.7.1.min.js\"></script>";
    $html .= "<script type=\"text/javascript\" src=\"inc/PBB/jquery-ui-1.8.18.custom/js/jquery-ui-1.8.18.custom.min.js\"></script>";
    $html .= "<script language=\"javascript\" src=\"./function/BPHTB/dispenda/penilaian/func-display-penilaian.js?N\" type=\"text/javascript\"></script>";
