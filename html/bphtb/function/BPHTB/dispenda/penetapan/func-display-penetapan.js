function checkform(event) {
	...
	// console.log("Tombol yang diklik:", clickedButton);
	if (clickedButton === "Kurang Bayar") { /* handler even pada file func-dispay-doc.php penetapan di function viewVerifPenetapan */
...
function printToPDFSKPDKB(json) {
	// console.log('itu');
	window.open('./function/BPHTB/notaris/svc-print-notaris-skpdkb.php?q=' + encodeBase64(json), '_newtab');
}
