        ...
        <td>
         ...
         <tr>
				<td width=\"2%\"><div align=\"right\"></div></td>
				  <td width=\"18%\"></td> 
          <td width=\"30%\"><input type=\"hidden\" name=\"name2\" id=\"name2\"/> </td>
				  <!--  <td width=\"30%\"><input type=\"hidden\" name=\"name2\" id=\"name2\"/> <label id=\"load-pbb\"></label></td> --> 
				  <!-- <td>Nama WP Lama :</td> -->
			...
			<tr>
			  ...
			  <td width=\"97%\"><table width=\"900\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
				...
				<tr>
				  <td width=\"2%\"><div align=\"right\">1.</div></td>
				  <td>Nomor KTP</td>
          <td width=\"30%\"><input type=\"text\" name=\"noktp\" id=\"noktp\" value=\"" . $value[38] . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"16\" maxlength=\"24\" title=\"No KTP wajib di isi\" \" onblur=\"checkTransLast();\" /> <input type=\"button\" value=\"Cek KTP\" onclick=\"checkKTP();\" id=\"cekktp\"> <label id=\"load-ktp\"> <span style=\"color :red;  font-style: italic;\"><sup>Double klik</sup></span></label></td>
				<tr>
			  ...
			  <table width=\"747\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
				<tr>
				  ...
				  <td><input type=\"text\" name=\"Koordinat\" id=\"Koordinat\" value=\"" . 0 . "\" onkeyup=\"javascript:{this.value = this.value.toUpperCase(); }\" value=\"\" onkeypress=\"return nextFocus(this,event)\" size=\"20\" title=\"Titik Koordinat Wajib diisi\" isdatepicker=\"true\"></td>
			    <tr>
                <tr>
