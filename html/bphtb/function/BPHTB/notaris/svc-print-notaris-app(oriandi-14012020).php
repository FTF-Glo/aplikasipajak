...
function getData($iddoc) {
    ...
    $query = sprintf("SELECT * , DATE_FORMAT(A.CPM_SSB_CREATED, '%%d-%%m-%%Y') as COM_SSB_CREATED,
					...
					AND B.CPM_TRAN_FLAG=0 AND A.CPM_SSB_ID='%s'", getConfigValue("1", 'TENGGAT_WAKTU'), $iddoc);
...
function getHTML($iddoc,$lampiran,$ket_lamp) {
    global $uname, $NOP, $setuju, $draf,$ids;
...
BEA PEROLEHAN HAK ATAS TANAH DAN BANGUNAN <br />
  ...
  <tr>
	...
	<table width=\"100%\" border=\"0\" cellpadding=\"1\">
      ...
      <tr>
        ...
        <td>NPWP</td>
        <td>:</td>
        <td  colspan=\"11\"><span class=\"document-x\">" . $npwp . "</span></td>
      </tr>
      <tr>
        <td align=\"right\">3.</td>
      ...
      <tr>
        ...
        <td>No. KTP</td>
        <td>:</td>
        <td width=\"225\" colspan=\"11\"><span class=\"document-x\">" . $noktp . "</span></td>		
      </tr>
      <tr>
        <td align=\"right\">5.</td>
  ...
  <tr>
	...
	<table width=\"500\" border=\"0\" cellpadding=\"1\">
      ...
      <tr>
        ...
        <td width=\"130\" align=\"right\">
			<table>
				<tr>
					<td width=\"20\" align=\"left\">Rp. </td>
					<td width=\"133\" align=\"right\"> " . number_format(getBPHTBPayment(0), 0, ',', '.') . "</td>
				</tr>
			</table>
		</td>
      </tr>
      <tr>
        ...
        <td>
			<table>
				<tr>
					<td width=\"20\" align=\"left\">Rp. </td>
					<td width=\"133\" align=\"right\"> " . number_format($NPOPTKP, 0, ',', '.') . "</td>
				</tr>
			</table>			
		</td>
      </tr>
      <tr>
        <td width=\"382\" align=\"left\">Nilai Perolehan Objek Pajak Kena Pajak(NPOPKP)</td>
        ...
        <td>
			<table border=\"0\">
				<tr>
					<td width=\"20\" align=\"left\">Rp. </td>
					<td width=\"133\" align=\"right\">" . number_format(getBPHTBPayment(1), 0, ',', '.') . "</td>
				</tr>
			</table>	
		</td>
      </tr>
      <tr>
        ...
        <td>
			<table>
				<tr>
					<td width=\"20\" align=\"left\">Rp. </td>
					<td width=\"133\" align=\"right\">" . number_format(getBPHTBPayment(2), 0, ',', '.') . "</td>
				</tr>
			</table>
		</td>
      </tr>
	  <tr>
        ...
        <td>
			<table>
				<tr>
					<td width=\"20\" align=\"left\">Rp. </td>
					<td width=\"133\" align=\"right\">" . number_format(getBPHTBPayment(3), 0, ',', '.') . "</td>
				</tr>
			</table>
		</td>
      </tr>
	  <tr>
        <td></td><td align=\"left\"><font size=\"-1\">APHB  ".$tampilAPHB."</font></td>
        ...
        <td>
			<table>
				<tr>
					<td width=\"20\" align=\"left\">Rp. </td>
					<td width=\"133\" align=\"right\">" . number_format(getBPHTBPayment(4), 0, ',', '.') . "</td>
				</tr>
			</table>
		</td>
      </tr>
	  <tr>
		<td></td>
        <td align=\"left\">Bea Perolehan atas Hak Tanah dan Bangunan yang harus dibayar</td>
        <td><font size=\"-2\"></font></td>
        <td align=\"left\">7.</td>
        <td>
			<table>
				<tr>
					<td width=\"20\" align=\"left\">Rp. </td>
					<td width=\"133\" align=\"right\">" . number_format(intval(getBPHTBPayment(5)), 0, ',', '.'). "</td>
				</tr>
			</table>
		</td>
      </tr>
	...
	<tr>
		...
		<td>
			<table>
				<tr>
					<td width=\"20\" align=\"left\">Rp. </td>
					<td width=\"133\" align=\"right\">" . number_format(intval(getBPHTBPayment(6)), 0, ',', '.') . "</td>
				</tr>
			</table>
		</td>	
	  </tr>
			  ...
			  <tr>
				...
				<td>
					<table border=\"1\" width=\"575\">
						<tr>
							<td>&nbsp;&nbsp;<font size=\"-2\">" . strtoupper(SayInIndonesian(number_format(intval(getBPHTBPayment(6)), 0, ',', ''))) . " RUPIAH</font></td>
						</tr>
					</table>
				</td>        
			  </tr>
  ...
  <tr>
	...
	<td width=\"185\">
		<table width=\"100%\" border=\"0\">		  
			<tr>
		      <td align=\"center\" height=\"10\" colspan=\"3\">
			  	<font size=\"-3\">PPAT/NOTARIS<br><br></font>		  
			  </td>
	        </tr>
			<tr>
	...
	<table width=\"100%\" border=\"0\">
		    <tr>
		      <td align=\"center\" height=\"10\" colspan=\"3\">
			  <font size=\"-2\">TELAH DIVERIFIKASI <br>BADAN PENGELOLAAN PAJAK DAN RETRIBUSI DAERAH<br> KABUPATEN LAMPUNG SELATAN</font>			  
			  </td>
	        </tr>
			<tr>
			...
			<tr>
			  <td width=\"10\"></td>
		      <td align=\"center\" valign=\"top\">
			  	<font size=\"-2\" ><b>NIP: " . getConfigValue("1", 'NIP_PJB_PENGESAH') . "</b></font>
			  </td>
			  <td width=\"10\"></td>
	        </tr>
		</table>
...
for ($i = 0; $i < $v; $i++) {
	...
	$lampiran_wp_ket="Untuk<br>WAJIB PAJAK<br>SEBAGAI<br>BUKTI PEMBAYARAN";
	$lampiran_bpprd="Lembar 2";
	$lampiran_bpprd_ket="Untuk<br>BPPRD<br>MELALUI BANK LAMPUNG<br>SEBAGAI<br>ARSIP DAN PELAPORAN";
	$lampiran_bpprd_pen="Lembar 3";
	$lampiran_bpprd_pen_ket="Untuk<br>BPPRD<br>SEBAGAI<br>BUKTI PEMBAYARAN";
	$lampiran_bpprd_BPN="Lembar 4";
	$lampiran_bpprd_BPN_ket="Untuk<br>KANTOR BPN<br>DISAMPAIKAN OLEH WP<br>SEBAGAI<br>ARSIP DAN PELAPORAN KE<br>BPPRD";
	$lampiran_bpprd_2="Lembar 5";
	$lampiran_bpprd_ket_2="Untuk<br>BPPRD<br>MELALUI BANK LAMPUNG<br>SEBAGAI<br>ARSIP DAN PELAPORAN";
	$lampiran_notaris="Lembar 6";
	$lampiran_notaris_ket="Untuk<br>PPAT/NOTARIS<br>SEBAGAI<br>ARSIP DAN PELAPORAN KE<br>BPPRD";
