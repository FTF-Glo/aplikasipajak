...
function getHTML($iddoc, $lampiran, $ket_lamp)
{
  ...
  $payment_code = get_datassb($data->CPM_SSB_ID);
...
BEA PEROLEHAN HAK ATAS TANAH DAN BANGUNAN <br />
    ...
    Kode Bayar: &nbsp;<br><strong>" . $payment_code . "<br></strong></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<table width=\"780\" border=\"0\" cellpadding=\"1\">
      ...
      <tr>
        ...
        <td width=\"132\"> RT/RW</td>
        <td width=\"8\">:</td>
        <td width=\"175\" colspan=\"6\"><span class=\"document-x\">" . $data->CPM_OP_RT . "/" . $data->CPM_OP_RW . "</span></td>
      </tr>
      <tr>
        <td align=\"right\">5.</td>
        <td>Kecamatan</td>
...
if ($data->statuspengurangan == 1) {
  ...
  <td>" . $data->CPM_PAYMENT_TIPE_PENGURANGAN . "%</td>";
    ...
    $html .= " <td>Bedasarkan peraturan KDH No</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><table width=\"100%\" border=\"1\" cellpadding=\"1\">
        ...
        <table width=\"100%\" border=\"0\">       
            <tr>
              <td align=\"center\" height=\"10\" colspan=\"3\">
                ...
                <font size=\"-3\">MENGETAHUI PPAT/NOTARIS</font>       
              </td>
            </tr>
            <tr>
              <td align=\"left\" colspan=\"3\" height=\"70\">
              <font size=\"-3\">&nbsp;&nbsp;&nbsp;</font>
              </td>
            </tr>
            <tr>
...
for ($i = 0; $i < $v; $i++) {
  ...
  $pdf->Image($sRootPath . 'view/Registrasi/configure/logo/' . $fileLogo, 14, 2, 19, '', '', '', '', false, 300, '', false);
  $pdf->SetAlpha(0.3);
  if (($draf == 1) && ($setuju != 1)) {
    $bottomMargin = 0;
    for ($x = 1; $x <= 9; $x++) {
  ...
  // $pdf->Image($sRootPath . 'view/Registrasi/configure/logo/' . $fileLogo, 13, -1, 25, '', '', '', '', false, 300, '', false);
  $pdf->Image($sRootPath . 'view/Registrasi/configure/logo/' . $fileLogo, 14, 2, 22, '', '', '', '', false, 300, '', false);
  $pdf->SetAlpha(0.3);
  if (($draf == 1) && ($setuju != 1)) {
    $bottomMargin = 0;
    for ($x = 1; $x <= 9; $x++) {
