...
function checkform()
{
        ...
        if (x.type == 'text') {
            ...
            if (x.value == '') {
               ...
               // if ((i != 30) && (i != 31) && (i != 32) && (i != 34) && (i != 35)) {
				...
				if ((i != 57) && (i != 56) && (i != 58) && (i != 61) && (i != 62)&& (i != 28) && (i != 44)&& (i != 69)
                && (i != 70) && i!= 71 && i!=63) {
                    var ge = document.getElementById('err_' + i);
                    if (!ge) {
                        imgEx[i] = document.createElement("img");
    ...
    if (window.status_pelaporan==1) {
        alert("Pelaporan ini sudah diinput! Silahkan lanjutkan pada menu Pelaporan tab Tertunda")
        return false
    ...
    else if(window.status_pelaporan==9 || window.status_pelaporan == 0){
        window.load_pelaporan='success'
    }


    if (window.load_pelaporan=='') {
        return false
    }
    else{
        hideMask();
...
function loadNPOPTKP() {
    ...
    Ext.Ajax.request({
        ...
        method: 'POST',
        params: {id: d, axx: axx, noktp: noktp,jh:jh},
        success: function(result, request) {
...
function check_nop_ktp() {
    ...
    var nop = document.getElementById("name2").value;
    Ext.Ajax.request({
        url : './function/BPHTB/notaris/svc-validasi-pelaporanbaru.php',
        method: 'POST',
