var cNPOPTKP = 0;
var xOk = false;
var status_pelaporan = '';
var load_pelaporan = '';
function checkform() {
    var f = document.getElementById('form-notaris');
    var kelrhn = document.getElementById('kelurahan').value;
    var els = f.elements;
    var err = '';
    ...
    for (var i = 0, len = els.length; i < len; i++) {
        ...
        if (x.type == 'text') {
            ...
            if (x.value == '') {
                ...
                // if ( (i != 57) && (i != 58) && (i != 61) && (i != 62) && (i != 28) && (i != 44) && (i != 70) && (i != 71) && (i != 72) && (i != 63) && (i != 64) && (i != 73) && (i != 65)) {
                // if ((i != 28) && (i != 44) &&(i != 57) && (i != 58) && (i != 59) && (i != 62) && (i != 63) && (i != 64) && (i != 65) &&  (i != 66)  &&  (i != 71) && (i != 72) && (i != 73) &&  (i != 74)  ) {
                // if ((i != 28) && (i != 44) && (i != 57) && (i != 58) && (i != 59) && (i != 60) && (i != 61) && 
                //     (i != 64) && (i != 65) && (i != 66) && (i != 67) && (i != 68) && (i != 73) && (i != 74) && (i != 75) && 
                //     (i != 76) && (i != 80) && (i != 81)) {
                //     var ge = document.getElementById('err_' + i);
                //     if (!ge) {
                //         imgEx[i] = document.createElement("img");
                //         imgEx[i].setAttribute("src", "./image/icon/exclamation.png");
                //         imgEx[i].setAttribute("title", x.title + ' belum diisi! 1');
                //         imgEx[i].setAttribute("id", 'err_' + i);
                //         x.parentNode.appendChild(imgEx[i]);
                //     }
                //     err += x.title + 'belum diisi! 2' + i + '\n'
                // };
                ...
                //             imgEx[i] = document.createElement("img");
                //             imgEx[i].setAttribute("src", "./image/icon/exclamation.png");
                //             imgEx[i].setAttribute("title", x.title + ' belum diisi 10!');
                //             imgEx[i].setAttribute("id", 'err_' + i);
                //             x.parentNode.appendChild(imgEx[i]);
                //         }
                //         err += x.title + ' belum diisi! 3\n';
                //     }
                // }
                // else if (rb == 5) {
                //     // if ((i == 34) || (i == 35)) {
                ...
                //             imgEx[i] = document.createElement("img");
                //             imgEx[i].setAttribute("src", "./image/icon/exclamation.png");
                //             imgEx[i].setAttribute("title", x.title + ' belum diisi! 4');
                //             imgEx[i].setAttribute("id", 'err_' + i);
                //             x.parentNode.appendChild(imgEx[i]);
                //         }
                //         err += x.title + 'belum diisi! 5\n';
                //     }
                // }

                var mainNopInput = document.getElementById("main-nop-input").value;
                var nopSub1Input = document.getElementById("nopsub-2-1").value;
                var nopSub2Input = document.getElementById("nopsub-2-2").value;
                var nopSub3Input = document.getElementById("nopsub-2-3").value;
                var nopSub4Input = document.getElementById("nopsub-2-4").value;
                var nopSub5Input = document.getElementById("nopsub-2-5").value;
                var nopSub6Input = document.getElementById("nopsub-2-6").value;
                var nopSub7Input = document.getElementById("nopsub-2-7").value;
                var namaWpLamaInput = document.getElementById("nama-wp-lama").value;
                var npwp = document.getElementById("npwp").value;
                var nama_wp_cert = document.getElementById("nama-wp-cert").value;
                ...
                nopSub7Input === "") {
                    alert("harus diisi terisi semua!");
                    return false;
                }
            }
        }
        if (x.name == 'address') {
            if (x.value.trim() == "") {
                ...
                if (!ge) {
                    imgEx[i] = document.createElement("img");
                    imgEx[i].setAttribute("src", "./image/icon/exclamation.png");
                    imgEx[i].setAttribute("title", x.title + ' belum diisi! 6');
                    imgEx[i].setAttribute("id", 'err_' + i);
                    x.parentNode.appendChild(imgEx[i]);
                }
                err += x.title + ' belum diisi! 7\n';
            }
        }
            ...
            if (x.name == 'jsb-etc') {
                if (x.value == "") {
                    ...
                    if (!ge) {
                        imgEx[i] = document.createElement("img");
                        imgEx[i].setAttribute("src", "./image/icon/exclamation.png");
                        imgEx[i].setAttribute("title", x.title + ' belum diisi! 8');
                        imgEx[i].setAttribute("id", 'err_' + i);
                        x.parentNode.appendChild(imgEx[i]);
                    }
                    err += x.title + ' belum diisi! 9 \n';
                }
            }
            ;
        }
    ...
    if (kelrhn == '') {
        err += ' Silahkan pilih kelurahan terlebih dahulu!\n'
    }
    if (rb == '')
    ...
    if (window.status_pelaporan == 1) {
        alert("Pelaporan ini sudah diinput! Silahkan lanjutkan pada menu Pelaporan tab Sementara")
        return false
    } else if (window.status_pelaporan == 2) {
        alert("Pelaporan ini sudah diinput! Menunggu untuk verifikasi")
        return false
    } else if (window.status_pelaporan == 3) {
        alert("Pelaporan ini sudah diinput! Menunggu untuk persetujuan")
        return false
    } else if (window.status_pelaporan == 4) {
        alert("Pelaporan ini sudah diinput! Silahkan lanjutkan pada menu Pelaporan tab Ditolak")
        return false
    } else if (window.status_pelaporan == 99) {
        alert("Pelaporan ini sudah diinput! Menunggu untuk pembayaran")
        return false
    }
    else {
        validasi_check_nop()
        ...
        if (window.status_pelaporan == 1) {
            ...
            alert("Pelaporan ini sudah diinput! Menunggu untuk Ferivikasi")
            return false
        } else if (window.status_pelaporan == 3) {
            alert("Pelaporan ini sudah diinput! Menunggu untuk persetujuan")
            return false
        ...
        else if (window.status_pelaporan == 9) {
            // alert(window.status_pelaporan);
            load_pelaporan = 'success'
        }
    }
    ...
    else if (load_pelaporan == 'success') {
        hideMask();
        return true;
    }
}
        ...
        success: function (result, request) {
            ...
            if (jsonData.success) {
                if (jsonData.result == 3) {
                    alert("Maaf data anda tidak bisa ditindaklanjuti, karena data sudah masuk dan sedang diproses!");
                    //dikomentar karena bphtb sebelumnya cek nop sudah diproses atau belum jadi tanpa validasi
                    //$("input[type=submit]").attr("disabled", "disabled");
                    return false;
                } else if (jsonData.result == 2) {
                    alert("Maaf data anda tidak bisa ditindaklanjuti, karena data sebelumnya belum dibayar!");
                    //dikomentar karena bphtb sebelumnya cek nop sudah diproses atau belum jadi tanpa validasi
                    //$("input[type=submit]").attr("disabled", "disabled");
                    return false;
                } else {
                    // alert("NOP yang anda masukan tidak tersedia, Silakan cek ulang!");
                    //dikomentar karena bphtb sebelumnya cek nop sudah diproses atau belum jadi tanpa validasi
...
$(document).ready(function () {
    document.getElementById('NPOPTKP_input').addEventListener('input', checkTransaction);
});
...
function checkTransaction() {
    ...
    var NPOPTKP_input = document.getElementById('NPOPTKP_input').value;
    // console.log(eNPOPTKP);
    // var eNPOPTKP = document.getElementById('NPOPTKP');
    ...
    if (m <= 0) {
        ...
        NPOPKP = jsbtotalbefore.value - NPOPTKP_input;
        // NPOPKP = 30;
        // NPOPKP = (jsbtotalbefore.value*peraphb_) - cNPOPTKP;
    ...
    // var npopkp = document.createTextNode(number_format(10, 0, '.', ','));
    // var npopkp =10;
    // console.log(npopkp)
...
console.log(NPOPTKP_input);
    document.getElementById('denda-value').value = denda;
    document.getElementById("hd-npoptkp").value = NPOPTKP_input;
...
function loadNPOPTKP() {
    ...
    var jh = document.getElementById("right-land-build").value;
    var eNPOPTKP = document.getElementById("NPOPTKP");
    var NPOPTKP_input = document.getElementById("NPOPTKP_input");
    var checkboxs = document.getElementById("npoptkptahunlalu");
    var kotak = document.getElementById("tahunlalu");
    var nop = document.getElementById("name2").value;

    values = 0;
    if (kotak.checked) {
        // console.log("masuk nggak");
        var values = document.getElementById("tahunlalu").value;
        // values= val;
    }
    Ext.Ajax.request({
        url: './function/BPHTB/notaris/svc-npoptkp.php',
        method: 'POST',
        params: { id: d, axx: axx, noktp: noktp, jh: jh, nop: nop, lama: values },
        success: function (result, request) {
            var jsonData = JSON.parse(result.responseText);
            if (jsonData.success) {
                // console.log('NPOPTKP Value:', cNPOPTKP); // Log the value
                ...
                NPOPTKP_input.value = cNPOPTKP; // Set value directly
                checkTransaction();
                ...
                removeFChild(eNPOPTKP);
                var noptkp = document.createTextNode(number_format(cNPOPTKP, 0, '.', ','));
                NPOPTKP_input.value = cNPOPTKP; // Set value here
                eNPOPTKP.appendChild(noptkp);
...
function handleCheckboxChange() {
    var checkbox = document.getElementById("tahunlalu");
    if (checkbox.checked) {
        loadNPOPTKP()
    } else {
        loadNPOPTKP()
...
function check_nop_ktp() {
    var noktp = document.getElementById("noktp").value;
    var nop = document.getElementById("name2").value;
    Ext.Ajax.request({
        url: './function/BPHTB/notaris/svc-validasi-pelaporanbaruke.php',
        method: 'POST',
        params: { axx: axx, noktp: noktp, nop: nop },
        success: function (result, request) {
            var jsonData = JSON.parse(result.responseText);
            if (jsonData.success) {
                window.status_pelaporan = jsonData.status_pelaporan;
                checkTransaction();
                hideMask();
            }
        },
...
function validasi_check_nop() {
    var noktp = document.getElementById("noktp").value;
    var nop = document.getElementById("name2").value;
    Ext.Ajax.request({
        url: './function/BPHTB/notaris/svc-validasi-pelaporanbaruke2.php',
        method: 'POST',
        params: { axx: axx, noktp: noktp, nop: nop },
        success: function (result, request) {
            var jsonData = JSON.parse(result.responseText);
...
function loadLaikPasar() {
    ...
    Ext.Ajax.request({
        ...
        success: function (result, request) {
            var jsonData = JSON.parse(result.responseText),
                dennnied = $("input[type=submit]").attr("denied");
            if (jsonData.success) {
...
function checkNOP() {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.message)
                alert(res.message);
            // =========================== fungsi ini untuk mematikan button simpan dan finalkan =============================
            // if (res.denied == 1) {
            //     $("input[type=submit]").attr("disabled", "disabled");
            //     $("input[type=submit]").attr("denied", "1");
            // } else {
            //     $("input[type=submit]").removeAttr("disabled");
            //     $("input[type=submit]").attr("denied", "0");
            // }
            // =========================== end fungsi ini untuk mematikan button simpan dan finalkan =============================
            $('#errnop').remove();
            if (res.denied)
                if (res.denied == 1) {
                    var errnop = $("<span id='errnop'><br>" + res.message + "</span>").css({ 'color': '#FF0000' })
...
function checkKTP() {
    $("#load-ktp").html("<img src='image/large-loading.gif' style='width:20px;'>");
    var val = $.trim($("#noktp").val());
    $('#errnop').remove();
    if (val.length < 16) {
        var errnop = $("<span id='errnop'><br> KTP anda : " + val + ", harus 16 digit</span>").css({ 'color': '#FF0000' })
        // $(obj).val('').after(errnop);
        return false;
    }
    //$("#name2").blur();
    ...
    $.ajax({
        type: "post",
        data: "nop=" + val,
        url: "./function/BPHTB/notaris/svc-check-nop-ktp.php",
        dataType: "json",
        success: function (res) {
            //$("#load-pbb").html("");
            if (res.message)
...
function changekelurahann(e) {
    var val = e;
    $.ajax({
        type: "post",
        data: "value_=" + val,
        url: "./function/BPHTB/notaris/select_kelurahan.php",
        dataType: "json",
