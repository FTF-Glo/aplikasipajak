...
function getNOPBPHTB($nop) {
    ...
    $sql_pbb = "SELECT
	cppmod_ssb_doc.CPM_OP_NOMOR,
	cppmod_ssb_tranmain.CPM_TRAN_SSB_ID
FROM
	cppmod_ssb_doc
JOIN cppmod_ssb_tranmain ON cppmod_ssb_doc.CPM_SSB_ID = cppmod_ssb_tranmain.CPM_TRAN_SSB_ID
WHERE
	CPM_TRAN_STATUS != '5'
AND cppmod_ssb_doc.CPM_OP_NOMOR = '{$nop}'";
