...
function formSSB ($dat,$edit) {
	global $data,$uname,$a,$DBLink;
	echo "<script language=\"javascript\">var axx='".base64_encode($a)."';</script>\n";
	echo "<script src=\"function/BPHTB/updateBPHTB/pembayaran/pencatatan-tanggal-validasi/func-form-update-bphtb.js?ver=0\"></script>\n";
...
.myButton:active {
	...
	<div id=\"main-content\"><form id=\"form-notaris\" name=\"form-notaris\" method=\"post\" action=\"\" onsubmit=\"return checkform();\">
			...
			<tr>
			  <td colspan=\"2\" align=\"center\" style=\"border-radius: 10px 10px 0px 0px;\"><strong><font size=\"+2\">Pencatatan Tanggal Validasi<br>(Tanggal Bayar)</font></strong></td>
			</tr>
			<tr>
			  ...
			  <td><table width=\"850\" border=\"0\" cellspacing=\"1\" cellpadding=\"4\">
				<tr>
				  ...
				  <td width=\"220\"><input type=\"text\" name=\"noktps\" id=\"noktps\" value=\"" . $dat->wp_noktp . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"25\"  " . $readonly . " title=\"noktps\"/ readonly></td>
				</tr>
				<tr>
				  <td width=\"10\"><div align=\"right\"></div></td>
				  <td width=\"200\">Nama WP</td>
				  <td width=\"220\"><input type=\"text\" name=\"namawp\" id=\"namawp\" value=\"" . $dat->wp_nama . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"25\"  " . $readonly . " title=\"namawp\"/ readonly></td>
				</tr>
				<tr>
				  <td width=\"10\"><div align=\"right\"></div></td>
				  <td width=\"200\">No.BPHTB</td>
				  <td width=\"220\"><input type=\"text\" name=\"opnomor\" id=\"opnomor\" value=\"" . $dat->op_nomor . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"25\"  " . $readonly . " title=\"opnomor\"/ readonly></td>
				</tr>
				<tr>
				  <td width=\"10\"><div align=\"right\"></div></td>
				  <td width=\"200\">Tanggal Bayar</td>
				  <td width=\"220\"><input type=\"date\" name=\"payment_paid2\" id=\"payment_paid2\" value=\"" . $dat->payment_paid2 . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"25\"  " . $readonly . " title=\"Tanggal Bayar\"/></td>
				  <td width=\"220\"><input type=\"hidden\" name=\"payment_paid\" id=\"payment_paid\" value=\"" . $dat->payment_paid . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"25\"  " . $readonly . " title=\"payment_paid\"/></td>
				  <td width=\"220\"><input type=\"hidden\" name=\"id_switching\" id=\"id_switching\" value=\"" . $dat->id_switching . "\" onKeyPress=\"return nextFocus(this, event)\" size=\"25\"  " . $readonly . " title=\"Id Switching\"/></td>
				</tr>
