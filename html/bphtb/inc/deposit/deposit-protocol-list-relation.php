<?php 
class DepositProtocolListRelationRequest extends CISO8583Message
{
	function __construct()
	{
		...
		$this->SetValueForDataElement(24,440); //f_code for list relation
	}
...
class DepositProtocolListRelationResponse extends CISO8583Parser
{
