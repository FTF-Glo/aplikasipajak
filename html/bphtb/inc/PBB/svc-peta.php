<?php
define("SPOP_DBHOST", "127.0.0.1:3306");   // database host
define("SPOP_DBNAME", "SW_SSB_O2W_DEMO");   // database name
define("SPOP_DBUSER", "sw_user"); // database username to connect to database
//define("SPOP_DBPWD", "sw_pwd");   // database password to connect to database for supplied username
define("SPOP_DBPWD", "");   // database password to connect to database for supplied username
