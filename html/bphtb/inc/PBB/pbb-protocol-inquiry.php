...
class pbbProtocolInquiryRequest extends CISO8583Message
{
...
class pbbProtocolInquiryResponse extends CISO8583Parser
{
	...
	public function ExtractDataElement()
	{
		if($this->Parse())
		{
			...
			if ($this->dataElement['rc'] == "0000") {
				...
				$this->SplitThirdPrivateData($this->dataElement['priv3']);
