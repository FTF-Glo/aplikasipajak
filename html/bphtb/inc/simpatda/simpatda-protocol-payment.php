...
class simpatdaProtocolPaymentRequest extends CISO8583Message
{
	...
	private function ConstructPrivateData($aPriv)
	{
		...
		$sPriv .= str_pad($aPriv['object_name'],26," ",STR_PAD_RIGHT);
...
class simpatdaProtocolPaymentResponse extends CISO8583Parser
{
