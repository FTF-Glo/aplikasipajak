...
function onChangeTime(inputId){
	var iH = document.getElementById(inputId+'_hour').value;
	var iM = document.getElementById(inputId+'_minute').value;
	var iS = document.getElementById(inputId+'_second').value;
	var iTime = iH+':'+iM+':'+iS;
	document.getElementById(inputId).value=iTime;
}
