...
if(isset($submit))
{
	$txtCari=mysqli_real_escape_string($DBLink, $txtCari);
	$sqlCari="SELECT *FROM tbl_reg_user_bphtb WHERE userId LIKE ('%$txtCari%') AND status='1' AND kota='$NameKK' ORDER BY id";
...
{
$sqlTampil= "SELECT * FROM tbl_reg_user_bphtb WHERE status='1' AND kota='$NameKK' ORDER BY id DESC LIMIT 10";
