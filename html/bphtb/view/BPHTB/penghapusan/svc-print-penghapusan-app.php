...
foreach ($data as $item) {
	...
	//	$jam = date('');
	$queryup = "UPDATE sw_ssb.cppmod_ssb_doc SET  sdelete = '1', delete_by='$pengguna' ,delete_at = NOW() , keterangan = '$reasonn'  WHERE CPM_SSB_ID = '$id'";
	$res = mysqli_query($DBLink, $queryup);
...
function getHTML($iddoc, $draf, $lampiran, $ket_lamp)
{
  ...
  <tr>
	...
	BEA PEROLEHAN HAK ATAS TANAH DAN BANGUNAN <br />
	    </font></strong><strong><font size=\"+1\">(SSPD-BPHTB)</font><br/><font size=\"+2\">BADAN PENGELOLA PAJAK DAN RETRIBUSI <br/>DAERAH KABUPATEN AENAWfRnt></strong></td>
