...
function displayMenu ($selected) {
	...
	echo "\t<ul>\n";
	echo "\t\t<a href=\"main.php?param=".base64_encode($par1)."\"><li ".$selected1." ><span id=\"dil5-menu\">Tunda</span></li></a>\n";
	echo "\t\t<a href=\"main.php?param=".base64_encode($par2)."\"><li ".$selected2." ><span id=\"app-menu\">Disetujui</span></li></a>\n";
	echo "\t\t<a href=\"main.php?param=".base64_encode($par3)."\"><li ".$selected3." ><span id=\"rej-menu\">Ditolak</span></li></a>\n";
	echo "\t</ul>\n";
	echo "</div>\n";
}
