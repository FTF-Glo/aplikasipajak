...
// require_once($sRootPath . "pengurangan/json.php");

// require_once($sRootPath . "view/BPHTB/mod-display.php");
// /var/www/html/bphtb/view/BPHTB/pengurangan
function displayMenuPendata()
{  // srch
    global $a, $m, $data;
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/BPHTB/pengurangan/svc-list-pengurangan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'5', 'n':'1', 'u':'$data->uname'}") . "\"> Disetujui <span class=\"w3-badge w3-tiny w3-green\" id=\"setuju\">0</span></a></li>\n";

    // echo "\t\t<li><a href=\"view/BPHTB/pengurangan/svc-list-pengurangan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'4', 'n':'2', 'u':'$data->uname'}") . "\"> Ditolak <span class=\"w3-badge w3-tiny w3-red\" id=\"tolak\">0</span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/pengurangan/svc-list-pengurangan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'2', 'n':'3', 'u':'$data->uname'}") . "\"> Tertunda <span class=\"w3-badge w3-tiny w3-orange\" id=\"tunda\">0</span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/pengurangan/svc-list-pengurangan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'1', 'n':'4', 'u':'$data->uname'}") . "\"> Sementara <span class=\"w3-badge w3-tiny w3-blue\" id=\"sementara\">0</span></a></li>\n";
    // echo "\t\t<li><a href=\"view/BPHTB/pengurangan/svc-list-pengurangan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'99','n':'5', 'u':'$data->uname'}") . "\"><i class=\"\" style=\"font-size:16px;\"></i> Kadaluarsa <span class=\"w3-badge w3-tiny w3-black\" id=\"semua\">0</span></a></li>\n";

    // echo "\t\t<li><a href=\"view/BPHTB/pengurangan/svc-list-pengurangan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'100','n':'6', 'u':'$data->uname'}") . "\"><i class=\"fa fa-list-ul\" style=\"font-size:16px;\"></i> Semua Data <span class=\"w3-badge w3-tiny w3-black\" id=\"semua\">0</span></a></li>\n";


    // echo "\t\t<li><a href=\"view/BPHTB/pengurangan/svc-list-pengurangan.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'6', 'n':'7', 'u':'$data->uname'}") . "\"><i class=\"fa fa-archive\" style=\"font-size:16px;\"></i> History</a> </li>\n";
    echo "\t</ul>\n";
}
?>
...
<script type="text/javascript">
    ...
    // function hitit(token, id, code, exp, nop) {
    //     if (repeat != 0) {
    //         Ext.Ajax.request({
    //             url: "http://103.140.188.162:5051/function/curl/",
    //             method: "POST",
    //             params: {
    //                 token: token,
    //                 id: id,
    ...
    //                 exp: exp,
    //                 nop: nop,
    //                 callback: 'http://36.92.151.83:6030/function/BPHTB/func-save-qris.php'
    //             },
    ...
    // function loadData() {
    //     Ext.Ajax.request({
    //         url: './view/BPHTB/pengurangan/svc-pengurangan.php',
    //         params: {
    //             uname: uname
    //         },
    //         method: 'POST',
