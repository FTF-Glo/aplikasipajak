...
{  // srch
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/BPHTB/dispenda/svc-list-verifikasi_3.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'5', 'n':'1', 'u':'$data->uname'}") . "\"> Siap Terbit NTPD <span class=\"w3-badge w3-tiny w3-red\" id=\"setuju\"></span></a></li>\n";
    echo "\t\t<li><a href=\"view/BPHTB/dispenda/svc-list-verifikasi_3.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'2', 'n':'3', 'u':'$data->uname'}") . "\"> Sudah Terbit NTPD <span class=\"w3-badge w3-tiny w3-red\" id=\"tunda\"></span></a></li>\n";

    // echo "\t\t<li><a href=\"view/BPHTB/dispenda/svc-list-verifikasi_3.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'2', 'n':'3', 'u':'$data->uname'}") . "\"><i class=\"fa fa-inbox\" style=\"font-size:16px;\"></i> Sudah Terbit NTPD <span class=\"w3-badge w3-tiny w3-red\" id=\"tunda\"></span></a></a></li>\n";
