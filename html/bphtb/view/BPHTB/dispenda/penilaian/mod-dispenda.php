...
{  // srch
    ...
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/BPHTB/dispenda/penilaian/svc-list-verifikasi.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'7', 'n':'1', 'u':'$data->uname'}") . "\"> Disetujui <span class=\"w3-badge w3-tiny w3-red\" id=\"setuju\"></span></a></li>\n";
    echo "\t\t<li><a href=\"view/BPHTB/dispenda/penilaian/svc-list-verifikasi.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'4', 'n':'2', 'u':'$data->uname'}") . "\"> Ditolak <span class=\"w3-badge w3-tiny w3-red\" id=\"tolak\"></span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/dispenda/penilaian/svc-list-verifikasi.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'6', 'n':'3', 'u':'$data->uname'}") . "\"> Tertunda <span class=\"w3-badge w3-tiny w3-red\" id=\"proses\"></span></a></a></li>\n";
    // echo "\t\t<li><a href=\"view/BPHTB/dispenda/penilaian/svc-list-verifikasi.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'3', 'n':'4', 'u':'$data->uname'}") . "\"> Proses se <span class=\"w3-badge w3-tiny w3-red\" id=\"proses\"></span></a></li>\n";
    echo "\t\t<li><a href=\"view/BPHTB/dispenda/penilaian/svc-list-verifikasi.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'100', 'n':'5', 'u':'$data->uname'}") . "\"> Semua Data</a></li>\n";
    echo "\t</ul>\n";
}
?>
