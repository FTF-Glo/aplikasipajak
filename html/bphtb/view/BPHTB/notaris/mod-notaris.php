...
{  // srch
    global $a, $m, $data;
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'5', 'n':'1', 'u':'$data->uname'}") . "\"> Disetujui<span class=\"w3-badge w3-tiny w3-green\" id=\"setuju\">0</span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'4', 'n':'2', 'u':'$data->uname'}") . "\"> Ditolak <span class=\"w3-badge w3-tiny w3-red\" id=\"tolak\">0</span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'2', 'n':'3', 'u':'$data->uname'}") . "\"> Tertunda <span class=\"w3-badge w3-tiny w3-orange\" id=\"tunda\">0</span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'1', 'n':'4', 'u':'$data->uname'}") . "\"> Sementara <span class=\"w3-badge w3-tiny w3-blue\" id=\"sementara\">0</span></a></li>\n";
    ...
    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'100','n':'6', 'u':'$data->uname'}") . "\"> Semua Data <span class=\"w3-badge w3-tiny w3-black\" id=\"semua\">0</span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'6', 'n':'7', 'u':'$data->uname'}") . "\"> History</a> </li>\n";
    echo "\t</ul>\n";
}
?>
