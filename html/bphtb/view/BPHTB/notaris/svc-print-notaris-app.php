...
function getHTML($iddoc, $draf, $lampiran, $ket_lamp)
{
	...
	$data = getData($iddoc);
	// var_dump($data->CPM_TRAN_STATUS, $data->CPM_TRAN_FLAG);
	// die;
	...
	$NTPD = (($data->CPM_STATUS_NTPD == 1) ? 'NTPD : <b>' . $dataGwssb['ntpd'] . '</b>' : 'NTPD : <b> - </b>');
  ...
  <tr>
	...
	BEA PEROLEHAN HAK ATAS TANAH DAN BANGUNAN<br />
	    </font></strong><strong><font size=\"+1\">(SSPD-BPHTB)</font><br/><font size=\"+2\">BADAN PENDAPATAN DAERAH <br/> KABUPATEN PESISIR BARAT</font></strong></td>
	  ...
	  <tr>
		<td colspan=\"4\">
			<table width=\"100%\" border=\"0\" cellpadding=\"1\">
				<tr>
					<td colspan=\"2\" ><b><font size=\"-2\">" . strtoupper("Badan Pendapatan Daerah Kabupaten pesisir barat")   . "</font></b></td>
	  ...
	  <tr>
		...
		<table width=\"100%\" border=\"0\" cellpadding=\"1\">
	      ...
	      <tr>
	        ...
	        <td>NPWP</td>
	        <td>:</td>
	        <td colspan=\"7\"><span class=\"document-x\">" . $data->CPM_WP_NPWP . "</span></td>
			<td colspan=\"4\"align=\"right\"><font size=\"-2\">" . $NTPD . "</font></td>
	      </tr>
	      <tr>
	        <td align=\"right\">3.</td>
  ...
  <!--<tr>
	...
	if ($data->CPM_SSB_ID == '0a47f6b79fddd134857b2d3ebcb7b2f6' || $data->CPM_SSB_ID == '8ebb877e961c42c4fd38bc9517a40155' || $data->CPM_SSB_ID == '4b665c11967f1934e96ce403caa06b69' ||  $data->CPM_SSB_ID == '0649878e22b159e4b996d11a133bb1bc') {
		$TOTAL_SEMUANYA = 0;
	} else {
  ...
  <tr>
	...
	if ($data->statuspengurangan == 1) {
		$html .= " <td>Pengurangan menjadi <b> Rp. " . number_format($data->CPM_BPHTB_BAYAR, 0, ',', '.') . "   </b></td>
					<td>" . $data->nilaipersen . "%</td>";
	} else {
		$html .= " <td>Pengurangan menjadi  </td>
		<td>" . $data->CPM_PAYMENT_TIPE_PENGURANGAN . "%</td>";
	}

	$html .= " <td>Bedasarkan peraturan KDH No  : " . $data->CPM_PAYMENT_TIPE_KHD_NOMOR . "</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><table width=\"100%\" border=\"1\" cellpadding=\"1\">
	  ...
	  <tr>
			...
			<table width=\"100%\" border=\"0\">		  
				...
				<tr>
				 ...
				 <!-- <td align=\"center\" valign=\"top\" style=\"border-bottom:1px #000 solid\" width=\"165\"><b>" . strtoupper($nm_lengkap_notaris) . "</b>-->
				  <td align=\"center\" valign=\"top\" style=\"border-bottom:1px #000 solid\" width=\"165\"><b></b>			  	
				  </td>
				  <td width=\"10\"></td>
		        </tr>
				<tr>
		...
		<td width=\"165\">
			<table width=\"100%\" border=\"0\">
			    <tr>
			      <td align=\"center\" height=\"10\" colspan=\"3\">
				  <font size=\"-2\">TELAH DIVERIFIKASI <br>BADAN PENDAPATAN DAERAH<br>KABUPATEN PESISIR BARAT</font>			  
				  </td>
		        </tr>
				<tr>
...
for ($i = 0; $i < $v; $i++) {
	...
	$pdf->Image($sRootPath . 'view/Registrasi/configure/logo/' . $fileLogo, 19, 10, 17, '', '', '', '', false, 300, '', false);
	$pdf->SetAlpha(0.3);
	$pdf->ln(1);
	$pdf->SetAlpha(1);
	$pdf->write1DBarcode($NOP, 'C128', '', '', '', 17, 0.4, $style, 'N');
	if ($QRCodeSVG) {
		$pdf->ImageSVG('@' . $QRCodeSVG, $x = 112, $y = 283, $w = 32, $h = 32, $link = '', $align = '', $palign = '', $border = 0, $fitonpage = false);
		$pdf->ImageSVG('@' . $icoQRIS, $x = 146, $y = 304, $w = 16, $h = 16, $link = '', $align = '', $palign = '', $border = 0, $fitonpage = false);
	}
