...
{  // srch
    global $a, $m, $data;
    echo "\t<ul>\n";
    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'5', 'n':'1', 'u':'$data->uname'}") . "\"><i class=\"fa fa-clipboard\" style=\"font-size:16px;\"></i> Disetujui<span class=\"w3-badge w3-tiny w3-green\" id=\"setuju\">0</span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'4', 'n':'2', 'u':'$data->uname'}") . "\"><i class=\"fa fa-window-close\" style=\"font-size:16px;\"></i> Ditolak <span class=\"w3-badge w3-tiny w3-red\" id=\"tolak\">0</span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'2', 'n':'3', 'u':'$data->uname'}") . "\"><i class=\"fa fa-inbox\" style=\"font-size:16px;\"></i> Tertunda <span class=\"w3-badge w3-tiny w3-orange\" id=\"tunda\">0</span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'1', 'n':'4', 'u':'$data->uname'}") . "\"><i class=\"fa fa-paperclip\" style=\"font-size:16px;\"></i> Sementara <span class=\"w3-badge w3-tiny w3-blue\" id=\"sementara\">0</span></a></li>\n";
    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'99','n':'5', 'u':'$data->uname'}") . "\"><i class=\"\" style=\"font-size:16px;\"></i> Kadaluarsa <span class=\"w3-badge w3-tiny w3-black\" id=\"semua\">0</span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'100','n':'6', 'u':'$data->uname'}") . "\"><i class=\"fa fa-list-ul\" style=\"font-size:16px;\"></i> Semua Data <span class=\"w3-badge w3-tiny w3-black\" id=\"semua\">0</span></a></li>\n";

    echo "\t\t<li><a href=\"view/BPHTB/notaris/svc-list-notaris.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'6', 'n':'7', 'u':'$data->uname'}") . "\"><i class=\"fa fa-archive\" style=\"font-size:16px;\"></i> History</a> </li>\n";
    echo "\t</ul>\n";
}
?>
