			  ...
			  <tr>
				...
				<td>
					<table border=\"1\" width=\"575\">
						<tr>
							<td>&nbsp;&nbsp;<font size=\"-2\">" . strtoupper(SayInIndonesian(number_format($m,0,',',''))) . " RUPIAH</font></td>
						</tr>
					</table>
				</td>        
			  </tr>
    ...
    <td width=\"190\" height=\"90\">				
		<table width=\"100%\" border=\"0\">
		    <tr>
			  ...
			  <font size=\"-2\">TELAH DIVERIFIKASI <br>DINAS PENDAPATAN DAERAH<br> KOTA PALEMBANG</font>			  
			  </td>
	        </tr>
			<tr>
...
for ($i = 0; $i < $v; $i++) {
    ...
    $pdf->Image($sRootPath . 'view/Registrasi/configure/logo/' . $fileLogo, 10, 18, 30, '', '', '', '', false, 300, '', false);
    $pdf->SetAlpha(0.3);
    if ($draf == 1) {
        $bottomMargin = 0;
        for ($x = 1; $x <= 9; $x++) {
