...
function getHTML($iddoc,$draf) {
    ...
    if ($data->CPM_OP_JENIS_HAK == '2')
        $jenishak = "<span class=\"document-x\">Tukar Menukar</span>";
    if ($data->CPM_OP_JENIS_HAK == '3')
        $jenishak = "<span class=\"document-x\">Hibah</span>";
    if ($data->CPM_OP_JENIS_HAK == '4')
        $jenishak = "<span class=\"document-x\">Hibah Wasiat Sedarah Satu Derajat</span>";
    if ($data->CPM_OP_JENIS_HAK == '5')
        $jenishak = "<span class=\"document-x\">Hibah Wasiat Non Sedarah Satu Derajat</span>";
    if ($data->CPM_OP_JENIS_HAK == '6')
        $jenishak = "<span class=\"document-x\">Waris</span>";
    if ($data->CPM_OP_JENIS_HAK == '7')
        $jenishak = "<span class=\"document-x\">Pemasukan dalam perseroan/badan hukum lainnya</span>";
    if ($data->CPM_OP_JENIS_HAK == '8')
        $jenishak = "<span class=\"document-x\">Pemisahan hak yang mengakibatkan peralihan</span>";
    if ($data->CPM_OP_JENIS_HAK == '9')
        $jenishak = "<span class=\"document-x\">Penunjukan pembeli dalam lelang</span>";
    if ($data->CPM_OP_JENIS_HAK == '10')
        $jenishak = "<span class=\"document-x\">Pelaksanaan putusan hakim yang <br>mempunyai kekuatan hukum tetap</span>";
    if ($data->CPM_OP_JENIS_HAK == '11')
        $jenishak = "<span class=\"document-x\">Penggabungan usaha</span>";
    if ($data->CPM_OP_JENIS_HAK == '12')
        $jenishak = "<span class=\"document-x\">Pemekaran usaha</span>";
    if ($data->CPM_OP_JENIS_HAK == '13')
        $jenishak = "<span class=\"document-x\">Hadiah</span>";
    if ($data->CPM_OP_JENIS_HAK == '14')
        $jenishak = "<span class=\"document-x\">Jual beli khusus perolehan hak Rumah Sederhana dan
	Rumah Susun Sederhana melalui KPR bersubsidi</span>";
    if ($data->CPM_OP_JENIS_HAK == '15')
        $jenishak = "<span class=\"document-x\">Pemberian hak baru sebagai kelanjutan pelepasan hak</span>";
    if ($data->CPM_OP_JENIS_HAK == '16')
        $jenishak = "<span class=\"document-x\">Pemberian hak baru diluar pelepasan hak</span>";
      ...
      <tr>
        ...
        <td width=\"130\" align=\"right\">
			<table>
				<tr>
					<td width=\"20\" align=\"left\">Rp. </td>
					<td width=\"133\" align=\"right\"> " . number_format($npop, 0, ',', '.') . "</td>
				</tr>
			</table>
		</td>
      </tr>
      ...
      <tr>
        ...
        <td>
			<table border=\"0\">
				<tr>
					<td width=\"20\" align=\"left\">Rp. </td>
					<td width=\"133\" align=\"right\">" . number_format($b, 0, ',', '.') . "</td>
				</tr>
			</table>	
		</td>
      </tr>
      <tr>
        ...
        <td>
			<table>
				<tr>
					<td width=\"20\" align=\"left\">Rp. </td>
					<td width=\"133\" align=\"right\">" . number_format($a, 0, ',', '.') . "</td>
				</tr>
			</table>
		</td>
      </tr>      
			  ...
			  <tr>
				...
				<td>
					<table border=\"1\" width=\"575\">
						<tr>
							<td>&nbsp;&nbsp;<font size=\"-2\">" . strtoupper(SayInIndonesian(ceil($m))) . " RUPIAH</font></td>
						</tr>
					</table>
				</td>        
			  </tr>
  ...
  <tr>
	...
	<td width=\"185\">
		<table width=\"100%\" border=\"0\">		  
			<tr>
		      <td align=\"center\" height=\"10\" colspan=\"3\">
			  	<font size=\"-3\">MENGETAHUI:<br>PPAT/NOTARIS/KEPALA KANTOR PERTANAHAN KAB. CIANJUR/KEPALA KANTOR LELANG/PEJABAT LELANG,</font>		  
			  </td>
	        </tr>
			<tr>
	...
	<td width=\"165\">
		<table width=\"100%\" border=\"0\">
		    <tr>
		      <td align=\"center\" height=\"10\" colspan=\"3\">
			  <font size=\"-2\">TELAH DIVERIFIKASI <br>BADAN PENGELOLAAN PAJAK DAERAH<br> KABUPATEN CIANJUR</font>			  
			  </td>
	        </tr>
			<tr>
...
$style = array('position' => '', #for barcode
    'align' => 'C',
    'stretch' => true,
    'fitwidth' => true,
    'cellfitalign' => '',
