...
function displayMenuPendata() {  // srch
  ...
  echo "\t<ul>\n";
  echo "\t\t<li><a href=\"view/BPHTB/balailelang/svc-list-balailelang.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'5', 'n':'1', 'u':'$data->uname'}") . "\">Disetujui</a></li>\n";
  echo "\t\t<li><a href=\"view/BPHTB/balailelang/svc-list-balailelang.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'4', 'n':'2', 'u':'$data->uname'}") . "\">Ditolak</a></li>\n";
  echo "\t\t<li><a href=\"view/BPHTB/balailelang/svc-list-balailelang.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'2', 'n':'3', 'u':'$data->uname'}") . "\">Tertunda</a></li>\n";
  echo "\t\t<li><a href=\"view/BPHTB/balailelang/svc-list-balailelang.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'1', 'n':'4', 'u':'$data->uname'}") . "\">Sementara</a></li>\n";
  echo "\t\t<li><a href=\"view/BPHTB/balailelang/svc-list-balailelang.php?q=" . base64_encode("{'a':'$a', 'm':'$m', 's':'100', 'n':'5', 'u':'$data->uname'}") . "\">Semua Data</a></li>\n";
  echo "\t</ul>\n";
}
...
<script type="text/javascript">
	...
	function setTabs (sts) {
		...
		$( "#tabsContent" ).tabs( "option", "ajaxOptions", { async: false, data: { find: find } } );
	...
	if (json){
		window.open('./view/BPHTB/balailelang/svc-print-notaris-app.php?q='+encodeBase64(json), '_newtab');
	} else {
