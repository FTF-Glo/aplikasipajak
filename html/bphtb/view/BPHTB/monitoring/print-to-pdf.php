...
function headerContentAll($sts) {
	...
	$HTML .= "\t<tr>\n";
	$HTML .= "\t\t<th width=\"100\" align=\"center\"><b>Nomor Objek Pajak</b></th> \n";
	$HTML .= "\t\t<th width=\"100\" align=\"center\"><b>Wajib Pajak</b></th> \n";
	$HTML .= "\t\t<th width=\"150\" align=\"center\"><b>Alamat Objek Pajak</b></th>
				<th width=\"100\" align=\"center\"><b>User</b></th>
				<th width=\"100\" align=\"center\"><b>BPHTB yang harus dibayar</b></th>\n";
	$HTML .= "\t\t<th width=\"80\" align=\"center\"><b>Tanggal Pembayaran</b></th>\n";
	$HTML .= "\t</tr>\n";
...
$app = $q->app;
$src = trim($q->src);
$find_notaris = trim($q->find_notaris);
$tgl1= $q->tgl1;
$tgl2= $q->tgl2;
