...
function insertData($imgB)
{
  ...
  insertToTable($a, 'NPOPTKP_LAMA', $_REQUEST['NPOPTKP_lama']);
  ...
  //tambahan
  insertToTable($a, 'JUMLAH_TARGET', $_REQUEST['jumlah_target']);
  insertToTable($a, 'TAHUN_TARGET', $_REQUEST['tahun_target']);
    ...
    <table width="900" border="0" cellpadding="4">
      <tr>
        ...
        <td width="700"><input type="file" id="logo_file" name="logo_file" /><br /><i>
          ...
          <img width="200" height="200" src="view/Registrasi/configure/logo/<?php echo getConfigValue($a, 'FILE_LOGO') ?>" </td>
      </tr>
      <tr>
        <td colspan="2">Tengat Waktu</td>
        <td align="center">:</td>
        <td><label for="textfield"></label>
          <input type="text" name="tengat_waktu" id="tengat_waktu" value="<?php echo getConfigValue($a, 'TENGGAT_WAKTU') ?>">
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2">Nilai NPOPTKP Tahun Lalu</td>
        <td align="center">:</td>
        <td><input type="text" name="NPOPTKP_lama" id="NPOPTKP_lama" value="<?php echo getConfigValue($a, 'NPOPTKP_LAMA') ?>"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><label for="textarea"></label>
          <textarea name="alamat" id="alamat" cols="45" rows="5"><?php echo getConfigValue($a, 'ALAMAT') ?></textarea>
        </td>
      </tr>
      <tr>
        <td valign="top">&nbsp;</td>
      ...
      <tr>
        <td colspan="2" valign="top">Jumlah Target Pajak</td>
        <td align="center" valign="top">:</td>
        <td><input name="jumlah_target" type="text" id="jumlah_target" size="40" value="<?php echo getConfigValue($a, 'JUMLAH_TARGET') ?>"></td>
      </tr>

      <tr>
        <td colspan="2" valign="top">Tahun Target Pajak</td>
        <td align="center" valign="top">:</td>
        <td><input name="tahun_target" type="text" id="tahun_target" size="40" value="<?php echo getConfigValue($a, 'TAHUN_TARGET') ?>"></td>
      </tr>
